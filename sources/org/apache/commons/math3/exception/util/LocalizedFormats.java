...
public enum LocalizedFormats implements Localizable {
    ...
    private LocalizedFormats(String sourceFormat2) {
        this.sourceFormat = sourceFormat2;
    }

    public String getLocalizedString(Locale locale) {
        try {
            ResourceBundle bundle = ResourceBundle.getBundle("assets/" + LocalizedFormats.class.getName().replaceAll("\\.", "/"), locale);
