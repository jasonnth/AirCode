...
public abstract class DateTimeFieldType implements Serializable {
    ...
    public static final DateTimeFieldType CENTURY_OF_ERA_TYPE = new StandardDateTimeFieldType("centuryOfEra", 3, DurationFieldType.centuries(), DurationFieldType.eras());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType CLOCKHOUR_OF_DAY_TYPE = new StandardDateTimeFieldType("clockhourOfDay", 16, DurationFieldType.hours(), DurationFieldType.days());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType CLOCKHOUR_OF_HALFDAY_TYPE = new StandardDateTimeFieldType("clockhourOfHalfday", 15, DurationFieldType.hours(), DurationFieldType.halfdays());
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public static final DateTimeFieldType DAY_OF_WEEK_TYPE = new StandardDateTimeFieldType("dayOfWeek", PassportService.SF_DG12, DurationFieldType.days(), DurationFieldType.weeks());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType DAY_OF_YEAR_TYPE = new StandardDateTimeFieldType("dayOfYear", 6, DurationFieldType.days(), DurationFieldType.years());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType ERA_TYPE = new StandardDateTimeFieldType("era", 1, DurationFieldType.eras(), null);
    /* access modifiers changed from: private */
    public static final DateTimeFieldType HALFDAY_OF_DAY_TYPE = new StandardDateTimeFieldType("halfdayOfDay", 13, DurationFieldType.halfdays(), DurationFieldType.days());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType HOUR_OF_DAY_TYPE = new StandardDateTimeFieldType("hourOfDay", 17, DurationFieldType.hours(), DurationFieldType.days());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType HOUR_OF_HALFDAY_TYPE = new StandardDateTimeFieldType("hourOfHalfday", 14, DurationFieldType.hours(), DurationFieldType.halfdays());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType MILLIS_OF_DAY_TYPE = new StandardDateTimeFieldType("millisOfDay", 22, DurationFieldType.millis(), DurationFieldType.days());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType MILLIS_OF_SECOND_TYPE = new StandardDateTimeFieldType("millisOfSecond", 23, DurationFieldType.millis(), DurationFieldType.seconds());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType MINUTE_OF_DAY_TYPE = new StandardDateTimeFieldType("minuteOfDay", 18, DurationFieldType.minutes(), DurationFieldType.days());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType MINUTE_OF_HOUR_TYPE = new StandardDateTimeFieldType("minuteOfHour", 19, DurationFieldType.minutes(), DurationFieldType.hours());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType MONTH_OF_YEAR_TYPE = new StandardDateTimeFieldType("monthOfYear", 7, DurationFieldType.months(), DurationFieldType.years());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType SECOND_OF_DAY_TYPE = new StandardDateTimeFieldType("secondOfDay", 20, DurationFieldType.seconds(), DurationFieldType.days());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType SECOND_OF_MINUTE_TYPE = new StandardDateTimeFieldType("secondOfMinute", 21, DurationFieldType.seconds(), DurationFieldType.minutes());
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public static final DateTimeFieldType WEEK_OF_WEEKYEAR_TYPE = new StandardDateTimeFieldType("weekOfWeekyear", PassportService.SF_DG11, DurationFieldType.weeks(), DurationFieldType.weekyears());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType YEAR_OF_CENTURY_TYPE = new StandardDateTimeFieldType("yearOfCentury", 4, DurationFieldType.years(), DurationFieldType.centuries());
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public static final DateTimeFieldType YEAR_TYPE = new StandardDateTimeFieldType("year", 5, DurationFieldType.years(), null);
