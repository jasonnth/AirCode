...
abstract class BasicChronology extends AssembledChronology {
    ...
    public long getDateTimeMillis(int i, int i2, int i3, int i4, int i5, int i6, int i7) throws IllegalArgumentException {
        ...
        return getDateTimeMillis0(i, i2, i3, (int) ((long) ((JPushConstants.ONE_HOUR * i4) + (JPushConstants.ONE_MINUTE * i5) + (i6 * 1000) + i7)));
    }
    ...
    private long getDateTimeMillis0(int i, int i2, int i3, int i4) {
        ...
        if (dateMidnightMillis == Long.MIN_VALUE) {
            i4 -= 86400000;
            j = getDateMidnightMillis(i, i2, i3 + 1);
        } else {
    ...
    public int getDaysInYear(int i) {
        ...
        return MaxDaysNoticeSetting.MAX_DAYS_NOTICE_1_YEAR;
    }
    ...
    private YearInfo getYearInfo(int i) {
        ...
        this.iYearInfoCache[i & 1023] = yearInfo2;
        return yearInfo2;
    }
}
