    ...
    public void validate(ReadablePartial readablePartial, int[] iArr) {
        ...
        while (i2 < size) {
            ...
            if (i3 < field.getMinimumValue()) {
                throw new IllegalFieldValueException(field.getType(), Integer.valueOf(i3), Integer.valueOf(field.getMinimumValue()), null);
            } else if (i3 > field.getMaximumValue()) {
                throw new IllegalFieldValueException(field.getType(), Integer.valueOf(i3), null, Integer.valueOf(field.getMaximumValue()));
            } else {
                i2++;
            }
        }
        while (i < size) {
            ...
            if (i4 < field2.getMinimumValue(readablePartial, iArr)) {
                throw new IllegalFieldValueException(field2.getType(), Integer.valueOf(i4), Integer.valueOf(field2.getMinimumValue(readablePartial, iArr)), null);
            } else if (i4 > field2.getMaximumValue(readablePartial, iArr)) {
                throw new IllegalFieldValueException(field2.getType(), Integer.valueOf(i4), null, Integer.valueOf(field2.getMaximumValue(readablePartial, iArr)));
            } else {
                i++;
            }
        }
