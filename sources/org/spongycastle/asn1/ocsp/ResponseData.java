...
public class ResponseData extends ASN1Object {
    ...
    /* renamed from: V1 */
    private static final ASN1Integer f6384V1 = new ASN1Integer(0);
    ...
    public ResponseData(ResponderID responderID2, ASN1GeneralizedTime producedAt2, ASN1Sequence responses2, X509Extensions responseExtensions2) {
        this(f6384V1, responderID2, ASN1GeneralizedTime.getInstance(producedAt2), responses2, Extensions.getInstance(responseExtensions2));
    }
    ...
    public ResponseData(ResponderID responderID2, ASN1GeneralizedTime producedAt2, ASN1Sequence responses2, Extensions responseExtensions2) {
        this(f6384V1, responderID2, producedAt2, responses2, responseExtensions2);
    }

    private ResponseData(ASN1Sequence seq) {
        int index = 0;
        if (!(seq.getObjectAt(0) instanceof ASN1TaggedObject)) {
            this.version = f6384V1;
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (this.versionPresent || !this.version.equals(f6384V1)) {
