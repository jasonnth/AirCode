...
class LazyEncodedSequence extends ASN1Sequence {
    ...
    public synchronized Enumeration getObjects() {
        Enumeration lazyConstructionEnumeration;
        if (this.encoded == null) {
            lazyConstructionEnumeration = super.getObjects();
        } else {
            lazyConstructionEnumeration = new LazyConstructionEnumeration(this.encoded);
        }
