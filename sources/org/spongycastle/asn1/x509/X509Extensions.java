...
public class X509Extensions extends ASN1Object {
    ...
    public X509Extensions(ASN1Sequence seq) {
        ...
        while (e.hasMoreElements()) {
            ...
            if (s.size() == 3) {
                this.extensions.put(s.getObjectAt(0), new X509Extension(ASN1Boolean.getInstance((Object) s.getObjectAt(1)), ASN1OctetString.getInstance(s.getObjectAt(2))));
            } else if (s.size() == 2) {
    ...
    public X509Extensions(Vector ordering2, Hashtable extensions2) {
        ...
        while (e2.hasMoreElements()) {
            ASN1ObjectIdentifier oid = ASN1ObjectIdentifier.getInstance(e2.nextElement());
    ...
    public X509Extensions(Vector objectIDs, Vector values) {
        ...
        Enumeration e2 = this.ordering.elements();
        while (e2.hasMoreElements()) {
            this.extensions.put((ASN1ObjectIdentifier) e2.nextElement(), (X509Extension) values.elementAt(count));
            count++;
        }
    }
