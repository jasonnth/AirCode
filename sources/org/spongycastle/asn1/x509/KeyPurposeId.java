...
public class KeyPurposeId extends ASN1Object {
    public static final KeyPurposeId anyExtendedKeyUsage = new KeyPurposeId(Extension.extendedKeyUsage.branch(AppEventsConstants.EVENT_PARAM_VALUE_NO));
    ...
    /* renamed from: id */
    private ASN1ObjectIdentifier f6425id;
    ...
    public String getId() {
        return this.f6425id.getId();
    }

    public String toString() {
        return this.f6425id.toString();
    }
}
