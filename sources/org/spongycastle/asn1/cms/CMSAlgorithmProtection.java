...
public class CMSAlgorithmProtection extends ASN1Object {
    ...
    public CMSAlgorithmProtection(AlgorithmIdentifier digestAlgorithm2, int type, AlgorithmIdentifier algorithmIdentifier) {
        if (digestAlgorithm2 == null || algorithmIdentifier == null) {
