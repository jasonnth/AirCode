...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    /* renamed from: c */
    public static final ASN1ObjectIdentifier f6412c = new ASN1ObjectIdentifier("2.5.4.6").intern();

    /* renamed from: cn */
    public static final ASN1ObjectIdentifier f6413cn = new ASN1ObjectIdentifier("2.5.4.3").intern();

    /* renamed from: dc */
    public static final ASN1ObjectIdentifier f6414dc = new ASN1ObjectIdentifier("0.9.2342.19200300.100.1.25").intern();
    ...
    /* renamed from: l */
    public static final ASN1ObjectIdentifier f6415l = new ASN1ObjectIdentifier("2.5.4.7").intern();
    ...
    /* renamed from: o */
    public static final ASN1ObjectIdentifier f6416o = new ASN1ObjectIdentifier("2.5.4.10").intern();

    /* renamed from: ou */
    public static final ASN1ObjectIdentifier f6417ou = new ASN1ObjectIdentifier("2.5.4.11").intern();
    ...
    /* renamed from: sn */
    public static final ASN1ObjectIdentifier f6418sn = new ASN1ObjectIdentifier("2.5.4.4").intern();

    /* renamed from: st */
    public static final ASN1ObjectIdentifier f6419st = new ASN1ObjectIdentifier("2.5.4.8").intern();
    ...
    static {
        ...
        DefaultSymbols.put(f6412c, "c");
        DefaultSymbols.put(f6413cn, "cn");
        DefaultSymbols.put(f6414dc, "dc");
        ...
        DefaultSymbols.put(f6415l, "l");
        DefaultSymbols.put(member, "member");
        DefaultSymbols.put(name, "name");
        DefaultSymbols.put(f6416o, "o");
        DefaultSymbols.put(f6417ou, "ou");
        ...
        DefaultSymbols.put(postalCode, PostalAddress.POSTAL_CODE_KEY);
        ...
        DefaultSymbols.put(f6418sn, "sn");
        DefaultSymbols.put(f6419st, "st");
        ...
        DefaultSymbols.put(uid, JPushReportInterface.UID);
        ...
        DefaultLookUp.put("c", f6412c);
        DefaultLookUp.put("cn", f6413cn);
        DefaultLookUp.put("dc", f6414dc);
        ...
        DefaultLookUp.put("l", f6415l);
        DefaultLookUp.put("member", member);
        DefaultLookUp.put("name", name);
        DefaultLookUp.put("o", f6416o);
        DefaultLookUp.put("ou", f6417ou);
        ...
        DefaultLookUp.put("sn", f6418sn);
        DefaultLookUp.put("st", f6419st);
    ...
    public ASN1Encodable encodeStringValue(ASN1ObjectIdentifier oid, String value) {
        if (oid.equals(f6414dc)) {
            return new DERIA5String(value);
        }
        if (oid.equals(f6412c) || oid.equals(serialNumber) || oid.equals(dnQualifier) || oid.equals(telephoneNumber)) {
