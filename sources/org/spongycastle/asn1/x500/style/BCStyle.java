...
public class BCStyle extends AbstractX500NameStyle {
    ...
    /* renamed from: C */
    public static final ASN1ObjectIdentifier f6402C = new ASN1ObjectIdentifier("2.5.4.6").intern();

    /* renamed from: CN */
    public static final ASN1ObjectIdentifier f6403CN = new ASN1ObjectIdentifier("2.5.4.3").intern();
    ...
    /* renamed from: DC */
    public static final ASN1ObjectIdentifier f6404DC = new ASN1ObjectIdentifier("0.9.2342.19200300.100.1.25");
    ...
    /* renamed from: E */
    public static final ASN1ObjectIdentifier f6405E = EmailAddress;
    ...
    /* renamed from: L */
    public static final ASN1ObjectIdentifier f6406L = new ASN1ObjectIdentifier("2.5.4.7").intern();
    public static final ASN1ObjectIdentifier NAME = X509ObjectIdentifiers.id_at_name;
    public static final ASN1ObjectIdentifier NAME_AT_BIRTH = new ASN1ObjectIdentifier("1.3.36.8.3.14").intern();

    /* renamed from: O */
    public static final ASN1ObjectIdentifier f6407O = new ASN1ObjectIdentifier("2.5.4.10").intern();

    /* renamed from: OU */
    public static final ASN1ObjectIdentifier f6408OU = new ASN1ObjectIdentifier("2.5.4.11").intern();
    ...
    public static final ASN1ObjectIdentifier SERIALNUMBER = f6409SN;

    /* renamed from: SN */
    public static final ASN1ObjectIdentifier f6409SN = new ASN1ObjectIdentifier("2.5.4.5").intern();

    /* renamed from: ST */
    public static final ASN1ObjectIdentifier f6410ST = new ASN1ObjectIdentifier("2.5.4.8").intern();
    ...
    /* renamed from: T */
    public static final ASN1ObjectIdentifier f6411T = new ASN1ObjectIdentifier("2.5.4.12").intern();
    ...
    static {
        DefaultSymbols.put(f6402C, "C");
        DefaultSymbols.put(f6407O, "O");
        DefaultSymbols.put(f6411T, "T");
        DefaultSymbols.put(f6408OU, "OU");
        DefaultSymbols.put(f6403CN, AirbnbConstants.COUNTRY_CODE_CHINA);
        DefaultSymbols.put(f6406L, "L");
        DefaultSymbols.put(f6410ST, "ST");
        DefaultSymbols.put(f6409SN, "SERIALNUMBER");
        DefaultSymbols.put(EmailAddress, "E");
        DefaultSymbols.put(f6404DC, "DC");
        ...
        DefaultLookUp.put("c", f6402C);
        DefaultLookUp.put("o", f6407O);
        DefaultLookUp.put("t", f6411T);
        DefaultLookUp.put("ou", f6408OU);
        DefaultLookUp.put("cn", f6403CN);
        DefaultLookUp.put("l", f6406L);
        DefaultLookUp.put("st", f6410ST);
        DefaultLookUp.put("sn", f6409SN);
        DefaultLookUp.put("serialnumber", f6409SN);
        DefaultLookUp.put("street", STREET);
        DefaultLookUp.put("emailaddress", f6405E);
        DefaultLookUp.put("dc", f6404DC);
        DefaultLookUp.put("e", f6405E);
    ...
    public ASN1Encodable encodeStringValue(ASN1ObjectIdentifier oid, String value) {
        if (oid.equals(EmailAddress) || oid.equals(f6404DC)) {
            return new DERIA5String(value);
        }
        if (oid.equals(DATE_OF_BIRTH)) {
            return new ASN1GeneralizedTime(value);
        }
        if (oid.equals(f6402C) || oid.equals(f6409SN) || oid.equals(DN_QUALIFIER) || oid.equals(TELEPHONE_NUMBER)) {
