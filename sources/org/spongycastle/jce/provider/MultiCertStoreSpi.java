...
public class MultiCertStoreSpi extends CertStoreSpi {
    ...
    public MultiCertStoreSpi(CertStoreParameters params2) throws InvalidAlgorithmParameterException {
        super(params2);
        if (!(params2 instanceof MultiCertStoreParameters)) {
        ...
        this.params = (MultiCertStoreParameters) params2;
    }
