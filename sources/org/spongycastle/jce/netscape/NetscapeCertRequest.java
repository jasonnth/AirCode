...
public class NetscapeCertRequest extends ASN1Object {
    ...
    private static ASN1Sequence getReq(byte[] r) throws IOException {
        return ASN1Sequence.getInstance(new ASN1InputStream((InputStream) new ByteArrayInputStream(r)).readObject());
    }
    ...
    public NetscapeCertRequest(ASN1Sequence spkac) {
        try {
            ...
            X509EncodedKeySpec xspec = new X509EncodedKeySpec(new DERBitString((ASN1Encodable) pubkeyinfo).getBytes());
    ...
    public NetscapeCertRequest(String challenge2, AlgorithmIdentifier signing_alg, PublicKey pub_key) throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchProviderException {
        ...
        content_der.add(new DERIA5String(challenge2));
        try {
            this.content = new DERBitString((ASN1Encodable) new DERSequence(content_der));
        } catch (IOException e) {
    ...
    public boolean verify(String challenge2) throws NoSuchAlgorithmException, InvalidKeyException, SignatureException, NoSuchProviderException {
    ...
    private ASN1Primitive getKeySpec() throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchProviderException {
        ...
        try {
            ...
            baos.close();
            return new ASN1InputStream((InputStream) new ByteArrayInputStream(baos.toByteArray())).readObject();
        } catch (IOException ioe) {
