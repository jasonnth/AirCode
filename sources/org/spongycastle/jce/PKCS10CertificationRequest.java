...
public class PKCS10CertificationRequest extends CertificationRequest {
    ...
    public PublicKey getPublicKey(String provider) throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException {
        ...
        try {
            xspec = new X509EncodedKeySpec(new DERBitString((ASN1Encodable) subjectPKInfo).getOctets());
    ...
    static String getSignatureName(AlgorithmIdentifier sigAlgId) {
        ...
        if (params2 == null || DERNull.INSTANCE.equals(params2) || !sigAlgId.getAlgorithm().equals(PKCSObjectIdentifiers.id_RSASSA_PSS)) {
