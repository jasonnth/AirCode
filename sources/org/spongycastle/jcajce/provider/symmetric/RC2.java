...
public final class RC2 {
    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        public AlgorithmParameters engineGenerateParameters() {
            if (this.spec == null) {
                ...
                try {
                    AlgorithmParameters params2 = createParametersInstance("RC2");
                    params2.init(this.spec);
                    return params2;
                } catch (Exception e2) {
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        /* renamed from: iv */
        private byte[] f6920iv;
        private int parameterVersion = 58;

        /* access modifiers changed from: protected */
        public byte[] engineGetEncoded() {
            return Arrays.clone(this.f6920iv);
        }
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class paramSpec) throws InvalidParameterSpecException {
            if (paramSpec != RC2ParameterSpec.class || this.parameterVersion == -1) {
                if (paramSpec == IvParameterSpec.class) {
                    return new IvParameterSpec(this.f6920iv);
                }
                throw new InvalidParameterSpecException("unknown parameter spec passed to RC2 parameters object.");
            } else if (this.parameterVersion < 256) {
                return new RC2ParameterSpec(ekb[this.parameterVersion], this.f6920iv);
            } else {
                return new RC2ParameterSpec(this.parameterVersion, this.f6920iv);
            }
        }
        ...
        public void engineInit(AlgorithmParameterSpec paramSpec) throws InvalidParameterSpecException {
            if (paramSpec instanceof IvParameterSpec) {
                this.f6920iv = ((IvParameterSpec) paramSpec).getIV();
                ...
                this.f6920iv = ((RC2ParameterSpec) paramSpec).getIV();
            } else {
        ...
        public void engineInit(byte[] params) throws IOException {
            this.f6920iv = Arrays.clone(params);
        }
