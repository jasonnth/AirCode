...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Set getExtensionOIDs(boolean critical) {
        Extensions extensions = this.f6914c.getExtensions();
        if (extensions == null) {
            return null;
        }
        Set set = new HashSet();
    ...
    private Extension getExtension(ASN1ObjectIdentifier oid) {
        Extensions exts = this.f6914c.getExtensions();
        if (exts != null) {
    ...
    public boolean equals(Object o) {
        ...
        return this.f6914c.equals(((X509CRLEntryObject) o).f6914c);
    }

    public byte[] getEncoded() throws CRLException {
        try {
            return this.f6914c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public BigInteger getSerialNumber() {
        return this.f6914c.getUserCertificate().getValue();
    }

    public Date getRevocationDate() {
        return this.f6914c.getRevocationDate().getDate();
    }

    public boolean hasExtensions() {
        return this.f6914c.getExtensions() != null;
    }
