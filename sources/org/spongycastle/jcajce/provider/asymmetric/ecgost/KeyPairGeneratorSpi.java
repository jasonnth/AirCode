...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public void initialize(int strength2, SecureRandom random2) {
        ...
        if (this.ecParams != null) {
            try {
                initialize((AlgorithmParameterSpec) (ECGenParameterSpec) this.ecParams, random2);
    ...
    public void initialize(AlgorithmParameterSpec params, SecureRandom random2) throws InvalidAlgorithmParameterException {
        ...
        if (params instanceof ECParameterSpec) {
            ...
            this.param = new ECKeyGenerationParameters(new ECDomainParameters(p.getCurve(), p.getG(), p.getN()), random2);
            ...
            this.param = new ECKeyGenerationParameters(new ECDomainParameters(curve, EC5Util.convertPoint(curve, p2.getGenerator(), false), p2.getOrder(), BigInteger.valueOf((long) p2.getCofactor())), random2);
            this.engine.init(this.param);
            this.initialised = true;
            ...
            this.param = new ECKeyGenerationParameters(new ECDomainParameters(curve2, EC5Util.convertPoint(curve2, p3.getGenerator(), false), p3.getOrder(), BigInteger.valueOf((long) p3.getCofactor())), random2);
            this.engine.init(this.param);
            this.initialised = true;
            ...
            this.ecParams = params;
            this.param = new ECKeyGenerationParameters(new ECDomainParameters(p4.getCurve(), p4.getG(), p4.getN()), random2);
            this.engine.init(this.param);
            this.initialised = true;
        } else if (params == null && BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa() == null) {
