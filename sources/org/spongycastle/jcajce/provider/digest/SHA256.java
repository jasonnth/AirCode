...
public class SHA256 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider provider) {
            ...
            addHMACAlgorithm(provider, McElieceCCA2ParameterSpec.DEFAULT_MD, PREFIX + "$HashMac", PREFIX + "$KeyGenerator");
            addHMACAlias(provider, McElieceCCA2ParameterSpec.DEFAULT_MD, PKCSObjectIdentifiers.id_hmacWithSHA256);
            addHMACAlias(provider, McElieceCCA2ParameterSpec.DEFAULT_MD, NISTObjectIdentifiers.id_sha256);
        }
    }
