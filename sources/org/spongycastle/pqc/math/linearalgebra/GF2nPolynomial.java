...
public class GF2nPolynomial {
    ...
    /* renamed from: at */
    public final GF2nElement mo54547at(int index) {
    ...
    public final GF2nPolynomial add(GF2nPolynomial b) throws RuntimeException {
    ...
    public final GF2nPolynomial scalarMultiply(GF2nElement s) throws RuntimeException {
    ...
    public final GF2nPolynomial multiply(GF2nPolynomial b) throws RuntimeException {
        int aDegree = size();
        if (aDegree != b.size()) {
    ...
    public final GF2nPolynomial multiplyAndReduce(GF2nPolynomial b, GF2nPolynomial g) throws RuntimeException, ArithmeticException {
    ...
    public final GF2nPolynomial[] divide(GF2nPolynomial b) throws RuntimeException, ArithmeticException {
    ...
    public final GF2nPolynomial gcd(GF2nPolynomial g) throws RuntimeException, ArithmeticException {
        GF2nPolynomial a = new GF2nPolynomial(this);
