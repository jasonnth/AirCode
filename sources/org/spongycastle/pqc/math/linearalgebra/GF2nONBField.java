...
public class GF2nONBField extends GF2nField {
    ...
    public GF2nElement getRandomRoot(GF2Polynomial polynomial) {
        ...
        while (gDegree2 > 1) {
            while (true) {
                ...
                GF2nPolynomial ut = new GF2nPolynomial(2, (GF2nElement) GF2nONBElement.ZERO(this));
                ut.set(1, u);
    ...
    public int[][] invMatrix(int[][] a) {
        int[][] iArr = (int[][]) Array.newInstance(Integer.TYPE, new int[]{this.mDegree, this.mDegree});
        int[][] A = a;
        int[][] inv = (int[][]) Array.newInstance(Integer.TYPE, new int[]{this.mDegree, this.mDegree});
        for (int i = 0; i < this.mDegree; i++) {
            inv[i][i] = 1;
        }
