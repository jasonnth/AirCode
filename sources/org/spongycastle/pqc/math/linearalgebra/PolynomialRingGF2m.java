...
public class PolynomialRingGF2m {
    ...
    /* renamed from: p */
    private PolynomialGF2mSmallM f7233p;
    protected PolynomialGF2mSmallM[] sqMatrix;
    protected PolynomialGF2mSmallM[] sqRootMatrix;

    public PolynomialRingGF2m(GF2mField field2, PolynomialGF2mSmallM p) {
        this.field = field2;
        this.f7233p = p;
    ...
    private void computeSquaringMatrix() {
        int numColumns = this.f7233p.getDegree();
        ...
        for (int i2 = numColumns >> 1; i2 < numColumns; i2++) {
            ...
            monomCoeffs2[i2 << 1] = 1;
            this.sqMatrix[i2] = new PolynomialGF2mSmallM(this.field, monomCoeffs2).mod(this.f7233p);
        }
    }
    ...
    private void computeSquareRootMatrix() {
        ...
        for (int i3 = 0; i3 < numColumns; i3++) {
            ...
            for (int j2 = 0; j2 < numColumns; j2++) {
                if (j2 != i3) {
                    int coef = tmpMatrix[j2].getCoefficient(i3);
                    if (coef != 0) {
