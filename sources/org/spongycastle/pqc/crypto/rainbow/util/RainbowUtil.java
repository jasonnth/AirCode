...
public class RainbowUtil {
    ...
    public static short[][] convertArray(byte[][] in) {
        short[][] out = (short[][]) Array.newInstance(Short.TYPE, new int[]{in.length, in[0].length});
        for (int i = 0; i < in.length; i++) {
    ...
    public static short[][][] convertArray(byte[][][] in) {
        short[][][] out = (short[][][]) Array.newInstance(Short.TYPE, new int[]{in.length, in[0].length, in[0][0].length});
        for (int i = 0; i < in.length; i++) {
            for (int j = 0; j < in[0].length; j++) {
    ...
    public static byte[][] convertArray(short[][] in) {
        byte[][] out = (byte[][]) Array.newInstance(Byte.TYPE, new int[]{in.length, in[0].length});
        for (int i = 0; i < in.length; i++) {
            for (int j = 0; j < in[0].length; j++) {
                out[i][j] = (byte) in[i][j];
            }
    ...
    public static byte[][][] convertArray(short[][][] in) {
        byte[][][] out = (byte[][][]) Array.newInstance(Byte.TYPE, new int[]{in.length, in[0].length, in[0][0].length});
        for (int i = 0; i < in.length; i++) {
            for (int j = 0; j < in[0].length; j++) {
                for (int k = 0; k < in[0][0].length; k++) {
