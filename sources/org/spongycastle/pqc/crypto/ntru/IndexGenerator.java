...
public class IndexGenerator {
    ...
    IndexGenerator(byte[] seed2, NTRUEncryptionParameters params) {
        this.seed = seed2;
        this.f7131N = params.f7140N;
        this.f7132c = params.f7141c;
    ...
    public int nextIndex() {
        ...
        do {
            this.totLen += this.f7132c;
            BitString M = this.buf.getTrailing(this.remLen);
            if (this.remLen < this.f7132c) {
                int tmpLen = this.f7132c - this.remLen;
                ...
                this.remLen -= this.f7132c;
            }
            i = M.getLeadingAsInt(this.f7132c);
        } while (i >= (1 << this.f7132c) - ((1 << this.f7132c) % this.f7131N));
        return i % this.f7131N;
    }
