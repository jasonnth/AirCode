...
public class SecP224K1Field {
    ...
    /* renamed from: P */
    static final int[] f7014P = {-6803, -2, -1, -1, -1, -1, -1};

    /* renamed from: P6 */
    private static final int f7015P6 = -1;
    ...
    public static void add(int[] x, int[] y, int[] z) {
        if (Nat224.add(x, y, z) != 0 || (z[6] == -1 && Nat224.gte(z, f7014P))) {
    ...
    public static void addOne(int[] x, int[] z) {
        if (Nat.inc(7, x, z) != 0 || (z[6] == -1 && Nat224.gte(z, f7014P))) {
            Nat.add33To(7, PInv33, z);
        }
    }
    ...
    public static void half(int[] x, int[] z) {
        if ((x[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(7, z, Nat224.add(x, f7014P, z));
        }
    }
    ...
    public static void negate(int[] x, int[] z) {
        if (Nat224.isZero(x)) {
            ...
            Nat224.sub(f7014P, x, z);
        }
    }

    public static void reduce(int[] xx, int[] z) {
        if (Nat224.mul33DWordAdd(PInv33, Nat224.mul33Add(PInv33, xx, 7, xx, 0, z, 0), z, 0) != 0 || (z[6] == -1 && Nat224.gte(z, f7014P))) {
            Nat.add33To(7, PInv33, z);
        }
    }

    public static void reduce32(int x, int[] z) {
        if ((x != 0 && Nat224.mul33WordAdd(PInv33, x, z, 0) != 0) || (z[6] == -1 && Nat224.gte(z, f7014P))) {
            Nat.add33To(7, PInv33, z);
        }
    }
    ...
    public static void twice(int[] x, int[] z) {
        if (Nat.shiftUpBit(7, x, 0, z) != 0 || (z[6] == -1 && Nat224.gte(z, f7014P))) {
            Nat.add33To(7, PInv33, z);
        }
    }
}
