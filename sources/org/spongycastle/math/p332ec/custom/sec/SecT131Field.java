...
/* renamed from: org.spongycastle.math.ec.custom.sec.SecT131Field */
public class SecT131Field {
    ...
    public static void reduce(long[] xx, long[] z) {
        ...
        long x4 = xx[4];
        long x32 = x3 ^ (x4 >>> 59);
        long x12 = (x1 ^ ((x4 << 61) ^ (x4 << 63))) ^ ((((x32 >>> 3) ^ (x32 >>> 1)) ^ x32) ^ (x32 << 5));
    ...
    protected static void implMultiply(long[] x, long[] y, long[] zz) {
        ...
        long w2 = (u2 ^ v2) ^ (w1 >>> 44);
        long w12 = w1 & M44;
        long w02 = ((w0 & M44) >>> 1) ^ ((1 & w12) << 43);
        long w03 = w02 ^ (w02 << 1);
        long w04 = w03 ^ (w03 << 2);
        long w05 = w04 ^ (w04 << 4);
        long w06 = w05 ^ (w05 << 8);
        long w07 = w06 ^ (w06 << 16);
        long w08 = (w07 ^ (w07 << 32)) & M44;
        long w13 = ((w12 >>> 1) ^ ((1 & w2) << 43)) ^ (w08 >>> 43);
        long w14 = w13 ^ (w13 << 1);
        long w15 = w14 ^ (w14 << 2);
        long w16 = w15 ^ (w15 << 4);
        long w17 = w16 ^ (w16 << 8);
