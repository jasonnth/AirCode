...
public class SecT239Field {
    ...
    public static void invert(long[] x, long[] z) {
        ...
        square(t1, t1);
        multiply(t1, x, t1);
        squareN(t1, LDSFile.EF_SOD_TAG, t0);
        multiply(t0, t1, t0);
        square(t0, z);
    }
    ...
    public static void reduce(long[] xx, long[] z) {
        ...
        long x12 = (x1 ^ (x52 << 17)) ^ (x42 >>> 47);
        long x22 = ((x2 ^ (x62 << 17)) ^ (x52 >>> 47)) ^ (x42 << 47);
    ...
    public static void sqrt(long[] x, long[] z) {
        ...
        long c12 = c1 ^ (c0 << 15);
        long[] tt = Nat256.createExt64();
        int[] shifts = {39, EACTags.COMPATIBLE_TAG_ALLOCATION_AUTHORITY};
    ...
    protected static void implMulwAcc(long x, long y, long[] z, int zOff) {
        ...
        long h2 = h ^ (((585610922974906400L & x) & ((y << 4) >> 63)) >>> 5);
        z[zOff] = z[zOff] ^ (M60 & l);
        int i = zOff + 1;
        z[i] = z[i] ^ ((l >>> 60) ^ (h2 << 4));
    }
