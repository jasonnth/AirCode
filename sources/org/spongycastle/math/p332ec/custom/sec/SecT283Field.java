...
/* renamed from: org.spongycastle.math.ec.custom.sec.SecT283Field */
public class SecT283Field {
    ...
    public static void invert(long[] x, long[] z) {
        ...
        square(t0, t0);
        multiply(t0, x, t0);
        squareN(t0, CipherSuite.TLS_PSK_WITH_AES_256_CBC_SHA, t1);
        multiply(t1, t0, t1);
        square(t1, z);
    }
    ...
    public static void reduce(long[] xx, long[] z) {
        ...
        long x32 = (x3 ^ ((((x8 << 37) ^ (x8 << 42)) ^ (x8 << 44)) ^ (x8 << 49))) ^ ((((x7 >>> 27) ^ (x7 >>> 22)) ^ (x7 >>> 20)) ^ (x7 >>> 15));
        long x22 = (x2 ^ ((((x7 << 37) ^ (x7 << 42)) ^ (x7 << 44)) ^ (x7 << 49))) ^ ((((x6 >>> 27) ^ (x6 >>> 22)) ^ (x6 >>> 20)) ^ (x6 >>> 15));
        long x12 = (x1 ^ ((((x6 << 37) ^ (x6 << 42)) ^ (x6 << 44)) ^ (x6 << 49))) ^ ((((x5 >>> 27) ^ (x5 >>> 22)) ^ (x5 >>> 20)) ^ (x5 >>> 15));
        long t = x42 >>> 27;
    ...
    protected static void implMultiply(long[] x, long[] y, long[] zz) {
        ...
        implExpand(y, b);
        long[] p = new long[26];
        implMulw(a[0], b[0], p, 0);
        implMulw(a[1], b[1], p, 2);
        implMulw(a[2], b[2], p, 4);
        implMulw(a[3], b[3], p, 6);
        implMulw(a[4], b[4], p, 8);
        long u0 = a[0] ^ a[1];
        long v0 = b[0] ^ b[1];
        long u1 = a[0] ^ a[2];
        long v1 = b[0] ^ b[2];
        ...
        long u3 = a[3] ^ a[4];
        long v3 = b[3] ^ b[4];
        implMulw(u1 ^ a[3], v1 ^ b[3], p, 18);
        implMulw(u2 ^ a[1], v2 ^ b[1], p, 20);
        long A4 = u0 ^ u3;
        long B4 = v0 ^ v3;
        long A5 = A4 ^ a[2];
        long B5 = B4 ^ b[2];
    ...
    protected static void implMulw(long x, long y, long[] z, int zOff) {
        ...
        long h2 = h ^ (((72198606942111744L & x) & ((y << 7) >> 63)) >>> 8);
        z[zOff] = M57 & l;
        z[zOff + 1] = (l >>> 57) ^ (h2 << 7);
    }
