...
/* renamed from: org.spongycastle.math.ec.custom.sec.SecP160R2Point */
public class SecP160R2Point extends AbstractFp {
    ...
    public ECPoint add(ECPoint b) {
        ...
        if (!Nat160.isZero(H)) {
            ...
            return new SecP160R2Point(curve, X3, Y3, new ECFieldElement[]{secP160R2FieldElement}, this.withCompression);
    ...
    public ECPoint twice() {
        ...
        boolean Z1IsOne = Z1.isOne();
        int[] Z1Squared = Z1.f7001x;
        if (!Z1IsOne) {
            Z1Squared = t2;
            SecP160R2Field.square(Z1.f7001x, Z1Squared);
        }
        SecP160R2Field.subtract(X1.f7001x, Z1Squared, t1);
        int[] M = t2;
        SecP160R2Field.add(X1.f7001x, Z1Squared, M);
        ...
        SecP160R2FieldElement secP160R2FieldElement = new SecP160R2FieldElement(M);
        SecP160R2Field.twice(Y1.f7001x, secP160R2FieldElement.f7001x);
        if (!Z1IsOne) {
            SecP160R2Field.multiply(secP160R2FieldElement.f7001x, Z1.f7001x, secP160R2FieldElement.f7001x);
        }
        return new SecP160R2Point(curve, X3, Y3, new ECFieldElement[]{secP160R2FieldElement}, this.withCompression);
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160R2Point(this.curve, this.f6973x, this.f6974y.negate(), this.f6975zs, this.withCompression);
    }
}
