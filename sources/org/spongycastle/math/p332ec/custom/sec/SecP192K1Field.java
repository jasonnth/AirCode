...
public class SecP192K1Field {
    ...
    /* renamed from: P */
    static final int[] f7003P = {-4553, -2, -1, -1, -1, -1};

    /* renamed from: P5 */
    private static final int f7004P5 = -1;
    ...
    public static void add(int[] x, int[] y, int[] z) {
        if (Nat192.add(x, y, z) != 0 || (z[5] == -1 && Nat192.gte(z, f7003P))) {
    ...
    public static void addOne(int[] x, int[] z) {
        if (Nat.inc(6, x, z) != 0 || (z[5] == -1 && Nat192.gte(z, f7003P))) {
            Nat.add33To(6, PInv33, z);
        }
    }
    ...
    public static int[] fromBigInteger(BigInteger x) {
        ...
        if (z[5] == -1 && Nat192.gte(z, f7003P)) {
            Nat192.subFrom(f7003P, z);
        }
        return z;
    }
    ...
    public static void half(int[] x, int[] z) {
        if ((x[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(6, z, Nat192.add(x, f7003P, z));
        }
    }
    ...
    public static void negate(int[] x, int[] z) {
        if (Nat192.isZero(x)) {
            ...
            Nat192.sub(f7003P, x, z);
        }
    }

    public static void reduce(int[] xx, int[] z) {
        if (Nat192.mul33DWordAdd(PInv33, Nat192.mul33Add(PInv33, xx, 6, xx, 0, z, 0), z, 0) != 0 || (z[5] == -1 && Nat192.gte(z, f7003P))) {
            Nat.add33To(6, PInv33, z);
        }
    }

    public static void reduce32(int x, int[] z) {
        if ((x != 0 && Nat192.mul33WordAdd(PInv33, x, z, 0) != 0) || (z[5] == -1 && Nat192.gte(z, f7003P))) {
            Nat.add33To(6, PInv33, z);
        }
    }
    ...
    public static void twice(int[] x, int[] z) {
        if (Nat.shiftUpBit(6, x, 0, z) != 0 || (z[5] == -1 && Nat192.gte(z, f7003P))) {
            Nat.add33To(6, PInv33, z);
        }
    }
}
