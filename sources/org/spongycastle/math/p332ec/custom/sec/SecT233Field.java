...
/* renamed from: org.spongycastle.math.ec.custom.sec.SecT233Field */
public class SecT233Field {
    ...
    public static void reduce(long[] xx, long[] z) {
        ...
        long x12 = (x1 ^ (x52 << 23)) ^ ((x42 >>> 41) ^ (x42 << 33));
        long x22 = ((x2 ^ (x6 << 23)) ^ ((x52 >>> 41) ^ (x52 << 33))) ^ (x42 >>> 31);
        long t = x32 >>> 41;
        z[0] = (x0 ^ (x42 << 23)) ^ t;
        z[1] = (t << 10) ^ x12;
        z[2] = x22;
    ...
    public static void sqrt(long[] x, long[] z) {
        ...
        long c02 = c0 ^ (c0 << 37);
        long[] tt = Nat256.createExt64();
        int[] shifts = {32, LDSFile.EF_DG2_TAG, CipherSuite.TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA256};
    ...
    protected static void implSquare(long[] x, long[] zz) {
        ...
        zz[7] = ((long) Interleave.expand16to32((int) (x3 >>> 32))) & 4294967295L;
    }
}
