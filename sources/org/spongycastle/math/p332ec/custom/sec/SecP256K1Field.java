...
public class SecP256K1Field {
    ...
    /* renamed from: P */
    static final int[] f7025P = {-977, -2, -1, -1, -1, -1, -1, -1};

    /* renamed from: P7 */
    private static final int f7026P7 = -1;
    ...
    public static void add(int[] x, int[] y, int[] z) {
        if (Nat256.add(x, y, z) != 0 || (z[7] == -1 && Nat256.gte(z, f7025P))) {
    ...
    public static void addOne(int[] x, int[] z) {
        if (Nat.inc(8, x, z) != 0 || (z[7] == -1 && Nat256.gte(z, f7025P))) {
            Nat.add33To(8, PInv33, z);
        }
    }
    ...
    public static int[] fromBigInteger(BigInteger x) {
        ...
        if (z[7] == -1 && Nat256.gte(z, f7025P)) {
            Nat256.subFrom(f7025P, z);
        }
        return z;
    }
    ...
    public static void half(int[] x, int[] z) {
        if ((x[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(8, z, Nat256.add(x, f7025P, z));
        }
    }
    ...
    public static void negate(int[] x, int[] z) {
        if (Nat256.isZero(x)) {
            ...
            Nat256.sub(f7025P, x, z);
        }
    }

    public static void reduce(int[] xx, int[] z) {
        if (Nat256.mul33DWordAdd(PInv33, Nat256.mul33Add(PInv33, xx, 8, xx, 0, z, 0), z, 0) != 0 || (z[7] == -1 && Nat256.gte(z, f7025P))) {
            Nat.add33To(8, PInv33, z);
        }
    }

    public static void reduce32(int x, int[] z) {
        if ((x != 0 && Nat256.mul33WordAdd(PInv33, x, z, 0) != 0) || (z[7] == -1 && Nat256.gte(z, f7025P))) {
            Nat.add33To(8, PInv33, z);
        }
    }
    ...
    public static void twice(int[] x, int[] z) {
        if (Nat.shiftUpBit(8, x, 0, z) != 0 || (z[7] == -1 && Nat256.gte(z, f7025P))) {
            Nat.add33To(8, PInv33, z);
        }
    }
}
