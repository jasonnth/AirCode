...
public class SecP256R1Point extends AbstractFp {
    ...
    public ECPoint add(ECPoint b) {
        ...
        SecP256R1FieldElement X1 = (SecP256R1FieldElement) this.f6973x;
        SecP256R1FieldElement Y1 = (SecP256R1FieldElement) this.f6974y;
        SecP256R1FieldElement X2 = (SecP256R1FieldElement) b.getXCoord();
        SecP256R1FieldElement Y2 = (SecP256R1FieldElement) b.getYCoord();
        SecP256R1FieldElement Z1 = (SecP256R1FieldElement) this.f6975zs[0];
        ...
        if (Z1IsOne) {
            ...
            S2 = t3;
            SecP256R1Field.square(Z1.f7034x, S2);
            U2 = t2;
            SecP256R1Field.multiply(S2, X2.f7034x, U2);
            SecP256R1Field.multiply(S2, Z1.f7034x, S2);
            SecP256R1Field.multiply(S2, Y2.f7034x, S2);
        }
        ...
        if (Z2IsOne) {
            ...
            S1 = t4;
            SecP256R1Field.square(Z2.f7034x, S1);
            U1 = tt1;
            SecP256R1Field.multiply(S1, X1.f7034x, U1);
            SecP256R1Field.multiply(S1, Z2.f7034x, S1);
            SecP256R1Field.multiply(S1, Y1.f7034x, S1);
        }
        int[] H = Nat256.create();
        ...
        if (!Nat256.isZero(H)) {
            ...
            SecP256R1Field.square(R, X3.f7034x);
            SecP256R1Field.subtract(X3.f7034x, G, X3.f7034x);
            SecP256R1FieldElement Y3 = new SecP256R1FieldElement(G);
            SecP256R1Field.subtract(V, X3.f7034x, Y3.f7034x);
            SecP256R1Field.multiplyAddToExt(Y3.f7034x, R, tt1);
            SecP256R1Field.reduce(tt1, Y3.f7034x);
            SecP256R1FieldElement secP256R1FieldElement = new SecP256R1FieldElement(H);
            if (!Z1IsOne) {
                SecP256R1Field.multiply(secP256R1FieldElement.f7034x, Z1.f7034x, secP256R1FieldElement.f7034x);
            }
            if (!Z2IsOne) {
                SecP256R1Field.multiply(secP256R1FieldElement.f7034x, Z2.f7034x, secP256R1FieldElement.f7034x);
            }
    ...
    public ECPoint twice() {
        ...
        SecP256R1Field.square(Y1.f7034x, Y1Squared);
        int[] T = Nat256.create();
        SecP256R1Field.square(Y1Squared, T);
        boolean Z1IsOne = Z1.isOne();
        int[] Z1Squared = Z1.f7034x;
        if (!Z1IsOne) {
            Z1Squared = t2;
            SecP256R1Field.square(Z1.f7034x, Z1Squared);
        }
        SecP256R1Field.subtract(X1.f7034x, Z1Squared, t1);
        int[] M = t2;
        SecP256R1Field.add(X1.f7034x, Z1Squared, M);
        SecP256R1Field.multiply(M, t1, M);
        SecP256R1Field.reduce32(Nat256.addBothTo(M, M, M), M);
        int[] S = Y1Squared;
        SecP256R1Field.multiply(Y1Squared, X1.f7034x, S);
        SecP256R1Field.reduce32(Nat.shiftUpBits(8, S, 2, 0), S);
        SecP256R1Field.reduce32(Nat.shiftUpBits(8, T, 3, 0, t1), t1);
        SecP256R1FieldElement X3 = new SecP256R1FieldElement(T);
        SecP256R1Field.square(M, X3.f7034x);
        SecP256R1Field.subtract(X3.f7034x, S, X3.f7034x);
        SecP256R1Field.subtract(X3.f7034x, S, X3.f7034x);
        SecP256R1FieldElement Y3 = new SecP256R1FieldElement(S);
        SecP256R1Field.subtract(S, X3.f7034x, Y3.f7034x);
        SecP256R1Field.multiply(Y3.f7034x, M, Y3.f7034x);
        SecP256R1Field.subtract(Y3.f7034x, t1, Y3.f7034x);
        SecP256R1FieldElement secP256R1FieldElement = new SecP256R1FieldElement(M);
        SecP256R1Field.twice(Y1.f7034x, secP256R1FieldElement.f7034x);
        if (!Z1IsOne) {
            SecP256R1Field.multiply(secP256R1FieldElement.f7034x, Z1.f7034x, secP256R1FieldElement.f7034x);
        }
        return new SecP256R1Point(curve, X3, Y3, new ECFieldElement[]{secP256R1FieldElement}, this.withCompression);
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP256R1Point(this.curve, this.f6973x, this.f6974y.negate(), this.f6975zs, this.withCompression);
    }
}
