...
public class JPAKEExample {
    public static void main(String[] args) throws CryptoException {
        ...
        JPAKEParticipant alice = new JPAKEParticipant("alice", alicePassword.toCharArray(), group, sHA256Digest, random);
        JPAKEParticipant bob = new JPAKEParticipant("bob", bobPassword.toCharArray(), group, sHA256Digest, random);
        ...
        System.out.println();
        BigInteger deriveSessionKey = deriveSessionKey(aliceKeyingMaterial);
        BigInteger deriveSessionKey2 = deriveSessionKey(bobKeyingMaterial);
