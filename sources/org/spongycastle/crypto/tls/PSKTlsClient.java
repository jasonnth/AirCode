...
public class PSKTlsClient extends AbstractTlsClient {
    ...
    public PSKTlsClient(TlsPSKIdentity pskIdentity2) {
        this(new DefaultTlsCipherFactory(), pskIdentity2);
    }

    public PSKTlsClient(TlsCipherFactory cipherFactory, TlsPSKIdentity pskIdentity2) {
        super(cipherFactory);
