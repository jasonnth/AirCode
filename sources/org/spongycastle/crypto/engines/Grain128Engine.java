...
public class Grain128Engine implements StreamCipher {
    ...
    private int getOutputNFSR() {
        ...
        return ((((((((((b0 ^ b26) ^ b56) ^ b91) ^ this.nfsr[3]) ^ (b3 & b67)) ^ (b11 & b13)) ^ (b17 & b18)) ^ (b27 & b59)) ^ (b40 & b48)) ^ (b61 & b65)) ^ (b68 & b84);
    }
    ...
    private int getOutput() {
        ...
        return ((((((((((((b12 & ((this.lfsr[0] >>> 8) | (this.lfsr[1] << 24))) ^ (((this.lfsr[0] >>> 13) | (this.lfsr[1] << 19)) & ((this.lfsr[0] >>> 20) | (this.lfsr[1] << 12)))) ^ (b95 & ((this.lfsr[1] >>> 10) | (this.lfsr[2] << 22)))) ^ (((this.lfsr[1] >>> 28) | (this.lfsr[2] << 4)) & ((this.lfsr[2] >>> 15) | (this.lfsr[3] << 17)))) ^ ((b12 & b95) & ((this.lfsr[2] >>> 31) | (this.lfsr[3] << 1)))) ^ ((this.lfsr[2] >>> 29) | (this.lfsr[3] << 3))) ^ b2) ^ b15) ^ b36) ^ b45) ^ this.nfsr[2]) ^ ((this.nfsr[2] >>> 9) | (this.nfsr[3] << 23))) ^ ((this.nfsr[2] >>> 25) | (this.nfsr[3] << 7));
    }
    ...
    private void setKey(byte[] keyBytes, byte[] ivBytes) {
        ...
        for (int i = 0; i < this.nfsr.length; i++) {
            this.nfsr[i] = (this.workingKey[j + 3] << 24) | ((this.workingKey[j + 2] << 16) & 16711680) | ((this.workingKey[j + 1] << 8) & 65280) | (this.workingKey[j] & 255);
            this.lfsr[i] = (this.workingIV[j + 3] << 24) | ((this.workingIV[j + 2] << 16) & 16711680) | ((this.workingIV[j + 1] << 8) & 65280) | (this.workingIV[j] & 255);
            j += 4;
        }
    }
