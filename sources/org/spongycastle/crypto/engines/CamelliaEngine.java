...
public class CamelliaEngine implements BlockCipher {
    ...
    /* renamed from: ke */
    private int[] f6663ke = new int[12];

    /* renamed from: kw */
    private int[] f6664kw = new int[8];
    ...
    private void setKey(boolean forEncryption, byte[] key) {
        ...
        if (!this._keyIs128) {
            ...
            if (forEncryption) {
                ...
                this.f6663ke[8] = ka[1];
                this.f6663ke[9] = ka[2];
                this.f6663ke[10] = ka[3];
                this.f6663ke[11] = ka[0];
                ...
                roldqo32(51, kb, 0, this.f6664kw, 4);
                return;
            }
            this.f6664kw[4] = k[0];
            this.f6664kw[5] = k[1];
            ...
            roldqo32(51, kb, 0, this.f6664kw, 0);
            ...
            this.subkey[16] = t[0];
            this.subkey[17] = t[1];
            decroldq(17, k, 0, this.f6663ke, 0);
    ...
    private int processBlock192or256(byte[] in, int inOff, byte[] out, int outOff) {
        ...
        camelliaF2(this.state, this.subkey, 28);
        camelliaF2(this.state, this.subkey, 32);
        camelliaFLs(this.state, this.f6663ke, 8);
