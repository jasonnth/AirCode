...
public final class CAST6Engine extends CAST5Engine {
    ...
    public void setKey(byte[] key) {
        ...
        for (int i3 = 0; i3 < 12; i3++) {
            ...
            iArr[6] = iArr[6] ^ mo51101F1(this._workingKey[7], this._Tm[i22], this._Tr[i22]);
            int[] iArr2 = this._workingKey;
            iArr2[5] = iArr2[5] ^ mo51102F2(this._workingKey[6], this._Tm[i22 + 1], this._Tr[i22 + 1]);
            int[] iArr3 = this._workingKey;
            iArr3[4] = iArr3[4] ^ mo51103F3(this._workingKey[5], this._Tm[i22 + 2], this._Tr[i22 + 2]);
            int[] iArr4 = this._workingKey;
            iArr4[3] = iArr4[3] ^ mo51101F1(this._workingKey[4], this._Tm[i22 + 3], this._Tr[i22 + 3]);
            int[] iArr5 = this._workingKey;
            iArr5[2] = iArr5[2] ^ mo51102F2(this._workingKey[3], this._Tm[i22 + 4], this._Tr[i22 + 4]);
            int[] iArr6 = this._workingKey;
            iArr6[1] = iArr6[1] ^ mo51103F3(this._workingKey[2], this._Tm[i22 + 5], this._Tr[i22 + 5]);
            int[] iArr7 = this._workingKey;
            iArr7[0] = iArr7[0] ^ mo51101F1(this._workingKey[1], this._Tm[i22 + 6], this._Tr[i22 + 6]);
            int[] iArr8 = this._workingKey;
            iArr8[7] = iArr8[7] ^ mo51102F2(this._workingKey[0], this._Tm[i22 + 7], this._Tr[i22 + 7]);
            int i23 = ((i3 * 2) + 1) * 8;
            int[] iArr9 = this._workingKey;
            iArr9[6] = iArr9[6] ^ mo51101F1(this._workingKey[7], this._Tm[i23], this._Tr[i23]);
            int[] iArr10 = this._workingKey;
            iArr10[5] = iArr10[5] ^ mo51102F2(this._workingKey[6], this._Tm[i23 + 1], this._Tr[i23 + 1]);
            int[] iArr11 = this._workingKey;
            iArr11[4] = iArr11[4] ^ mo51103F3(this._workingKey[5], this._Tm[i23 + 2], this._Tr[i23 + 2]);
            int[] iArr12 = this._workingKey;
            iArr12[3] = iArr12[3] ^ mo51101F1(this._workingKey[4], this._Tm[i23 + 3], this._Tr[i23 + 3]);
            int[] iArr13 = this._workingKey;
            iArr13[2] = iArr13[2] ^ mo51102F2(this._workingKey[3], this._Tm[i23 + 4], this._Tr[i23 + 4]);
            int[] iArr14 = this._workingKey;
            iArr14[1] = iArr14[1] ^ mo51103F3(this._workingKey[2], this._Tm[i23 + 5], this._Tr[i23 + 5]);
            int[] iArr15 = this._workingKey;
            iArr15[0] = iArr15[0] ^ mo51101F1(this._workingKey[1], this._Tm[i23 + 6], this._Tr[i23 + 6]);
            int[] iArr16 = this._workingKey;
            iArr16[7] = iArr16[7] ^ mo51102F2(this._workingKey[0], this._Tm[i23 + 7], this._Tr[i23 + 7]);
    ...
    public final void CAST_Encipher(int A, int B, int C, int D, int[] result) {
        for (int i = 0; i < 6; i++) {
            int x = i * 4;
            C ^= mo51101F1(D, this._Km[x], this._Kr[x]);
            B ^= mo51102F2(C, this._Km[x + 1], this._Kr[x + 1]);
            A ^= mo51103F3(B, this._Km[x + 2], this._Kr[x + 2]);
            D ^= mo51101F1(A, this._Km[x + 3], this._Kr[x + 3]);
        }
        for (int i2 = 6; i2 < 12; i2++) {
            int x2 = i2 * 4;
            D ^= mo51101F1(A, this._Km[x2 + 3], this._Kr[x2 + 3]);
            A ^= mo51103F3(B, this._Km[x2 + 2], this._Kr[x2 + 2]);
            B ^= mo51102F2(C, this._Km[x2 + 1], this._Kr[x2 + 1]);
            C ^= mo51101F1(D, this._Km[x2], this._Kr[x2]);
        }
        result[0] = A;
        result[1] = B;
        result[2] = C;
