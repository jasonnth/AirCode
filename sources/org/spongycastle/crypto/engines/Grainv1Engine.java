...
public class Grainv1Engine implements StreamCipher {
    ...
    private int getOutputNFSR() {
        ...
        return (((((((((((((((((((((((this.nfsr[3] >>> 14) | (this.nfsr[4] << 2)) ^ b60) ^ b52) ^ b45) ^ b37) ^ b33) ^ b28) ^ b21) ^ ((this.nfsr[0] >>> 14) | (this.nfsr[1] << 2))) ^ b9) ^ this.nfsr[0]) ^ (b63 & b60)) ^ (b37 & b33)) ^ (b15 & b9)) ^ ((b60 & b52) & b45)) ^ ((b33 & b28) & b21)) ^ (((b63 & b45) & b28) & b9)) ^ (((b60 & b52) & b37) & b33)) ^ (((b63 & b60) & b21) & b15)) ^ ((((b63 & b60) & b52) & b45) & b37)) ^ ((((b33 & b28) & b21) & b15) & b9)) ^ (((((b52 & b45) & b37) & b33) & b28) & b21)) & MinElf.PN_XNUM;
    }

    private int getOutputLFSR() {
        return (((((this.lfsr[0] ^ ((this.lfsr[0] >>> 13) | (this.lfsr[1] << 3))) ^ ((this.lfsr[1] >>> 7) | (this.lfsr[2] << 9))) ^ ((this.lfsr[2] >>> 6) | (this.lfsr[3] << 10))) ^ ((this.lfsr[3] >>> 3) | (this.lfsr[4] << 13))) ^ ((this.lfsr[3] >>> 14) | (this.lfsr[4] << 2))) & MinElf.PN_XNUM;
    }
    ...
    private int getOutput() {
        ...
        int s64 = this.lfsr[4];
        return ((((((((((((((((s25 ^ b63) ^ (s3 & s64)) ^ (s46 & s64)) ^ (s64 & b63)) ^ ((s3 & s25) & s46)) ^ ((s3 & s46) & s64)) ^ ((s3 & s46) & b63)) ^ ((s25 & s46) & b63)) ^ ((s46 & s64) & b63)) ^ b1) ^ b2) ^ b4) ^ b10) ^ b31) ^ b43) ^ b56) & MinElf.PN_XNUM;
    }
    ...
    private void setKey(byte[] keyBytes, byte[] ivBytes) {
        ...
        for (int i = 0; i < this.nfsr.length; i++) {
            this.nfsr[i] = ((this.workingKey[j + 1] << 8) | (this.workingKey[j] & 255)) & 65535;
            this.lfsr[i] = ((this.workingIV[j + 1] << 8) | (this.workingIV[j] & 255)) & 65535;
            j += 2;
        }
    }
