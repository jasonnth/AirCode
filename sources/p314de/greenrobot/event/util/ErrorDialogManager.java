package p314de.greenrobot.event.util;
...
/* renamed from: de.greenrobot.event.util.ErrorDialogManager */
public class ErrorDialogManager {
    ...
    @TargetApi(11)
    /* renamed from: de.greenrobot.event.util.ErrorDialogManager$HoneycombManagerFragment */
    ...
    /* renamed from: de.greenrobot.event.util.ErrorDialogManager$SupportManagerFragment */
    public static class SupportManagerFragment extends android.support.p000v4.app.Fragment {
        protected Bundle argumentsForErrorDialog;
        private EventBus eventBus;
        private Object executionScope;
        protected boolean finishAfterDialog;
        ...
        public void onEventMainThread(ThrowableFailureEvent event) {
            if (ErrorDialogManager.isInExecutionScope(this.executionScope, event)) {
                ErrorDialogManager.checkLogException(event);
                android.support.p000v4.app.FragmentManager fm = getFragmentManager();
                fm.executePendingTransactions();
                android.support.p000v4.app.DialogFragment existingFragment = (android.support.p000v4.app.DialogFragment) fm.findFragmentByTag(ErrorDialogManager.TAG_ERROR_DIALOG);
                if (existingFragment != null) {
                    existingFragment.dismiss();
                }
                android.support.p000v4.app.DialogFragment errorFragment = (android.support.p000v4.app.DialogFragment) ErrorDialogManager.factory.prepareErrorFragment(event, this.finishAfterDialog, this.argumentsForErrorDialog);
                if (errorFragment != null) {
                    errorFragment.show(fm, ErrorDialogManager.TAG_ERROR_DIALOG);
                }
            }
        ...
        public static void attachTo(Activity activity, Object executionScope2, boolean finishAfterDialog2, Bundle argumentsForErrorDialog2) {
            android.support.p000v4.app.FragmentManager fm = ((FragmentActivity) activity).getSupportFragmentManager();
            ...
            if (fragment == null) {
                ...
                fm.beginTransaction().add((android.support.p000v4.app.Fragment) fragment, ErrorDialogManager.TAG_ERROR_DIALOG_MANAGER).commit();
                fm.executePendingTransactions();
            }
            fragment.finishAfterDialog = finishAfterDialog2;
            fragment.argumentsForErrorDialog = argumentsForErrorDialog2;
