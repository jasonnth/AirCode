...
/* renamed from: de.greenrobot.event.util.ErrorDialogFragmentFactory */
public abstract class ErrorDialogFragmentFactory<T> {
    protected final ErrorDialogConfig config;

    @TargetApi(11)
    /* renamed from: de.greenrobot.event.util.ErrorDialogFragmentFactory$Honeycomb */
    public static class Honeycomb extends ErrorDialogFragmentFactory<Fragment> {
        ...
        public Fragment createErrorFragment(ThrowableFailureEvent event, Bundle arguments) {
            p314de.greenrobot.event.util.ErrorDialogFragments.Honeycomb errorFragment = new p314de.greenrobot.event.util.ErrorDialogFragments.Honeycomb();
            errorFragment.setArguments(arguments);
            return errorFragment;
        }
    }

    /* renamed from: de.greenrobot.event.util.ErrorDialogFragmentFactory$Support */
    public static class Support extends ErrorDialogFragmentFactory<android.support.p000v4.app.Fragment> {
        public Support(ErrorDialogConfig config) {
            super(config);
        }

        /* access modifiers changed from: protected */
        public android.support.p000v4.app.Fragment createErrorFragment(ThrowableFailureEvent event, Bundle arguments) {
            p314de.greenrobot.event.util.ErrorDialogFragments.Support errorFragment = new p314de.greenrobot.event.util.ErrorDialogFragments.Support();
            errorFragment.setArguments(arguments);
            return errorFragment;
        }
    }
