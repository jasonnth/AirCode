...
import p315io.branch.referral.BranchShortLinkBuilder;
import p315io.branch.referral.Defines.Jsonkey;
import p315io.branch.referral.util.CurrencyType;
import p315io.branch.referral.util.LinkProperties;
import p315io.branch.referral.util.ShareSheetStyle;
...
public class BranchUniversalObject implements Parcelable {
    ...
    /* renamed from: io.branch.indexing.BranchUniversalObject$LinkShareListenerWrapper */
    ...
    /* renamed from: io.branch.indexing.BranchUniversalObject$RegisterViewStatusListener */
    ...
    public void userCompletedAction(String action, HashMap<String, String> metadata) {
        ...
        try {
            ...
            actionCompletedPayload.put("$canonical_identifier_list", canonicalIDList);
    ...
    public String getShortUrl(Context context, LinkProperties linkProperties, boolean defaultToLongUrl) {
        return ((BranchShortLinkBuilder) getLinkBuilder(context, linkProperties).setDefaultToLongUrl(defaultToLongUrl)).getShortUrl();
    }

    public void generateShortUrl(Context context, LinkProperties linkProperties, BranchLinkCreateListener callback) {
        getLinkBuilder(context, linkProperties).generateShortUrl(callback);
    }

    public void generateShortUrl(Context context, LinkProperties linkProperties, BranchLinkCreateListener callback, boolean defaultToLongUrl) {
    ...
    public void showShareSheet(Activity activity, LinkProperties linkProperties, ShareSheetStyle style, BranchLinkShareListener callback) {
        showShareSheet(activity, linkProperties, style, callback, null);
    }

    public void showShareSheet(Activity activity, LinkProperties linkProperties, ShareSheetStyle style, BranchLinkShareListener callback, IChannelProperties channelProperties) {
        if (Branch.getInstance() != null) {
        ...
        try {
            ...
            try {
                ...
                if (jsonObject.has("$amount")) {
                    branchUniversalObject.price_ = Double.valueOf(jsonObject.getDouble("$amount"));
                }
                ...
                if (jsonObject.has(Jsonkey.PublicallyIndexable.getKey())) {
                    try {
                        ...
                        branchUniversalObject.localIndexMode_ = jsonObject.getBoolean(Jsonkey.LocallyIndexable.getKey()) ? CONTENT_INDEX_MODE.PUBLIC : CONTENT_INDEX_MODE.PRIVATE;
                    } catch (JSONException e) {
                        ...
                        branchUniversalObject.localIndexMode_ = jsonObject.getInt(Jsonkey.LocallyIndexable.getKey()) == 1 ? CONTENT_INDEX_MODE.PUBLIC : CONTENT_INDEX_MODE.PRIVATE;
                    }
                }
    ...
    public JSONObject convertToJson() {
        ...
        try {
            ...
            if (this.price_ != null) {
                buoJsonModel.put("$amount", this.price_);
                buoJsonModel.put("$currency", this.currency_.toString());
            }
