...
class JdkWithJettyBootPlatform extends Platform {
    ...
    private static class JettyNegoProvider implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if (methodName.equals("unsupported") && Void.TYPE == returnType) {
                ...
                if ((methodName.equals("selectProtocol") || methodName.equals(BaseAnalytics.SELECT)) && String.class == returnType && args.length == 1 && (args[0] instanceof List)) {
    ...
    public static Platform buildIfSupported() {
        ...
        try {
            ...
            return new JdkWithJettyBootPlatform(negoClass.getMethod("put", new Class[]{SSLSocket.class, providerClass}), negoClass.getMethod("get", new Class[]{SSLSocket.class}), negoClass.getMethod("remove", new Class[]{SSLSocket.class}), clientProviderClass2, serverProviderClass2);
