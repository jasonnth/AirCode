...
public class Platform {
    ...
    public X509TrustManager trustManager(SSLSocketFactory sslSocketFactory) {
        try {
            Object context = readFieldOrNull(sslSocketFactory, Class.forName("sun.security.ssl.SSLContextImpl"), PlaceFields.CONTEXT);
            if (context == null) {
                return null;
            }
    ...
    private static Platform findPlatform() {
        ...
        Platform buildIfSupported = Jdk9Platform.buildIfSupported();
