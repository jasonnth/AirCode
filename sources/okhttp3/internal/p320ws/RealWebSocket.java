...
import okhttp3.internal.p320ws.WebSocketReader.FrameCallback;
...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    static final class C5200Message {
        final ByteString data;
        final int formatOpcode;

        C5200Message(int formatOpcode2, ByteString data2) {
    ...
    public RealWebSocket(Request request, WebSocketListener listener2, Random random2) {
        ...
        this.key = ByteString.m3949of(nonce).base64();
        ...
        synchronized (this) {
            if (!this.failed && !this.enqueuedClose) {
                if (this.queueSize + ((long) data.size()) > 16777216) {
                    ...
                    this.messageAndCloseQueue.add(new C5200Message(formatOpcode, data));
                    runWriter();
                    z = true;
                }
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x0075, code lost:
        if ((r4 instanceof okhttp3.internal.p320ws.RealWebSocket.C5200Message) == false) goto L_0x00ad;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x0077, code lost:
        r3 = ((okhttp3.internal.p320ws.RealWebSocket.C5200Message) r4).data;
        r8 = okio.Okio.buffer(r10.newMessageSink(((okhttp3.internal.p320ws.RealWebSocket.C5200Message) r4).formatOpcode, (long) r3.size()));
        r8.write(r3);
        r8.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:47:0x00af, code lost:
        if ((r4 instanceof okhttp3.internal.p320ws.RealWebSocket.Close) == false) goto L_0x00c8;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x00b1, code lost:
        r2 = (okhttp3.internal.p320ws.RealWebSocket.Close) r4;
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x000e:
            ...
            boolean r12 = r4 instanceof okhttp3.internal.p320ws.RealWebSocket.Close     // Catch:{ all -> 0x006c }
        ...
        L_0x0050:
            ...
            r0 = r4
            okhttp3.internal.ws.RealWebSocket$Close r0 = (okhttp3.internal.p320ws.RealWebSocket.Close) r0     // Catch:{ all -> 0x006c }
            r11 = r0
        ...
        L_0x006f:
            ...
            goto L_0x000d
        L_0x0073:
            boolean r11 = r4 instanceof okhttp3.internal.p320ws.RealWebSocket.C5200Message     // Catch:{ all -> 0x00a8 }
            if (r11 == 0) goto L_0x00ad
            r0 = r4
            okhttp3.internal.ws.RealWebSocket$Message r0 = (okhttp3.internal.p320ws.RealWebSocket.C5200Message) r0     // Catch:{ all -> 0x00a8 }
            r11 = r0
            okio.ByteString r3 = r11.data     // Catch:{ all -> 0x00a8 }
            okhttp3.internal.ws.RealWebSocket$Message r4 = (okhttp3.internal.p320ws.RealWebSocket.C5200Message) r4     // Catch:{ all -> 0x00a8 }
        ...
        L_0x00a8:
            ...
            throw r11
        L_0x00ad:
            boolean r11 = r4 instanceof okhttp3.internal.p320ws.RealWebSocket.Close     // Catch:{ all -> 0x00a8 }
            if (r11 == 0) goto L_0x00c8
            r0 = r4
            okhttp3.internal.ws.RealWebSocket$Close r0 = (okhttp3.internal.p320ws.RealWebSocket.Close) r0     // Catch:{ all -> 0x00a8 }
            r2 = r0
        ...
        L_0x00c8:
            ...
            throw r11     // Catch:{ all -> 0x00a8 }
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p320ws.RealWebSocket.writeOneFrame():boolean");
    }
    ...
    public void writePingFrame() {
        /*
            r3 = this;
            monitor-enter(r3)
            boolean r2 = r3.failed     // Catch:{ all -> 0x0016 }
            if (r2 == 0) goto L_0x0007
            monitor-exit(r3)     // Catch:{ all -> 0x0016 }
        L_0x0006:
            return
        L_0x0007:
            okhttp3.internal.ws.WebSocketWriter r1 = r3.writer     // Catch:{ all -> 0x0016 }
            monitor-exit(r3)     // Catch:{ all -> 0x0016 }
            okio.ByteString r2 = okio.ByteString.EMPTY     // Catch:{ IOException -> 0x0010 }
            r1.writePing(r2)     // Catch:{ IOException -> 0x0010 }
            goto L_0x0006
        L_0x0010:
            r0 = move-exception
            r2 = 0
            r3.failWebSocket(r0, r2)
            goto L_0x0006
        L_0x0016:
            r2 = move-exception
            monitor-exit(r3)     // Catch:{ all -> 0x0016 }
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p320ws.RealWebSocket.writePingFrame():void");
    }
    ...
    public void failWebSocket(java.lang.Exception r4, okhttp3.Response r5) {
        ...
        L_0x002f:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p320ws.RealWebSocket.failWebSocket(java.lang.Exception, okhttp3.Response):void");
    }
}
