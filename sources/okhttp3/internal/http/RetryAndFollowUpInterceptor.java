...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    private C5164Address createAddress(HttpUrl url) {
        ...
        return new C5164Address(url.host(), url.port(), this.client.dns(), this.client.socketFactory(), sslSocketFactory, hostnameVerifier, certificatePinner, this.client.proxyAuthenticator(), this.client.proxy(), this.client.protocols(), this.client.connectionSpecs(), this.client.proxySelector());
    }
    ...
    private Request followUpRequest(Response userResponse) throws IOException {
        ...
        if (HttpMethod.permitsRequestBody(method)) {
            ...
            if (!maintainBody) {
                ...
                requestBuilder.removeHeader(ApiRequestHeadersInterceptor.HEADER_CONTENT_TYPE);
            }
        }
