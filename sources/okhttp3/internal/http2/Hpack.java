...
final class Hpack {
    ...
    static final Header[] STATIC_HEADER_TABLE = {new Header(Header.TARGET_AUTHORITY, ""), new Header(Header.TARGET_METHOD, "GET"), new Header(Header.TARGET_METHOD, "POST"), new Header(Header.TARGET_PATH, "/"), new Header(Header.TARGET_PATH, "/index.html"), new Header(Header.TARGET_SCHEME, UriUtil.HTTP_SCHEME), new Header(Header.TARGET_SCHEME, UriUtil.HTTPS_SCHEME), new Header(Header.RESPONSE_STATUS, "200"), new Header(Header.RESPONSE_STATUS, "204"), new Header(Header.RESPONSE_STATUS, "206"), new Header(Header.RESPONSE_STATUS, "304"), new Header(Header.RESPONSE_STATUS, "400"), new Header(Header.RESPONSE_STATUS, "404"), new Header(Header.RESPONSE_STATUS, "500"), new Header("accept-charset", ""), new Header("accept-encoding", "gzip, deflate"), new Header("accept-language", ""), new Header("accept-ranges", ""), new Header("accept", ""), new Header("access-control-allow-origin", ""), new Header("age", ""), new Header("allow", ""), new Header("authorization", ""), new Header("cache-control", ""), new Header("content-disposition", ""), new Header("content-encoding", ""), new Header("content-language", ""), new Header("content-length", ""), new Header("content-location", ""), new Header("content-range", ""), new Header("content-type", ""), new Header("cookie", ""), new Header("date", ""), new Header("etag", ""), new Header("expect", ""), new Header("expires", ""), new Header(BaseAnalytics.FROM, ""), new Header(TripRole.ROLE_KEY_HOST, ""), new Header("if-match", ""), new Header("if-modified-since", ""), new Header("if-none-match", ""), new Header("if-range", ""), new Header("if-unmodified-since", ""), new Header("last-modified", ""), new Header("link", ""), new Header("location", ""), new Header("max-forwards", ""), new Header("proxy-authenticate", ""), new Header("proxy-authorization", ""), new Header("range", ""), new Header("referer", ""), new Header("refresh", ""), new Header("retry-after", ""), new Header("server", ""), new Header("set-cookie", ""), new Header("strict-transport-security", ""), new Header("transfer-encoding", ""), new Header("user-agent", ""), new Header("vary", ""), new Header("via", ""), new Header("www-authenticate", "")};
    ...
    static final class Reader {
        ...
        public void readHeaders() throws IOException {
            while (!this.source.exhausted()) {
                ...
                if (b == 128) {
                    ...
                    readIndexedHeader(readInt(b, CertificateBody.profileType) - 1);
                } else if (b == 64) {
        ...
        public int readInt(int firstByte, int prefixMask) throws IOException {
            ...
            while (true) {
                ...
                result += (b & CertificateBody.profileType) << shift;
                shift += 7;
            }
        }
        ...
        public ByteString readByteString() throws IOException {
            ...
            int length = readInt(firstByte, CertificateBody.profileType);
            if (huffmanDecode) {
                return ByteString.m3949of(Huffman.get().decode(this.source.readByteArray((long) length)));
            }
    ...
    static final class Writer {
        ...
        public void writeHeaders(List<Header> headerBlock) throws IOException {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (headerIndex != -1) {
                    writeInt(headerIndex, CertificateBody.profileType, 128);
                } else if (headerNameIndex == -1) {
        ...
        public void writeInt(int value, int prefixMask, int bits) {
            ...
            while (value2 >= 128) {
                this.out.writeByte((value2 & CertificateBody.profileType) | 128);
                value2 >>>= 7;
            }
        ...
        public void writeByteString(ByteString data) throws IOException {
            if (!this.useCompression || Huffman.get().encodedLength(data) >= data.size()) {
                writeInt(data.size(), CertificateBody.profileType, 0);
                this.out.write(data);
                return;
            }
            ...
            writeInt(huffmanBytes.size(), CertificateBody.profileType, 128);
