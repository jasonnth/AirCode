...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f6321dn;
    private int end;
    private final int length = this.f6321dn.length();
    private int pos;

    public DistinguishedNameParser(X500Principal principal) {
        this.f6321dn = principal.getName("RFC2253");
    }
    ...
    private String nextAT() {
        ...
        if (this.pos >= this.length) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f6321dn);
        }
        this.end = this.pos;
    ...
    private int getByte(int position) {
        ...
        if (position + 1 >= this.length) {
            throw new IllegalStateException("Malformed DN: " + this.f6321dn);
        }
    ...
    public String findMostSpecific(String attributeType) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f6321dn.toCharArray();
