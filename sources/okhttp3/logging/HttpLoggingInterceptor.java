...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (logHeaders) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (!ApiRequestHeadersInterceptor.HEADER_CONTENT_TYPE.equalsIgnoreCase(name) && !"Content-Length".equalsIgnoreCase(name)) {
    ...
    private boolean bodyEncoded(Headers headers) {
        ...
        return contentEncoding != null && !contentEncoding.equalsIgnoreCase(InterpolationAnimatedNode.EXTRAPOLATE_TYPE_IDENTITY);
    }
}
