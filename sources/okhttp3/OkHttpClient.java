...
import okhttp3.internal.p320ws.RealWebSocket;
import okhttp3.internal.platform.Platform;
import okhttp3.internal.tls.CertificateChainCleaner;
import okhttp3.internal.tls.OkHostnameVerifier;

public class OkHttpClient implements Cloneable, Factory {
    static final List<ConnectionSpec> DEFAULT_CONNECTION_SPECS = Util.immutableList((T[]) new ConnectionSpec[]{ConnectionSpec.MODERN_TLS, ConnectionSpec.COMPATIBLE_TLS, ConnectionSpec.CLEARTEXT});
    ...
    static {
        Internal.instance = new Internal() {
            ...
            public RealConnection get(ConnectionPool pool, C5164Address address, StreamAllocation streamAllocation) {
                return pool.get(address, streamAllocation);
            }

            public Socket deduplicate(ConnectionPool pool, C5164Address address, StreamAllocation streamAllocation) {
