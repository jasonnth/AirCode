...
public final class Cookie {
    ...
    public static final class Builder {
        ...
        private Builder domain(String domain2, boolean hostOnly2) {
            ...
            String canonicalDomain = Util.domainToAscii(domain2);
    ...
    static Cookie parse(long currentTimeMillis, HttpUrl url, String setCookie) {
        ...
        if (deltaSeconds == Long.MIN_VALUE) {
            ...
            expiresAt2 = currentTimeMillis + (deltaSeconds <= 9223372036854775L ? deltaSeconds * 1000 : Long.MAX_VALUE);
    ...
    private static long parseExpires(String s, int pos, int limit) {
        ...
        if (year >= 0 && year <= 69) {
            year += OfficialIdPhotoSelectionFragment.MAX_IMAGE_SIZE;
        }
        if (year < 1601) {
