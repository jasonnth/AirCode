...
/* renamed from: okhttp3.Address */
public final class C5164Address {
    ...
    public C5164Address(String uriHost, int uriPort, Dns dns2, SocketFactory socketFactory2, SSLSocketFactory sslSocketFactory2, HostnameVerifier hostnameVerifier2, CertificatePinner certificatePinner2, Authenticator proxyAuthenticator2, Proxy proxy2, List<Protocol> protocols2, List<ConnectionSpec> connectionSpecs2, ProxySelector proxySelector2) {
        this.url = new Builder().scheme(sslSocketFactory2 != null ? UriUtil.HTTPS_SCHEME : UriUtil.HTTP_SCHEME).host(uriHost).port(uriPort).build();
        if (dns2 == null) {
    ...
    public boolean equals(Object other) {
        if (!(other instanceof C5164Address)) {
            return false;
        }
        C5164Address that = (C5164Address) other;
