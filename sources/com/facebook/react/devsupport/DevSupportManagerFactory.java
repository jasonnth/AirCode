...
public class DevSupportManagerFactory {
    ...
    public static DevSupportManager create(Context applicationContext, ReactInstanceDevCommandsHandler reactInstanceCommandsHandler, String packagerPathForJSBundleName, boolean enableOnCreate) {
