...
public class FpsView extends FrameLayout {
    ...
    private final TextView mTextView = ((TextView) findViewById(C3704R.C3706id.fps_text));
    ...
    public FpsView(ReactContext reactContext) {
        super(reactContext);
        inflate(reactContext, C3704R.layout.fps_view, this);
    ...
    public void setCurrentFPS(double currentFPS, double currentJSFPS, int droppedUIFrames, int total4PlusFrameStutters) {
        ...
        FLog.m1795d(ReactConstants.TAG, fpsString);
    }
}
