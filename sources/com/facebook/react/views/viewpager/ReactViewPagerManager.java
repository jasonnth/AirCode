...
public class ReactViewPagerManager extends ViewGroupManager<ReactViewPager> {
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.m1884of(PageScrollEvent.EVENT_NAME, MapBuilder.m1882of("registrationName", "onPageScroll"), PageScrollStateChangedEvent.EVENT_NAME, MapBuilder.m1882of("registrationName", "onPageScrollStateChanged"), PageSelectedEvent.EVENT_NAME, MapBuilder.m1882of("registrationName", "onPageSelected"));
    }

    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m1883of("setPage", Integer.valueOf(1), "setPageWithoutAnimation", Integer.valueOf(2));
    }
