...
class UIManagerModuleConstantsHelper {
    ...
    static Map<String, Object> createConstants(List<ViewManager> viewManagers) {
        ...
        for (ViewManager viewManager : viewManagers) {
            SystraceMessage.beginSection(0, "constants for ViewManager").arg("ViewManager", (Object) viewManager.getName()).flush();
            try {
