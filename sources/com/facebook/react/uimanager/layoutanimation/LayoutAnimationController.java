...
public class LayoutAnimationController {
    ...
    public boolean shouldAnimateLayout(View viewToAnimate) {
        if (!this.mShouldAnimateLayout || viewToAnimate.getParent() == null) {
            return false;
        }
        return ENABLED;
    }
    ...
    public void applyLayoutUpdate(View view, int x, int y, int width, int height) {
        ...
        Animation animation = ((view.getWidth() == 0 || view.getHeight() == 0) ? this.mLayoutCreateAnimation : this.mLayoutUpdateAnimation).createAnimation(view, x, y, width, height);
