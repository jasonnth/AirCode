...
public class UIManagerModule extends ReactContextBaseJavaModule implements LifecycleEventListener, OnBatchCompleteListener, PerformanceCounter {
    ...
    public UIManagerModule(ReactApplicationContext reactContext, List<ViewManager> viewManagerList, UIImplementationProvider uiImplementationProvider) {
        super(reactContext);
        DisplayMetricsHolder.initDisplayMetricsIfNotInitialized(reactContext);
        this.mEventDispatcher = new EventDispatcher(reactContext);
        this.mModuleConstants = createConstants(viewManagerList);
