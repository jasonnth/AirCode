...
public class MatrixMathHelper {
    ...
    public static void multiplyInto(double[] out, double[] a, double[] b) {
        ...
        double b23 = b[10];
        double b33 = b[11];
        out[8] = (b03 * a00) + (b13 * a10) + (b23 * a20) + (b33 * a30);
        out[9] = (b03 * a01) + (b13 * a11) + (b23 * a21) + (b33 * a31);
        out[10] = (b03 * a02) + (b13 * a12) + (b23 * a22) + (b33 * a32);
        out[11] = (b03 * a03) + (b13 * a13) + (b23 * a23) + (b33 * a33);
        double b04 = b[12];
        double b14 = b[13];
        double b24 = b[14];
        double b34 = b[15];
        out[12] = (b04 * a00) + (b14 * a10) + (b24 * a20) + (b34 * a30);
        out[13] = (b04 * a01) + (b14 * a11) + (b24 * a21) + (b34 * a31);
        out[14] = (b04 * a02) + (b14 * a12) + (b24 * a22) + (b34 * a32);
        out[15] = (b04 * a03) + (b14 * a13) + (b24 * a23) + (b34 * a33);
    }
        ...
        if (!isZero(transformMatrix[15])) {
            ...
            if (!isZero(determinant(perspectiveMatrix))) {
                ...
                for (int i3 = 0; i3 < 3; i3++) {
                    translation[i3] = matrix[3][i3];
                }
                double[][] row = (double[][]) Array.newInstance(Double.TYPE, new int[]{3, 3});
                for (int i4 = 0; i4 < 3; i4++) {
                    row[i4][0] = matrix[i4][0];
                    row[i4][1] = matrix[i4][1];
                    row[i4][2] = matrix[i4][2];
                }
