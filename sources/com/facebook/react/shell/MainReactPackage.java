...
import com.facebook.react.modules.share.C1066ShareModule;
...
public class MainReactPackage extends LazyReactPackage {
    ...
    public List<ModuleSpec> getNativeModules(final ReactApplicationContext context) {
        ...
        }), new ModuleSpec(C1066ShareModule.class, new Provider<NativeModule>() {
            public NativeModule get() {
                return new C1066ShareModule(context);
            }
