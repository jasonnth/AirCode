...
public class LikeActionController {
    ...
    private abstract class AbstractRequestWrapper implements RequestWrapper {
        ...
        protected AbstractRequestWrapper(String objectId2, ObjectType objectType2) {
        ...
        public void setRequest(GraphRequest request2) {
            ...
            request2.setCallback(new Callback() {
    ...
    private static class CreateLikeActionControllerWorkItem implements Runnable {
        ...
        CreateLikeActionControllerWorkItem(String objectId2, ObjectType objectType2, CreationCallback callback2) {
            this.objectId = objectId2;
            this.objectType = objectType2;
    ...
    private class GetEngagementRequestWrapper extends AbstractRequestWrapper {
        ...
        GetEngagementRequestWrapper(String objectId, ObjectType objectType) {
            ...
            requestParams.putString(AccountKitGraphConstants.PARAMETER_LOCALE, Locale.getDefault().toString());
    ...
    private class GetOGObjectLikesRequestWrapper extends AbstractRequestWrapper implements LikeRequestWrapper {
        ...
        GetOGObjectLikesRequestWrapper(String objectId2, ObjectType objectType2) {
    ...
    private class PublishUnlikeRequestWrapper extends AbstractRequestWrapper {
        ...
        PublishUnlikeRequestWrapper(String unlikeToken2) {
            ...
            setRequest(new GraphRequest(AccessToken.getCurrentAccessToken(), unlikeToken2, null, HttpMethod.DELETE));
        }
    ...
    public static void getControllerForObjectId(String objectId2, ObjectType objectType2, CreationCallback callback) {
        if (!isInitialized) {
    ...
    private static void verifyControllerAndInvokeCallback(LikeActionController likeActionController, ObjectType objectType2, CreationCallback callback) {
        ObjectType bestObjectType = ShareInternalUtility.getMostSpecificObjectType(objectType2, likeActionController.objectType);
    ...
    /* access modifiers changed from: private */
    public static void createControllerForObjectIdAndType(String objectId2, ObjectType objectType2, CreationCallback callback) {
        LikeActionController controllerForObject = getControllerFromInMemoryCache(objectId2);
        if (controllerForObject != null) {
            verifyControllerAndInvokeCallback(controllerForObject, objectType2, callback);
            return;
    ...
    private LikeActionController(String objectId2, ObjectType objectType2) {
        this.objectId = objectId2;
        this.objectType = objectType2;
    }
    ...
    public void updateState(boolean isObjectLiked2, String likeCountStringWithLike2, String likeCountStringWithoutLike2, String socialSentenceWithLike2, String socialSentenceWithoutLike2, String unlikeToken2) {
        String likeCountStringWithLike3 = Utility.coerceValueIfNullOrEmpty(likeCountStringWithLike2, null);
        String likeCountStringWithoutLike3 = Utility.coerceValueIfNullOrEmpty(likeCountStringWithoutLike2, null);
        String socialSentenceWithLike3 = Utility.coerceValueIfNullOrEmpty(socialSentenceWithLike2, null);
        String socialSentenceWithoutLike3 = Utility.coerceValueIfNullOrEmpty(socialSentenceWithoutLike2, null);
        String unlikeToken3 = Utility.coerceValueIfNullOrEmpty(unlikeToken2, null);
