...
public final class ShareInternalUtility {
        ...
        return new ResultProcessor(callback) {
            public void onSuccess(AppCall appCall, Bundle results) {
                if (results != null) {
                    ...
                    } else if (BaseAnalytics.CANCEL.equalsIgnoreCase(gesture)) {
    ...
    public static List<String> getPhotoUrls(SharePhotoContent photoContent, final UUID appCallId) {
        if (photoContent != null) {
            ...
            if (photos != null) {
                ...
                List<String> map = Utility.map(attachments, new Mapper<Attachment, String>() {
    ...
    public static JSONObject toJSONObjectForCall(final UUID callId, ShareOpenGraphContent content) throws JSONException {
        ...
        JSONObject actionJSON = OpenGraphJSONUtility.toJSONObject(action, (PhotoJSONProcessor) new PhotoJSONProcessor() {
        ...
        if (content.getPeopleIds() != null) {
            JSONArray peopleTags = actionJSON.optJSONArray(PushService.PARAM_TAGS);
            if (peopleTags == null) {
            ...
            actionJSON.put(PushService.PARAM_TAGS, new JSONArray(peopleIdSet));
        }
        return actionJSON;
    }
    ...
    public static Attachment getAttachment(UUID callId, ShareMedia medium) {
        Bitmap bitmap = null;
        Uri uri = null;
