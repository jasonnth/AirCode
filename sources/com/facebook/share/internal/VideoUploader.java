...
public class VideoUploader {
    ...
    private static class UploadContext {
        ...
        private UploadContext(ShareVideoContent videoContent, String graphNode2, FacebookCallback<Result> callback2) {
            ...
            if (!Utility.isNullOrEmpty((Collection<T>) videoContent.getPeopleIds())) {
                this.params.putString(PushService.PARAM_TAGS, TextUtils.join(", ", videoContent.getPeopleIds()));
            }
