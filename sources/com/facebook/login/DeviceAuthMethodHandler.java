...
class DeviceAuthMethodHandler extends LoginMethodHandler {
    ...
    public void onSuccess(String accessToken, String applicationId, String userId, Collection<String> permissions2, Collection<String> declinedPermissions, AccessTokenSource accessTokenSource, Date expirationTime, Date lastRefreshTime) {
        this.loginClient.completeAndValidate(Result.createTokenResult(this.loginClient.getPendingRequest(), new AccessToken(accessToken, applicationId, userId, permissions2, declinedPermissions, accessTokenSource, expirationTime, lastRefreshTime)));
    }
