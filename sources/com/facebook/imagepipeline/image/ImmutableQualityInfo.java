...
public class ImmutableQualityInfo implements QualityInfo {
    public static final QualityInfo FULL_QUALITY = m1876of(Integer.MAX_VALUE, true, true);
    ...
    /* renamed from: of */
    public static QualityInfo m1876of(int quality, boolean isOfGoodEnoughQuality, boolean isOfFullQuality) {
