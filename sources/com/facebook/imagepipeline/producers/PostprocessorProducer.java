...
public class PostprocessorProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    private class PostprocessorConsumer extends DelegatingConsumer<CloseableReference<CloseableImage>, CloseableReference<CloseableImage>> {
        ...
        private void updateSourceImageRef(com.facebook.common.references.CloseableReference<com.facebook.imagepipeline.image.CloseableImage> r4, boolean r5) {
            /*
                r3 = this;
                monitor-enter(r3)
        ...
        private Map<String, String> getExtraMap(ProducerListener listener, String requestId, Postprocessor postprocessor) {
            ...
            return ImmutableMap.m1780of(PostprocessorProducer.POSTPROCESSOR, postprocessor.getName());
        }
        ...
        private CloseableReference<CloseableImage> postprocessInternal(CloseableImage sourceImage) {
            ...
            try {
                return CloseableReference.m1871of(new CloseableStaticBitmap(bitmapRef, sourceImage.getQualityInfo(), staticBitmap.getRotationAngle()));
            } finally {
