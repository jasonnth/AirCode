...
public abstract class MultiplexProducer<K, T extends Closeable> implements Producer<T> {
    ...
    class Multiplexer {
        ...
        public void onFailure(com.facebook.imagepipeline.producers.MultiplexProducer$Multiplexer.ForwardingConsumer r5, java.lang.Throwable r6) {
            /*
                r4 = this;
                monitor-enter(r4)
                com.facebook.imagepipeline.producers.MultiplexProducer$Multiplexer.ForwardingConsumer<> r2 = r4.mForwardingConsumer     // Catch:{ all -> 0x003b }
        ...
        public void onNextResult(com.facebook.imagepipeline.producers.MultiplexProducer$Multiplexer.ForwardingConsumer r5, T r6, boolean r7) {
            /*
                r4 = this;
                monitor-enter(r4)
                com.facebook.imagepipeline.producers.MultiplexProducer$Multiplexer.ForwardingConsumer<> r2 = r4.mForwardingConsumer     // Catch:{ all -> 0x0046 }
                if (r2 == r5) goto L_0x0007
        ...
        public void onProgressUpdate(com.facebook.imagepipeline.producers.MultiplexProducer$Multiplexer.ForwardingConsumer r4, float r5) {
            /*
                r3 = this;
                monitor-enter(r3)
                com.facebook.imagepipeline.producers.MultiplexProducer$Multiplexer.ForwardingConsumer<> r2 = r3.mForwardingConsumer     // Catch:{ all -> 0x0029 }
    ...
    /* access modifiers changed from: private */
    public synchronized Multiplexer getExistingMultiplexer(K key) {
    ...
    /* access modifiers changed from: private */
    public synchronized void removeMultiplexer(K key, Multiplexer multiplexer) {
