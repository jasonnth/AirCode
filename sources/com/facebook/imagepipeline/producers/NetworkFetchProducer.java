...
public class NetworkFetchProducer implements Producer<EncodedImage> {
    ...
    public void produceResults(Consumer<EncodedImage> consumer, ProducerContext context) {
        ...
        this.mNetworkFetcher.fetch(fetchState, new Callback() {
    ...
    private void notifyConsumer(PooledByteBufferOutputStream pooledOutputStream, boolean isFinal, Consumer<EncodedImage> consumer) {
        CloseableReference<PooledByteBuffer> result = CloseableReference.m1871of(pooledOutputStream.toByteBuffer());
