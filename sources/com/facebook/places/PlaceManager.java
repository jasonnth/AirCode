...
public class PlaceManager {
    ...
    public static void newCurrentPlaceRequest(final CurrentPlaceRequestParams requestParams, final OnRequestReadyCallback callback) {
        ...
        ScanMode scanMode = requestParams.getScanMode();
        Builder builder = new Builder();
    ...
    public static Bundle getCurrentPlaceParameters(CurrentPlaceRequestParams request, LocationPackage locationPackage) throws FacebookException {
        ...
        try {
            ...
            bundle.putString("summary", PARAM_TRACKING);
            ...
            if (location.hasAccuracy()) {
                coordinates.put("accuracy", (double) location.getAccuracy());
            }
            ...
            if (location.hasSpeed()) {
                coordinates.put(PARAM_SPEED, (double) location.getSpeed());
            }
            ...
            if (locationPackage != null) {
                ...
                wifi.put("enabled", locationPackage.isWifiScanningEnabled);
                ...
                bundle.putString(PARAM_WIFI, wifi.toString());
                JSONObject bluetooth = new JSONObject();
                bluetooth.put("enabled", locationPackage.isBluetoothScanningEnabled);
            ...
            FacebookException facebookException = new FacebookException((Throwable) ex);
    ...
    private static JSONObject getWifiScanJson(WifiScanResult wifiScanResult) throws JSONException {
        ...
        wifiData.put("mac_address", wifiScanResult.bssid);
