...
public interface PlaceFields {
    ...
    /* renamed from: ID */
    public static final String f3122ID = "id";
    ...
    public static final String PHOTOS_TAGGED = "photos.type(tagged)";
    public static final String PHOTOS_UPLOADED = "photos.type(uploaded)";
