...
public final class FacebookRequestError implements Parcelable {
    ...
    FacebookRequestError(HttpURLConnection connection2, Exception exception2) {
        this(-1, -1, -1, null, null, null, null, false, null, null, null, connection2, exception2 instanceof FacebookException ? (FacebookException) exception2 : new FacebookException((Throwable) exception2));
    }

    public FacebookRequestError(int errorCode2, String errorType2, String errorMessage2) {
        this(-1, errorCode2, -1, errorType2, errorMessage2, null, null, false, null, null, null, null, null);
    }
    ...
    static FacebookRequestError checkResponseAndCreateError(JSONObject singleResult, Object batchResult, HttpURLConnection connection2) {
        ...
        try {
            if (singleResult.has("code")) {
                ...
                Object body = Utility.getStringPropertyAsJSON(singleResult, "body", GraphResponse.NON_JSON_RESPONSE_PROPERTY);
                if (body != null && (body instanceof JSONObject)) {
                    ...
                    if (jsonBody.has("error")) {
                        ...
                        errorUserMessage2 = error.optString("error_user_msg", null);
                        ...
                        errorType2 = jsonBody.optString("error_reason", null);
                        errorMessage2 = jsonBody.optString("error_msg", null);
                        errorCode2 = jsonBody.optInt("error_code", -1);
                        errorSubCode = jsonBody.optInt("error_subcode", -1);
                        hasError = true;
                    }
                    if (hasError) {
                        return new FacebookRequestError(responseCode, errorCode2, errorSubCode, errorType2, errorMessage2, errorUserTitle2, errorUserMessage2, errorIsTransient, jsonBody, singleResult, batchResult, connection2, null);
                    }
                }
                if (!HTTP_RANGE_SUCCESS.contains(responseCode)) {
                    ...
                    return new FacebookRequestError(responseCode, -1, -1, null, null, null, null, false, jSONObject, singleResult, batchResult, connection2, null);
                }
            }
