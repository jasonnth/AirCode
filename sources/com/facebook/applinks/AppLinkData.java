...
public class AppLinkData {
    ...
    public static AppLinkData createFromAlApplinkData(Intent intent) {
        ...
        Bundle extras = applinks.getBundle("extras");
        if (extras == null) {
            return appLinkData;
        }
        String deeplinkContext = extras.getString("deeplink_context");
        ...
        try {
            ...
            if (appLinkArgsJson.getJSONObject("bridge_args").getString(BRIDGE_ARGS_METHOD_KEY).equals("applink") && version.equals("2")) {
                ...
                if (appLinkData.arguments.has("extras")) {
                    JSONObject extrasData = appLinkData.arguments.getJSONObject("extras");
