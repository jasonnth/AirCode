...
public class FacebookAppLinkResolver {
    ...
    public Task<Map<Uri, AppLink>> getAppLinkFromUrlsInBackground(List<Uri> uris) {
        ...
        appLinkRequestParameters.putString(GraphRequest.FIELDS_PARAM, String.format("%s.fields(%s,%s)", new Object[]{"app_links", "android", "web"}));
        new GraphRequest(AccessToken.getCurrentAccessToken(), "", appLinkRequestParameters, null, new Callback() {
    ...
    /* access modifiers changed from: private */
    public static Target getAndroidTargetFromJson(JSONObject targetJson) {
