...
/* renamed from: com.facebook.accountkit.ui.SentCodeContentController */
abstract class SentCodeContentController extends ContentControllerBase {
    ...
    public void onResume(final Activity activity) {
        ...
        this.delayedTransitionRunnable = new Runnable() {
            public void run() {
                LocalBroadcastManager.getInstance(activity).sendBroadcast(new Intent(LoginFlowBroadcastReceiver.ACTION_UPDATE).putExtra(LoginFlowBroadcastReceiver.EXTRA_EVENT, Event.SENT_CODE_COMPLETE));
    ...
    public TitleFragment getHeaderFragment() {
        if (this.headerFragment == null) {
            setHeaderFragment(TitleFragmentFactory.create(this.configuration.getUIManager(), C3354R.string.com_accountkit_sent_title, new String[0]));
        }
