...
final class LocaleMapper {
    ...
    static {
        ...
        LANGUAGE_MAP.put("it", "it_IT");
        LANGUAGE_MAP.put("iw", "he_IL");
        LANGUAGE_MAP.put(AirbnbConstants.LANGUAGE_CODE_JAPAN, "ja_JP");
        LANGUAGE_MAP.put("ka", "ka_GE");
        LANGUAGE_MAP.put("km", "km_KH");
        LANGUAGE_MAP.put("kn", "kn_IN");
        LANGUAGE_MAP.put(AirbnbConstants.LANGUAGE_CODE_KOREA, "ko_KR");
        ...
        LANGUAGE_MAP.put(AirbnbConstants.LANGUAGE_CODE_CHINESE, "zh_CN");
    ...
    public static String getSystemLocale() {
        ...
        String localeString = String.format("%s_%s", new Object[]{language, loc.getCountry()});
        if (LOCALE_MAP.containsKey(localeString)) {
            return (String) LOCALE_MAP.get(localeString);
        }
        String result = (String) LANGUAGE_MAP.get(language);
        if (result != null) {
            return result;
        }
