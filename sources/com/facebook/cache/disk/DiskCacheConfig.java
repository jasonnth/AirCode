...
public class DiskCacheConfig {
    ...
    public static class Builder {
        ...
        public Builder setBaseDirectoryPath(File baseDirectoryPath) {
            this.mBaseDirectoryPathSupplier = Suppliers.m1786of(baseDirectoryPath);
            return this;
        }
    ...
    private DiskCacheConfig(Builder builder) {
        CacheErrorLogger access$700;
        CacheEventListener access$800;
        DiskTrimmableRegistry access$900;
        ...
        if (builder.mCacheErrorLogger == null) {
            access$700 = NoOpCacheErrorLogger.getInstance();
        } else {
            access$700 = builder.mCacheErrorLogger;
        }
        this.mCacheErrorLogger = access$700;
        if (builder.mCacheEventListener == null) {
            access$800 = NoOpCacheEventListener.getInstance();
        } else {
            access$800 = builder.mCacheEventListener;
        }
        this.mCacheEventListener = access$800;
        if (builder.mDiskTrimmableRegistry == null) {
            access$900 = NoOpDiskTrimmableRegistry.getInstance();
        } else {
            access$900 = builder.mDiskTrimmableRegistry;
        }
        this.mDiskTrimmableRegistry = access$900;
    }
