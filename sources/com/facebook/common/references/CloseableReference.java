...
public final class CloseableReference<T> implements Closeable, Cloneable {
    ...
    /* renamed from: of */
    public static <T extends Closeable> CloseableReference<T> m1871of(T t) {
        if (t == null) {
            return null;
        }
    ...
    /* renamed from: of */
    public static <T> CloseableReference<T> m1872of(T t, ResourceReleaser<T> resourceReleaser) {
        if (t == null) {
            return null;
        }
    ...
    public void finalize() throws Throwable {
        try {
            synchronized (this) {
                if (!this.mIsClosed) {
                    FLog.m1845w(TAG, "Finalized without closing: %x %x (type = %s)", Integer.valueOf(System.identityHashCode(this)), Integer.valueOf(System.identityHashCode(this.mSharedReference)), this.mSharedReference.get().getClass().getSimpleName());
                    close();
                    super.finalize();
                }
            }
