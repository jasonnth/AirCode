...
public final class DiskLruCache implements Closeable {
    ...
    private DiskLruCache(File directory2, int appVersion2, int valueCount2, long maxSize2) {
        ...
        this.journalFile = new File(directory2, "journal");
        this.journalFileTmp = new File(directory2, "journal.tmp");
        this.journalFileBackup = new File(directory2, "journal.bkp");
    ...
    private synchronized com.bumptech.glide.disklrucache.DiskLruCache.Editor edit(java.lang.String r5, long r6) throws java.io.IOException {
        ...
        L_0x002c:
            ...
            r1.currentEditor = r0     // Catch:{ all -> 0x0056 }
