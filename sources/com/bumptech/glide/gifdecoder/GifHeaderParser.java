...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        boolean lctFlag;
        boolean z = true;
        this.header.currentFrame.f2928ix = readShort();
        this.header.currentFrame.f2929iy = readShort();
        this.header.currentFrame.f2927iw = readShort();
        this.header.currentFrame.f2926ih = readShort();
        int packed = read();
        if ((packed & 128) != 0) {
            lctFlag = true;
        } else {
