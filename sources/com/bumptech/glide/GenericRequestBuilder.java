...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
    ...
    GenericRequestBuilder(Context context2, Class<ModelType> modelClass2, LoadProvider<ModelType, DataType, ResourceType, TranscodeType> loadProvider2, Class<TranscodeType> transcodeClass2, Glide glide2, RequestTracker requestTracker2, Lifecycle lifecycle2) {
        ...
        if (loadProvider2 != null) {
            childLoadProvider = new ChildLoadProvider<>(loadProvider2);
        }
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> animate(int animationId) {
        return animate((GlideAnimationFactory<TranscodeType>) new ViewAnimationFactory<TranscodeType>(this.context, animationId));
    }
    ...
    public Target<TranscodeType> into(ImageView view) {
        ...
        if (!this.isTransformationSet && view.getScaleType() != null) {
            switch (C10032.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
                case 1:
                    applyCenterCrop();
                    break;
                case 2:
        ...
        return into((Y) this.glide.buildImageViewTarget(view, this.transcodeClass));
    }
    ...
    public Target<TranscodeType> preload(int width, int height) {
        return into((Y) PreloadTarget.obtain(width, height));
    }
