...
public final class LazyHeaders implements Headers {
    ...
    public static final class Builder {
        ...
        static {
            ...
            temp.put("Accept-Encoding", Collections.singletonList(new StringHeaderFactory(InterpolationAnimatedNode.EXTRAPOLATE_TYPE_IDENTITY)));
        ...
        public Builder addHeader(String key, LazyHeaderFactory factory) {
            if ((this.isEncodingDefault && "Accept-Encoding".equalsIgnoreCase(key)) || (this.isUserAgentDefault && "User-Agent".equalsIgnoreCase(key))) {
        ...
        public Builder setHeader(String key, LazyHeaderFactory factory) {
            ...
            if (this.isEncodingDefault && "Accept-Encoding".equalsIgnoreCase(key)) {
    ...
    private Map<String, String> generateHeaders() {
        ...
        for (Entry<String, List<LazyHeaderFactory>> entry : this.headers.entrySet()) {
            ...
            combinedHeaders2.put(entry.getKey(), sb.toString());
        }
