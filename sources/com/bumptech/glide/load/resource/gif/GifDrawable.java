...
public class GifDrawable extends GlideDrawable implements FrameCallback {
    ...
    static class GifState extends ConstantState {
        ...
        public GifState(GifHeader header, byte[] data2, Context context2, Transformation<Bitmap> frameTransformation2, int targetWidth2, int targetHeight2, BitmapProvider provider, BitmapPool bitmapPool2, Bitmap firstFrame2) {
            if (firstFrame2 == null) {
    ...
    public void draw(Canvas canvas) {
        if (!this.isRecycled) {
            if (this.applyGravity) {
                Gravity.apply(LDSFile.EF_SOD_TAG, getIntrinsicWidth(), getIntrinsicHeight(), getBounds(), this.destRect);
