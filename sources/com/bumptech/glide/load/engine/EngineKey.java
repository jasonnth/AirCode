...
class EngineKey implements Key {
    ...
    public Key getOriginalKey() {
        if (this.originalKey == null) {
            this.originalKey = new OriginalKey(this.f2932id, this.signature);
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!this.f2932id.equals(engineKey.f2932id) || !this.signature.equals(engineKey.signature) || this.height != engineKey.height || this.width != engineKey.width) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        int i5 = 0;
        if (this.hashCode == 0) {
            this.hashCode = this.f2932id.hashCode();
    ...
    public String toString() {
        ...
        if (this.stringKey == null) {
            StringBuilder append = new StringBuilder().append("EngineKey{").append(this.f2932id).append('+').append(this.signature).append("+[").append(this.width).append('x').append(this.height).append("]+").append('\'');
            if (this.cacheDecoder != null) {
    ...
    public void updateDiskCacheKey(MessageDigest messageDigest) throws UnsupportedEncodingException {
        ...
        messageDigest.update(this.f2932id.getBytes(JPushConstants.ENCODING_UTF_8));
        messageDigest.update(dimensions);
        messageDigest.update((this.cacheDecoder != null ? this.cacheDecoder.getId() : "").getBytes(JPushConstants.ENCODING_UTF_8));
        messageDigest.update((this.decoder != null ? this.decoder.getId() : "").getBytes(JPushConstants.ENCODING_UTF_8));
        messageDigest.update((this.transformation != null ? this.transformation.getId() : "").getBytes(JPushConstants.ENCODING_UTF_8));
        messageDigest.update((this.encoder != null ? this.encoder.getId() : "").getBytes(JPushConstants.ENCODING_UTF_8));
        messageDigest.update((this.sourceEncoder != null ? this.sourceEncoder.getId() : "").getBytes(JPushConstants.ENCODING_UTF_8));
    }
}
