...
public final class Stopwatch {
    ...
    /* renamed from: com.nytimes.android.external.cache.Stopwatch$1 */
    ...
    public String toString() {
        ...
        return String.format(Locale.ROOT, "%.4g %s", new Object[]{Double.valueOf(((double) nanos) / ((double) TimeUnit.NANOSECONDS.convert(1, unit))), abbreviate(unit)});
    }
    ...
    private static String abbreviate(TimeUnit unit) {
        switch (C46621.$SwitchMap$java$util$concurrent$TimeUnit[unit.ordinal()]) {
            case 1:
                return "ns";
            case 2:
                return "μs";
