...
public class ReactVideoViewManager extends SimpleViewManager<ReactVideoView> {
    ...
    public void setSrc(ReactVideoView videoView, ReadableMap src) {
        ...
        if (mainVer > 0) {
            videoView.setSrc(src.getString("uri"), src.getString("type"), src.getBoolean("isNetwork"), src.getBoolean("isAsset"), mainVer, patchVer);
            return;
        }
    ...
    public void setProgressUpdateInterval(ReactVideoView videoView, float progressUpdateInterval) {
