...
/* renamed from: com.android.ex.chips.RecipientEntry */
public class RecipientEntry {
    ...
    private RecipientEntry(int entryType, String displayName, String destination, int destinationType, String destinationLabel, long contactId, Long directoryId, long dataId, Uri photoThumbnailUri, boolean isFirstLevel, boolean isValid, String lookupKey) {
    ...
    public static RecipientEntry constructFakeEntry(String address, boolean isValid) {
        ...
        if (tokens.length > 0) {
            tokenizedAddress = tokens[0].getAddress();
        } else {
            tokenizedAddress = address;
        }
        return new RecipientEntry(0, tokenizedAddress, tokenizedAddress, -1, null, -1, null, -1, null, true, isValid, null);
    }

    public static RecipientEntry constructFakePhoneEntry(String phoneNumber, boolean isValid) {
        return new RecipientEntry(0, phoneNumber, phoneNumber, -1, null, -1, null, -1, null, true, isValid, null);
    }
    ...
    public static RecipientEntry constructGeneratedEntry(String display, String address, boolean isValid) {
        return new RecipientEntry(0, display, address, -1, null, -2, null, -2, null, true, isValid, null);
    }
