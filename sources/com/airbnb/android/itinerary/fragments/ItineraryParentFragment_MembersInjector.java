...
public final class ItineraryParentFragment_MembersInjector implements MembersInjector<ItineraryParentFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!ItineraryParentFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static MembersInjector<ItineraryParentFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperAndSharedPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<PerformanceLogger> performanceLoggerProvider2) {
        return new ItineraryParentFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperAndSharedPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, performanceLoggerProvider2);
    }

    public void injectMembers(ItineraryParentFragment instance) {
        if (instance == null) {
    ...
    public static void injectPerformanceLogger(ItineraryParentFragment instance, Provider<PerformanceLogger> performanceLoggerProvider2) {
        instance.performanceLogger = (PerformanceLogger) performanceLoggerProvider2.get();
    }

    public static void injectSharedPrefsHelper(ItineraryParentFragment instance, Provider<SharedPrefsHelper> sharedPrefsHelperProvider) {
