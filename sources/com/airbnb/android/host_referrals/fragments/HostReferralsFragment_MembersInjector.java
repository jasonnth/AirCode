...
public final class HostReferralsFragment_MembersInjector implements MembersInjector<HostReferralsFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!HostReferralsFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<HostReferralLogger> hostReferralLoggerProvider;
                                                            ...
                                                            if ($assertionsDisabled || clientSessionValidatorProvider2 != null) {
                                                                ...
                                                                if ($assertionsDisabled || viewBreadcrumbManagerProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || resourceManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || hostReferralLoggerProvider2 != null) {
                                                                            this.hostReferralLoggerProvider = hostReferralLoggerProvider2;
                                                                            return;
                                                                        }
    ...
    public static MembersInjector<HostReferralsFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<HostReferralLogger> hostReferralLoggerProvider2) {
        return new HostReferralsFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, hostReferralLoggerProvider2);
    }

    public void injectMembers(HostReferralsFragment instance) {
        if (instance == null) {
        ...
        instance.hostReferralLogger = (HostReferralLogger) this.hostReferralLoggerProvider.get();
    }

    public static void injectHostReferralLogger(HostReferralsFragment instance, Provider<HostReferralLogger> hostReferralLoggerProvider2) {
        instance.hostReferralLogger = (HostReferralLogger) hostReferralLoggerProvider2.get();
    }
}
