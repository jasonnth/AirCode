...
public class ManageListingHouseRulesSettingsFragment_ViewBinding implements Unbinder {
    private ManageListingHouseRulesSettingsFragment target;
    private View view2131755498;

    public ManageListingHouseRulesSettingsFragment_ViewBinding(final ManageListingHouseRulesSettingsFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingHouseRulesSettingsFragment target2 = this.target;
        if (target2 == null) {
