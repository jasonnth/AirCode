...
public class ManageListingBasePriceSettingFragment_ViewBinding implements Unbinder {
    private ManageListingBasePriceSettingFragment target;
    private View view2131755498;

    public ManageListingBasePriceSettingFragment_ViewBinding(final ManageListingBasePriceSettingFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingBasePriceSettingFragment target2 = this.target;
        if (target2 == null) {
