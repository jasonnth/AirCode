...
public class ManageListingCheckInOutFragment_ViewBinding implements Unbinder {
    private ManageListingCheckInOutFragment target;
    private View view2131755498;

    public ManageListingCheckInOutFragment_ViewBinding(final ManageListingCheckInOutFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingCheckInOutFragment target2 = this.target;
        if (target2 == null) {
