...
public class CityRegistrationApplicationFragment_ViewBinding implements Unbinder {
    ...
    public CityRegistrationApplicationFragment_ViewBinding(final CityRegistrationApplicationFragment target2, View source) {
        ...
        View view = Utils.findRequiredView(source, C7368R.C7370id.save_button, "field 'saveButton' and method 'onSubmit'");
    ...
    public void unbind() {
        CityRegistrationApplicationFragment target2 = this.target;
        if (target2 == null) {
