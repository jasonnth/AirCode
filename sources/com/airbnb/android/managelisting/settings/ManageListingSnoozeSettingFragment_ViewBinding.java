...
public class ManageListingSnoozeSettingFragment_ViewBinding implements Unbinder {
    private ManageListingSnoozeSettingFragment target;
    private View view2131755498;

    public ManageListingSnoozeSettingFragment_ViewBinding(final ManageListingSnoozeSettingFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingSnoozeSettingFragment target2 = this.target;
        if (target2 == null) {
