...
public class ManageListingTripLengthFragment_ViewBinding implements Unbinder {
    private ManageListingTripLengthFragment target;
    private View view2131755498;

    public ManageListingTripLengthFragment_ViewBinding(final ManageListingTripLengthFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingTripLengthFragment target2 = this.target;
        if (target2 == null) {
