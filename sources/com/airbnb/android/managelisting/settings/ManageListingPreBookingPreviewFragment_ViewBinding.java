...
public class ManageListingPreBookingPreviewFragment_ViewBinding implements Unbinder {
    private ManageListingPreBookingPreviewFragment target;

    public ManageListingPreBookingPreviewFragment_ViewBinding(ManageListingPreBookingPreviewFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingPreBookingPreviewFragment target2 = this.target;
        if (target2 == null) {
