...
public class ManageListingAvailabilitySettingsFragment_ViewBinding implements Unbinder {
    private ManageListingAvailabilitySettingsFragment target;
    private View view2131755498;

    public ManageListingAvailabilitySettingsFragment_ViewBinding(final ManageListingAvailabilitySettingsFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingAvailabilitySettingsFragment target2 = this.target;
        if (target2 == null) {
