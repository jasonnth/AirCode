...
public class DiscountsExampleFragment_ViewBinding implements Unbinder {
    private DiscountsExampleFragment target;

    public DiscountsExampleFragment_ViewBinding(DiscountsExampleFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        DiscountsExampleFragment target2 = this.target;
        if (target2 == null) {
