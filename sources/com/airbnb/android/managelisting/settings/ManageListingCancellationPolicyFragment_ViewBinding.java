...
public class ManageListingCancellationPolicyFragment_ViewBinding implements Unbinder {
    ...
    public ManageListingCancellationPolicyFragment_ViewBinding(final ManageListingCancellationPolicyFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingCancellationPolicyFragment target2 = this.target;
        if (target2 == null) {
