...
public class ManageListingDescriptionSettingsFragment_ViewBinding implements Unbinder {
    private ManageListingDescriptionSettingsFragment target;

    public ManageListingDescriptionSettingsFragment_ViewBinding(ManageListingDescriptionSettingsFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingDescriptionSettingsFragment target2 = this.target;
        if (target2 == null) {
