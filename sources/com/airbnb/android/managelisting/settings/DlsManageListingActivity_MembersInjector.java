...
public final class DlsManageListingActivity_MembersInjector implements MembersInjector<DlsManageListingActivity> {
    static final /* synthetic */ boolean $assertionsDisabled = (!DlsManageListingActivity_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<CheckInJitneyLogger> checkInJitneyLoggerProvider;
                                                                    ...
                                                                    if ($assertionsDisabled || wishListManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || dLSloggerProvider2 != null) {
                                                                            ...
                                                                            if ($assertionsDisabled || cohostingManagementJitneyLoggerProvider2 != null) {
                                                                                ...
                                                                                if ($assertionsDisabled || checkInJitneyLoggerProvider2 != null) {
                                                                                    this.checkInJitneyLoggerProvider = checkInJitneyLoggerProvider2;
                                                                                    return;
                                                                                }
    ...
    public void injectMembers(DlsManageListingActivity instance) {
        ...
        instance.checkInJitneyLogger = (CheckInJitneyLogger) this.checkInJitneyLoggerProvider.get();
    }

    public static void injectCohostingManagementJitneyLogger(DlsManageListingActivity instance, Provider<CohostingManagementJitneyLogger> cohostingManagementJitneyLoggerProvider2) {
        instance.cohostingManagementJitneyLogger = (CohostingManagementJitneyLogger) cohostingManagementJitneyLoggerProvider2.get();
    }

    public static void injectCheckInJitneyLogger(DlsManageListingActivity instance, Provider<CheckInJitneyLogger> checkInJitneyLoggerProvider2) {
        instance.checkInJitneyLogger = (CheckInJitneyLogger) checkInJitneyLoggerProvider2.get();
    }
}
