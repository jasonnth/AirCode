...
public class ManageListingUnlistOtherReasonFragment_ViewBinding implements Unbinder {
    private ManageListingUnlistOtherReasonFragment target;
    private View view2131755497;

    public ManageListingUnlistOtherReasonFragment_ViewBinding(final ManageListingUnlistOtherReasonFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingUnlistOtherReasonFragment target2 = this.target;
        if (target2 == null) {
