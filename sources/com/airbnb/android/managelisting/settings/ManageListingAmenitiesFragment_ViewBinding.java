...
public class ManageListingAmenitiesFragment_ViewBinding implements Unbinder {
    private ManageListingAmenitiesFragment target;
    private View view2131755498;

    public ManageListingAmenitiesFragment_ViewBinding(final ManageListingAmenitiesFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingAmenitiesFragment target2 = this.target;
        if (target2 == null) {
