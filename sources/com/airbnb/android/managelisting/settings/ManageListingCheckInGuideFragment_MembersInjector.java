...
public final class ManageListingCheckInGuideFragment_MembersInjector implements MembersInjector<ManageListingCheckInGuideFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!ManageListingCheckInGuideFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<CheckInJitneyLogger> jitneyLoggerProvider;
    ...
    public static MembersInjector<ManageListingCheckInGuideFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<CheckInJitneyLogger> jitneyLoggerProvider2, Provider<PhotoUploadManager> photoUploadManagerProvider2) {
        return new ManageListingCheckInGuideFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, jitneyLoggerProvider2, photoUploadManagerProvider2);
    }

    public void injectMembers(ManageListingCheckInGuideFragment instance) {
        if (instance == null) {
        ...
        instance.jitneyLogger = (CheckInJitneyLogger) this.jitneyLoggerProvider.get();
        instance.photoUploadManager = (PhotoUploadManager) this.photoUploadManagerProvider.get();
    }

    public static void injectJitneyLogger(ManageListingCheckInGuideFragment instance, Provider<CheckInJitneyLogger> jitneyLoggerProvider2) {
        instance.jitneyLogger = (CheckInJitneyLogger) jitneyLoggerProvider2.get();
    }

    public static void injectPhotoUploadManager(ManageListingCheckInGuideFragment instance, Provider<PhotoUploadManager> photoUploadManagerProvider2) {
