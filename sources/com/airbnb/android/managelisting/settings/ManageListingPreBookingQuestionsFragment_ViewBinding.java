...
public class ManageListingPreBookingQuestionsFragment_ViewBinding implements Unbinder {
    private ManageListingPreBookingQuestionsFragment target;

    public ManageListingPreBookingQuestionsFragment_ViewBinding(ManageListingPreBookingQuestionsFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingPreBookingQuestionsFragment target2 = this.target;
        if (target2 == null) {
