...
public class ManageListingNightlyPriceSettingsFragment_ViewBinding implements Unbinder {
    private ManageListingNightlyPriceSettingsFragment target;
    private View view2131755498;

    public ManageListingNightlyPriceSettingsFragment_ViewBinding(final ManageListingNightlyPriceSettingsFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingNightlyPriceSettingsFragment target2 = this.target;
        if (target2 == null) {
