...
public class ManageListingEarlyBirdDiscountFragment_ViewBinding implements Unbinder {
    private ManageListingEarlyBirdDiscountFragment target;
    private View view2131755498;

    public ManageListingEarlyBirdDiscountFragment_ViewBinding(final ManageListingEarlyBirdDiscountFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingEarlyBirdDiscountFragment target2 = this.target;
        if (target2 == null) {
