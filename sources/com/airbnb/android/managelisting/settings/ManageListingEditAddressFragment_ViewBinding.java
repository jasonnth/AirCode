...
public class ManageListingEditAddressFragment_ViewBinding implements Unbinder {
    private ManageListingEditAddressFragment target;
    private View view2131755498;

    public ManageListingEditAddressFragment_ViewBinding(final ManageListingEditAddressFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingEditAddressFragment target2 = this.target;
        if (target2 == null) {
