...
public class CityRegistrationReviewExemptedFragment_ViewBinding implements Unbinder {
    private CityRegistrationReviewExemptedFragment target;
    private View view2131755498;

    public CityRegistrationReviewExemptedFragment_ViewBinding(final CityRegistrationReviewExemptedFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        CityRegistrationReviewExemptedFragment target2 = this.target;
        if (target2 == null) {
