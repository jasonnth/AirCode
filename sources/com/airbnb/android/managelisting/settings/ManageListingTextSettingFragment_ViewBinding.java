...
public class ManageListingTextSettingFragment_ViewBinding implements Unbinder {
    private ManageListingTextSettingFragment target;
    private View view2131755497;

    public ManageListingTextSettingFragment_ViewBinding(final ManageListingTextSettingFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingTextSettingFragment target2 = this.target;
        if (target2 == null) {
