...
public class ManageListingRoomsGuestsFragment_ViewBinding implements Unbinder {
    private ManageListingRoomsGuestsFragment target;
    private View view2131755498;

    public ManageListingRoomsGuestsFragment_ViewBinding(final ManageListingRoomsGuestsFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingRoomsGuestsFragment target2 = this.target;
        if (target2 == null) {
