...
public class ManageListingPreBookingAddQuestionsFragment_ViewBinding implements Unbinder {
    private ManageListingPreBookingAddQuestionsFragment target;

    public ManageListingPreBookingAddQuestionsFragment_ViewBinding(ManageListingPreBookingAddQuestionsFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingPreBookingAddQuestionsFragment target2 = this.target;
        if (target2 == null) {
