...
public class ManageListingCurrencyFragment_ViewBinding implements Unbinder {
    private ManageListingCurrencyFragment target;
    private View view2131755498;

    public ManageListingCurrencyFragment_ViewBinding(final ManageListingCurrencyFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingCurrencyFragment target2 = this.target;
        if (target2 == null) {
