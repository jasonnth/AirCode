...
public class ManageListingCheckinTypeTextSettingFragment_ViewBinding implements Unbinder {
    private ManageListingCheckinTypeTextSettingFragment target;
    private View view2131755497;

    public ManageListingCheckinTypeTextSettingFragment_ViewBinding(final ManageListingCheckinTypeTextSettingFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingCheckinTypeTextSettingFragment target2 = this.target;
        if (target2 == null) {
