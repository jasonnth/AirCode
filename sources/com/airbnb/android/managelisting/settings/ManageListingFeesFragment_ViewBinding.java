...
public class ManageListingFeesFragment_ViewBinding implements Unbinder {
    private ManageListingFeesFragment target;
    private View view2131755498;

    public ManageListingFeesFragment_ViewBinding(final ManageListingFeesFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingFeesFragment target2 = this.target;
        if (target2 == null) {
