...
public class ManageListingLicenseOrRegistrationNumberFragment_ViewBinding implements Unbinder {
    private ManageListingLicenseOrRegistrationNumberFragment target;
    private View view2131755498;

    public ManageListingLicenseOrRegistrationNumberFragment_ViewBinding(final ManageListingLicenseOrRegistrationNumberFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingLicenseOrRegistrationNumberFragment target2 = this.target;
        if (target2 == null) {
