...
public class ManageListingBedDetailsFragment_ViewBinding implements Unbinder {
    ...
    public ManageListingBedDetailsFragment_ViewBinding(ManageListingBedDetailsFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingBedDetailsFragment target2 = this.target;
        if (target2 == null) {
