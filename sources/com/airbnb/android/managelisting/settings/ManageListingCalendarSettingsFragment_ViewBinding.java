...
public class ManageListingCalendarSettingsFragment_ViewBinding implements Unbinder {
    private ManageListingCalendarSettingsFragment target;

    public ManageListingCalendarSettingsFragment_ViewBinding(ManageListingCalendarSettingsFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingCalendarSettingsFragment target2 = this.target;
        if (target2 == null) {
