...
public class ManageListingLastMinuteDiscountFragment_ViewBinding implements Unbinder {
    private ManageListingLastMinuteDiscountFragment target;
    private View view2131755498;

    public ManageListingLastMinuteDiscountFragment_ViewBinding(final ManageListingLastMinuteDiscountFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ManageListingLastMinuteDiscountFragment target2 = this.target;
        if (target2 == null) {
