...
public final class ManageListingPickerFragment_MembersInjector implements MembersInjector<ManageListingPickerFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!ManageListingPickerFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static MembersInjector<ManageListingPickerFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperAndSharedPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<BottomBarController> bottomBarControllerProvider2) {
        return new ManageListingPickerFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperAndSharedPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, bottomBarControllerProvider2);
    }

    public void injectMembers(ManageListingPickerFragment instance) {
        if (instance == null) {
        ...
        AirFragment_MembersInjector.injectMPrefsHelper(instance, this.mPrefsHelperAndSharedPrefsHelperProvider);
    ...
    public static void injectBottomBarController(ManageListingPickerFragment instance, Provider<BottomBarController> bottomBarControllerProvider2) {
        instance.bottomBarController = (BottomBarController) bottomBarControllerProvider2.get();
    }

    public static void injectSharedPrefsHelper(ManageListingPickerFragment instance, Provider<SharedPrefsHelper> sharedPrefsHelperProvider) {
