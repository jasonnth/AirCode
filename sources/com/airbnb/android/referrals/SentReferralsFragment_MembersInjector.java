...
public final class SentReferralsFragment_MembersInjector implements MembersInjector<SentReferralsFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!SentReferralsFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<CurrencyFormatter> currencyFormatterAndMCurrencyHelperProvider;
                                ...
                                if ($assertionsDisabled || mPrefsHelperProvider2 != null) {
                                    ...
                                    if ($assertionsDisabled || mMemoryUtilsProvider2 != null) {
                                        ...
                                        if ($assertionsDisabled || mBusProvider2 != null) {
                                            ...
                                            if ($assertionsDisabled || currencyFormatterAndMCurrencyHelperProvider2 != null) {
                                                this.currencyFormatterAndMCurrencyHelperProvider = currencyFormatterAndMCurrencyHelperProvider2;
    ...
    public static MembersInjector<SentReferralsFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> currencyFormatterAndMCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2) {
        return new SentReferralsFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, currencyFormatterAndMCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2);
    }

    public void injectMembers(SentReferralsFragment instance) {
        if (instance == null) {
        ...
        AirFragment_MembersInjector.injectMCurrencyHelper(instance, this.currencyFormatterAndMCurrencyHelperProvider);
        ...
        instance.currencyFormatter = (CurrencyFormatter) this.currencyFormatterAndMCurrencyHelperProvider.get();
    }

    public static void injectCurrencyFormatter(SentReferralsFragment instance, Provider<CurrencyFormatter> currencyFormatterProvider) {
        instance.currencyFormatter = (CurrencyFormatter) currencyFormatterProvider.get();
    }
}
