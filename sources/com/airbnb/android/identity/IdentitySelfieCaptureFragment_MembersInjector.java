...
public final class IdentitySelfieCaptureFragment_MembersInjector implements MembersInjector<IdentitySelfieCaptureFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!IdentitySelfieCaptureFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<TakeSelfieController> takeSelfieControllerProvider;
                                                            ...
                                                            if ($assertionsDisabled || clientSessionValidatorProvider2 != null) {
                                                                ...
                                                                if ($assertionsDisabled || viewBreadcrumbManagerProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || resourceManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || takeSelfieControllerProvider2 != null) {
                                                                            this.takeSelfieControllerProvider = takeSelfieControllerProvider2;
                                                                            return;
                                                                        }
    ...
    public static MembersInjector<IdentitySelfieCaptureFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<TakeSelfieController> takeSelfieControllerProvider2) {
        return new IdentitySelfieCaptureFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, takeSelfieControllerProvider2);
    }

    public void injectMembers(IdentitySelfieCaptureFragment instance) {
        if (instance == null) {
        ...
        instance.takeSelfieController = (TakeSelfieController) this.takeSelfieControllerProvider.get();
    }

    public static void injectTakeSelfieController(IdentitySelfieCaptureFragment instance, Provider<TakeSelfieController> takeSelfieControllerProvider2) {
        instance.takeSelfieController = (TakeSelfieController) takeSelfieControllerProvider2.get();
    }
}
