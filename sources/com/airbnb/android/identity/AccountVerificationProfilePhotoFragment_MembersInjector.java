...
public final class AccountVerificationProfilePhotoFragment_MembersInjector implements MembersInjector<AccountVerificationProfilePhotoFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!AccountVerificationProfilePhotoFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<ChooseProfilePhotoController> chooseProfilePhotoControllerProvider;
                                                            ...
                                                            if ($assertionsDisabled || clientSessionValidatorProvider2 != null) {
                                                                ...
                                                                if ($assertionsDisabled || viewBreadcrumbManagerProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || resourceManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || chooseProfilePhotoControllerProvider2 != null) {
                                                                            this.chooseProfilePhotoControllerProvider = chooseProfilePhotoControllerProvider2;
                                                                            return;
                                                                        }
    ...
    public static MembersInjector<AccountVerificationProfilePhotoFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<ChooseProfilePhotoController> chooseProfilePhotoControllerProvider2) {
        return new AccountVerificationProfilePhotoFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, chooseProfilePhotoControllerProvider2);
    }

    public void injectMembers(AccountVerificationProfilePhotoFragment instance) {
        if (instance == null) {
        ...
        instance.chooseProfilePhotoController = (ChooseProfilePhotoController) this.chooseProfilePhotoControllerProvider.get();
    }

    public static void injectChooseProfilePhotoController(AccountVerificationProfilePhotoFragment instance, Provider<ChooseProfilePhotoController> chooseProfilePhotoControllerProvider2) {
        instance.chooseProfilePhotoController = (ChooseProfilePhotoController) chooseProfilePhotoControllerProvider2.get();
    }
}
