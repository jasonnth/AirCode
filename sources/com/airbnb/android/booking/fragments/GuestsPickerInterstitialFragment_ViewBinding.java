...
public class GuestsPickerInterstitialFragment_ViewBinding implements Unbinder {
    private GuestsPickerInterstitialFragment target;
    private View view2131755509;

    public GuestsPickerInterstitialFragment_ViewBinding(final GuestsPickerInterstitialFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        GuestsPickerInterstitialFragment target2 = this.target;
        if (target2 == null) {
