...
public class PendingAmenityOrderListFragment_ViewBinding implements Unbinder {
    ...
    public PendingAmenityOrderListFragment_ViewBinding(PendingAmenityOrderListFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        PendingAmenityOrderListFragment target2 = this.target;
        if (target2 == null) {
