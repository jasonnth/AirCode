...
public final class BasePurchaseAmenityFragment_MembersInjector implements MembersInjector<BasePurchaseAmenityFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!BasePurchaseAmenityFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<PaidAmenityJitneyLogger> paidAmenityJitneyLoggerProvider;
                                                            ...
                                                            if ($assertionsDisabled || clientSessionValidatorProvider2 != null) {
                                                                ...
                                                                if ($assertionsDisabled || viewBreadcrumbManagerProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || resourceManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || paidAmenityJitneyLoggerProvider2 != null) {
                                                                            this.paidAmenityJitneyLoggerProvider = paidAmenityJitneyLoggerProvider2;
                                                                            return;
                                                                        }
    ...
    public static MembersInjector<BasePurchaseAmenityFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<PaidAmenityJitneyLogger> paidAmenityJitneyLoggerProvider2) {
        return new BasePurchaseAmenityFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, paidAmenityJitneyLoggerProvider2);
    }

    public void injectMembers(BasePurchaseAmenityFragment instance) {
        if (instance == null) {
        ...
        instance.paidAmenityJitneyLogger = (PaidAmenityJitneyLogger) this.paidAmenityJitneyLoggerProvider.get();
    }

    public static void injectPaidAmenityJitneyLogger(BasePurchaseAmenityFragment instance, Provider<PaidAmenityJitneyLogger> paidAmenityJitneyLoggerProvider2) {
        instance.paidAmenityJitneyLogger = (PaidAmenityJitneyLogger) paidAmenityJitneyLoggerProvider2.get();
    }
}
