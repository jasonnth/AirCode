...
public class RequestAmenityFragment_ViewBinding implements Unbinder {
    private RequestAmenityFragment target;

    public RequestAmenityFragment_ViewBinding(RequestAmenityFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        RequestAmenityFragment target2 = this.target;
        if (target2 == null) {
