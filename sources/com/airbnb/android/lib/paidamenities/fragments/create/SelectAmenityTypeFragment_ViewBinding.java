...
public class SelectAmenityTypeFragment_ViewBinding implements Unbinder {
    private SelectAmenityTypeFragment target;

    public SelectAmenityTypeFragment_ViewBinding(SelectAmenityTypeFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        SelectAmenityTypeFragment target2 = this.target;
        if (target2 == null) {
