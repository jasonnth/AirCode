...
public class AddAmenityDetailsFragment_ViewBinding implements Unbinder {
    private AddAmenityDetailsFragment target;
    private View view2131756035;

    public AddAmenityDetailsFragment_ViewBinding(final AddAmenityDetailsFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        AddAmenityDetailsFragment target2 = this.target;
        if (target2 == null) {
