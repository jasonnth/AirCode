...
public class SelectListingFragment_ViewBinding implements Unbinder {
    private SelectListingFragment target;

    public SelectListingFragment_ViewBinding(SelectListingFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        SelectListingFragment target2 = this.target;
        if (target2 == null) {
