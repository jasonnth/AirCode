...
public class HostAmenityListFragment_ViewBinding implements Unbinder {
    private HostAmenityListFragment target;

    public HostAmenityListFragment_ViewBinding(HostAmenityListFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        HostAmenityListFragment target2 = this.target;
        if (target2 == null) {
