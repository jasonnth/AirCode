...
public class HostPendingAmenityActivity extends AirActivity implements Listener {
    ...
    public static Intent intent(Context context, String confirmationCode2, long threadId2, long listingId2) {
        return new Intent(context, HostPendingAmenityActivity.class).putExtra("confirmation_code", confirmationCode2).putExtra("thread_id", threadId2).putExtra("listing_id", listingId2);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            Check.state((this.confirmationCode.isEmpty() || this.listingId == -1 || this.threadId == -1) ? false : true);
            showFragment(PendingAmenityOrderListFragment.newInstanceAsHost(this.confirmationCode), C0880R.C0882id.content_container, FragmentTransitionType.SlideInFromSide, true);
        }
    }
    ...
    public void goToPendingAmenityOrderDetail(PaidAmenityOrder paidAmenityOrder) {
        showFragment(PendingAmenityOrderDetailFragment.newInstanceAsHost(paidAmenityOrder), C0880R.C0882id.content_container, FragmentTransitionType.SlideInFromSide, true);
    }
