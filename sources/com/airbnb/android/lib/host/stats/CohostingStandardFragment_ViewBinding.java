...
public class CohostingStandardFragment_ViewBinding implements Unbinder {
    private CohostingStandardFragment target;

    public CohostingStandardFragment_ViewBinding(CohostingStandardFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        CohostingStandardFragment target2 = this.target;
        if (target2 == null) {
