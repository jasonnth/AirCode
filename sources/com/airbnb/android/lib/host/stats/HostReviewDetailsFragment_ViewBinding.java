...
public class HostReviewDetailsFragment_ViewBinding implements Unbinder {
    private HostReviewDetailsFragment target;

    public HostReviewDetailsFragment_ViewBinding(HostReviewDetailsFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        HostReviewDetailsFragment target2 = this.target;
        if (target2 == null) {
