...
public final class HostStatsFragment_MembersInjector implements MembersInjector<HostStatsFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!HostStatsFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static MembersInjector<HostStatsFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> accountManagerAndMAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<HostStatsJitneyLogger> statsJitneyLoggerProvider2, Provider<BottomBarController> bottomBarControllerProvider2) {
        return new HostStatsFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, accountManagerAndMAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, statsJitneyLoggerProvider2, bottomBarControllerProvider2);
    }

    public void injectMembers(HostStatsFragment instance) {
        if (instance == null) {
    ...
    public static void injectAccountManager(HostStatsFragment instance, Provider<AirbnbAccountManager> accountManagerProvider) {
        instance.accountManager = (AirbnbAccountManager) accountManagerProvider.get();
    }

    public static void injectStatsJitneyLogger(HostStatsFragment instance, Provider<HostStatsJitneyLogger> statsJitneyLoggerProvider2) {
        instance.statsJitneyLogger = (HostStatsJitneyLogger) statsJitneyLoggerProvider2.get();
    }

    public static void injectBottomBarController(HostStatsFragment instance, Provider<BottomBarController> bottomBarControllerProvider2) {
