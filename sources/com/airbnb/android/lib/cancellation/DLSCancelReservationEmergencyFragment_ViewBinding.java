...
public class DLSCancelReservationEmergencyFragment_ViewBinding implements Unbinder {
    ...
    public DLSCancelReservationEmergencyFragment_ViewBinding(final DLSCancelReservationEmergencyFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        DLSCancelReservationEmergencyFragment target2 = this.target;
        if (target2 == null) {
