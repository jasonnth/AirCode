...
public class CancellationDatesUnavailableFragment_ViewBinding implements Unbinder {
    private CancellationDatesUnavailableFragment target;
    private View view2131756104;

    public CancellationDatesUnavailableFragment_ViewBinding(final CancellationDatesUnavailableFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        CancellationDatesUnavailableFragment target2 = this.target;
        if (target2 == null) {
