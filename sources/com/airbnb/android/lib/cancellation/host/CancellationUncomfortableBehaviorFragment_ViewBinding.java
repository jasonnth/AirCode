...
public class CancellationUncomfortableBehaviorFragment_ViewBinding implements Unbinder {
    private CancellationUncomfortableBehaviorFragment target;
    private View view2131756104;
    private View view2131756128;
    private View view2131756130;

    public CancellationUncomfortableBehaviorFragment_ViewBinding(final CancellationUncomfortableBehaviorFragment target2, View source) {
        this.target = target2;
        ...
        View view2 = Utils.findRequiredView(source, C0880R.C0882id.edit_button, "field 'editButton' and method 'oClickEditButton'");
    ...
    public void unbind() {
        CancellationUncomfortableBehaviorFragment target2 = this.target;
        if (target2 == null) {
