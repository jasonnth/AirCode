...
public class CancellationAlterReservationFragment_ViewBinding implements Unbinder {
    private CancellationAlterReservationFragment target;
    private View view2131756104;

    public CancellationAlterReservationFragment_ViewBinding(final CancellationAlterReservationFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        CancellationAlterReservationFragment target2 = this.target;
        if (target2 == null) {
