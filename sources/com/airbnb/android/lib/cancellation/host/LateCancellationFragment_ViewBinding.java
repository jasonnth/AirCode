...
public class LateCancellationFragment_ViewBinding implements Unbinder {
    private LateCancellationFragment target;

    public LateCancellationFragment_ViewBinding(LateCancellationFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        LateCancellationFragment target2 = this.target;
        if (target2 == null) {
