...
public class CancellationOtherFragment extends AirFragment {
    @BindView
    ...
    public interface Listener {
        ...
        void onConfirmOther(String str);
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup view = (ViewGroup) inflater.inflate(C0880R.layout.fragment_cancellation_other_fragment, container, false);
        bindViews(view);
    ...
    public void onClickContinueButton() {
        this.listener.onConfirmOther(this.message);
    }
    ...
    public NavigationTag getNavigationTrackingTag() {
        return NavigationTag.HostCancellationOtherReason;
    }
