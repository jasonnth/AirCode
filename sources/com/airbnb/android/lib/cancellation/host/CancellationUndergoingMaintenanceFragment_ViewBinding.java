...
public class CancellationUndergoingMaintenanceFragment_ViewBinding implements Unbinder {
    ...
    public CancellationUndergoingMaintenanceFragment_ViewBinding(final CancellationUndergoingMaintenanceFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        CancellationUndergoingMaintenanceFragment target2 = this.target;
        if (target2 == null) {
