...
public class CancellationExtenuatingCircumstancesFragment_ViewBinding implements Unbinder {
    private CancellationExtenuatingCircumstancesFragment target;
    private View view2131756104;

    public CancellationExtenuatingCircumstancesFragment_ViewBinding(final CancellationExtenuatingCircumstancesFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        CancellationExtenuatingCircumstancesFragment target2 = this.target;
        if (target2 == null) {
