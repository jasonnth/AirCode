...
public class DLSCancelReservationDatesFragment_ViewBinding implements Unbinder {
    private DLSCancelReservationDatesFragment target;
    private View view2131756292;

    public DLSCancelReservationDatesFragment_ViewBinding(final DLSCancelReservationDatesFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        DLSCancelReservationDatesFragment target2 = this.target;
        if (target2 == null) {
