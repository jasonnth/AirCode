...
public class DLSCancelReservationAskedFragment_ViewBinding implements Unbinder {
    ...
    public DLSCancelReservationAskedFragment_ViewBinding(final DLSCancelReservationAskedFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        DLSCancelReservationAskedFragment target2 = this.target;
        if (target2 == null) {
