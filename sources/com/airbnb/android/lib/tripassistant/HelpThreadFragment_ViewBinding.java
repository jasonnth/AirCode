...
public class HelpThreadFragment_ViewBinding implements Unbinder {
    private HelpThreadFragment target;

    public HelpThreadFragment_ViewBinding(HelpThreadFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        HelpThreadFragment target2 = this.target;
        if (target2 == null) {
