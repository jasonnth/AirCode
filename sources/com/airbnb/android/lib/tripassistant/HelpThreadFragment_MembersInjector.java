...
public final class HelpThreadFragment_MembersInjector implements MembersInjector<HelpThreadFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!HelpThreadFragment_MembersInjector.class.desiredAssertionStatus());
                                                            ...
                                                            if ($assertionsDisabled || clientSessionValidatorProvider2 != null) {
                                                                ...
                                                                if ($assertionsDisabled || viewBreadcrumbManagerProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || resourceManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || bypassProvider2 != null) {
                                                                            this.bypassProvider = bypassProvider2;
                                                                            return;
                                                                        }
    ...
    public static MembersInjector<HelpThreadFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<Bypass> bypassProvider2) {
        return new HelpThreadFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, bypassProvider2);
    }

    public void injectMembers(HelpThreadFragment instance) {
        if (instance == null) {
        ...
        instance.bypass = (Bypass) this.bypassProvider.get();
    }

    public static void injectBypass(HelpThreadFragment instance, Provider<Bypass> bypassProvider2) {
        instance.bypass = (Bypass) bypassProvider2.get();
    }
}
