...
public final class WorkEmailFragment_MembersInjector implements MembersInjector<WorkEmailFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!WorkEmailFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static void injectBusinessTravelJitneyLogger(WorkEmailFragment instance, Provider<BusinessTravelJitneyLogger> businessTravelJitneyLoggerProvider2) {
        instance.businessTravelJitneyLogger = (BusinessTravelJitneyLogger) businessTravelJitneyLoggerProvider2.get();
    }

    public static void injectBusinessTravelAccountManager(WorkEmailFragment instance, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2) {
