...
public final class AdvancedSettingsFragment_MembersInjector implements MembersInjector<AdvancedSettingsFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!AdvancedSettingsFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<LowBandwidthManager> lowBandwidthManagerProvider;
                                                            ...
                                                            if ($assertionsDisabled || clientSessionValidatorProvider2 != null) {
                                                                ...
                                                                if ($assertionsDisabled || viewBreadcrumbManagerProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || resourceManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || lowBandwidthManagerProvider2 != null) {
                                                                            this.lowBandwidthManagerProvider = lowBandwidthManagerProvider2;
                                                                            return;
                                                                        }
    ...
    public static MembersInjector<AdvancedSettingsFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<LowBandwidthManager> lowBandwidthManagerProvider2) {
        return new AdvancedSettingsFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, lowBandwidthManagerProvider2);
    }
    ...
    public void injectMembers(AdvancedSettingsFragment instance) {
        ...
        instance.lowBandwidthManager = (LowBandwidthManager) this.lowBandwidthManagerProvider.get();
    }

    public static void injectLowBandwidthManager(AdvancedSettingsFragment instance, Provider<LowBandwidthManager> lowBandwidthManagerProvider2) {
        instance.lowBandwidthManager = (LowBandwidthManager) lowBandwidthManagerProvider2.get();
    }
}
