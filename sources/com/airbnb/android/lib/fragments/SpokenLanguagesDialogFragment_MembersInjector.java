...
public final class SpokenLanguagesDialogFragment_MembersInjector implements MembersInjector<SpokenLanguagesDialogFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!SpokenLanguagesDialogFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static MembersInjector<SpokenLanguagesDialogFragment> create(Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<DebugSettings> debugSettingsProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<AirbnbApi> mAirbnbApiProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<ResourceManager> resourceManagerProvider2) {
        return new SpokenLanguagesDialogFragment_MembersInjector(mAccountManagerProvider2, debugSettingsProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, mAirbnbApiProvider2, mBusProvider2, mCurrencyHelperProvider2, resourceManagerProvider2);
    }

    public void injectMembers(SpokenLanguagesDialogFragment instance) {
        if (instance == null) {
    ...
    public static void injectMAirbnbApi(SpokenLanguagesDialogFragment instance, Provider<AirbnbApi> mAirbnbApiProvider2) {
