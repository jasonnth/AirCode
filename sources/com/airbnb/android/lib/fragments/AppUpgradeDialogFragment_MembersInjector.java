...
public final class AppUpgradeDialogFragment_MembersInjector implements MembersInjector<AppUpgradeDialogFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!AppUpgradeDialogFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static MembersInjector<AppUpgradeDialogFragment> create(Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<DebugSettings> debugSettingsProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<AirbnbApi> mAirbnbApiProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<AirbnbPreferences> preferencesProvider2) {
        return new AppUpgradeDialogFragment_MembersInjector(mAccountManagerProvider2, debugSettingsProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, mAirbnbApiProvider2, mBusProvider2, mCurrencyHelperProvider2, resourceManagerProvider2, preferencesProvider2);
    }

    public void injectMembers(AppUpgradeDialogFragment instance) {
        if (instance == null) {
    ...
    public static void injectPreferences(AppUpgradeDialogFragment instance, Provider<AirbnbPreferences> preferencesProvider2) {
