...
public class PriceBreakdownFragment_ViewBinding implements Unbinder {
    private PriceBreakdownFragment target;

    public PriceBreakdownFragment_ViewBinding(PriceBreakdownFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        PriceBreakdownFragment target2 = this.target;
        if (target2 == null) {
