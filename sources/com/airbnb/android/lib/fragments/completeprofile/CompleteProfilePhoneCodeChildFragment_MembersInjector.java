...
public final class CompleteProfilePhoneCodeChildFragment_MembersInjector implements MembersInjector<CompleteProfilePhoneCodeChildFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!CompleteProfilePhoneCodeChildFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static void injectMAccountManager(CompleteProfilePhoneCodeChildFragment instance, Provider<AirbnbAccountManager> mAccountManagerProvider2) {
        instance.mAccountManager = (AirbnbAccountManager) mAccountManagerProvider2.get();
    }

    public static void injectMBus(CompleteProfilePhoneCodeChildFragment instance, Provider<Bus> mBusProvider2) {
