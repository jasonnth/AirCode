...
public final class CompleteProfilePhoneChildFragment_MembersInjector implements MembersInjector<CompleteProfilePhoneChildFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!CompleteProfilePhoneChildFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static MembersInjector<CompleteProfilePhoneChildFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<VerifiedIdAnalytics> verifiedIdAnalyticsProvider2, Provider<PhoneUtil> phoneUtilProvider2) {
        return new CompleteProfilePhoneChildFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, verifiedIdAnalyticsProvider2, phoneUtilProvider2);
    }

    public void injectMembers(CompleteProfilePhoneChildFragment instance) {
        if (instance == null) {
    ...
    public static void injectVerifiedIdAnalytics(CompleteProfilePhoneChildFragment instance, Provider<VerifiedIdAnalytics> verifiedIdAnalyticsProvider2) {
        instance.verifiedIdAnalytics = (VerifiedIdAnalytics) verifiedIdAnalyticsProvider2.get();
    }

    public static void injectPhoneUtil(CompleteProfilePhoneChildFragment instance, Provider<PhoneUtil> phoneUtilProvider2) {
