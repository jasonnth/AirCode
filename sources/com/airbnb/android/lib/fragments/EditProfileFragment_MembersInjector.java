...
public final class EditProfileFragment_MembersInjector implements MembersInjector<EditProfileFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!EditProfileFragment_MembersInjector.class.desiredAssertionStatus());
                                                            ...
                                                            if ($assertionsDisabled || clientSessionValidatorProvider2 != null) {
                                                                ...
                                                                if ($assertionsDisabled || viewBreadcrumbManagerProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || resourceManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || imageUtilsProvider2 != null) {
                                                                            this.imageUtilsProvider = imageUtilsProvider2;
    ...
    public static MembersInjector<EditProfileFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<ImageUtils> imageUtilsProvider2, Provider<PhotoCompressor> photoCompressorProvider2, Provider<IdentityJitneyLogger> identityJitneyLoggerProvider2) {
        return new EditProfileFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, imageUtilsProvider2, photoCompressorProvider2, identityJitneyLoggerProvider2);
    }
    ...
    public void injectMembers(EditProfileFragment instance) {
        ...
        instance.imageUtils = (ImageUtils) this.imageUtilsProvider.get();
        instance.photoCompressor = (PhotoCompressor) this.photoCompressorProvider.get();
    ...
    public static void injectImageUtils(EditProfileFragment instance, Provider<ImageUtils> imageUtilsProvider2) {
        instance.imageUtils = (ImageUtils) imageUtilsProvider2.get();
    }

    public static void injectPhotoCompressor(EditProfileFragment instance, Provider<PhotoCompressor> photoCompressorProvider2) {
        instance.photoCompressor = (PhotoCompressor) photoCompressorProvider2.get();
    }

    public static void injectBusinessTravelAccountManager(EditProfileFragment instance, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2) {
        instance.businessTravelAccountManager = (BusinessTravelAccountManager) businessTravelAccountManagerProvider2.get();
    }

    public static void injectIdentityJitneyLogger(EditProfileFragment instance, Provider<IdentityJitneyLogger> identityJitneyLoggerProvider2) {
