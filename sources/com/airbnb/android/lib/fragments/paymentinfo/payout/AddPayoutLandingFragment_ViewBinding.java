...
public class AddPayoutLandingFragment_ViewBinding implements Unbinder {
    private AddPayoutLandingFragment target;
    private View view2131756035;

    public AddPayoutLandingFragment_ViewBinding(final AddPayoutLandingFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        AddPayoutLandingFragment target2 = this.target;
        if (target2 == null) {
