...
public class PayoutSummaryFragment_ViewBinding implements Unbinder {
    private PayoutSummaryFragment target;

    public PayoutSummaryFragment_ViewBinding(PayoutSummaryFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        PayoutSummaryFragment target2 = this.target;
        if (target2 == null) {
