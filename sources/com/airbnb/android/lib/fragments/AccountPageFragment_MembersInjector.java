...
public final class AccountPageFragment_MembersInjector implements MembersInjector<AccountPageFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!AccountPageFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static MembersInjector<AccountPageFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<BottomBarController> bottomBarControllerProvider2, Provider<BusinessTravelJitneyLogger> businessTravelJitneyLoggerProvider2, Provider<ProfileCompletionManager> profileCompletionManagerProvider2, Provider<ListingPromoController> listingPromoControllerProvider2) {
        return new AccountPageFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, bottomBarControllerProvider2, businessTravelJitneyLoggerProvider2, profileCompletionManagerProvider2, listingPromoControllerProvider2);
    }

    public void injectMembers(AccountPageFragment instance) {
        if (instance == null) {
    ...
    public static void injectBottomBarController(AccountPageFragment instance, Provider<BottomBarController> bottomBarControllerProvider2) {
        instance.bottomBarController = (BottomBarController) bottomBarControllerProvider2.get();
    }

    public static void injectBusinessTravelJitneyLogger(AccountPageFragment instance, Provider<BusinessTravelJitneyLogger> businessTravelJitneyLoggerProvider2) {
        instance.businessTravelJitneyLogger = (BusinessTravelJitneyLogger) businessTravelJitneyLoggerProvider2.get();
    }

    public static void injectProfileCompletionManager(AccountPageFragment instance, Provider<ProfileCompletionManager> profileCompletionManagerProvider2) {
        instance.profileCompletionManager = (ProfileCompletionManager) profileCompletionManagerProvider2.get();
    }

    public static void injectListingPromoController(AccountPageFragment instance, Provider<ListingPromoController> listingPromoControllerProvider2) {
