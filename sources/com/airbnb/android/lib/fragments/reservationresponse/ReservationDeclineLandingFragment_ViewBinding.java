...
public class ReservationDeclineLandingFragment_ViewBinding implements Unbinder {
    private ReservationDeclineLandingFragment target;

    public ReservationDeclineLandingFragment_ViewBinding(ReservationDeclineLandingFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ReservationDeclineLandingFragment target2 = this.target;
        if (target2 == null) {
