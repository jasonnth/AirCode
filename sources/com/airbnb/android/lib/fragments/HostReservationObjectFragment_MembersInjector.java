...
public final class HostReservationObjectFragment_MembersInjector implements MembersInjector<HostReservationObjectFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!HostReservationObjectFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<InstantBookUpsellManager> instantBookUpsellManagerProvider;
    private final Provider<HostReservationObjectJitneyLogger> jitneyLoggerProvider;
                                                                        ...
                                                                        if ($assertionsDisabled || messagingRequestFactoryProvider2 != null) {
                                                                            ...
                                                                            if ($assertionsDisabled || calendarStoreProvider2 != null) {
                                                                                ...
                                                                                if ($assertionsDisabled || jitneyLoggerProvider2 != null) {
                                                                                    ...
                                                                                    if ($assertionsDisabled || instantBookUpsellManagerProvider2 != null) {
                                                                                        this.instantBookUpsellManagerProvider = instantBookUpsellManagerProvider2;
                                                                                        return;
                                                                                    }
    ...
    public static MembersInjector<HostReservationObjectFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<MessagingRequestFactory> messagingRequestFactoryProvider2, Provider<CalendarStore> calendarStoreProvider2, Provider<HostReservationObjectJitneyLogger> jitneyLoggerProvider2, Provider<InstantBookUpsellManager> instantBookUpsellManagerProvider2) {
        return new HostReservationObjectFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, messagingRequestFactoryProvider2, calendarStoreProvider2, jitneyLoggerProvider2, instantBookUpsellManagerProvider2);
    }

    public void injectMembers(HostReservationObjectFragment instance) {
        if (instance == null) {
        ...
        instance.jitneyLogger = (HostReservationObjectJitneyLogger) this.jitneyLoggerProvider.get();
        instance.instantBookUpsellManager = (InstantBookUpsellManager) this.instantBookUpsellManagerProvider.get();
        instance.loggingContextFactory = (LoggingContextFactory) this.loggingContextFactoryProvider.get();
    }

    public static void injectMessagingRequestFactory(HostReservationObjectFragment instance, Provider<MessagingRequestFactory> messagingRequestFactoryProvider2) {
        instance.messagingRequestFactory = (MessagingRequestFactory) messagingRequestFactoryProvider2.get();
    }

    public static void injectCalendarStore(HostReservationObjectFragment instance, Provider<CalendarStore> calendarStoreProvider2) {
        instance.calendarStore = (CalendarStore) calendarStoreProvider2.get();
    }

    public static void injectJitneyLogger(HostReservationObjectFragment instance, Provider<HostReservationObjectJitneyLogger> jitneyLoggerProvider2) {
        instance.jitneyLogger = (HostReservationObjectJitneyLogger) jitneyLoggerProvider2.get();
    }

    public static void injectInstantBookUpsellManager(HostReservationObjectFragment instance, Provider<InstantBookUpsellManager> instantBookUpsellManagerProvider2) {
        instance.instantBookUpsellManager = (InstantBookUpsellManager) instantBookUpsellManagerProvider2.get();
    }

    public static void injectLoggingContextFactory(HostReservationObjectFragment instance, Provider<LoggingContextFactory> loggingContextFactoryProvider2) {
