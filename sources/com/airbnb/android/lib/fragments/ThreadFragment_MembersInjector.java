...
public final class ThreadFragment_MembersInjector implements MembersInjector<ThreadFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!ThreadFragment_MembersInjector.class.desiredAssertionStatus());
        ...
        if ($assertionsDisabled || mAirbnbApiProvider2 != null) {
            ...
            if ($assertionsDisabled || wishListManagerProvider2 != null) {
                ...
                if ($assertionsDisabled || businessTravelAccountManagerProvider2 != null) {
                    ...
                    if ($assertionsDisabled || accountManagerAndMAccountManagerProvider2 != null) {
                        this.accountManagerAndMAccountManagerProvider = accountManagerAndMAccountManagerProvider2;
    ...
    public static MembersInjector<ThreadFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> accountManagerAndMAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<MessagingRequestFactory> messagingRequestFactoryProvider2, Provider<MessagingJitneyLogger> jitneyLoggerProvider2) {
        return new ThreadFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, accountManagerAndMAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, messagingRequestFactoryProvider2, jitneyLoggerProvider2);
    }

    public void injectMembers(ThreadFragment instance) {
        if (instance == null) {
        ...
        AirFragment_MembersInjector.injectMAccountManager(instance, this.accountManagerAndMAccountManagerProvider);
        ...
        instance.accountManager = (AirbnbAccountManager) this.accountManagerAndMAccountManagerProvider.get();
        instance.businessTravelAccountManager = (BusinessTravelAccountManager) this.businessTravelAccountManagerProvider.get();
        instance.jitneyLogger = (MessagingJitneyLogger) this.jitneyLoggerProvider.get();
    }

    public static void injectMessagingRequestFactory(ThreadFragment instance, Provider<MessagingRequestFactory> messagingRequestFactoryProvider2) {
        instance.messagingRequestFactory = (MessagingRequestFactory) messagingRequestFactoryProvider2.get();
    }

    public static void injectAccountManager(ThreadFragment instance, Provider<AirbnbAccountManager> accountManagerProvider) {
        instance.accountManager = (AirbnbAccountManager) accountManagerProvider.get();
    }

    public static void injectBusinessTravelAccountManager(ThreadFragment instance, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2) {
        instance.businessTravelAccountManager = (BusinessTravelAccountManager) businessTravelAccountManagerProvider2.get();
    }

    public static void injectJitneyLogger(ThreadFragment instance, Provider<MessagingJitneyLogger> jitneyLoggerProvider2) {
        instance.jitneyLogger = (MessagingJitneyLogger) jitneyLoggerProvider2.get();
    }
}
