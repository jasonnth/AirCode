...
public final class CommunityCommitmentWriteFeedbackFragment_MembersInjector implements MembersInjector<CommunityCommitmentWriteFeedbackFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!CommunityCommitmentWriteFeedbackFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<CommunityCommitmentJitneyLogger> loggerProvider;
    ...
    public void injectMembers(CommunityCommitmentWriteFeedbackFragment instance) {
        ...
        instance.logger = (CommunityCommitmentJitneyLogger) this.loggerProvider.get();
    }

    public static void injectLogger(CommunityCommitmentWriteFeedbackFragment instance, Provider<CommunityCommitmentJitneyLogger> loggerProvider2) {
        instance.logger = (CommunityCommitmentJitneyLogger) loggerProvider2.get();
    }
}
