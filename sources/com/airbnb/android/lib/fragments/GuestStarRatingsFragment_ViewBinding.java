...
public class GuestStarRatingsFragment_ViewBinding implements Unbinder {
    private GuestStarRatingsFragment target;

    public GuestStarRatingsFragment_ViewBinding(GuestStarRatingsFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        GuestStarRatingsFragment target2 = this.target;
        if (target2 == null) {
