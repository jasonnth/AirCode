...
final class AutoValue_TripsBillPriceQuoteRequestBody extends TripsBillPriceQuoteRequestBody {
    ...
    static final class Builder extends com.airbnb.android.lib.payments.networking.requests.requestbodies.params.trips.TripsBillPriceQuoteRequestBody.Builder {
        ...
        public com.airbnb.android.lib.payments.networking.requests.requestbodies.params.trips.TripsBillPriceQuoteRequestBody.Builder products(List<ProductParam> products2) {
            if (products2 == null) {
        ...
        public com.airbnb.android.lib.payments.networking.requests.requestbodies.params.trips.TripsBillPriceQuoteRequestBody.Builder paymentParams(PaymentParam paymentParams2) {
        ...
        public com.airbnb.android.lib.payments.networking.requests.requestbodies.params.trips.TripsBillPriceQuoteRequestBody.Builder version(int version2) {
            this.version = Integer.valueOf(version2);
            return this;
        }

        /* access modifiers changed from: 0000 */
        public TripsBillPriceQuoteRequestBody autoBuild() {
            String missing = "";
    ...
    private AutoValue_TripsBillPriceQuoteRequestBody(List<ProductParam> products2, PaymentParam paymentParams2, int version2) {
        this.products = products2;
        this.paymentParams = paymentParams2;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TripsBillPriceQuoteRequestBody)) {
            return false;
        }
        TripsBillPriceQuoteRequestBody that = (TripsBillPriceQuoteRequestBody) o;
