...
public final class AddCouponCodeFragment_MembersInjector implements MembersInjector<AddCouponCodeFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!AddCouponCodeFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<BillPriceQuoteRequestFactory> requestsFactoryProvider;
                                                            ...
                                                            if ($assertionsDisabled || clientSessionValidatorProvider2 != null) {
                                                                ...
                                                                if ($assertionsDisabled || viewBreadcrumbManagerProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || resourceManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || requestsFactoryProvider2 != null) {
                                                                            this.requestsFactoryProvider = requestsFactoryProvider2;
                                                                            return;
                                                                        }
    ...
    public static MembersInjector<AddCouponCodeFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<BillPriceQuoteRequestFactory> requestsFactoryProvider2) {
        return new AddCouponCodeFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, requestsFactoryProvider2);
    }

    public void injectMembers(AddCouponCodeFragment instance) {
        if (instance == null) {
        ...
        instance.requestsFactory = (BillPriceQuoteRequestFactory) this.requestsFactoryProvider.get();
    }

    public static void injectRequestsFactory(AddCouponCodeFragment instance, Provider<BillPriceQuoteRequestFactory> requestsFactoryProvider2) {
        instance.requestsFactory = (BillPriceQuoteRequestFactory) requestsFactoryProvider2.get();
    }
}
