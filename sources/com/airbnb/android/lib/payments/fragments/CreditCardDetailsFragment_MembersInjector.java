...
public final class CreditCardDetailsFragment_MembersInjector implements MembersInjector<CreditCardDetailsFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!CreditCardDetailsFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<CreditCardValidator> cardValidatorProvider;
    private final Provider<ClientSessionValidator> clientSessionValidatorProvider;
    private final Provider<DigitalRiverApi> digitalRiverApiProvider;
                                                                ...
                                                                if ($assertionsDisabled || viewBreadcrumbManagerProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || resourceManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || braintreeFactoryProvider2 != null) {
                                                                            ...
                                                                            if ($assertionsDisabled || cardValidatorProvider2 != null) {
                                                                                this.cardValidatorProvider = cardValidatorProvider2;
                                                                                if ($assertionsDisabled || jitneyLoggerProvider2 != null) {
                                                                                    this.jitneyLoggerProvider = jitneyLoggerProvider2;
                                                                                    if ($assertionsDisabled || digitalRiverApiProvider2 != null) {
                                                                                        this.digitalRiverApiProvider = digitalRiverApiProvider2;
                                                                                        return;
                                                                                    }
    ...
    public static MembersInjector<CreditCardDetailsFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<BraintreeFactory> braintreeFactoryProvider2, Provider<CreditCardValidator> cardValidatorProvider2, Provider<QuickPayJitneyLogger> jitneyLoggerProvider2, Provider<DigitalRiverApi> digitalRiverApiProvider2) {
        return new CreditCardDetailsFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, braintreeFactoryProvider2, cardValidatorProvider2, jitneyLoggerProvider2, digitalRiverApiProvider2);
    }

    public void injectMembers(CreditCardDetailsFragment instance) {
        if (instance == null) {
        ...
        instance.cardValidator = (CreditCardValidator) this.cardValidatorProvider.get();
        instance.jitneyLogger = (QuickPayJitneyLogger) this.jitneyLoggerProvider.get();
        instance.digitalRiverApi = (DigitalRiverApi) this.digitalRiverApiProvider.get();
    }

    public static void injectBraintreeFactory(CreditCardDetailsFragment instance, Provider<BraintreeFactory> braintreeFactoryProvider2) {
        instance.braintreeFactory = (BraintreeFactory) braintreeFactoryProvider2.get();
    }

    public static void injectCardValidator(CreditCardDetailsFragment instance, Provider<CreditCardValidator> cardValidatorProvider2) {
        instance.cardValidator = (CreditCardValidator) cardValidatorProvider2.get();
    }

    public static void injectJitneyLogger(CreditCardDetailsFragment instance, Provider<QuickPayJitneyLogger> jitneyLoggerProvider2) {
        instance.jitneyLogger = (QuickPayJitneyLogger) jitneyLoggerProvider2.get();
    }

    public static void injectDigitalRiverApi(CreditCardDetailsFragment instance, Provider<DigitalRiverApi> digitalRiverApiProvider2) {
        instance.digitalRiverApi = (DigitalRiverApi) digitalRiverApiProvider2.get();
    }
}
