...
public class AddPaymentMethodFragment_ViewBinding implements Unbinder {
    private AddPaymentMethodFragment target;

    public AddPaymentMethodFragment_ViewBinding(AddPaymentMethodFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        AddPaymentMethodFragment target2 = this.target;
        if (target2 == null) {
