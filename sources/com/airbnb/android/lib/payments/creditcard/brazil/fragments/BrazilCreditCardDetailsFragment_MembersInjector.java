...
public final class BrazilCreditCardDetailsFragment_MembersInjector implements MembersInjector<BrazilCreditCardDetailsFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!BrazilCreditCardDetailsFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<BrazilPaymentInputFormatter> inputFormatterProvider;
                                                            ...
                                                            if ($assertionsDisabled || clientSessionValidatorProvider2 != null) {
                                                                ...
                                                                if ($assertionsDisabled || viewBreadcrumbManagerProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || resourceManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || inputFormatterProvider2 != null) {
                                                                            this.inputFormatterProvider = inputFormatterProvider2;
    ...
    public static MembersInjector<BrazilCreditCardDetailsFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<BrazilPaymentInputFormatter> inputFormatterProvider2, Provider<DigitalRiverApi> digitalRiverApiProvider2, Provider<QuickPayJitneyLogger> jitneyLoggerProvider2) {
        return new BrazilCreditCardDetailsFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, inputFormatterProvider2, digitalRiverApiProvider2, jitneyLoggerProvider2);
    }

    public void injectMembers(BrazilCreditCardDetailsFragment instance) {
        if (instance == null) {
        ...
        instance.inputFormatter = (BrazilPaymentInputFormatter) this.inputFormatterProvider.get();
    ...
    public static void injectInputFormatter(BrazilCreditCardDetailsFragment instance, Provider<BrazilPaymentInputFormatter> inputFormatterProvider2) {
        instance.inputFormatter = (BrazilPaymentInputFormatter) inputFormatterProvider2.get();
    }

    public static void injectDigitalRiverApi(BrazilCreditCardDetailsFragment instance, Provider<DigitalRiverApi> digitalRiverApiProvider2) {
        instance.digitalRiverApi = (DigitalRiverApi) digitalRiverApiProvider2.get();
    }

    public static void injectJitneyLogger(BrazilCreditCardDetailsFragment instance, Provider<QuickPayJitneyLogger> jitneyLoggerProvider2) {
