...
public final class BookingV2Activity_MembersInjector implements MembersInjector<BookingV2Activity> {
    static final /* synthetic */ boolean $assertionsDisabled = (!BookingV2Activity_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<BookingJitneyLogger> bookingJitneyLoggerProvider;
                                                                    ...
                                                                    if ($assertionsDisabled || wishListManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || dLSloggerProvider2 != null) {
                                                                            ...
                                                                            if ($assertionsDisabled || businessTravelAccountManagerProvider2 != null) {
                                                                                ...
                                                                                if ($assertionsDisabled || bookingJitneyLoggerProvider2 != null) {
                                                                                    this.bookingJitneyLoggerProvider = bookingJitneyLoggerProvider2;
    ...
    public static MembersInjector<BookingV2Activity> create(Provider<AirbnbAccountManager> accountManagerProvider2, Provider<SharedPrefsHelper> sharedPrefsHelperProvider2, Provider<Bus> busProvider2, Provider<CurrencyFormatter> currencyFormatterProvider2, Provider<Erf> erfProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirbnbPreferences> preferencesProvider2, Provider<ShakeFeedbackSensorListener> shakeHelperProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<SuperHeroManager> superHeroManagerProvider2, Provider<AirReactInstanceManager> reactInstanceManagerProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<AppLaunchAnalytics> launchAnalyticsProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<AirbnbApi> airbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<DLSJitneyLogger> dLSloggerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<BookingJitneyLogger> bookingJitneyLoggerProvider2, Provider<ExplorePerformanceAnalytics> performanceAnalyticsProvider2, Provider<IdentityJitneyLogger> identityJitneyLoggerProvider2) {
        return new BookingV2Activity_MembersInjector(accountManagerProvider2, sharedPrefsHelperProvider2, busProvider2, currencyFormatterProvider2, erfProvider2, navigationAnalyticsProvider2, preferencesProvider2, shakeHelperProvider2, airRequestInitializerProvider2, superHeroManagerProvider2, reactInstanceManagerProvider2, viewBreadcrumbManagerProvider2, launchAnalyticsProvider2, resourceManagerProvider2, airbnbApiProvider2, wishListManagerProvider2, dLSloggerProvider2, businessTravelAccountManagerProvider2, bookingJitneyLoggerProvider2, performanceAnalyticsProvider2, identityJitneyLoggerProvider2);
    }

    public void injectMembers(BookingV2Activity instance) {
        if (instance == null) {
        ...
        instance.bookingJitneyLogger = (BookingJitneyLogger) this.bookingJitneyLoggerProvider.get();
    ...
    public static void injectBusinessTravelAccountManager(BookingV2Activity instance, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2) {
        instance.businessTravelAccountManager = (BusinessTravelAccountManager) businessTravelAccountManagerProvider2.get();
    }

    public static void injectBookingJitneyLogger(BookingV2Activity instance, Provider<BookingJitneyLogger> bookingJitneyLoggerProvider2) {
        instance.bookingJitneyLogger = (BookingJitneyLogger) bookingJitneyLoggerProvider2.get();
    }

    public static void injectPerformanceAnalytics(BookingV2Activity instance, Provider<ExplorePerformanceAnalytics> performanceAnalyticsProvider2) {
        instance.performanceAnalytics = (ExplorePerformanceAnalytics) performanceAnalyticsProvider2.get();
    }

    public static void injectIdentityJitneyLogger(BookingV2Activity instance, Provider<IdentityJitneyLogger> identityJitneyLoggerProvider2) {
