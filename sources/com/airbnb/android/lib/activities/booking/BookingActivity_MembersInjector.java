...
public final class BookingActivity_MembersInjector implements MembersInjector<BookingActivity> {
    static final /* synthetic */ boolean $assertionsDisabled = (!BookingActivity_MembersInjector.class.desiredAssertionStatus());
    ...
    public static MembersInjector<BookingActivity> create(Provider<AirbnbAccountManager> accountManagerProvider2, Provider<SharedPrefsHelper> sharedPrefsHelperProvider2, Provider<Bus> busProvider2, Provider<CurrencyFormatter> currencyFormatterProvider2, Provider<Erf> erfProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirbnbPreferences> preferencesProvider2, Provider<ShakeFeedbackSensorListener> shakeHelperProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<SuperHeroManager> superHeroManagerProvider2, Provider<AirReactInstanceManager> reactInstanceManagerProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<AppLaunchAnalytics> launchAnalyticsProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<AirbnbApi> airbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<DLSJitneyLogger> dLSloggerProvider2, Provider<ExplorePerformanceAnalytics> performanceAnalyticsProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirlockErrorHandler> airlockErrorHandlerProvider2, Provider<IdentityJitneyLogger> identityJitneyLoggerProvider2) {
        return new BookingActivity_MembersInjector(accountManagerProvider2, sharedPrefsHelperProvider2, busProvider2, currencyFormatterProvider2, erfProvider2, navigationAnalyticsProvider2, preferencesProvider2, shakeHelperProvider2, airRequestInitializerProvider2, superHeroManagerProvider2, reactInstanceManagerProvider2, viewBreadcrumbManagerProvider2, launchAnalyticsProvider2, resourceManagerProvider2, airbnbApiProvider2, wishListManagerProvider2, dLSloggerProvider2, performanceAnalyticsProvider2, businessTravelAccountManagerProvider2, airlockErrorHandlerProvider2, identityJitneyLoggerProvider2);
    }
    ...
    public static void injectPerformanceAnalytics(BookingActivity instance, Provider<ExplorePerformanceAnalytics> performanceAnalyticsProvider2) {
        instance.performanceAnalytics = (ExplorePerformanceAnalytics) performanceAnalyticsProvider2.get();
    }

    public static void injectBusinessTravelAccountManager(BookingActivity instance, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2) {
        instance.businessTravelAccountManager = (BusinessTravelAccountManager) businessTravelAccountManagerProvider2.get();
    }

    public static void injectAirlockErrorHandler(BookingActivity instance, Provider<AirlockErrorHandler> airlockErrorHandlerProvider2) {
        instance.airlockErrorHandler = (AirlockErrorHandler) airlockErrorHandlerProvider2.get();
    }

    public static void injectIdentityJitneyLogger(BookingActivity instance, Provider<IdentityJitneyLogger> identityJitneyLoggerProvider2) {
