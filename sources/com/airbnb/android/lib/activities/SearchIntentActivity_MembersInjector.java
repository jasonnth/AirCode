...
public final class SearchIntentActivity_MembersInjector implements MembersInjector<SearchIntentActivity> {
    static final /* synthetic */ boolean $assertionsDisabled = (!SearchIntentActivity_MembersInjector.class.desiredAssertionStatus());
    ...
    public void injectMembers(SearchIntentActivity instance) {
        ...
        instance.affiliateInfo = DoubleCheck.lazy(this.affiliateInfoProvider);
    }

    public static void injectAffiliateInfo(SearchIntentActivity instance, Provider<AffiliateInfo> affiliateInfoProvider2) {
        instance.affiliateInfo = DoubleCheck.lazy(affiliateInfoProvider2);
    }
}
