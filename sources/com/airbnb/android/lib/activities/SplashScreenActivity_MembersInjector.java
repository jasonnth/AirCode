...
public final class SplashScreenActivity_MembersInjector implements MembersInjector<SplashScreenActivity> {
    static final /* synthetic */ boolean $assertionsDisabled = (!SplashScreenActivity_MembersInjector.class.desiredAssertionStatus());
    ...
    public static void injectSplashScreenController(SplashScreenActivity instance, Provider<SplashScreenController> splashScreenControllerProvider2) {
        instance.splashScreenController = (SplashScreenController) splashScreenControllerProvider2.get();
    }

    public static void injectExperimentConfigController(SplashScreenActivity instance, Provider<ExperimentConfigController> experimentConfigControllerProvider2) {
