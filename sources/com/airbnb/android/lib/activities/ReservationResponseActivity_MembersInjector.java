...
public final class ReservationResponseActivity_MembersInjector implements MembersInjector<ReservationResponseActivity> {
    static final /* synthetic */ boolean $assertionsDisabled = (!ReservationResponseActivity_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<ReservationResponseLogger> loggerProvider;
    ...
    public static MembersInjector<ReservationResponseActivity> create(Provider<AirbnbAccountManager> accountManagerProvider2, Provider<SharedPrefsHelper> sharedPrefsHelperProvider2, Provider<Bus> busProvider2, Provider<CurrencyFormatter> currencyFormatterProvider2, Provider<Erf> erfProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirbnbPreferences> preferencesProvider2, Provider<ShakeFeedbackSensorListener> shakeHelperProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<SuperHeroManager> superHeroManagerProvider2, Provider<AirReactInstanceManager> reactInstanceManagerProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<AppLaunchAnalytics> launchAnalyticsProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<AirbnbApi> airbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<DLSJitneyLogger> dLSloggerProvider2, Provider<ReservationResponseLogger> loggerProvider2, Provider<InstantBookUpsellManager> instantBookUpsellManagerProvider2) {
        return new ReservationResponseActivity_MembersInjector(accountManagerProvider2, sharedPrefsHelperProvider2, busProvider2, currencyFormatterProvider2, erfProvider2, navigationAnalyticsProvider2, preferencesProvider2, shakeHelperProvider2, airRequestInitializerProvider2, superHeroManagerProvider2, reactInstanceManagerProvider2, viewBreadcrumbManagerProvider2, launchAnalyticsProvider2, resourceManagerProvider2, airbnbApiProvider2, wishListManagerProvider2, dLSloggerProvider2, loggerProvider2, instantBookUpsellManagerProvider2);
    }

    public void injectMembers(ReservationResponseActivity instance) {
        if (instance == null) {
        ...
        instance.logger = (ReservationResponseLogger) this.loggerProvider.get();
        instance.instantBookUpsellManager = (InstantBookUpsellManager) this.instantBookUpsellManagerProvider.get();
    }

    public static void injectLogger(ReservationResponseActivity instance, Provider<ReservationResponseLogger> loggerProvider2) {
        instance.logger = (ReservationResponseLogger) loggerProvider2.get();
    }

    public static void injectInstantBookUpsellManager(ReservationResponseActivity instance, Provider<InstantBookUpsellManager> instantBookUpsellManagerProvider2) {
