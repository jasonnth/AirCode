...
public final class PayWithAlipayActivity_MembersInjector implements MembersInjector<PayWithAlipayActivity> {
    static final /* synthetic */ boolean $assertionsDisabled = (!PayWithAlipayActivity_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<AlipayAnalytics> alipayAnalyticsProvider;
                                                                ...
                                                                if ($assertionsDisabled || airbnbApiProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || wishListManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || dLSloggerProvider2 != null) {
                                                                            ...
                                                                            if ($assertionsDisabled || alipayAnalyticsProvider2 != null) {
                                                                                this.alipayAnalyticsProvider = alipayAnalyticsProvider2;
                                                                                return;
                                                                            }
    ...
    public void injectMembers(PayWithAlipayActivity instance) {
        ...
        instance.alipayAnalytics = (AlipayAnalytics) this.alipayAnalyticsProvider.get();
    }

    public static void injectAlipayAnalytics(PayWithAlipayActivity instance, Provider<AlipayAnalytics> alipayAnalyticsProvider2) {
        instance.alipayAnalytics = (AlipayAnalytics) alipayAnalyticsProvider2.get();
    }
}
