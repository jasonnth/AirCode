...
final /* synthetic */ class StoryPublishController$$Lambda$9 implements Action1 {
    private final StoryPublishController arg$1;
    private final long arg$2;
    private final StoryPublishArguments arg$3;

    private StoryPublishController$$Lambda$9(StoryPublishController storyPublishController, long j, StoryPublishArguments storyPublishArguments) {
    ...
    public static Action1 lambdaFactory$(StoryPublishController storyPublishController, long j, StoryPublishArguments storyPublishArguments) {
        return new StoryPublishController$$Lambda$9(storyPublishController, j, storyPublishArguments);
    }

    public void call(Object obj) {
        this.arg$1.recoverStoryInComposer(this.arg$2, this.arg$3, NetworkUtil.getErrorMessage(this.arg$1.context, (NetworkException) ((Throwable) obj)), PublishErrorType.UploadPhotoError);
    }
}
