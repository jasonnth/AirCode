...
public final class StoryCreationComposerFragment_MembersInjector implements MembersInjector<StoryCreationComposerFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!StoryCreationComposerFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<StoryPublishController> storyPublishControllerProvider;
                                                            ...
                                                            if ($assertionsDisabled || clientSessionValidatorProvider2 != null) {
                                                                ...
                                                                if ($assertionsDisabled || viewBreadcrumbManagerProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || resourceManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || storyPublishControllerProvider2 != null) {
                                                                            this.storyPublishControllerProvider = storyPublishControllerProvider2;
                                                                            return;
                                                                        }
    ...
    public static MembersInjector<StoryCreationComposerFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<StoryPublishController> storyPublishControllerProvider2) {
        return new StoryCreationComposerFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, storyPublishControllerProvider2);
    }

    public void injectMembers(StoryCreationComposerFragment instance) {
        if (instance == null) {
        ...
        instance.storyPublishController = (StoryPublishController) this.storyPublishControllerProvider.get();
    }

    public static void injectStoryPublishController(StoryCreationComposerFragment instance, Provider<StoryPublishController> storyPublishControllerProvider2) {
        instance.storyPublishController = (StoryPublishController) storyPublishControllerProvider2.get();
    }
}
