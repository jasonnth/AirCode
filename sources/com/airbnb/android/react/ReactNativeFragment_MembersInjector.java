...
public final class ReactNativeFragment_MembersInjector implements MembersInjector<ReactNativeFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!ReactNativeFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static MembersInjector<ReactNativeFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<ReactNavigationCoordinator> reactNavigationCoordinatorProvider2, Provider<AirReactInstanceManager> reactInstanceManagerProvider2, Provider<PerformanceLogger> performanceLoggerProvider2) {
        return new ReactNativeFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, reactNavigationCoordinatorProvider2, reactInstanceManagerProvider2, performanceLoggerProvider2);
    }

    public void injectMembers(ReactNativeFragment instance) {
        if (instance == null) {
    ...
    public static void injectReactNavigationCoordinator(ReactNativeFragment instance, Provider<ReactNavigationCoordinator> reactNavigationCoordinatorProvider2) {
        instance.reactNavigationCoordinator = (ReactNavigationCoordinator) reactNavigationCoordinatorProvider2.get();
    }

    public static void injectReactInstanceManager(ReactNativeFragment instance, Provider<AirReactInstanceManager> reactInstanceManagerProvider2) {
        instance.reactInstanceManager = (AirReactInstanceManager) reactInstanceManagerProvider2.get();
    }

    public static void injectPerformanceLogger(ReactNativeFragment instance, Provider<PerformanceLogger> performanceLoggerProvider2) {
