...
/* renamed from: com.airbnb.android.p3.P3ReviewSearchFragment_MembersInjector */
public final class P3ReviewSearchFragment_MembersInjector implements MembersInjector<P3ReviewSearchFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!P3ReviewSearchFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static MembersInjector<P3ReviewSearchFragment> create(Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<DebugSettings> debugSettingsProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ReviewSearchJitneyLogger> jitneyLoggerProvider2) {
        return new P3ReviewSearchFragment_MembersInjector(mAccountManagerProvider2, debugSettingsProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, jitneyLoggerProvider2);
    }

    public void injectMembers(P3ReviewSearchFragment instance) {
        if (instance == null) {
    ...
    public static void injectJitneyLogger(P3ReviewSearchFragment instance, Provider<ReviewSearchJitneyLogger> jitneyLoggerProvider2) {
