...
/* renamed from: com.airbnb.android.login.ui.PhoneForgotPasswordFragment_MembersInjector */
public final class PhoneForgotPasswordFragment_MembersInjector implements MembersInjector<PhoneForgotPasswordFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!PhoneForgotPasswordFragment_MembersInjector.class.desiredAssertionStatus());
                                                            ...
                                                            if ($assertionsDisabled || clientSessionValidatorProvider2 != null) {
                                                                ...
                                                                if ($assertionsDisabled || viewBreadcrumbManagerProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || resourceManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || smsMonitorProvider2 != null) {
                                                                            this.smsMonitorProvider = smsMonitorProvider2;
                                                                            return;
                                                                        }
    ...
    public static MembersInjector<PhoneForgotPasswordFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<SMSMonitor> smsMonitorProvider2) {
        return new PhoneForgotPasswordFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, smsMonitorProvider2);
    }

    public void injectMembers(PhoneForgotPasswordFragment instance) {
        if (instance == null) {
        ...
        instance.smsMonitor = DoubleCheck.lazy(this.smsMonitorProvider);
    }

    public static void injectSmsMonitor(PhoneForgotPasswordFragment instance, Provider<SMSMonitor> smsMonitorProvider2) {
        instance.smsMonitor = DoubleCheck.lazy(smsMonitorProvider2);
    }
}
