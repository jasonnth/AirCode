...
public final class MTExploreParentFragment_MembersInjector implements MembersInjector<MTExploreParentFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!MTExploreParentFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<ExploreDataRepository> dataRepositoryProvider;
    ...
    private final Provider<ExplorePerformanceAnalytics> performanceAnalyticsProvider;
                                                            ...
                                                            if ($assertionsDisabled || clientSessionValidatorProvider2 != null) {
                                                                ...
                                                                if ($assertionsDisabled || viewBreadcrumbManagerProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || resourceManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || dataRepositoryProvider2 != null) {
                                                                            this.dataRepositoryProvider = dataRepositoryProvider2;
                                                                            if ($assertionsDisabled || performanceAnalyticsProvider2 != null) {
                                                                                this.performanceAnalyticsProvider = performanceAnalyticsProvider2;
                                                                                if ($assertionsDisabled || businessTravelJitneyLoggerProvider2 != null) {
                                                                                    this.businessTravelJitneyLoggerProvider = businessTravelJitneyLoggerProvider2;
    ...
    public static MembersInjector<MTExploreParentFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<ExploreDataRepository> dataRepositoryProvider2, Provider<ExplorePerformanceAnalytics> performanceAnalyticsProvider2, Provider<BusinessTravelJitneyLogger> businessTravelJitneyLoggerProvider2, Provider<ErfAnalytics> erfAnalyticsProvider2) {
        return new MTExploreParentFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, dataRepositoryProvider2, performanceAnalyticsProvider2, businessTravelJitneyLoggerProvider2, erfAnalyticsProvider2);
    }

    public void injectMembers(MTExploreParentFragment instance) {
        if (instance == null) {
        ...
        instance.dataRepository = (ExploreDataRepository) this.dataRepositoryProvider.get();
        instance.performanceAnalytics = (ExplorePerformanceAnalytics) this.performanceAnalyticsProvider.get();
        instance.businessTravelJitneyLogger = (BusinessTravelJitneyLogger) this.businessTravelJitneyLoggerProvider.get();
        instance.erfAnalytics = (ErfAnalytics) this.erfAnalyticsProvider.get();
    }

    public static void injectDataRepository(MTExploreParentFragment instance, Provider<ExploreDataRepository> dataRepositoryProvider2) {
        instance.dataRepository = (ExploreDataRepository) dataRepositoryProvider2.get();
    }

    public static void injectPerformanceAnalytics(MTExploreParentFragment instance, Provider<ExplorePerformanceAnalytics> performanceAnalyticsProvider2) {
        instance.performanceAnalytics = (ExplorePerformanceAnalytics) performanceAnalyticsProvider2.get();
    }

    public static void injectBusinessTravelJitneyLogger(MTExploreParentFragment instance, Provider<BusinessTravelJitneyLogger> businessTravelJitneyLoggerProvider2) {
        instance.businessTravelJitneyLogger = (BusinessTravelJitneyLogger) businessTravelJitneyLoggerProvider2.get();
    }

    public static void injectErfAnalytics(MTExploreParentFragment instance, Provider<ErfAnalytics> erfAnalyticsProvider2) {
