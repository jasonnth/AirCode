...
final /* synthetic */ class BaseExploreAdapter$$Lambda$15 implements OnClickListener {
    private final BaseExploreAdapter arg$1;
    private final RecommendationItem arg$2;

    private BaseExploreAdapter$$Lambda$15(BaseExploreAdapter baseExploreAdapter, RecommendationItem recommendationItem) {
    ...
    public static OnClickListener lambdaFactory$(BaseExploreAdapter baseExploreAdapter, RecommendationItem recommendationItem) {
        return new BaseExploreAdapter$$Lambda$15(baseExploreAdapter, recommendationItem);
    }
