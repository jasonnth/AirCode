...
public final class SelectPayoutCountryActivity_MembersInjector implements MembersInjector<SelectPayoutCountryActivity> {
    static final /* synthetic */ boolean $assertionsDisabled = (!SelectPayoutCountryActivity_MembersInjector.class.desiredAssertionStatus());
    ...
    public static MembersInjector<SelectPayoutCountryActivity> create(Provider<AirbnbAccountManager> accountManagerProvider2, Provider<SharedPrefsHelper> sharedPrefsHelperProvider2, Provider<Bus> busProvider2, Provider<CurrencyFormatter> currencyFormatterProvider2, Provider<Erf> erfProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirbnbPreferences> preferencesProvider2, Provider<ShakeFeedbackSensorListener> shakeHelperProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<SuperHeroManager> superHeroManagerProvider2, Provider<AirReactInstanceManager> reactInstanceManagerProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<AppLaunchAnalytics> launchAnalyticsProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<AirbnbApi> airbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<DLSJitneyLogger> dLSloggerProvider2, Provider<AddPayoutMethodJitneyLogger> addPayoutMethodJitneyLoggerProvider2) {
        return new SelectPayoutCountryActivity_MembersInjector(accountManagerProvider2, sharedPrefsHelperProvider2, busProvider2, currencyFormatterProvider2, erfProvider2, navigationAnalyticsProvider2, preferencesProvider2, shakeHelperProvider2, airRequestInitializerProvider2, superHeroManagerProvider2, reactInstanceManagerProvider2, viewBreadcrumbManagerProvider2, launchAnalyticsProvider2, resourceManagerProvider2, airbnbApiProvider2, wishListManagerProvider2, dLSloggerProvider2, addPayoutMethodJitneyLoggerProvider2);
    }

    public void injectMembers(SelectPayoutCountryActivity instance) {
        if (instance == null) {
    ...
    public static void injectAddPayoutMethodJitneyLogger(SelectPayoutCountryActivity instance, Provider<AddPayoutMethodJitneyLogger> addPayoutMethodJitneyLoggerProvider2) {
