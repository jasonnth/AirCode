...
public class EditPayoutFragment_ViewBinding implements Unbinder {
    private EditPayoutFragment target;

    public EditPayoutFragment_ViewBinding(EditPayoutFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        EditPayoutFragment target2 = this.target;
        if (target2 == null) {
