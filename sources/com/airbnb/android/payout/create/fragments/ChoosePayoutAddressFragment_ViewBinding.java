...
public class ChoosePayoutAddressFragment_ViewBinding implements Unbinder {
    private ChoosePayoutAddressFragment target;

    public ChoosePayoutAddressFragment_ViewBinding(ChoosePayoutAddressFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        ChoosePayoutAddressFragment target2 = this.target;
        if (target2 == null) {
