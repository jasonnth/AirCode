...
public class AddPayoutAccountInfoFragment_ViewBinding implements Unbinder {
    private AddPayoutAccountInfoFragment target;

    public AddPayoutAccountInfoFragment_ViewBinding(AddPayoutAccountInfoFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        AddPayoutAccountInfoFragment target2 = this.target;
        if (target2 == null) {
