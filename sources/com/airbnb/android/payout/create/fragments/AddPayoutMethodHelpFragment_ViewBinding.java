...
public class AddPayoutMethodHelpFragment_ViewBinding implements Unbinder {
    private AddPayoutMethodHelpFragment target;

    public AddPayoutMethodHelpFragment_ViewBinding(AddPayoutMethodHelpFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        AddPayoutMethodHelpFragment target2 = this.target;
        if (target2 == null) {
