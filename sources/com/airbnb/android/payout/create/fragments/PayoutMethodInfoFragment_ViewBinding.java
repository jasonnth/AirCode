...
public class PayoutMethodInfoFragment_ViewBinding implements Unbinder {
    private PayoutMethodInfoFragment target;

    public PayoutMethodInfoFragment_ViewBinding(PayoutMethodInfoFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        PayoutMethodInfoFragment target2 = this.target;
        if (target2 == null) {
