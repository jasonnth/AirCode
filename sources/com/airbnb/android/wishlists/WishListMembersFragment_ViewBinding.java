...
public class WishListMembersFragment_ViewBinding implements Unbinder {
    private WishListMembersFragment target;

    public WishListMembersFragment_ViewBinding(WishListMembersFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        WishListMembersFragment target2 = this.target;
        if (target2 == null) {
