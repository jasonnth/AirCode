...
public abstract class GenListingDescription implements Parcelable {
    @JsonProperty("access")
    ...
    protected GenListingDescription(String access, String authorType, String description, String houseRules, String interaction, String locale, String localizedLanguageName, String name, String neighborhoodOverview, String notes, String space, String summary, String transit) {
        this();
        this.mAccess = access;
    ...
    protected GenListingDescription() {
    }
