...
public abstract class GenListingTranslatedDescription implements Parcelable {
    @JsonProperty("access")
    ...
    protected GenListingTranslatedDescription(String access, String authorType, String description, String houseRules, String interaction, String locale, String localizedLanguageName, String name, String neighborhoodOverview, String notes, String space, String summary, String transit) {
        this();
        this.mAccess = access;
    ...
    protected GenListingTranslatedDescription() {
    }
