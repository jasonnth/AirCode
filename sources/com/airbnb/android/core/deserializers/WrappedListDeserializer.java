...
public class WrappedListDeserializer extends JsonDeserializer<Object> implements ContextualDeserializer {
    private Class<?> wrappedType;
    private String wrapperKey;

    public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property) throws JsonMappingException {
        this.wrapperKey = ((WrappedObject) property.getAnnotation(WrappedObject.class)).value();
        this.wrappedType = property.getType().containedType(0).getRawClass();
        return this;
    }
    ...
    public Object deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
        ...
        if (jsonNode.has(this.wrapperKey)) {
