...
public final class LYSSelectPricingTypeFragment_MembersInjector implements MembersInjector<LYSSelectPricingTypeFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!LYSSelectPricingTypeFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static void injectJitneyLogger(LYSSelectPricingTypeFragment instance, Provider<LYSJitneyLogger> jitneyLoggerProvider2) {
        instance.jitneyLogger = (LYSJitneyLogger) jitneyLoggerProvider2.get();
    }

    public static void injectLoggingContextFactory(LYSSelectPricingTypeFragment instance, Provider<LoggingContextFactory> loggingContextFactoryProvider2) {
