...
public class LYSNewHostDiscountFragment_ViewBinding extends LYSBaseFragment_ViewBinding {
    private LYSNewHostDiscountFragment target;
    private View view2131755495;

    public LYSNewHostDiscountFragment_ViewBinding(final LYSNewHostDiscountFragment target2, View source) {
    ...
    public void unbind() {
        LYSNewHostDiscountFragment target2 = this.target;
        if (target2 == null) {
