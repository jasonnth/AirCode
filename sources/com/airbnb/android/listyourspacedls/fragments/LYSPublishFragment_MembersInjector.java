...
public final class LYSPublishFragment_MembersInjector implements MembersInjector<LYSPublishFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!LYSPublishFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static MembersInjector<LYSPublishFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<LYSJitneyLogger> jitneyLoggerProvider2, Provider<CalendarStore> calendarStoreProvider2, Provider<ListingPromoController> listingPromoControllerProvider2) {
        return new LYSPublishFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, jitneyLoggerProvider2, calendarStoreProvider2, listingPromoControllerProvider2);
    }

    public void injectMembers(LYSPublishFragment instance) {
        if (instance == null) {
    ...
    public static void injectJitneyLogger(LYSPublishFragment instance, Provider<LYSJitneyLogger> jitneyLoggerProvider2) {
        instance.jitneyLogger = (LYSJitneyLogger) jitneyLoggerProvider2.get();
    }

    public static void injectCalendarStore(LYSPublishFragment instance, Provider<CalendarStore> calendarStoreProvider2) {
        instance.calendarStore = (CalendarStore) calendarStoreProvider2.get();
    }

    public static void injectListingPromoController(LYSPublishFragment instance, Provider<ListingPromoController> listingPromoControllerProvider2) {
