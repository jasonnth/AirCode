...
public class LYSAvailabilityFragment_ViewBinding extends LYSBaseFragment_ViewBinding {
    private LYSAvailabilityFragment target;
    private View view2131755495;

    public LYSAvailabilityFragment_ViewBinding(final LYSAvailabilityFragment target2, View source) {
    ...
    public void unbind() {
        LYSAvailabilityFragment target2 = this.target;
        if (target2 == null) {
