...
public final class LYSPhotoManagerFragment_MembersInjector implements MembersInjector<LYSPhotoManagerFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!LYSPhotoManagerFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static MembersInjector<LYSPhotoManagerFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<PhotoUploadManager> photoUploadManagerProvider2, Provider<LYSJitneyLogger> jitneyLoggerProvider2) {
        return new LYSPhotoManagerFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, photoUploadManagerProvider2, jitneyLoggerProvider2);
    }

    public void injectMembers(LYSPhotoManagerFragment instance) {
        if (instance == null) {
    ...
    public static void injectPhotoUploadManager(LYSPhotoManagerFragment instance, Provider<PhotoUploadManager> photoUploadManagerProvider2) {
        instance.photoUploadManager = (PhotoUploadManager) photoUploadManagerProvider2.get();
    }

    public static void injectJitneyLogger(LYSPhotoManagerFragment instance, Provider<LYSJitneyLogger> jitneyLoggerProvider2) {
