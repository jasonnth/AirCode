...
public class LYSSpaceTypeFragment_ViewBinding extends LYSBaseFragment_ViewBinding {
    private LYSSpaceTypeFragment target;
    private View view2131755495;

    public LYSSpaceTypeFragment_ViewBinding(final LYSSpaceTypeFragment target2, View source) {
    ...
    public void unbind() {
        LYSSpaceTypeFragment target2 = this.target;
        if (target2 == null) {
