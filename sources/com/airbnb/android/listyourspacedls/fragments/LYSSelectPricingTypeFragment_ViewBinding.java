...
public class LYSSelectPricingTypeFragment_ViewBinding extends LYSBaseFragment_ViewBinding {
    private LYSSelectPricingTypeFragment target;
    private View view2131755495;

    public LYSSelectPricingTypeFragment_ViewBinding(final LYSSelectPricingTypeFragment target2, View source) {
    ...
    public void unbind() {
        LYSSelectPricingTypeFragment target2 = this.target;
        if (target2 == null) {
