...
public class LYSRoomsAndGuestsFragment_ViewBinding extends LYSBaseFragment_ViewBinding {
    private LYSRoomsAndGuestsFragment target;
    private View view2131755495;

    public LYSRoomsAndGuestsFragment_ViewBinding(final LYSRoomsAndGuestsFragment target2, View source) {
    ...
    public void unbind() {
        LYSRoomsAndGuestsFragment target2 = this.target;
        if (target2 == null) {
