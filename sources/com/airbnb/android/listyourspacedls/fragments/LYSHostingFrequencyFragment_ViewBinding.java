...
public class LYSHostingFrequencyFragment_ViewBinding extends LYSBaseFragment_ViewBinding {
    private LYSHostingFrequencyFragment target;
    private View view2131755495;

    public LYSHostingFrequencyFragment_ViewBinding(final LYSHostingFrequencyFragment target2, View source) {
    ...
    public void unbind() {
        LYSHostingFrequencyFragment target2 = this.target;
        if (target2 == null) {
