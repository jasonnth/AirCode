...
public class LYSGuestBookFragment_ViewBinding extends LYSBaseFragment_ViewBinding {
    private LYSGuestBookFragment target;
    private View view2131755495;

    public LYSGuestBookFragment_ViewBinding(final LYSGuestBookFragment target2, View source) {
    ...
    public void unbind() {
        LYSGuestBookFragment target2 = this.target;
        if (target2 == null) {
