...
public final class LYSLandingFragment_MembersInjector implements MembersInjector<LYSLandingFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!LYSLandingFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<LYSJitneyLogger> lysJitneyLoggerProvider;
                                                            ...
                                                            if ($assertionsDisabled || clientSessionValidatorProvider2 != null) {
                                                                ...
                                                                if ($assertionsDisabled || viewBreadcrumbManagerProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || resourceManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || lysJitneyLoggerProvider2 != null) {
                                                                            this.lysJitneyLoggerProvider = lysJitneyLoggerProvider2;
                                                                            return;
                                                                        }
    ...
    public static MembersInjector<LYSLandingFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<LYSJitneyLogger> lysJitneyLoggerProvider2) {
        return new LYSLandingFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, lysJitneyLoggerProvider2);
    }

    public void injectMembers(LYSLandingFragment instance) {
        if (instance == null) {
        ...
        instance.lysJitneyLogger = (LYSJitneyLogger) this.lysJitneyLoggerProvider.get();
    }

    public static void injectLysJitneyLogger(LYSLandingFragment instance, Provider<LYSJitneyLogger> lysJitneyLoggerProvider2) {
        instance.lysJitneyLogger = (LYSJitneyLogger) lysJitneyLoggerProvider2.get();
    }
}
