...
public class LYSDiscountsFragment_ViewBinding extends LYSBaseFragment_ViewBinding {
    private LYSDiscountsFragment target;
    private View view2131755495;

    public LYSDiscountsFragment_ViewBinding(final LYSDiscountsFragment target2, View source) {
    ...
    public void unbind() {
        LYSDiscountsFragment target2 = this.target;
        if (target2 == null) {
