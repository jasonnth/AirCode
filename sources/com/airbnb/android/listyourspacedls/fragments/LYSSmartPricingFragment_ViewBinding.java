...
public class LYSSmartPricingFragment_ViewBinding extends LYSBaseFragment_ViewBinding {
    private LYSSmartPricingFragment target;
    private View view2131755495;

    public LYSSmartPricingFragment_ViewBinding(final LYSSmartPricingFragment target2, View source) {
    ...
    public void unbind() {
        LYSSmartPricingFragment target2 = this.target;
        if (target2 == null) {
