...
public final class CalendarNestedBusyDayFragment_MembersInjector implements MembersInjector<CalendarNestedBusyDayFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!CalendarNestedBusyDayFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static void injectCalendarStore(CalendarNestedBusyDayFragment instance, Provider<CalendarStore> calendarStoreProvider2) {
        instance.calendarStore = (CalendarStore) calendarStoreProvider2.get();
    }

    public static void injectJitneyLogger(CalendarNestedBusyDayFragment instance, Provider<CalendarJitneyLogger> jitneyLoggerProvider2) {
