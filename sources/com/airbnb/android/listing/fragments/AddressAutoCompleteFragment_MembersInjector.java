...
public final class AddressAutoCompleteFragment_MembersInjector implements MembersInjector<AddressAutoCompleteFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!AddressAutoCompleteFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<LYSAddressAutoCompleteLogger> lysAddressAutoCompleteLoggerProvider;
                                                            ...
                                                            if ($assertionsDisabled || clientSessionValidatorProvider2 != null) {
                                                                ...
                                                                if ($assertionsDisabled || viewBreadcrumbManagerProvider2 != null) {
                                                                    ...
                                                                    if ($assertionsDisabled || resourceManagerProvider2 != null) {
                                                                        ...
                                                                        if ($assertionsDisabled || lysAddressAutoCompleteLoggerProvider2 != null) {
                                                                            this.lysAddressAutoCompleteLoggerProvider = lysAddressAutoCompleteLoggerProvider2;
                                                                            return;
                                                                        }
    ...
    public static MembersInjector<AddressAutoCompleteFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<LYSAddressAutoCompleteLogger> lysAddressAutoCompleteLoggerProvider2) {
        return new AddressAutoCompleteFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, lysAddressAutoCompleteLoggerProvider2);
    }

    public void injectMembers(AddressAutoCompleteFragment instance) {
        if (instance == null) {
        ...
        instance.lysAddressAutoCompleteLogger = (LYSAddressAutoCompleteLogger) this.lysAddressAutoCompleteLoggerProvider.get();
    }

    public static void injectLysAddressAutoCompleteLogger(AddressAutoCompleteFragment instance, Provider<LYSAddressAutoCompleteLogger> lysAddressAutoCompleteLoggerProvider2) {
        instance.lysAddressAutoCompleteLogger = (LYSAddressAutoCompleteLogger) lysAddressAutoCompleteLoggerProvider2.get();
    }
}
