...
public final class WhatsMyPlaceWorthFragment_MembersInjector implements MembersInjector<WhatsMyPlaceWorthFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!WhatsMyPlaceWorthFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<WhatsMyPlaceWorthLogger> loggerProvider;
    ...
    public void injectMembers(WhatsMyPlaceWorthFragment instance) {
        ...
        instance.logger = (WhatsMyPlaceWorthLogger) this.loggerProvider.get();
    }

    public static void injectLogger(WhatsMyPlaceWorthFragment instance, Provider<WhatsMyPlaceWorthLogger> loggerProvider2) {
        instance.logger = (WhatsMyPlaceWorthLogger) loggerProvider2.get();
    }
}
