...
final /* synthetic */ class EditAddressAdapter$$Lambda$7 implements Function {
    private final ImmutableMap arg$1;

    private EditAddressAdapter$$Lambda$7(ImmutableMap immutableMap) {
        this.arg$1 = immutableMap;
    }

    public static Function lambdaFactory$(ImmutableMap immutableMap) {
        return new EditAddressAdapter$$Lambda$7(immutableMap);
    }
