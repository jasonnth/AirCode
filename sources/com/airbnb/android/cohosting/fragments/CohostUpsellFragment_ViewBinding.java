...
public class CohostUpsellFragment_ViewBinding implements Unbinder {
    private CohostUpsellFragment target;

    public CohostUpsellFragment_ViewBinding(CohostUpsellFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        CohostUpsellFragment target2 = this.target;
        if (target2 == null) {
