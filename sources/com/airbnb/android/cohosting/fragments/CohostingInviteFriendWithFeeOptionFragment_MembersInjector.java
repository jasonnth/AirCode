...
public final class CohostingInviteFriendWithFeeOptionFragment_MembersInjector implements MembersInjector<CohostingInviteFriendWithFeeOptionFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!CohostingInviteFriendWithFeeOptionFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static MembersInjector<CohostingInviteFriendWithFeeOptionFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<CohostingManagementJitneyLogger> loggerProvider2) {
        return new CohostingInviteFriendWithFeeOptionFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, loggerProvider2);
    }

    public void injectMembers(CohostingInviteFriendWithFeeOptionFragment instance) {
        if (instance == null) {
    ...
    public static void injectLogger(CohostingInviteFriendWithFeeOptionFragment instance, Provider<CohostingManagementJitneyLogger> loggerProvider2) {
