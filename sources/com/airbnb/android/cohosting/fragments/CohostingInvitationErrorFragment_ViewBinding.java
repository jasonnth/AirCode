...
public class CohostingInvitationErrorFragment_ViewBinding implements Unbinder {
    ...
    public CohostingInvitationErrorFragment_ViewBinding(CohostingInvitationErrorFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        CohostingInvitationErrorFragment target2 = this.target;
        if (target2 == null) {
