...
public class CohostingListingPickerFragment_ViewBinding implements Unbinder {
    private CohostingListingPickerFragment target;

    public CohostingListingPickerFragment_ViewBinding(CohostingListingPickerFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        CohostingListingPickerFragment target2 = this.target;
        if (target2 == null) {
