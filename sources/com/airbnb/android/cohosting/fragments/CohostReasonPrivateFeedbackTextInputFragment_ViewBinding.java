...
public class CohostReasonPrivateFeedbackTextInputFragment_ViewBinding implements Unbinder {
    private CohostReasonPrivateFeedbackTextInputFragment target;

    public CohostReasonPrivateFeedbackTextInputFragment_ViewBinding(CohostReasonPrivateFeedbackTextInputFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        CohostReasonPrivateFeedbackTextInputFragment target2 = this.target;
        if (target2 == null) {
