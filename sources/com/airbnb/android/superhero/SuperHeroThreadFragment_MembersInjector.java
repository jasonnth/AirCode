...
public final class SuperHeroThreadFragment_MembersInjector implements MembersInjector<SuperHeroThreadFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!SuperHeroThreadFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    public static MembersInjector<SuperHeroThreadFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> mAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<SuperHeroTableOpenHelper> superHeroTableOpenHelperProvider2, Provider<SuperHeroManager> superHeroManagerProvider2) {
        return new SuperHeroThreadFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, mAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, superHeroTableOpenHelperProvider2, superHeroManagerProvider2);
    }

    public void injectMembers(SuperHeroThreadFragment instance) {
        if (instance == null) {
    ...
    public static void injectSuperHeroTableOpenHelper(SuperHeroThreadFragment instance, Provider<SuperHeroTableOpenHelper> superHeroTableOpenHelperProvider2) {
        instance.superHeroTableOpenHelper = (SuperHeroTableOpenHelper) superHeroTableOpenHelperProvider2.get();
    }

    public static void injectSuperHeroManager(SuperHeroThreadFragment instance, Provider<SuperHeroManager> superHeroManagerProvider2) {
        instance.superHeroManager = (SuperHeroManager) superHeroManagerProvider2.get();
    }

    public static void injectLoggingContextFactory(SuperHeroThreadFragment instance, Provider<LoggingContextFactory> loggingContextFactoryProvider2) {
