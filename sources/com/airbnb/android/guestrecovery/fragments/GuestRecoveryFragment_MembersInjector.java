...
public final class GuestRecoveryFragment_MembersInjector implements MembersInjector<GuestRecoveryFragment> {
    static final /* synthetic */ boolean $assertionsDisabled = (!GuestRecoveryFragment_MembersInjector.class.desiredAssertionStatus());
    ...
    private final Provider<GuestRecoveryLogger> loggerProvider;
    ...
    public static MembersInjector<GuestRecoveryFragment> create(Provider<AirbnbApi> mAirbnbApiProvider2, Provider<WishListManager> wishListManagerProvider2, Provider<BusinessTravelAccountManager> businessTravelAccountManagerProvider2, Provider<AirbnbAccountManager> accountManagerAndMAccountManagerProvider2, Provider<AirbnbPreferences> mPreferencesProvider2, Provider<Erf> mErfProvider2, Provider<SharedPrefsHelper> mPrefsHelperProvider2, Provider<MemoryUtils> mMemoryUtilsProvider2, Provider<Bus> mBusProvider2, Provider<CurrencyFormatter> mCurrencyHelperProvider2, Provider<NavigationLogging> navigationAnalyticsProvider2, Provider<AirRequestInitializer> airRequestInitializerProvider2, Provider<LoggingContextFactory> loggingContextFactoryProvider2, Provider<ClientSessionValidator> clientSessionValidatorProvider2, Provider<ViewBreadcrumbManager> viewBreadcrumbManagerProvider2, Provider<ResourceManager> resourceManagerProvider2, Provider<GuestRecoveryLogger> loggerProvider2) {
        return new GuestRecoveryFragment_MembersInjector(mAirbnbApiProvider2, wishListManagerProvider2, businessTravelAccountManagerProvider2, accountManagerAndMAccountManagerProvider2, mPreferencesProvider2, mErfProvider2, mPrefsHelperProvider2, mMemoryUtilsProvider2, mBusProvider2, mCurrencyHelperProvider2, navigationAnalyticsProvider2, airRequestInitializerProvider2, loggingContextFactoryProvider2, clientSessionValidatorProvider2, viewBreadcrumbManagerProvider2, resourceManagerProvider2, loggerProvider2);
    }

    public void injectMembers(GuestRecoveryFragment instance) {
        if (instance == null) {
        ...
        instance.logger = (GuestRecoveryLogger) this.loggerProvider.get();
        instance.accountManager = (AirbnbAccountManager) this.accountManagerAndMAccountManagerProvider.get();
    }

    public static void injectLogger(GuestRecoveryFragment instance, Provider<GuestRecoveryLogger> loggerProvider2) {
        instance.logger = (GuestRecoveryLogger) loggerProvider2.get();
    }

    public static void injectAccountManager(GuestRecoveryFragment instance, Provider<AirbnbAccountManager> accountManagerProvider) {
