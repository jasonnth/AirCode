...
final /* synthetic */ class CityRegistrationDocReviewAdapter$$Lambda$1 implements OnClickListener {
    private final Listener arg$1;
    private final ListingRegistrationQuestion arg$2;

    private CityRegistrationDocReviewAdapter$$Lambda$1(Listener listener, ListingRegistrationQuestion listingRegistrationQuestion) {
        this.arg$1 = listener;
    ...
    public static OnClickListener lambdaFactory$(Listener listener, ListingRegistrationQuestion listingRegistrationQuestion) {
        return new CityRegistrationDocReviewAdapter$$Lambda$1(listener, listingRegistrationQuestion);
    }

    public void onClick(View view) {
        this.arg$1.showDocumentTypeSelection(this.arg$2);
    }
}
