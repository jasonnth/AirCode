...
public class CityRegistrationReviewFragment_ViewBinding implements Unbinder {
    private CityRegistrationReviewFragment target;
    private View view2131755475;

    public CityRegistrationReviewFragment_ViewBinding(final CityRegistrationReviewFragment target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        CityRegistrationReviewFragment target2 = this.target;
        if (target2 == null) {
