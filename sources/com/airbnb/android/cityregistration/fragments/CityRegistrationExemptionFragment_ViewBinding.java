...
public class CityRegistrationExemptionFragment_ViewBinding implements Unbinder {
    private CityRegistrationExemptionFragment target;
    private View view2131755475;

    public CityRegistrationExemptionFragment_ViewBinding(final CityRegistrationExemptionFragment target2, View source) {
        this.target = target2;
        ...
        View view = Utils.findRequiredView(source, C5630R.C5632id.save_button, "field 'saveButton' and method 'onSave'");
    ...
    public void unbind() {
        CityRegistrationExemptionFragment target2 = this.target;
        if (target2 == null) {
