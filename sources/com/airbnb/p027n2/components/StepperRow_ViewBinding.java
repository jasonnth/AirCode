...
/* renamed from: com.airbnb.n2.components.StepperRow_ViewBinding */
public final class StepperRow_ViewBinding implements Unbinder {
    private StepperRow target;

    public StepperRow_ViewBinding(StepperRow target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        StepperRow target2 = this.target;
        if (target2 == null) {
