...
/* renamed from: com.airbnb.n2.components.CityRegistrationToggleRow_ViewBinding */
public class CityRegistrationToggleRow_ViewBinding implements Unbinder {
    private CityRegistrationToggleRow target;

    public CityRegistrationToggleRow_ViewBinding(CityRegistrationToggleRow target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        CityRegistrationToggleRow target2 = this.target;
        if (target2 == null) {
