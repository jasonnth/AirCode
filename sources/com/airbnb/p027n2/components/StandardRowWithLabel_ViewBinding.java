...
/* renamed from: com.airbnb.n2.components.StandardRowWithLabel_ViewBinding */
public class StandardRowWithLabel_ViewBinding implements Unbinder {
    private StandardRowWithLabel target;

    public StandardRowWithLabel_ViewBinding(StandardRowWithLabel target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        StandardRowWithLabel target2 = this.target;
        if (target2 == null) {
