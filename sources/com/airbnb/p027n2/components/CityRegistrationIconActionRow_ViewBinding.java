...
/* renamed from: com.airbnb.n2.components.CityRegistrationIconActionRow_ViewBinding */
public class CityRegistrationIconActionRow_ViewBinding implements Unbinder {
    private CityRegistrationIconActionRow target;

    public CityRegistrationIconActionRow_ViewBinding(CityRegistrationIconActionRow target2, View source) {
        this.target = target2;
        ...
        target2.action = (AirTextView) Utils.findRequiredViewAsType(source, R.id.action, "field 'action'", AirTextView.class);
        target2.icon = (AirImageView) Utils.findRequiredViewAsType(source, R.id.icon, "field 'icon'", AirImageView.class);
    }

    public void unbind() {
        CityRegistrationIconActionRow target2 = this.target;
        if (target2 == null) {
