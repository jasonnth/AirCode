...
/* renamed from: com.airbnb.n2.components.StandardRowWithLabel */
public class StandardRowWithLabel extends LinearLayout implements DividerView {
    ...
    public StandardRowWithLabel(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public StandardRowWithLabel(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setupAttributes(AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.n2_StandardRowWithLabel, 0, 0);
        String titleText2 = a.getString(R.styleable.n2_StandardRowWithLabel_n2_titleText);
        String subtitleText2 = a.getString(R.styleable.n2_StandardRowWithLabel_n2_subtitleText);
        String inputText = a.getString(R.styleable.n2_StandardRowWithLabel_n2_inputText);
        String infoText = a.getString(R.styleable.n2_StandardRowWithLabel_n2_infoText);
        boolean dividerVisible = a.getBoolean(R.styleable.n2_StandardRowWithLabel_n2_showDivider, true);
        Drawable rowDrawable2 = ViewLibUtils.getDrawableCompat(context, a, R.styleable.n2_StandardRowWithLabel_n2_image);
    ...
    public void setlabelBackground(int resId) {
        this.label.setBackgroundResource(resId);
    }
    ...
    public void setLabel(CharSequence text2) {
        ViewLibUtils.setVisibleIf(this.label, !TextUtils.isEmpty(text2));
    ...
    public static void mockBasic(StandardRowWithLabel row) {
        row.setTitle((CharSequence) "Title");
    }

    public static void mockBasicPlus(StandardRowWithLabel row) {
        row.setTitle((CharSequence) "Title");
        row.setSubtitleText((CharSequence) "Optional subtitle");
    }

    public static void mockBasicPlusIcon(StandardRowWithLabel row) {
        row.setTitle((CharSequence) "Title");
        row.setRowDrawableRes(R.drawable.n2_icon_alert);
    }

    public static void mockBasicPlusIconWithBadge(StandardRowWithLabel row) {
        row.setTitle((CharSequence) "Title");
        row.setRowDrawableRes(R.drawable.n2_icon_alert);
        row.showBadge(true);
    }

    public static void mockInfo(StandardRowWithLabel row) {
        row.setTitle((CharSequence) "Title");
        row.setInfoText((CharSequence) "Info");
    }

    public static void mockInfoPlus(StandardRowWithLabel row) {
        row.setTitle((CharSequence) "Title");
        row.setInfoText((CharSequence) "Info");
        row.setSubtitleText((CharSequence) "Optional subtitle");
    }

    public static void mockAction(StandardRowWithLabel row) {
        row.setTitle((CharSequence) "Title");
        row.setActionText((CharSequence) "Action");
    }

    public static void mockActionPlus(StandardRowWithLabel row) {
        row.setTitle((CharSequence) "Title");
        row.setSubtitleText((CharSequence) "Subtitle");
        row.setActionText((CharSequence) "Action");
    }

    public static void mockLabel(StandardRowWithLabel row) {
        row.setTitle((CharSequence) "House Manual");
        row.setLabel((CharSequence) "New");
        row.setSubtitleText((CharSequence) "Good vs Evil");
        row.setRowDrawableRes(R.drawable.n2_standard_row_right_caret_gray);
    }

    public static void mockLabelBabu(StandardRowWithLabel row) {
        row.setTitle((CharSequence) "House Manual");
        row.setLabel((CharSequence) "New");
        row.setSubtitleText((CharSequence) "Good vs Evil");
        row.setlabelBackground(R.drawable.n2_label_background_small_babu);
        row.setRowDrawableRes(R.drawable.n2_standard_row_right_caret_gray);
    }
}
