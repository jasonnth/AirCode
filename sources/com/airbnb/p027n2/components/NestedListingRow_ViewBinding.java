...
/* renamed from: com.airbnb.n2.components.NestedListingRow_ViewBinding */
public class NestedListingRow_ViewBinding implements Unbinder {
    private NestedListingRow target;

    public NestedListingRow_ViewBinding(NestedListingRow target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        NestedListingRow target2 = this.target;
        if (target2 == null) {
