...
/* renamed from: com.airbnb.n2.components.MicroDisplayCard_ViewBinding */
public class MicroDisplayCard_ViewBinding implements Unbinder {
    private MicroDisplayCard target;

    public MicroDisplayCard_ViewBinding(MicroDisplayCard target2, View source) {
        this.target = target2;
    ...
    public void unbind() {
        MicroDisplayCard target2 = this.target;
        if (target2 == null) {
