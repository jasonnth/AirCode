...
/* renamed from: com.airbnb.n2.components.NoProfilePhotoDetailsSummary_ViewBinding */
public class NoProfilePhotoDetailsSummary_ViewBinding implements Unbinder {
    private NoProfilePhotoDetailsSummary target;

    public NoProfilePhotoDetailsSummary_ViewBinding(NoProfilePhotoDetailsSummary target2, View source) {
        this.target = target2;
        ...
        target2.titleStatusIcon = (AirImageView) Utils.findRequiredViewAsType(source, R.id.title_status_icon, "field 'titleStatusIcon'", AirImageView.class);
        target2.divider = Utils.findRequiredView(source, R.id.divider, "field 'divider'");
    }

    public void unbind() {
        NoProfilePhotoDetailsSummary target2 = this.target;
        if (target2 == null) {
