package com.airbnb.jitney.event.logging.Payouts.p196v2;
...
/* renamed from: com.airbnb.jitney.event.logging.Payouts.v2.PayoutsPayoutMethodErrorNativeEvent */
public final class PayoutsPayoutMethodErrorNativeEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Payouts.v2.PayoutsPayoutMethodErrorNativeEvent$PayoutsPayoutMethodErrorNativeEventAdapter */
    private static final class PayoutsPayoutMethodErrorNativeEventAdapter implements Adapter<PayoutsPayoutMethodErrorNativeEvent, Object> {
        ...
        public void write(Protocol protocol, PayoutsPayoutMethodErrorNativeEvent struct) throws IOException {
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("payout_method_type", 4, 8);
            protocol.writeI32(struct.payout_method_type.value);
            protocol.writeFieldEnd();
            if (struct.payment_instrument_type != null) {
                protocol.writeFieldBegin("payment_instrument_type", 5, 8);
                protocol.writeI32(struct.payment_instrument_type.value);
                protocol.writeFieldEnd();
            }
            protocol.writeFieldBegin("billing_country", 6, PassportService.SF_DG11);
            protocol.writeString(struct.billing_country);
            protocol.writeFieldEnd();
            protocol.writeFieldBegin(AirbnbConstants.PREFS_CURRENCY, 7, PassportService.SF_DG11);
    ...
    public boolean equals(Object other) {
        ...
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.payout_method_error == that.payout_method_error || this.payout_method_error.equals(that.payout_method_error)) && ((this.payout_method_type == that.payout_method_type || this.payout_method_type.equals(that.payout_method_type)) && ((this.payment_instrument_type == that.payment_instrument_type || (this.payment_instrument_type != null && this.payment_instrument_type.equals(that.payment_instrument_type))) && ((this.billing_country == that.billing_country || this.billing_country.equals(that.billing_country)) && ((this.currency == that.currency || this.currency.equals(that.currency)) && (this.operation == that.operation || this.operation.equals(that.operation)))))))))) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int i = 0;
        int code = (((((((((16777619 ^ (this.schema == null ? 0 : this.schema.hashCode())) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.payout_method_error.hashCode()) * -2128831035) ^ this.payout_method_type.hashCode()) * -2128831035;
    ...
    public String toString() {
        return "PayoutsPayoutMethodErrorNativeEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", payout_method_error=" + this.payout_method_error + ", payout_method_type=" + this.payout_method_type + ", payment_instrument_type=" + this.payment_instrument_type + ", billing_country=" + this.billing_country + ", currency=" + this.currency + ", operation=" + this.operation + "}";
    }
