package com.airbnb.jitney.event.logging.PaidGrowth.p181v3;
...
/* renamed from: com.airbnb.jitney.event.logging.PaidGrowth.v3.PaidGrowthBookingRequestPixelEvent */
public final class PaidGrowthBookingRequestPixelEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.PaidGrowth.v3.PaidGrowthBookingRequestPixelEvent$PaidGrowthBookingRequestPixelEventAdapter */
    ...
    public int hashCode() {
        return (((((((((((((((((((16777619 ^ (this.schema == null ? 0 : this.schema.hashCode())) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.listing_id.hashCode()) * -2128831035) ^ this.device_id.hashCode()) * -2128831035) ^ this.user_id.hashCode()) * -2128831035) ^ this.n_nights.hashCode()) * -2128831035) ^ this.is_first_time.hashCode()) * -2128831035) ^ this.request_id.hashCode()) * -2128831035;
    }

    public String toString() {
        return "PaidGrowthBookingRequestPixelEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", device_id=" + this.device_id + ", user_id=" + this.user_id + ", n_nights=" + this.n_nights + ", is_first_time=" + this.is_first_time + ", request_id=" + this.request_id + "}";
    }
