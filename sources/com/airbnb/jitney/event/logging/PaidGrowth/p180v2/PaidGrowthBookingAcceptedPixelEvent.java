...
/* renamed from: com.airbnb.jitney.event.logging.PaidGrowth.v2.PaidGrowthBookingAcceptedPixelEvent */
public final class PaidGrowthBookingAcceptedPixelEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.PaidGrowth.v2.PaidGrowthBookingAcceptedPixelEvent$PaidGrowthBookingAcceptedPixelEventAdapter */
    private static final class PaidGrowthBookingAcceptedPixelEventAdapter implements Adapter<PaidGrowthBookingAcceptedPixelEvent, Object> {
        ...
        public void write(Protocol protocol, PaidGrowthBookingAcceptedPixelEvent struct) throws IOException {
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("primary_host_id", 5, 10);
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("total_fees", 9, 4);
    ...
    public boolean equals(Object other) {
        ...
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.listing_id == that.listing_id || this.listing_id.equals(that.listing_id)) && ((this.primary_host_id == that.primary_host_id || this.primary_host_id.equals(that.primary_host_id)) && ((this.user_id == that.user_id || this.user_id.equals(that.user_id)) && ((this.n_nights == that.n_nights || this.n_nights.equals(that.n_nights)) && ((this.is_first_time == that.is_first_time || this.is_first_time.equals(that.is_first_time)) && ((this.total_fees == that.total_fees || this.total_fees.equals(that.total_fees)) && (this.request_id == that.request_id || this.request_id.equals(that.request_id)))))))))))) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((((((16777619 ^ (this.schema == null ? 0 : this.schema.hashCode())) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.listing_id.hashCode()) * -2128831035) ^ this.primary_host_id.hashCode()) * -2128831035) ^ this.user_id.hashCode()) * -2128831035) ^ this.n_nights.hashCode()) * -2128831035) ^ this.is_first_time.hashCode()) * -2128831035) ^ this.total_fees.hashCode()) * -2128831035) ^ this.request_id.hashCode()) * -2128831035;
    }

    public String toString() {
        return "PaidGrowthBookingAcceptedPixelEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", primary_host_id=" + this.primary_host_id + ", user_id=" + this.user_id + ", n_nights=" + this.n_nights + ", is_first_time=" + this.is_first_time + ", total_fees=" + this.total_fees + ", request_id=" + this.request_id + "}";
    }
