...
/* renamed from: com.airbnb.jitney.event.logging.PaidGrowth.v1.PaidGrowthBookingRequestPixelEvent */
public final class PaidGrowthBookingRequestPixelEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.PaidGrowth.v1.PaidGrowthBookingRequestPixelEvent$PaidGrowthBookingRequestPixelEventAdapter */
    ...
    public int hashCode() {
        return (((((((((((((((((((16777619 ^ (this.schema == null ? 0 : this.schema.hashCode())) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.listing_id.hashCode()) * -2128831035) ^ this.device_id.hashCode()) * -2128831035) ^ this.n_nights.hashCode()) * -2128831035) ^ this.is_first_time.hashCode()) * -2128831035) ^ this.payments_context.hashCode()) * -2128831035) ^ this.request_id.hashCode()) * -2128831035;
    }

    public String toString() {
        return "PaidGrowthBookingRequestPixelEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", device_id=" + this.device_id + ", n_nights=" + this.n_nights + ", is_first_time=" + this.is_first_time + ", payments_context=" + this.payments_context + ", request_id=" + this.request_id + "}";
    }
