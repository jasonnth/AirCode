...
/* renamed from: com.airbnb.jitney.event.logging.GuestCheckIn.v2.GuestCheckInCheckinGuideGuestClickPhotoInEvent */
public final class GuestCheckInCheckinGuideGuestClickPhotoInEvent implements Struct {
    public static final Adapter<GuestCheckInCheckinGuideGuestClickPhotoInEvent, Builder> ADAPTER = new GuestCheckInCheckinGuideGuestClickPhotoInEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GuestCheckIn.v2.GuestCheckInCheckinGuideGuestClickPhotoInEvent$Builder */
    public static final class Builder implements StructBuilder<GuestCheckInCheckinGuideGuestClickPhotoInEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.GuestCheckIn:GuestCheckInCheckinGuideGuestClickPhotoInEvent:2.0.0";
            this.event_name = "guestcheckin_checkin_guide_guest_click_photo_in";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GuestCheckIn.v2.GuestCheckInCheckinGuideGuestClickPhotoInEvent$GuestCheckInCheckinGuideGuestClickPhotoInEventAdapter */
    ...
    public String toString() {
        return "GuestCheckInCheckinGuideGuestClickPhotoInEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", step_index=" + this.step_index + "}";
    }
