...
/* renamed from: com.airbnb.jitney.event.logging.GuestCheckIn.v2.GuestCheckInCheckinGuideGuestTranslateOriginalEvent */
public final class GuestCheckInCheckinGuideGuestTranslateOriginalEvent implements Struct {
    public static final Adapter<GuestCheckInCheckinGuideGuestTranslateOriginalEvent, Builder> ADAPTER = new GuestCheckInCheckinGuideGuestTranslateOriginalEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GuestCheckIn.v2.GuestCheckInCheckinGuideGuestTranslateOriginalEvent$Builder */
    public static final class Builder implements StructBuilder<GuestCheckInCheckinGuideGuestTranslateOriginalEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.GuestCheckIn:GuestCheckInCheckinGuideGuestTranslateOriginalEvent:2.0.0";
            this.event_name = "guestcheckin_checkin_guide_guest_translate_original";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GuestCheckIn.v2.GuestCheckInCheckinGuideGuestTranslateOriginalEvent$GuestCheckInCheckinGuideGuestTranslateOriginalEventAdapter */
    private static final class GuestCheckInCheckinGuideGuestTranslateOriginalEventAdapter implements Adapter<GuestCheckInCheckinGuideGuestTranslateOriginalEvent, Builder> {
        ...
        public void write(Protocol protocol, GuestCheckInCheckinGuideGuestTranslateOriginalEvent struct) throws IOException {
            protocol.writeStructBegin("GuestCheckInCheckinGuideGuestTranslateOriginalEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof GuestCheckInCheckinGuideGuestTranslateOriginalEvent)) {
            return false;
        }
        GuestCheckInCheckinGuideGuestTranslateOriginalEvent that = (GuestCheckInCheckinGuideGuestTranslateOriginalEvent) other;
    ...
    public String toString() {
        return "GuestCheckInCheckinGuideGuestTranslateOriginalEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", step_index=" + this.step_index + ", device_language=" + this.device_language + ", guide_language=" + this.guide_language + "}";
    }
