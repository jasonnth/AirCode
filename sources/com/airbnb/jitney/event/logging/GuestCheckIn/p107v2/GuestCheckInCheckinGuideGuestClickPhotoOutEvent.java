...
/* renamed from: com.airbnb.jitney.event.logging.GuestCheckIn.v2.GuestCheckInCheckinGuideGuestClickPhotoOutEvent */
public final class GuestCheckInCheckinGuideGuestClickPhotoOutEvent implements Struct {
    public static final Adapter<GuestCheckInCheckinGuideGuestClickPhotoOutEvent, Builder> ADAPTER = new GuestCheckInCheckinGuideGuestClickPhotoOutEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GuestCheckIn.v2.GuestCheckInCheckinGuideGuestClickPhotoOutEvent$Builder */
    public static final class Builder implements StructBuilder<GuestCheckInCheckinGuideGuestClickPhotoOutEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.GuestCheckIn:GuestCheckInCheckinGuideGuestClickPhotoOutEvent:2.0.0";
            this.event_name = "guestcheckin_checkin_guide_guest_click_photo_out";
        ...
        public GuestCheckInCheckinGuideGuestClickPhotoOutEvent build() {
            if (this.event_name == null) {
                ...
                return new GuestCheckInCheckinGuideGuestClickPhotoOutEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GuestCheckIn.v2.GuestCheckInCheckinGuideGuestClickPhotoOutEvent$GuestCheckInCheckinGuideGuestClickPhotoOutEventAdapter */
    private static final class GuestCheckInCheckinGuideGuestClickPhotoOutEventAdapter implements Adapter<GuestCheckInCheckinGuideGuestClickPhotoOutEvent, Builder> {
    ...
    public String toString() {
        return "GuestCheckInCheckinGuideGuestClickPhotoOutEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", step_index=" + this.step_index + "}";
    }
