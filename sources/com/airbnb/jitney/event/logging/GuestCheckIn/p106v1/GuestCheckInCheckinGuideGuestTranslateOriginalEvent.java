...
/* renamed from: com.airbnb.jitney.event.logging.GuestCheckIn.v1.GuestCheckInCheckinGuideGuestTranslateOriginalEvent */
public final class GuestCheckInCheckinGuideGuestTranslateOriginalEvent implements Struct {
    public static final Adapter<GuestCheckInCheckinGuideGuestTranslateOriginalEvent, Object> ADAPTER = new GuestCheckInCheckinGuideGuestTranslateOriginalEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GuestCheckIn.v1.GuestCheckInCheckinGuideGuestTranslateOriginalEvent$GuestCheckInCheckinGuideGuestTranslateOriginalEventAdapter */
    private static final class GuestCheckInCheckinGuideGuestTranslateOriginalEventAdapter implements Adapter<GuestCheckInCheckinGuideGuestTranslateOriginalEvent, Object> {
    ...
    public String toString() {
        return "GuestCheckInCheckinGuideGuestTranslateOriginalEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", user_id=" + this.user_id + ", step_index=" + this.step_index + ", device_language=" + this.device_language + ", guide_language=" + this.guide_language + "}";
    }
