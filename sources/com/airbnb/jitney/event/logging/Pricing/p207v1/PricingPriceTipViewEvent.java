...
/* renamed from: com.airbnb.jitney.event.logging.Pricing.v1.PricingPriceTipViewEvent */
public final class PricingPriceTipViewEvent implements Struct {
    public static final Adapter<PricingPriceTipViewEvent, Builder> ADAPTER = new PricingPriceTipViewEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Pricing.v1.PricingPriceTipViewEvent$Builder */
    public static final class Builder implements StructBuilder<PricingPriceTipViewEvent> {
        /* access modifiers changed from: private */
        public Context context;
        /* access modifiers changed from: private */
        public String event_name = "pricing_price_tip_view";
        /* access modifiers changed from: private */
        ...
        /* access modifiers changed from: private */
        public String schema = "com.airbnb.jitney.event.logging.Pricing:PricingPriceTipViewEvent:1.0.0";
        /* access modifiers changed from: private */
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Pricing.v1.PricingPriceTipViewEvent$PricingPriceTipViewEventAdapter */
    private static final class PricingPriceTipViewEventAdapter implements Adapter<PricingPriceTipViewEvent, Builder> {
        ...
        public void write(Protocol protocol, PricingPriceTipViewEvent struct) throws IOException {
            protocol.writeStructBegin("PricingPriceTipViewEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PricingPriceTipViewEvent)) {
            return false;
        }
        PricingPriceTipViewEvent that = (PricingPriceTipViewEvent) other;
    ...
    public String toString() {
        return "PricingPriceTipViewEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", listing_id=" + this.listing_id + ", price_suggestions_with_context=" + this.price_suggestions_with_context + ", price_tips_days_type=" + this.price_tips_days_type + "}";
    }
