...
/* renamed from: com.airbnb.jitney.event.logging.Pricing.v1.PricingBasePriceTipAdoptionEvent */
public final class PricingBasePriceTipAdoptionEvent implements Struct {
    public static final Adapter<PricingBasePriceTipAdoptionEvent, Builder> ADAPTER = new PricingBasePriceTipAdoptionEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Pricing.v1.PricingBasePriceTipAdoptionEvent$Builder */
    public static final class Builder implements StructBuilder<PricingBasePriceTipAdoptionEvent> {
        ...
        /* access modifiers changed from: private */
        public String event_name = "pricing_base_price_tip_adoption";
        /* access modifiers changed from: private */
        ...
        /* access modifiers changed from: private */
        public String schema = "com.airbnb.jitney.event.logging.Pricing:PricingBasePriceTipAdoptionEvent:1.0.0";
        /* access modifiers changed from: private */
        ...
        public Builder(Context context2, C2585PricingSettingsPageType page2, C2586PricingSettingsSectionType section2, Long listing_id2, String currency2, Long old_base_price2, Long suggested_price2) {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Pricing.v1.PricingBasePriceTipAdoptionEvent$PricingBasePriceTipAdoptionEventAdapter */
    private static final class PricingBasePriceTipAdoptionEventAdapter implements Adapter<PricingBasePriceTipAdoptionEvent, Builder> {
        private PricingBasePriceTipAdoptionEventAdapter() {
        }

        public void write(Protocol protocol, PricingBasePriceTipAdoptionEvent struct) throws IOException {
            protocol.writeStructBegin("PricingBasePriceTipAdoptionEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PricingBasePriceTipAdoptionEvent)) {
            return false;
        }
        PricingBasePriceTipAdoptionEvent that = (PricingBasePriceTipAdoptionEvent) other;
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.page == that.page || this.page.equals(that.page)) && ((this.section == that.section || this.section.equals(that.section)) && ((this.listing_id == that.listing_id || this.listing_id.equals(that.listing_id)) && ((this.currency == that.currency || this.currency.equals(that.currency)) && ((this.old_base_price == that.old_base_price || this.old_base_price.equals(that.old_base_price)) && (this.suggested_price == that.suggested_price || this.suggested_price.equals(that.suggested_price)))))))))) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((16777619 ^ (this.schema == null ? 0 : this.schema.hashCode())) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.page.hashCode()) * -2128831035) ^ this.section.hashCode()) * -2128831035) ^ this.listing_id.hashCode()) * -2128831035) ^ this.currency.hashCode()) * -2128831035) ^ this.old_base_price.hashCode()) * -2128831035) ^ this.suggested_price.hashCode()) * -2128831035;
    }

    public String toString() {
        return "PricingBasePriceTipAdoptionEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", listing_id=" + this.listing_id + ", currency=" + this.currency + ", old_base_price=" + this.old_base_price + ", suggested_price=" + this.suggested_price + "}";
    }
