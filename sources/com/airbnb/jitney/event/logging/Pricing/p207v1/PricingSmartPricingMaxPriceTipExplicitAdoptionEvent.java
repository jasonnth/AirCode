...
/* renamed from: com.airbnb.jitney.event.logging.Pricing.v1.PricingSmartPricingMaxPriceTipExplicitAdoptionEvent */
public final class PricingSmartPricingMaxPriceTipExplicitAdoptionEvent implements Struct {
    public static final Adapter<PricingSmartPricingMaxPriceTipExplicitAdoptionEvent, Builder> ADAPTER = new PricingSmartPricingMaxPriceTipExplicitAdoptionEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Pricing.v1.PricingSmartPricingMaxPriceTipExplicitAdoptionEvent$Builder */
    public static final class Builder implements StructBuilder<PricingSmartPricingMaxPriceTipExplicitAdoptionEvent> {
        ...
        /* access modifiers changed from: private */
        public String event_name = "pricing_smart_pricing_max_price_tip_explicit_adoption";
        /* access modifiers changed from: private */
        ...
        /* access modifiers changed from: private */
        public String schema = "com.airbnb.jitney.event.logging.Pricing:PricingSmartPricingMaxPriceTipExplicitAdoptionEvent:1.0.0";
        /* access modifiers changed from: private */
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Pricing.v1.PricingSmartPricingMaxPriceTipExplicitAdoptionEvent$PricingSmartPricingMaxPriceTipExplicitAdoptionEventAdapter */
    private static final class PricingSmartPricingMaxPriceTipExplicitAdoptionEventAdapter implements Adapter<PricingSmartPricingMaxPriceTipExplicitAdoptionEvent, Builder> {
        private PricingSmartPricingMaxPriceTipExplicitAdoptionEventAdapter() {
        }

        public void write(Protocol protocol, PricingSmartPricingMaxPriceTipExplicitAdoptionEvent struct) throws IOException {
            protocol.writeStructBegin("PricingSmartPricingMaxPriceTipExplicitAdoptionEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PricingSmartPricingMaxPriceTipExplicitAdoptionEvent)) {
            return false;
        }
        PricingSmartPricingMaxPriceTipExplicitAdoptionEvent that = (PricingSmartPricingMaxPriceTipExplicitAdoptionEvent) other;
