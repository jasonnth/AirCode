...
/* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickSubmitReviewsEvent */
public final class ExperienceHostingClickSubmitReviewsEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickSubmitReviewsEvent$ExperienceHostingClickSubmitReviewsEventAdapter */
    private static final class ExperienceHostingClickSubmitReviewsEventAdapter implements Adapter<ExperienceHostingClickSubmitReviewsEvent, Object> {
        ...
        public void write(Protocol protocol, ExperienceHostingClickSubmitReviewsEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperienceHostingClickSubmitReviewsEvent)) {
            return false;
        }
        ExperienceHostingClickSubmitReviewsEvent that = (ExperienceHostingClickSubmitReviewsEvent) other;
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.page == that.page || this.page.equals(that.page)) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.product_info == that.product_info || this.product_info.equals(that.product_info)) && ((this.guest_reviews == that.guest_reviews || this.guest_reviews.equals(that.guest_reviews)) && (this.guest_labels == that.guest_labels || (this.guest_labels != null && this.guest_labels.equals(that.guest_labels)))))))))) {
    ...
    public int hashCode() {
        ...
        int code = (((((((((((((((16777619 ^ hashCode) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.page.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.product_info.hashCode()) * -2128831035) ^ this.guest_reviews.hashCode()) * -2128831035) ^ (this.guest_labels == null ? 0 : this.guest_labels.hashCode())) * -2128831035;
