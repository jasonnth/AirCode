...
/* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickCancelImmersionEvent */
public final class ExperienceHostingClickCancelImmersionEvent implements Struct {
    public static final Adapter<ExperienceHostingClickCancelImmersionEvent, Object> ADAPTER = new ExperienceHostingClickCancelImmersionEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickCancelImmersionEvent$ExperienceHostingClickCancelImmersionEventAdapter */
    private static final class ExperienceHostingClickCancelImmersionEventAdapter implements Adapter<ExperienceHostingClickCancelImmersionEvent, Object> {
        private ExperienceHostingClickCancelImmersionEventAdapter() {
        }

        public void write(Protocol protocol, ExperienceHostingClickCancelImmersionEvent struct) throws IOException {
            protocol.writeStructBegin("ExperienceHostingClickCancelImmersionEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperienceHostingClickCancelImmersionEvent)) {
            return false;
        }
        ExperienceHostingClickCancelImmersionEvent that = (ExperienceHostingClickCancelImmersionEvent) other;
    ...
    public String toString() {
        return "ExperienceHostingClickCancelImmersionEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", product_info=" + this.product_info + ", operation=" + this.operation + ", dates=" + this.dates + "}";
    }
