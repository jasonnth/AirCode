...
/* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickSaveAddressEvent */
public final class ExperienceHostingClickSaveAddressEvent implements Struct {
    public static final Adapter<ExperienceHostingClickSaveAddressEvent, Object> ADAPTER = new ExperienceHostingClickSaveAddressEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickSaveAddressEvent$ExperienceHostingClickSaveAddressEventAdapter */
    private static final class ExperienceHostingClickSaveAddressEventAdapter implements Adapter<ExperienceHostingClickSaveAddressEvent, Object> {
        private ExperienceHostingClickSaveAddressEventAdapter() {
        }

        public void write(Protocol protocol, ExperienceHostingClickSaveAddressEvent struct) throws IOException {
            protocol.writeStructBegin("ExperienceHostingClickSaveAddressEvent");
    ...
    public int hashCode() {
        return (((((((((((((((16777619 ^ (this.schema == null ? 0 : this.schema.hashCode())) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.page.hashCode()) * -2128831035) ^ this.product_info.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.dates.hashCode()) * -2128831035) ^ this.address.hashCode()) * -2128831035;
    }

    public String toString() {
        return "ExperienceHostingClickSaveAddressEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", product_info=" + this.product_info + ", operation=" + this.operation + ", dates=" + this.dates + ", address=" + this.address + "}";
    }
