...
/* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingScheduleScrollUpNextEvent */
public final class ExperienceHostingScheduleScrollUpNextEvent implements Struct {
    public static final Adapter<ExperienceHostingScheduleScrollUpNextEvent, Object> ADAPTER = new ExperienceHostingScheduleScrollUpNextEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingScheduleScrollUpNextEvent$ExperienceHostingScheduleScrollUpNextEventAdapter */
    private static final class ExperienceHostingScheduleScrollUpNextEventAdapter implements Adapter<ExperienceHostingScheduleScrollUpNextEvent, Object> {
        private ExperienceHostingScheduleScrollUpNextEventAdapter() {
        }

        public void write(Protocol protocol, ExperienceHostingScheduleScrollUpNextEvent struct) throws IOException {
            protocol.writeStructBegin("ExperienceHostingScheduleScrollUpNextEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperienceHostingScheduleScrollUpNextEvent)) {
            return false;
        }
        ExperienceHostingScheduleScrollUpNextEvent that = (ExperienceHostingScheduleScrollUpNextEvent) other;
    ...
    public String toString() {
        return "ExperienceHostingScheduleScrollUpNextEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", operation=" + this.operation + ", direction=" + this.direction + ", max_scroll_item_index=" + this.max_scroll_item_index + "}";
    }
