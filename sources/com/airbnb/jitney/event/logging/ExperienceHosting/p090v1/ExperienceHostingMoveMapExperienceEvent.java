...
/* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingMoveMapExperienceEvent */
public final class ExperienceHostingMoveMapExperienceEvent implements Struct {
    public static final Adapter<ExperienceHostingMoveMapExperienceEvent, Object> ADAPTER = new ExperienceHostingMoveMapExperienceEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingMoveMapExperienceEvent$ExperienceHostingMoveMapExperienceEventAdapter */
    private static final class ExperienceHostingMoveMapExperienceEventAdapter implements Adapter<ExperienceHostingMoveMapExperienceEvent, Object> {
        private ExperienceHostingMoveMapExperienceEventAdapter() {
        }

        public void write(Protocol protocol, ExperienceHostingMoveMapExperienceEvent struct) throws IOException {
            protocol.writeStructBegin("ExperienceHostingMoveMapExperienceEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperienceHostingMoveMapExperienceEvent)) {
            return false;
        }
        ExperienceHostingMoveMapExperienceEvent that = (ExperienceHostingMoveMapExperienceEvent) other;
    ...
    public String toString() {
        return "ExperienceHostingMoveMapExperienceEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", operation=" + this.operation + ", lat_lng_box=" + this.lat_lng_box + ", product_info=" + this.product_info + ", map_provider=" + this.map_provider + ", dates=" + this.dates + "}";
    }
