...
/* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingDismissSelectDatesEvent */
public final class ExperienceHostingDismissSelectDatesEvent implements Struct {
    public static final Adapter<ExperienceHostingDismissSelectDatesEvent, Object> ADAPTER = new ExperienceHostingDismissSelectDatesEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingDismissSelectDatesEvent$ExperienceHostingDismissSelectDatesEventAdapter */
    private static final class ExperienceHostingDismissSelectDatesEventAdapter implements Adapter<ExperienceHostingDismissSelectDatesEvent, Object> {
        private ExperienceHostingDismissSelectDatesEventAdapter() {
        }

        public void write(Protocol protocol, ExperienceHostingDismissSelectDatesEvent struct) throws IOException {
            protocol.writeStructBegin("ExperienceHostingDismissSelectDatesEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperienceHostingDismissSelectDatesEvent)) {
            return false;
        }
        ExperienceHostingDismissSelectDatesEvent that = (ExperienceHostingDismissSelectDatesEvent) other;
    ...
    public String toString() {
        return "ExperienceHostingDismissSelectDatesEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", dates=" + this.dates + ", product_info=" + this.product_info + "}";
    }
