...
/* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickConfirmStartDatesEvent */
public final class ExperienceHostingClickConfirmStartDatesEvent implements Struct {
    public static final Adapter<ExperienceHostingClickConfirmStartDatesEvent, Object> ADAPTER = new ExperienceHostingClickConfirmStartDatesEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickConfirmStartDatesEvent$ExperienceHostingClickConfirmStartDatesEventAdapter */
    private static final class ExperienceHostingClickConfirmStartDatesEventAdapter implements Adapter<ExperienceHostingClickConfirmStartDatesEvent, Object> {
        private ExperienceHostingClickConfirmStartDatesEventAdapter() {
        }

        public void write(Protocol protocol, ExperienceHostingClickConfirmStartDatesEvent struct) throws IOException {
            protocol.writeStructBegin("ExperienceHostingClickConfirmStartDatesEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperienceHostingClickConfirmStartDatesEvent)) {
            return false;
        }
        ExperienceHostingClickConfirmStartDatesEvent that = (ExperienceHostingClickConfirmStartDatesEvent) other;
    ...
    public String toString() {
        return "ExperienceHostingClickConfirmStartDatesEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", product_info=" + this.product_info + ", operation=" + this.operation + ", dates=" + this.dates + "}";
    }
