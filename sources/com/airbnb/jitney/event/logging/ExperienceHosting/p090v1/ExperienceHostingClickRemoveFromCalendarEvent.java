...
/* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickRemoveFromCalendarEvent */
public final class ExperienceHostingClickRemoveFromCalendarEvent implements Struct {
    public static final Adapter<ExperienceHostingClickRemoveFromCalendarEvent, Object> ADAPTER = new ExperienceHostingClickRemoveFromCalendarEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickRemoveFromCalendarEvent$ExperienceHostingClickRemoveFromCalendarEventAdapter */
    private static final class ExperienceHostingClickRemoveFromCalendarEventAdapter implements Adapter<ExperienceHostingClickRemoveFromCalendarEvent, Object> {
        private ExperienceHostingClickRemoveFromCalendarEventAdapter() {
        }

        public void write(Protocol protocol, ExperienceHostingClickRemoveFromCalendarEvent struct) throws IOException {
            protocol.writeStructBegin("ExperienceHostingClickRemoveFromCalendarEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperienceHostingClickRemoveFromCalendarEvent)) {
            return false;
        }
        ExperienceHostingClickRemoveFromCalendarEvent that = (ExperienceHostingClickRemoveFromCalendarEvent) other;
    ...
    public String toString() {
        return "ExperienceHostingClickRemoveFromCalendarEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", product_info=" + this.product_info + ", operation=" + this.operation + ", dates=" + this.dates + "}";
    }
