...
/* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingScheduleScrollEvent */
public final class ExperienceHostingScheduleScrollEvent implements Struct {
    public static final Adapter<ExperienceHostingScheduleScrollEvent, Object> ADAPTER = new ExperienceHostingScheduleScrollEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingScheduleScrollEvent$ExperienceHostingScheduleScrollEventAdapter */
    private static final class ExperienceHostingScheduleScrollEventAdapter implements Adapter<ExperienceHostingScheduleScrollEvent, Object> {
        private ExperienceHostingScheduleScrollEventAdapter() {
        }

        public void write(Protocol protocol, ExperienceHostingScheduleScrollEvent struct) throws IOException {
            protocol.writeStructBegin("ExperienceHostingScheduleScrollEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperienceHostingScheduleScrollEvent)) {
            return false;
        }
        ExperienceHostingScheduleScrollEvent that = (ExperienceHostingScheduleScrollEvent) other;
    ...
    public String toString() {
        return "ExperienceHostingScheduleScrollEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", operation=" + this.operation + ", direction=" + this.direction + ", max_scroll_item_index=" + this.max_scroll_item_index + "}";
    }
