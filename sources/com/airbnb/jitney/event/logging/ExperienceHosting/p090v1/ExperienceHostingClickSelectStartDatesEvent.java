...
/* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickSelectStartDatesEvent */
public final class ExperienceHostingClickSelectStartDatesEvent implements Struct {
    public static final Adapter<ExperienceHostingClickSelectStartDatesEvent, Object> ADAPTER = new ExperienceHostingClickSelectStartDatesEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickSelectStartDatesEvent$ExperienceHostingClickSelectStartDatesEventAdapter */
    private static final class ExperienceHostingClickSelectStartDatesEventAdapter implements Adapter<ExperienceHostingClickSelectStartDatesEvent, Object> {
        private ExperienceHostingClickSelectStartDatesEventAdapter() {
        }

        public void write(Protocol protocol, ExperienceHostingClickSelectStartDatesEvent struct) throws IOException {
            protocol.writeStructBegin("ExperienceHostingClickSelectStartDatesEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperienceHostingClickSelectStartDatesEvent)) {
            return false;
        }
        ExperienceHostingClickSelectStartDatesEvent that = (ExperienceHostingClickSelectStartDatesEvent) other;
    ...
    public String toString() {
        return "ExperienceHostingClickSelectStartDatesEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", product_info=" + this.product_info + ", operation=" + this.operation + ", dates=" + this.dates + "}";
    }
