...
/* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingEarningsScrollEvent */
public final class ExperienceHostingEarningsScrollEvent implements Struct {
    public static final Adapter<ExperienceHostingEarningsScrollEvent, Object> ADAPTER = new ExperienceHostingEarningsScrollEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingEarningsScrollEvent$ExperienceHostingEarningsScrollEventAdapter */
    private static final class ExperienceHostingEarningsScrollEventAdapter implements Adapter<ExperienceHostingEarningsScrollEvent, Object> {
        private ExperienceHostingEarningsScrollEventAdapter() {
        }

        public void write(Protocol protocol, ExperienceHostingEarningsScrollEvent struct) throws IOException {
            protocol.writeStructBegin("ExperienceHostingEarningsScrollEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperienceHostingEarningsScrollEvent)) {
            return false;
        }
        ExperienceHostingEarningsScrollEvent that = (ExperienceHostingEarningsScrollEvent) other;
    ...
    public String toString() {
        return "ExperienceHostingEarningsScrollEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", operation=" + this.operation + ", direction=" + this.direction + ", max_scroll_item_index=" + this.max_scroll_item_index + "}";
    }
