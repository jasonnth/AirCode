...
/* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickEditLocationEvent */
public final class ExperienceHostingClickEditLocationEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickEditLocationEvent$ExperienceHostingClickEditLocationEventAdapter */
    private static final class ExperienceHostingClickEditLocationEventAdapter implements Adapter<ExperienceHostingClickEditLocationEvent, Object> {
        ...
        public void write(Protocol protocol, ExperienceHostingClickEditLocationEvent struct) throws IOException {
            ...
            if (struct.address != null) {
                protocol.writeFieldBegin("address", 8, PassportService.SF_DG12);
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperienceHostingClickEditLocationEvent)) {
            return false;
        }
        ExperienceHostingClickEditLocationEvent that = (ExperienceHostingClickEditLocationEvent) other;
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.page == that.page || this.page.equals(that.page)) && ((this.product_info == that.product_info || this.product_info.equals(that.product_info)) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.target == that.target || this.target.equals(that.target)) && ((this.dates == that.dates || this.dates.equals(that.dates)) && (this.address == that.address || (this.address != null && this.address.equals(that.address))))))))))) {
    ...
    public int hashCode() {
        ...
        int code = (((((((((((((((((16777619 ^ hashCode) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.page.hashCode()) * -2128831035) ^ this.product_info.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.target.hashCode()) * -2128831035) ^ this.dates.hashCode()) * -2128831035) ^ (this.address == null ? 0 : this.address.hashCode())) * -2128831035;
        if (this.text != null) {
