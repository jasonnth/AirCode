...
/* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickViewImmersionEvent */
public final class ExperienceHostingClickViewImmersionEvent implements Struct {
    public static final Adapter<ExperienceHostingClickViewImmersionEvent, Object> ADAPTER = new ExperienceHostingClickViewImmersionEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingClickViewImmersionEvent$ExperienceHostingClickViewImmersionEventAdapter */
    private static final class ExperienceHostingClickViewImmersionEventAdapter implements Adapter<ExperienceHostingClickViewImmersionEvent, Object> {
        private ExperienceHostingClickViewImmersionEventAdapter() {
        }

        public void write(Protocol protocol, ExperienceHostingClickViewImmersionEvent struct) throws IOException {
            protocol.writeStructBegin("ExperienceHostingClickViewImmersionEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperienceHostingClickViewImmersionEvent)) {
            return false;
        }
        ExperienceHostingClickViewImmersionEvent that = (ExperienceHostingClickViewImmersionEvent) other;
    ...
    public String toString() {
        return "ExperienceHostingClickViewImmersionEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", product_info=" + this.product_info + ", operation=" + this.operation + ", dates=" + this.dates + "}";
    }
