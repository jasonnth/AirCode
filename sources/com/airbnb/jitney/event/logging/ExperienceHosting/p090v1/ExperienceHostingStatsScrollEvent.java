...
/* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingStatsScrollEvent */
public final class ExperienceHostingStatsScrollEvent implements Struct {
    public static final Adapter<ExperienceHostingStatsScrollEvent, Object> ADAPTER = new ExperienceHostingStatsScrollEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperienceHosting.v1.ExperienceHostingStatsScrollEvent$ExperienceHostingStatsScrollEventAdapter */
    private static final class ExperienceHostingStatsScrollEventAdapter implements Adapter<ExperienceHostingStatsScrollEvent, Object> {
        private ExperienceHostingStatsScrollEventAdapter() {
        }

        public void write(Protocol protocol, ExperienceHostingStatsScrollEvent struct) throws IOException {
            protocol.writeStructBegin("ExperienceHostingStatsScrollEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperienceHostingStatsScrollEvent)) {
            return false;
        }
        ExperienceHostingStatsScrollEvent that = (ExperienceHostingStatsScrollEvent) other;
    ...
    public String toString() {
        return "ExperienceHostingStatsScrollEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", operation=" + this.operation + ", direction=" + this.direction + ", max_scroll_item_index=" + this.max_scroll_item_index + "}";
    }
