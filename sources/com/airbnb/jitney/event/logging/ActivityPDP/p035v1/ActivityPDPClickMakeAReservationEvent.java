...
/* renamed from: com.airbnb.jitney.event.logging.ActivityPDP.v1.ActivityPDPClickMakeAReservationEvent */
public final class ActivityPDPClickMakeAReservationEvent implements Struct {
    public static final Adapter<ActivityPDPClickMakeAReservationEvent, Builder> ADAPTER = new ActivityPDPClickMakeAReservationEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ActivityPDP.v1.ActivityPDPClickMakeAReservationEvent$ActivityPDPClickMakeAReservationEventAdapter */
    private static final class ActivityPDPClickMakeAReservationEventAdapter implements Adapter<ActivityPDPClickMakeAReservationEvent, Builder> {
        private ActivityPDPClickMakeAReservationEventAdapter() {
        }

        public void write(Protocol protocol, ActivityPDPClickMakeAReservationEvent struct) throws IOException {
            protocol.writeStructBegin("ActivityPDPClickMakeAReservationEvent");
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ActivityPDP.v1.ActivityPDPClickMakeAReservationEvent$Builder */
    public static final class Builder implements StructBuilder<ActivityPDPClickMakeAReservationEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.ActivityPDP:ActivityPDPClickMakeAReservationEvent:1.0.0";
            this.event_name = "activitypdp_click_make_a_reservation";
            this.page = "activity_pdp";
            this.target = "make_a_reservation";
        ...
        public ActivityPDPClickMakeAReservationEvent build() {
            if (this.event_name == null) {
                ...
                return new ActivityPDPClickMakeAReservationEvent(this);
            } else {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ActivityPDPClickMakeAReservationEvent)) {
            return false;
        }
        ActivityPDPClickMakeAReservationEvent that = (ActivityPDPClickMakeAReservationEvent) other;
    ...
    public String toString() {
        return "ActivityPDPClickMakeAReservationEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", mt_product_type=" + this.mt_product_type + ", mt_product_id=" + this.mt_product_id + "}";
    }
