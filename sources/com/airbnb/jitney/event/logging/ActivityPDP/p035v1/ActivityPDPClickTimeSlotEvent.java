...
/* renamed from: com.airbnb.jitney.event.logging.ActivityPDP.v1.ActivityPDPClickTimeSlotEvent */
public final class ActivityPDPClickTimeSlotEvent implements Struct {
    public static final Adapter<ActivityPDPClickTimeSlotEvent, Builder> ADAPTER = new ActivityPDPClickTimeSlotEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ActivityPDP.v1.ActivityPDPClickTimeSlotEvent$ActivityPDPClickTimeSlotEventAdapter */
    private static final class ActivityPDPClickTimeSlotEventAdapter implements Adapter<ActivityPDPClickTimeSlotEvent, Builder> {
        private ActivityPDPClickTimeSlotEventAdapter() {
        }

        public void write(Protocol protocol, ActivityPDPClickTimeSlotEvent struct) throws IOException {
            protocol.writeStructBegin("ActivityPDPClickTimeSlotEvent");
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ActivityPDP.v1.ActivityPDPClickTimeSlotEvent$Builder */
    public static final class Builder implements StructBuilder<ActivityPDPClickTimeSlotEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.ActivityPDP:ActivityPDPClickTimeSlotEvent:1.0.0";
            this.event_name = "activitypdp_click_time_slot";
        ...
        public Builder(Context context2, Long mt_product_id2, C2757TimeSlotInfo time_slot_info2) {
            this.schema = "com.airbnb.jitney.event.logging.ActivityPDP:ActivityPDPClickTimeSlotEvent:1.0.0";
            this.event_name = "activitypdp_click_time_slot";
        ...
        public ActivityPDPClickTimeSlotEvent build() {
            if (this.event_name == null) {
                ...
                return new ActivityPDPClickTimeSlotEvent(this);
            } else {
    ...
    private ActivityPDPClickTimeSlotEvent(Builder builder) {
    ...
    public String toString() {
        return "ActivityPDPClickTimeSlotEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", mt_product_type=" + this.mt_product_type + ", mt_product_id=" + this.mt_product_id + ", time_slot_info=" + this.time_slot_info + "}";
    }
