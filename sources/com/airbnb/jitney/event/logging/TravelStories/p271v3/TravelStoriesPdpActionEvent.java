package com.airbnb.jitney.event.logging.TravelStories.p271v3;
...
/* renamed from: com.airbnb.jitney.event.logging.TravelStories.v3.TravelStoriesPdpActionEvent */
public final class TravelStoriesPdpActionEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.TravelStories.v3.TravelStoriesPdpActionEvent$TravelStoriesPdpActionEventAdapter */
    private static final class TravelStoriesPdpActionEventAdapter implements Adapter<TravelStoriesPdpActionEvent, Object> {
        ...
        public void write(Protocol protocol, TravelStoriesPdpActionEvent struct) throws IOException {
            ...
            if (struct.is_trip_summary != null) {
                protocol.writeFieldBegin("is_trip_summary", 10, 2);
    ...
    public boolean equals(Object other) {
        ...
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.travel_stories_entry_point == that.travel_stories_entry_point || this.travel_stories_entry_point.equals(that.travel_stories_entry_point)) && ((this.travel_stories_id == that.travel_stories_id || this.travel_stories_id.equals(that.travel_stories_id)) && ((this.travel_stories_slide == that.travel_stories_slide || (this.travel_stories_slide != null && this.travel_stories_slide.equals(that.travel_stories_slide))) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.target == that.target || this.target.equals(that.target)) && ((this.target_item_type == that.target_item_type || (this.target_item_type != null && this.target_item_type.equals(that.target_item_type))) && (this.target_item_id == that.target_item_id || (this.target_item_id != null && this.target_item_id.equals(that.target_item_id)))))))))))) {
            if (this.is_trip_summary == that.is_trip_summary) {
                return true;
            }
            if (this.is_trip_summary != null && this.is_trip_summary.equals(that.is_trip_summary)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        int i = 0;
        int code = (((((((((((((((((((16777619 ^ (this.schema == null ? 0 : this.schema.hashCode())) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.travel_stories_entry_point.hashCode()) * -2128831035) ^ this.travel_stories_id.hashCode()) * -2128831035) ^ (this.travel_stories_slide == null ? 0 : this.travel_stories_slide.hashCode())) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.target.hashCode()) * -2128831035) ^ (this.target_item_type == null ? 0 : this.target_item_type.hashCode())) * -2128831035) ^ (this.target_item_id == null ? 0 : this.target_item_id.hashCode())) * -2128831035;
        if (this.is_trip_summary != null) {
            i = this.is_trip_summary.hashCode();
        }
