...
/* renamed from: com.airbnb.jitney.event.logging.Message.v1.MessageThreadTakePhotoEvent */
public final class MessageThreadTakePhotoEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Message.v1.MessageThreadTakePhotoEvent$Builder */
    public static final class Builder implements StructBuilder<MessageThreadTakePhotoEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Message:MessageThreadTakePhotoEvent:1.0.0";
            this.event_name = "message_thread_take_photo";
            this.page = "message_thread";
            this.target = "take_a_photo";
            this.operation = "click";
        }

        public Builder(Context context2, Long message_thread_id2, String user_role2, String inbox_type2) {
            this.schema = "com.airbnb.jitney.event.logging.Message:MessageThreadTakePhotoEvent:1.0.0";
            this.event_name = "message_thread_take_photo";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Message.v1.MessageThreadTakePhotoEvent$MessageThreadTakePhotoEventAdapter */
    private static final class MessageThreadTakePhotoEventAdapter implements Adapter<MessageThreadTakePhotoEvent, Builder> {
        ...
        public void write(Protocol protocol, MessageThreadTakePhotoEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MessageThreadTakePhotoEvent)) {
            return false;
        }
        MessageThreadTakePhotoEvent that = (MessageThreadTakePhotoEvent) other;
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.page == that.page || this.page.equals(that.page)) && ((this.target == that.target || this.target.equals(that.target)) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.listing_id == that.listing_id || (this.listing_id != null && this.listing_id.equals(that.listing_id))) && ((this.message_thread_id == that.message_thread_id || this.message_thread_id.equals(that.message_thread_id)) && ((this.user_role == that.user_role || this.user_role.equals(that.user_role)) && (this.inbox_type == that.inbox_type || this.inbox_type.equals(that.inbox_type))))))))))) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((code ^ i) * -2128831035) ^ this.message_thread_id.hashCode()) * -2128831035) ^ this.user_role.hashCode()) * -2128831035) ^ this.inbox_type.hashCode()) * -2128831035;
    }
