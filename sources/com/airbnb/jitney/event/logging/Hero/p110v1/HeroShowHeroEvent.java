...
/* renamed from: com.airbnb.jitney.event.logging.Hero.v1.HeroShowHeroEvent */
public final class HeroShowHeroEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Hero.v1.HeroShowHeroEvent$HeroShowHeroEventAdapter */
    ...
    public int hashCode() {
        ...
        return (((code ^ i) * -2128831035) ^ this.is_timed.hashCode()) * -2128831035;
    }

    public String toString() {
        return "HeroShowHeroEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", text=" + this.text + ", button_texts=" + this.button_texts + ", subtab=" + this.subtab + ", is_timed=" + this.is_timed + "}";
    }
