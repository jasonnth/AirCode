...
/* renamed from: com.airbnb.jitney.event.logging.Hero.v2.HeroDismissHeroEvent */
public final class HeroDismissHeroEvent implements Struct {
    public static final Adapter<HeroDismissHeroEvent, Builder> ADAPTER = new HeroDismissHeroEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Hero.v2.HeroDismissHeroEvent$Builder */
    public static final class Builder implements StructBuilder<HeroDismissHeroEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Hero:HeroDismissHeroEvent:2.1.0";
            this.event_name = "hero_dismiss_hero";
            this.operation = C2451Operation.Dismiss;
        }

        public Builder(Context context2, String page2, String target2, C2205HeroContext hero_context2) {
            this.schema = "com.airbnb.jitney.event.logging.Hero:HeroDismissHeroEvent:2.1.0";
            this.event_name = "hero_dismiss_hero";
        ...
        public HeroDismissHeroEvent build() {
            if (this.event_name == null) {
                ...
                return new HeroDismissHeroEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Hero.v2.HeroDismissHeroEvent$HeroDismissHeroEventAdapter */
    private static final class HeroDismissHeroEventAdapter implements Adapter<HeroDismissHeroEvent, Builder> {
    ...
    private HeroDismissHeroEvent(Builder builder) {
    ...
    public String toString() {
        return "HeroDismissHeroEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", hero_context=" + this.hero_context + ", subtab=" + this.subtab + "}";
    }
