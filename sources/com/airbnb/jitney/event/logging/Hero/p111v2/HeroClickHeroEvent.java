...
/* renamed from: com.airbnb.jitney.event.logging.Hero.v2.HeroClickHeroEvent */
public final class HeroClickHeroEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Hero.v2.HeroClickHeroEvent$HeroClickHeroEventAdapter */
    ...
    public String toString() {
        return "HeroClickHeroEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", hero_context=" + this.hero_context + ", subtab=" + this.subtab + "}";
    }
