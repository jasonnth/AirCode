...
/* renamed from: com.airbnb.jitney.event.logging.Hero.v2.HeroCacheHeroEvent */
public final class HeroCacheHeroEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Hero.v2.HeroCacheHeroEvent$HeroCacheHeroEventAdapter */
    ...
    public String toString() {
        return "HeroCacheHeroEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", hero_context=" + this.hero_context + ", subtab=" + this.subtab + "}";
    }
