...
/* renamed from: com.airbnb.jitney.event.logging.Hero.v3.HeroScheduleHeroEvent */
public final class HeroScheduleHeroEvent implements Struct {
    public static final Adapter<HeroScheduleHeroEvent, Builder> ADAPTER = new HeroScheduleHeroEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Hero.v3.HeroScheduleHeroEvent$Builder */
    public static final class Builder implements StructBuilder<HeroScheduleHeroEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Hero:HeroScheduleHeroEvent:3.1.0";
            this.event_name = "hero_schedule_hero";
            this.operation = C2451Operation.Schedule;
        }
        ...
        public HeroScheduleHeroEvent build() {
            if (this.event_name == null) {
                ...
                return new HeroScheduleHeroEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Hero.v3.HeroScheduleHeroEvent$HeroScheduleHeroEventAdapter */
    private static final class HeroScheduleHeroEventAdapter implements Adapter<HeroScheduleHeroEvent, Builder> {
    ...
    private HeroScheduleHeroEvent(Builder builder) {
    ...
    public String toString() {
        return "HeroScheduleHeroEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", target=" + this.target + ", operation=" + this.operation + ", hero_context=" + this.hero_context + ", subtab=" + this.subtab + "}";
    }
