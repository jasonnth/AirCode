...
/* renamed from: com.airbnb.jitney.event.logging.Hero.v3.HeroShowHeroEvent */
public final class HeroShowHeroEvent implements Struct {
    public static final Adapter<HeroShowHeroEvent, Builder> ADAPTER = new HeroShowHeroEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Hero.v3.HeroShowHeroEvent$Builder */
    public static final class Builder implements StructBuilder<HeroShowHeroEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Hero:HeroShowHeroEvent:3.1.0";
            this.event_name = "hero_show_hero";
        ...
        public HeroShowHeroEvent build() {
            if (this.event_name == null) {
                ...
                return new HeroShowHeroEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Hero.v3.HeroShowHeroEvent$HeroShowHeroEventAdapter */
    private static final class HeroShowHeroEventAdapter implements Adapter<HeroShowHeroEvent, Builder> {
        private HeroShowHeroEventAdapter() {
        }

        public void write(Protocol protocol, HeroShowHeroEvent struct) throws IOException {
    ...
    private HeroShowHeroEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof HeroShowHeroEvent)) {
            return false;
        }
        HeroShowHeroEvent that = (HeroShowHeroEvent) other;
    ...
    public String toString() {
        return "HeroShowHeroEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", target=" + this.target + ", operation=" + this.operation + ", hero_context=" + this.hero_context + ", subtab=" + this.subtab + "}";
    }
