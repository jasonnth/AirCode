...
/* renamed from: com.airbnb.jitney.event.logging.Hero.v3.HeroCacheHeroEvent */
public final class HeroCacheHeroEvent implements Struct {
    public static final Adapter<HeroCacheHeroEvent, Builder> ADAPTER = new HeroCacheHeroEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Hero.v3.HeroCacheHeroEvent$Builder */
    public static final class Builder implements StructBuilder<HeroCacheHeroEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Hero:HeroCacheHeroEvent:3.1.0";
            this.event_name = "hero_cache_hero";
            this.operation = C2451Operation.Cache;
        }
        ...
        public HeroCacheHeroEvent build() {
            if (this.event_name == null) {
                ...
                return new HeroCacheHeroEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Hero.v3.HeroCacheHeroEvent$HeroCacheHeroEventAdapter */
    private static final class HeroCacheHeroEventAdapter implements Adapter<HeroCacheHeroEvent, Builder> {
    ...
    private HeroCacheHeroEvent(Builder builder) {
    ...
    public String toString() {
        return "HeroCacheHeroEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", target=" + this.target + ", operation=" + this.operation + ", hero_context=" + this.hero_context + ", subtab=" + this.subtab + "}";
    }
