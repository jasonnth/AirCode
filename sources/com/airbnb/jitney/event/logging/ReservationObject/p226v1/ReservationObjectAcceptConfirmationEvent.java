...
/* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v1.ReservationObjectAcceptConfirmationEvent */
public final class ReservationObjectAcceptConfirmationEvent implements Struct {
    public static final Adapter<ReservationObjectAcceptConfirmationEvent, Builder> ADAPTER = new ReservationObjectAcceptConfirmationEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v1.ReservationObjectAcceptConfirmationEvent$Builder */
    public static final class Builder implements StructBuilder<ReservationObjectAcceptConfirmationEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.ReservationObject:ReservationObjectAcceptConfirmationEvent:1.0.0";
            this.event_name = "reservation_object_accept_confirmation";
            this.page = "accept_confirmation";
            this.target = "accept";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v1.ReservationObjectAcceptConfirmationEvent$ReservationObjectAcceptConfirmationEventAdapter */
    private static final class ReservationObjectAcceptConfirmationEventAdapter implements Adapter<ReservationObjectAcceptConfirmationEvent, Builder> {
        private ReservationObjectAcceptConfirmationEventAdapter() {
        }

        public void write(Protocol protocol, ReservationObjectAcceptConfirmationEvent struct) throws IOException {
            protocol.writeStructBegin("ReservationObjectAcceptConfirmationEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ReservationObjectAcceptConfirmationEvent)) {
            return false;
        }
        ReservationObjectAcceptConfirmationEvent that = (ReservationObjectAcceptConfirmationEvent) other;
    ...
    public String toString() {
        return "ReservationObjectAcceptConfirmationEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", reservation_id=" + this.reservation_id + "}";
    }
