...
/* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v1.ReservationObjectDeclineConfirmationEvent */
public final class ReservationObjectDeclineConfirmationEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v1.ReservationObjectDeclineConfirmationEvent$ReservationObjectDeclineConfirmationEventAdapter */
    ...
    public String toString() {
        return "ReservationObjectDeclineConfirmationEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", reservation_id=" + this.reservation_id + "}";
    }
