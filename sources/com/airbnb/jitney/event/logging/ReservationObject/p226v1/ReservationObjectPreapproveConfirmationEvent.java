...
/* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v1.ReservationObjectPreapproveConfirmationEvent */
public final class ReservationObjectPreapproveConfirmationEvent implements Struct {
    public static final Adapter<ReservationObjectPreapproveConfirmationEvent, Object> ADAPTER = new ReservationObjectPreapproveConfirmationEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v1.ReservationObjectPreapproveConfirmationEvent$ReservationObjectPreapproveConfirmationEventAdapter */
    private static final class ReservationObjectPreapproveConfirmationEventAdapter implements Adapter<ReservationObjectPreapproveConfirmationEvent, Object> {
    ...
    public String toString() {
        return "ReservationObjectPreapproveConfirmationEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", reservation_id=" + this.reservation_id + "}";
    }
