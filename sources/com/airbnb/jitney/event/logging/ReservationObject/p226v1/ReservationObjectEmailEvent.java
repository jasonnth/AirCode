...
/* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v1.ReservationObjectEmailEvent */
public final class ReservationObjectEmailEvent implements Struct {
    public static final Adapter<ReservationObjectEmailEvent, Builder> ADAPTER = new ReservationObjectEmailEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v1.ReservationObjectEmailEvent$Builder */
    public static final class Builder implements StructBuilder<ReservationObjectEmailEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.ReservationObject:ReservationObjectEmailEvent:1.0.0";
            this.event_name = "reservation_object_email";
        ...
        public ReservationObjectEmailEvent build() {
            if (this.event_name == null) {
                ...
                return new ReservationObjectEmailEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v1.ReservationObjectEmailEvent$ReservationObjectEmailEventAdapter */
    private static final class ReservationObjectEmailEventAdapter implements Adapter<ReservationObjectEmailEvent, Builder> {
        private ReservationObjectEmailEventAdapter() {
        }

        public void write(Protocol protocol, ReservationObjectEmailEvent struct) throws IOException {
            protocol.writeStructBegin("ReservationObjectEmailEvent");
    ...
    private ReservationObjectEmailEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ReservationObjectEmailEvent)) {
            return false;
        }
        ReservationObjectEmailEvent that = (ReservationObjectEmailEvent) other;
    ...
    public String toString() {
        return "ReservationObjectEmailEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", reservation_id=" + this.reservation_id + "}";
    }
