...
/* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v1.ReservationObjectDeclineEvent */
public final class ReservationObjectDeclineEvent implements Struct {
    public static final Adapter<ReservationObjectDeclineEvent, Object> ADAPTER = new ReservationObjectDeclineEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v1.ReservationObjectDeclineEvent$ReservationObjectDeclineEventAdapter */
    private static final class ReservationObjectDeclineEventAdapter implements Adapter<ReservationObjectDeclineEvent, Object> {
    ...
    public String toString() {
        return "ReservationObjectDeclineEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", reservation_id=" + this.reservation_id + "}";
    }
