...
/* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v2.ReservationObjectPreapproveEvent */
public final class ReservationObjectPreapproveEvent implements Struct {
    public static final Adapter<ReservationObjectPreapproveEvent, Builder> ADAPTER = new ReservationObjectPreapproveEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v2.ReservationObjectPreapproveEvent$Builder */
    public static final class Builder implements StructBuilder<ReservationObjectPreapproveEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.ReservationObject:ReservationObjectPreapproveEvent:2.0.0";
            this.event_name = "reservation_object_preapprove";
        ...
        public ReservationObjectPreapproveEvent build() {
            if (this.event_name == null) {
                ...
                return new ReservationObjectPreapproveEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v2.ReservationObjectPreapproveEvent$ReservationObjectPreapproveEventAdapter */
    private static final class ReservationObjectPreapproveEventAdapter implements Adapter<ReservationObjectPreapproveEvent, Builder> {
    ...
    private ReservationObjectPreapproveEvent(Builder builder) {
    ...
    public String toString() {
        return "ReservationObjectPreapproveEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", message_thread_id=" + this.message_thread_id + "}";
    }
