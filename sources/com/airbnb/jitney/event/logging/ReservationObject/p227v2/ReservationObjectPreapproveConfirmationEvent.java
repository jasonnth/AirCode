...
/* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v2.ReservationObjectPreapproveConfirmationEvent */
public final class ReservationObjectPreapproveConfirmationEvent implements Struct {
    public static final Adapter<ReservationObjectPreapproveConfirmationEvent, Builder> ADAPTER = new ReservationObjectPreapproveConfirmationEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v2.ReservationObjectPreapproveConfirmationEvent$Builder */
    public static final class Builder implements StructBuilder<ReservationObjectPreapproveConfirmationEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.ReservationObject:ReservationObjectPreapproveConfirmationEvent:2.0.0";
            this.event_name = "reservation_object_preapprove_confirmation";
            this.page = "preapprove_confirmation";
            this.target = "preapprove";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ReservationObject.v2.ReservationObjectPreapproveConfirmationEvent$ReservationObjectPreapproveConfirmationEventAdapter */
    private static final class ReservationObjectPreapproveConfirmationEventAdapter implements Adapter<ReservationObjectPreapproveConfirmationEvent, Builder> {
        private ReservationObjectPreapproveConfirmationEventAdapter() {
        }

        public void write(Protocol protocol, ReservationObjectPreapproveConfirmationEvent struct) throws IOException {
            protocol.writeStructBegin("ReservationObjectPreapproveConfirmationEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ReservationObjectPreapproveConfirmationEvent)) {
            return false;
        }
        ReservationObjectPreapproveConfirmationEvent that = (ReservationObjectPreapproveConfirmationEvent) other;
    ...
    public String toString() {
        return "ReservationObjectPreapproveConfirmationEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", message_thread_id=" + this.message_thread_id + "}";
    }
