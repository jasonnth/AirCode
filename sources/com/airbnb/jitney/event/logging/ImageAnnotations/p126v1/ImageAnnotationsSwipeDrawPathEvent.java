...
/* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsSwipeDrawPathEvent */
public final class ImageAnnotationsSwipeDrawPathEvent implements Struct {
    public static final Adapter<ImageAnnotationsSwipeDrawPathEvent, Builder> ADAPTER = new ImageAnnotationsSwipeDrawPathEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsSwipeDrawPathEvent$Builder */
    public static final class Builder implements StructBuilder<ImageAnnotationsSwipeDrawPathEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.ImageAnnotations:ImageAnnotationsSwipeDrawPathEvent:1.0.0";
            this.event_name = "imageannotations_swipe_draw_path";
        ...
        public ImageAnnotationsSwipeDrawPathEvent build() {
            if (this.event_name == null) {
                ...
                return new ImageAnnotationsSwipeDrawPathEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsSwipeDrawPathEvent$ImageAnnotationsSwipeDrawPathEventAdapter */
    private static final class ImageAnnotationsSwipeDrawPathEventAdapter implements Adapter<ImageAnnotationsSwipeDrawPathEvent, Builder> {
        private ImageAnnotationsSwipeDrawPathEventAdapter() {
        }

        public void write(Protocol protocol, ImageAnnotationsSwipeDrawPathEvent struct) throws IOException {
            protocol.writeStructBegin("ImageAnnotationsSwipeDrawPathEvent");
    ...
    private ImageAnnotationsSwipeDrawPathEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ImageAnnotationsSwipeDrawPathEvent)) {
            return false;
        }
        ImageAnnotationsSwipeDrawPathEvent that = (ImageAnnotationsSwipeDrawPathEvent) other;
    ...
    public String toString() {
        return "ImageAnnotationsSwipeDrawPathEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", is_host_mode=" + this.is_host_mode + ", image_annotations_page=" + this.image_annotations_page + ", operation=" + this.operation + "}";
    }
