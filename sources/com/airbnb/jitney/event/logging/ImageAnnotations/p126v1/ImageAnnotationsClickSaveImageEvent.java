...
/* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsClickSaveImageEvent */
public final class ImageAnnotationsClickSaveImageEvent implements Struct {
    public static final Adapter<ImageAnnotationsClickSaveImageEvent, Builder> ADAPTER = new ImageAnnotationsClickSaveImageEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsClickSaveImageEvent$Builder */
    public static final class Builder implements StructBuilder<ImageAnnotationsClickSaveImageEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.ImageAnnotations:ImageAnnotationsClickSaveImageEvent:1.0.0";
            this.event_name = "imageannotations_click_save_image";
        ...
        public ImageAnnotationsClickSaveImageEvent build() {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsClickSaveImageEvent$ImageAnnotationsClickSaveImageEventAdapter */
    private static final class ImageAnnotationsClickSaveImageEventAdapter implements Adapter<ImageAnnotationsClickSaveImageEvent, Builder> {
        private ImageAnnotationsClickSaveImageEventAdapter() {
        }

        public void write(Protocol protocol, ImageAnnotationsClickSaveImageEvent struct) throws IOException {
            protocol.writeStructBegin("ImageAnnotationsClickSaveImageEvent");
    ...
    private ImageAnnotationsClickSaveImageEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ImageAnnotationsClickSaveImageEvent)) {
            return false;
        }
        ImageAnnotationsClickSaveImageEvent that = (ImageAnnotationsClickSaveImageEvent) other;
    ...
    public String toString() {
        return "ImageAnnotationsClickSaveImageEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", is_host_mode=" + this.is_host_mode + ", image_annotations_page=" + this.image_annotations_page + ", operation=" + this.operation + "}";
    }
