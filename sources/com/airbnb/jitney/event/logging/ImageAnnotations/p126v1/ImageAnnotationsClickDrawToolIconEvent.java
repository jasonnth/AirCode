...
/* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsClickDrawToolIconEvent */
public final class ImageAnnotationsClickDrawToolIconEvent implements Struct {
    public static final Adapter<ImageAnnotationsClickDrawToolIconEvent, Builder> ADAPTER = new ImageAnnotationsClickDrawToolIconEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsClickDrawToolIconEvent$Builder */
    public static final class Builder implements StructBuilder<ImageAnnotationsClickDrawToolIconEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.ImageAnnotations:ImageAnnotationsClickDrawToolIconEvent:1.0.0";
            this.event_name = "imageannotations_click_draw_tool_icon";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsClickDrawToolIconEvent$ImageAnnotationsClickDrawToolIconEventAdapter */
    private static final class ImageAnnotationsClickDrawToolIconEventAdapter implements Adapter<ImageAnnotationsClickDrawToolIconEvent, Builder> {
        private ImageAnnotationsClickDrawToolIconEventAdapter() {
        }

        public void write(Protocol protocol, ImageAnnotationsClickDrawToolIconEvent struct) throws IOException {
            protocol.writeStructBegin("ImageAnnotationsClickDrawToolIconEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ImageAnnotationsClickDrawToolIconEvent)) {
            return false;
        }
        ImageAnnotationsClickDrawToolIconEvent that = (ImageAnnotationsClickDrawToolIconEvent) other;
    ...
    public String toString() {
        return "ImageAnnotationsClickDrawToolIconEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", is_host_mode=" + this.is_host_mode + ", image_annotations_page=" + this.image_annotations_page + ", operation=" + this.operation + "}";
    }
