...
/* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsClickDrawToolUndoEvent */
public final class ImageAnnotationsClickDrawToolUndoEvent implements Struct {
    public static final Adapter<ImageAnnotationsClickDrawToolUndoEvent, Builder> ADAPTER = new ImageAnnotationsClickDrawToolUndoEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsClickDrawToolUndoEvent$Builder */
    public static final class Builder implements StructBuilder<ImageAnnotationsClickDrawToolUndoEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.ImageAnnotations:ImageAnnotationsClickDrawToolUndoEvent:1.0.0";
            this.event_name = "imageannotations_click_draw_tool_undo";
        ...
        public ImageAnnotationsClickDrawToolUndoEvent build() {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsClickDrawToolUndoEvent$ImageAnnotationsClickDrawToolUndoEventAdapter */
    private static final class ImageAnnotationsClickDrawToolUndoEventAdapter implements Adapter<ImageAnnotationsClickDrawToolUndoEvent, Builder> {
        private ImageAnnotationsClickDrawToolUndoEventAdapter() {
        }

        public void write(Protocol protocol, ImageAnnotationsClickDrawToolUndoEvent struct) throws IOException {
            protocol.writeStructBegin("ImageAnnotationsClickDrawToolUndoEvent");
    ...
    private ImageAnnotationsClickDrawToolUndoEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ImageAnnotationsClickDrawToolUndoEvent)) {
            return false;
        }
        ImageAnnotationsClickDrawToolUndoEvent that = (ImageAnnotationsClickDrawToolUndoEvent) other;
    ...
    public String toString() {
        return "ImageAnnotationsClickDrawToolUndoEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", is_host_mode=" + this.is_host_mode + ", image_annotations_page=" + this.image_annotations_page + ", operation=" + this.operation + "}";
    }
