...
/* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsClickCropImageEvent */
public final class ImageAnnotationsClickCropImageEvent implements Struct {
    public static final Adapter<ImageAnnotationsClickCropImageEvent, Builder> ADAPTER = new ImageAnnotationsClickCropImageEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsClickCropImageEvent$Builder */
    public static final class Builder implements StructBuilder<ImageAnnotationsClickCropImageEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.ImageAnnotations:ImageAnnotationsClickCropImageEvent:1.0.0";
            this.event_name = "imageannotations_click_crop_image";
        ...
        public ImageAnnotationsClickCropImageEvent build() {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsClickCropImageEvent$ImageAnnotationsClickCropImageEventAdapter */
    private static final class ImageAnnotationsClickCropImageEventAdapter implements Adapter<ImageAnnotationsClickCropImageEvent, Builder> {
        private ImageAnnotationsClickCropImageEventAdapter() {
        }

        public void write(Protocol protocol, ImageAnnotationsClickCropImageEvent struct) throws IOException {
            protocol.writeStructBegin("ImageAnnotationsClickCropImageEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ImageAnnotationsClickCropImageEvent)) {
            return false;
        }
        ImageAnnotationsClickCropImageEvent that = (ImageAnnotationsClickCropImageEvent) other;
    ...
    public String toString() {
        return "ImageAnnotationsClickCropImageEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", is_host_mode=" + this.is_host_mode + ", image_annotations_page=" + this.image_annotations_page + ", operation=" + this.operation + "}";
    }
