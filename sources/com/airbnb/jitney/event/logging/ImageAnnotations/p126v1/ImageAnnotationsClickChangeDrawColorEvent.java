...
/* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsClickChangeDrawColorEvent */
public final class ImageAnnotationsClickChangeDrawColorEvent implements Struct {
    public static final Adapter<ImageAnnotationsClickChangeDrawColorEvent, Builder> ADAPTER = new ImageAnnotationsClickChangeDrawColorEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsClickChangeDrawColorEvent$Builder */
    public static final class Builder implements StructBuilder<ImageAnnotationsClickChangeDrawColorEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.ImageAnnotations:ImageAnnotationsClickChangeDrawColorEvent:1.0.0";
            this.event_name = "imageannotations_click_change_draw_color";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ImageAnnotations.v1.ImageAnnotationsClickChangeDrawColorEvent$ImageAnnotationsClickChangeDrawColorEventAdapter */
    private static final class ImageAnnotationsClickChangeDrawColorEventAdapter implements Adapter<ImageAnnotationsClickChangeDrawColorEvent, Builder> {
        private ImageAnnotationsClickChangeDrawColorEventAdapter() {
        }

        public void write(Protocol protocol, ImageAnnotationsClickChangeDrawColorEvent struct) throws IOException {
            protocol.writeStructBegin("ImageAnnotationsClickChangeDrawColorEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ImageAnnotationsClickChangeDrawColorEvent)) {
            return false;
        }
        ImageAnnotationsClickChangeDrawColorEvent that = (ImageAnnotationsClickChangeDrawColorEvent) other;
    ...
    public String toString() {
        return "ImageAnnotationsClickChangeDrawColorEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", is_host_mode=" + this.is_host_mode + ", image_annotations_page=" + this.image_annotations_page + ", operation=" + this.operation + "}";
    }
