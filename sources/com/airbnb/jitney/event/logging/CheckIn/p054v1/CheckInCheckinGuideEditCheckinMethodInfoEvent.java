...
/* renamed from: com.airbnb.jitney.event.logging.CheckIn.v1.CheckInCheckinGuideEditCheckinMethodInfoEvent */
public final class CheckInCheckinGuideEditCheckinMethodInfoEvent implements Struct {
    public static final Adapter<CheckInCheckinGuideEditCheckinMethodInfoEvent, Builder> ADAPTER = new CheckInCheckinGuideEditCheckinMethodInfoEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.CheckIn.v1.CheckInCheckinGuideEditCheckinMethodInfoEvent$Builder */
    public static final class Builder implements StructBuilder<CheckInCheckinGuideEditCheckinMethodInfoEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.CheckIn:CheckInCheckinGuideEditCheckinMethodInfoEvent:1.0.0";
            this.event_name = "checkin_checkin_guide_edit_checkin_method_info";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.CheckIn.v1.CheckInCheckinGuideEditCheckinMethodInfoEvent$CheckInCheckinGuideEditCheckinMethodInfoEventAdapter */
    private static final class CheckInCheckinGuideEditCheckinMethodInfoEventAdapter implements Adapter<CheckInCheckinGuideEditCheckinMethodInfoEvent, Builder> {
        private CheckInCheckinGuideEditCheckinMethodInfoEventAdapter() {
        }

        public void write(Protocol protocol, CheckInCheckinGuideEditCheckinMethodInfoEvent struct) throws IOException {
            protocol.writeStructBegin("CheckInCheckinGuideEditCheckinMethodInfoEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CheckInCheckinGuideEditCheckinMethodInfoEvent)) {
            return false;
        }
        CheckInCheckinGuideEditCheckinMethodInfoEvent that = (CheckInCheckinGuideEditCheckinMethodInfoEvent) other;
    ...
    public String toString() {
        return "CheckInCheckinGuideEditCheckinMethodInfoEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", amenity_id=" + this.amenity_id + ", listing_id=" + this.listing_id + "}";
    }
