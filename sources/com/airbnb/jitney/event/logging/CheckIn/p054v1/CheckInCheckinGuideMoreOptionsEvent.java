...
/* renamed from: com.airbnb.jitney.event.logging.CheckIn.v1.CheckInCheckinGuideMoreOptionsEvent */
public final class CheckInCheckinGuideMoreOptionsEvent implements Struct {
    public static final Adapter<CheckInCheckinGuideMoreOptionsEvent, Builder> ADAPTER = new CheckInCheckinGuideMoreOptionsEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.CheckIn.v1.CheckInCheckinGuideMoreOptionsEvent$Builder */
    public static final class Builder implements StructBuilder<CheckInCheckinGuideMoreOptionsEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.CheckIn:CheckInCheckinGuideMoreOptionsEvent:1.0.0";
            this.event_name = "checkin_checkin_guide_more_options";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.CheckIn.v1.CheckInCheckinGuideMoreOptionsEvent$CheckInCheckinGuideMoreOptionsEventAdapter */
    private static final class CheckInCheckinGuideMoreOptionsEventAdapter implements Adapter<CheckInCheckinGuideMoreOptionsEvent, Builder> {
        ...
        public void write(Protocol protocol, CheckInCheckinGuideMoreOptionsEvent struct) throws IOException {
            protocol.writeStructBegin("CheckInCheckinGuideMoreOptionsEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CheckInCheckinGuideMoreOptionsEvent)) {
            return false;
        }
        CheckInCheckinGuideMoreOptionsEvent that = (CheckInCheckinGuideMoreOptionsEvent) other;
    ...
    public String toString() {
        return "CheckInCheckinGuideMoreOptionsEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", listing_id=" + this.listing_id + "}";
    }
