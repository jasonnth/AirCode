...
/* renamed from: com.airbnb.jitney.event.logging.CheckIn.v1.CheckInCheckinGuideUpdateStepPhotoEvent */
public final class CheckInCheckinGuideUpdateStepPhotoEvent implements Struct {
    public static final Adapter<CheckInCheckinGuideUpdateStepPhotoEvent, Object> ADAPTER = new CheckInCheckinGuideUpdateStepPhotoEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.CheckIn.v1.CheckInCheckinGuideUpdateStepPhotoEvent$CheckInCheckinGuideUpdateStepPhotoEventAdapter */
    private static final class CheckInCheckinGuideUpdateStepPhotoEventAdapter implements Adapter<CheckInCheckinGuideUpdateStepPhotoEvent, Object> {
    ...
    public String toString() {
        return "CheckInCheckinGuideUpdateStepPhotoEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", step_id=" + this.step_id + ", listing_id=" + this.listing_id + "}";
    }
