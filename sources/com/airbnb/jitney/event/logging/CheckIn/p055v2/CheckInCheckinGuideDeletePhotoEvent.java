...
/* renamed from: com.airbnb.jitney.event.logging.CheckIn.v2.CheckInCheckinGuideDeletePhotoEvent */
public final class CheckInCheckinGuideDeletePhotoEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.CheckIn.v2.CheckInCheckinGuideDeletePhotoEvent$CheckInCheckinGuideDeletePhotoEventAdapter */
    ...
    public String toString() {
        return "CheckInCheckinGuideDeletePhotoEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", check_in_step_id=" + this.check_in_step_id + ", listing_id=" + this.listing_id + "}";
    }
