...
/* renamed from: com.airbnb.jitney.event.logging.CheckIn.v2.CheckInCheckinGuideDeleteStepEvent */
public final class CheckInCheckinGuideDeleteStepEvent implements Struct {
    public static final Adapter<CheckInCheckinGuideDeleteStepEvent, Builder> ADAPTER = new CheckInCheckinGuideDeleteStepEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.CheckIn.v2.CheckInCheckinGuideDeleteStepEvent$Builder */
    public static final class Builder implements StructBuilder<CheckInCheckinGuideDeleteStepEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.CheckIn:CheckInCheckinGuideDeleteStepEvent:2.0.0";
            this.event_name = "checkin_checkin_guide_delete_step";
        ...
        public CheckInCheckinGuideDeleteStepEvent build() {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.CheckIn.v2.CheckInCheckinGuideDeleteStepEvent$CheckInCheckinGuideDeleteStepEventAdapter */
    private static final class CheckInCheckinGuideDeleteStepEventAdapter implements Adapter<CheckInCheckinGuideDeleteStepEvent, Builder> {
        private CheckInCheckinGuideDeleteStepEventAdapter() {
        }

        public void write(Protocol protocol, CheckInCheckinGuideDeleteStepEvent struct) throws IOException {
            protocol.writeStructBegin("CheckInCheckinGuideDeleteStepEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CheckInCheckinGuideDeleteStepEvent)) {
            return false;
        }
        CheckInCheckinGuideDeleteStepEvent that = (CheckInCheckinGuideDeleteStepEvent) other;
    ...
    public String toString() {
        return "CheckInCheckinGuideDeleteStepEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", check_in_step_id=" + this.check_in_step_id + ", listing_id=" + this.listing_id + "}";
    }
