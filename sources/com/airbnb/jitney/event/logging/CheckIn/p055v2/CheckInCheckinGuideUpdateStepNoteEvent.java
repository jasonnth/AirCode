...
/* renamed from: com.airbnb.jitney.event.logging.CheckIn.v2.CheckInCheckinGuideUpdateStepNoteEvent */
public final class CheckInCheckinGuideUpdateStepNoteEvent implements Struct {
    public static final Adapter<CheckInCheckinGuideUpdateStepNoteEvent, Builder> ADAPTER = new CheckInCheckinGuideUpdateStepNoteEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.CheckIn.v2.CheckInCheckinGuideUpdateStepNoteEvent$Builder */
    public static final class Builder implements StructBuilder<CheckInCheckinGuideUpdateStepNoteEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.CheckIn:CheckInCheckinGuideUpdateStepNoteEvent:2.0.0";
            this.event_name = "checkin_checkin_guide_update_step_note";
        ...
        public CheckInCheckinGuideUpdateStepNoteEvent build() {
            if (this.event_name == null) {
                ...
                return new CheckInCheckinGuideUpdateStepNoteEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.CheckIn.v2.CheckInCheckinGuideUpdateStepNoteEvent$CheckInCheckinGuideUpdateStepNoteEventAdapter */
    private static final class CheckInCheckinGuideUpdateStepNoteEventAdapter implements Adapter<CheckInCheckinGuideUpdateStepNoteEvent, Builder> {
        private CheckInCheckinGuideUpdateStepNoteEventAdapter() {
        }

        public void write(Protocol protocol, CheckInCheckinGuideUpdateStepNoteEvent struct) throws IOException {
            protocol.writeStructBegin("CheckInCheckinGuideUpdateStepNoteEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CheckInCheckinGuideUpdateStepNoteEvent)) {
            return false;
        }
        CheckInCheckinGuideUpdateStepNoteEvent that = (CheckInCheckinGuideUpdateStepNoteEvent) other;
    ...
    public String toString() {
        return "CheckInCheckinGuideUpdateStepNoteEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", check_in_step_id=" + this.check_in_step_id + ", listing_id=" + this.listing_id + "}";
    }
