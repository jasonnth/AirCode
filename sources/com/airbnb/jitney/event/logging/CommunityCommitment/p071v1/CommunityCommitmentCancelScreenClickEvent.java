...
/* renamed from: com.airbnb.jitney.event.logging.CommunityCommitment.v1.CommunityCommitmentCancelScreenClickEvent */
public final class CommunityCommitmentCancelScreenClickEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.CommunityCommitment.v1.CommunityCommitmentCancelScreenClickEvent$Builder */
    public static final class Builder implements StructBuilder<CommunityCommitmentCancelScreenClickEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.CommunityCommitment:CommunityCommitmentCancelScreenClickEvent:1.0.0";
            this.event_name = "communitycommitment_cancel_screen_click";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.CommunityCommitment.v1.CommunityCommitmentCancelScreenClickEvent$CommunityCommitmentCancelScreenClickEventAdapter */
    private static final class CommunityCommitmentCancelScreenClickEventAdapter implements Adapter<CommunityCommitmentCancelScreenClickEvent, Builder> {
        ...
        public void write(Protocol protocol, CommunityCommitmentCancelScreenClickEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CommunityCommitmentCancelScreenClickEvent)) {
            return false;
        }
        CommunityCommitmentCancelScreenClickEvent that = (CommunityCommitmentCancelScreenClickEvent) other;
