...
/* renamed from: com.airbnb.jitney.event.logging.Inbox.v1.InboxMarkMessageArchivedEvent */
public final class InboxMarkMessageArchivedEvent implements Struct {
    public static final Adapter<InboxMarkMessageArchivedEvent, Builder> ADAPTER = new InboxMarkMessageArchivedEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Inbox.v1.InboxMarkMessageArchivedEvent$Builder */
    public static final class Builder implements StructBuilder<InboxMarkMessageArchivedEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Inbox:InboxMarkMessageArchivedEvent:1.0.0";
            this.event_name = "inbox_mark_message_archived";
            this.page = "inbox";
            this.target = "archive_message";
        ...
        public InboxMarkMessageArchivedEvent build() {
            if (this.event_name == null) {
                ...
                return new InboxMarkMessageArchivedEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Inbox.v1.InboxMarkMessageArchivedEvent$InboxMarkMessageArchivedEventAdapter */
    private static final class InboxMarkMessageArchivedEventAdapter implements Adapter<InboxMarkMessageArchivedEvent, Builder> {
        private InboxMarkMessageArchivedEventAdapter() {
        }

        public void write(Protocol protocol, InboxMarkMessageArchivedEvent struct) throws IOException {
            protocol.writeStructBegin("InboxMarkMessageArchivedEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof InboxMarkMessageArchivedEvent)) {
            return false;
        }
        InboxMarkMessageArchivedEvent that = (InboxMarkMessageArchivedEvent) other;
    ...
    public String toString() {
        return "InboxMarkMessageArchivedEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", message_thread_id=" + this.message_thread_id + ", user_role=" + this.user_role + "}";
    }
