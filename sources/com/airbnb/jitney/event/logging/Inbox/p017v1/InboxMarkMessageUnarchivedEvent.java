...
/* renamed from: com.airbnb.jitney.event.logging.Inbox.v1.InboxMarkMessageUnarchivedEvent */
public final class InboxMarkMessageUnarchivedEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Inbox.v1.InboxMarkMessageUnarchivedEvent$Builder */
    public static final class Builder implements StructBuilder<InboxMarkMessageUnarchivedEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Inbox:InboxMarkMessageUnarchivedEvent:1.0.0";
            this.event_name = "inbox_mark_message_unarchived";
            this.page = "inbox";
            this.target = "unarchive_message";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Inbox.v1.InboxMarkMessageUnarchivedEvent$InboxMarkMessageUnarchivedEventAdapter */
    private static final class InboxMarkMessageUnarchivedEventAdapter implements Adapter<InboxMarkMessageUnarchivedEvent, Builder> {
        ...
        public void write(Protocol protocol, InboxMarkMessageUnarchivedEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof InboxMarkMessageUnarchivedEvent)) {
            return false;
        }
        InboxMarkMessageUnarchivedEvent that = (InboxMarkMessageUnarchivedEvent) other;
