...
/* renamed from: com.airbnb.jitney.event.logging.Inbox.v1.InboxFetchInboxEvent */
public final class InboxFetchInboxEvent implements Struct {
    public static final Adapter<InboxFetchInboxEvent, Builder> ADAPTER = new InboxFetchInboxEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Inbox.v1.InboxFetchInboxEvent$Builder */
    public static final class Builder implements StructBuilder<InboxFetchInboxEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Inbox:InboxFetchInboxEvent:1.0.0";
            this.event_name = "inbox_fetch_inbox";
            this.page = "inbox";
        }
        ...
        public InboxFetchInboxEvent build() {
            if (this.event_name == null) {
                ...
                return new InboxFetchInboxEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Inbox.v1.InboxFetchInboxEvent$InboxFetchInboxEventAdapter */
    private static final class InboxFetchInboxEventAdapter implements Adapter<InboxFetchInboxEvent, Builder> {
        private InboxFetchInboxEventAdapter() {
        }

        public void write(Protocol protocol, InboxFetchInboxEvent struct) throws IOException {
            protocol.writeStructBegin("InboxFetchInboxEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof InboxFetchInboxEvent)) {
            return false;
        }
        InboxFetchInboxEvent that = (InboxFetchInboxEvent) other;
    ...
    public String toString() {
        return "InboxFetchInboxEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", request_state=" + this.request_state + ", user_role=" + this.user_role + ", inbox_type=" + this.inbox_type + "}";
    }
