package com.airbnb.jitney.event.logging.ReviewFlow.p234v4;
...
/* renamed from: com.airbnb.jitney.event.logging.ReviewFlow.v4.ReviewFlowToggleKeyWordsEvent */
public final class ReviewFlowToggleKeyWordsEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ReviewFlow.v4.ReviewFlowToggleKeyWordsEvent$ReviewFlowToggleKeyWordsEventAdapter */
    ...
    public int hashCode() {
        return (((((((((((((((((16777619 ^ (this.schema == null ? 0 : this.schema.hashCode())) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.page.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.section.hashCode()) * -2128831035) ^ this.schedulable_info.hashCode()) * -2128831035) ^ this.target.hashCode()) * -2128831035) ^ this.key_word_status.hashCode()) * -2128831035;
    }

    public String toString() {
        return "ReviewFlowToggleKeyWordsEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", section=" + this.section + ", schedulable_info=" + this.schedulable_info + ", target=" + this.target + ", key_word_status=" + this.key_word_status + "}";
    }
