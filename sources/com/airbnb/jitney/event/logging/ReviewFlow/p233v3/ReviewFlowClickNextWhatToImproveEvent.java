...
/* renamed from: com.airbnb.jitney.event.logging.ReviewFlow.v3.ReviewFlowClickNextWhatToImproveEvent */
public final class ReviewFlowClickNextWhatToImproveEvent implements Struct {
    public static final Adapter<ReviewFlowClickNextWhatToImproveEvent, Object> ADAPTER = new ReviewFlowClickNextWhatToImproveEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ReviewFlow.v3.ReviewFlowClickNextWhatToImproveEvent$ReviewFlowClickNextWhatToImproveEventAdapter */
    private static final class ReviewFlowClickNextWhatToImproveEventAdapter implements Adapter<ReviewFlowClickNextWhatToImproveEvent, Object> {
        private ReviewFlowClickNextWhatToImproveEventAdapter() {
        }

        public void write(Protocol protocol, ReviewFlowClickNextWhatToImproveEvent struct) throws IOException {
            protocol.writeStructBegin("ReviewFlowClickNextWhatToImproveEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ReviewFlowClickNextWhatToImproveEvent)) {
            return false;
        }
        ReviewFlowClickNextWhatToImproveEvent that = (ReviewFlowClickNextWhatToImproveEvent) other;
    ...
    public String toString() {
        return "ReviewFlowClickNextWhatToImproveEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", schedulable_info=" + this.schedulable_info + ", key_words=" + this.key_words + "}";
    }
