...
/* renamed from: com.airbnb.jitney.event.logging.ReviewFlow.v3.ReviewFlowDismissWhatToImproveEvent */
public final class ReviewFlowDismissWhatToImproveEvent implements Struct {
    public static final Adapter<ReviewFlowDismissWhatToImproveEvent, Object> ADAPTER = new ReviewFlowDismissWhatToImproveEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ReviewFlow.v3.ReviewFlowDismissWhatToImproveEvent$ReviewFlowDismissWhatToImproveEventAdapter */
    private static final class ReviewFlowDismissWhatToImproveEventAdapter implements Adapter<ReviewFlowDismissWhatToImproveEvent, Object> {
        private ReviewFlowDismissWhatToImproveEventAdapter() {
        }

        public void write(Protocol protocol, ReviewFlowDismissWhatToImproveEvent struct) throws IOException {
            protocol.writeStructBegin("ReviewFlowDismissWhatToImproveEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ReviewFlowDismissWhatToImproveEvent)) {
            return false;
        }
        ReviewFlowDismissWhatToImproveEvent that = (ReviewFlowDismissWhatToImproveEvent) other;
    ...
    public String toString() {
        return "ReviewFlowDismissWhatToImproveEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", schedulable_info=" + this.schedulable_info + ", key_words=" + this.key_words + "}";
    }
