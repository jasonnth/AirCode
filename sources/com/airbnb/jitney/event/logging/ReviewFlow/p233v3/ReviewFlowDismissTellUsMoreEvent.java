...
/* renamed from: com.airbnb.jitney.event.logging.ReviewFlow.v3.ReviewFlowDismissTellUsMoreEvent */
public final class ReviewFlowDismissTellUsMoreEvent implements Struct {
    public static final Adapter<ReviewFlowDismissTellUsMoreEvent, Object> ADAPTER = new ReviewFlowDismissTellUsMoreEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ReviewFlow.v3.ReviewFlowDismissTellUsMoreEvent$ReviewFlowDismissTellUsMoreEventAdapter */
    private static final class ReviewFlowDismissTellUsMoreEventAdapter implements Adapter<ReviewFlowDismissTellUsMoreEvent, Object> {
        private ReviewFlowDismissTellUsMoreEventAdapter() {
        }

        public void write(Protocol protocol, ReviewFlowDismissTellUsMoreEvent struct) throws IOException {
            protocol.writeStructBegin("ReviewFlowDismissTellUsMoreEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ReviewFlowDismissTellUsMoreEvent)) {
            return false;
        }
        ReviewFlowDismissTellUsMoreEvent that = (ReviewFlowDismissTellUsMoreEvent) other;
    ...
    public String toString() {
        return "ReviewFlowDismissTellUsMoreEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", schedulable_info=" + this.schedulable_info + ", key_words=" + this.key_words + "}";
    }
