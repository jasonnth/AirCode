...
/* renamed from: com.airbnb.jitney.event.logging.Explore.v2.ExploreFiltersPaneImpressionEvent */
public final class ExploreFiltersPaneImpressionEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v2.ExploreFiltersPaneImpressionEvent$ExploreFiltersPaneImpressionEventAdapter */
    private static final class ExploreFiltersPaneImpressionEventAdapter implements Adapter<ExploreFiltersPaneImpressionEvent, Object> {
        ...
        public void write(Protocol protocol, ExploreFiltersPaneImpressionEvent struct) throws IOException {
            ...
            if (struct.adults != null) {
                protocol.writeFieldBegin(FindTweenAnalytics.ADULTS, 10, 10);
                protocol.writeI64(struct.adults.longValue());
                protocol.writeFieldEnd();
            }
            if (struct.children != null) {
                protocol.writeFieldBegin(FindTweenAnalytics.CHILDREN, 11, 10);
                protocol.writeI64(struct.children.longValue());
                protocol.writeFieldEnd();
            }
            if (struct.infants != null) {
                protocol.writeFieldBegin(FindTweenAnalytics.INFANTS, 12, 10);
                protocol.writeI64(struct.infants.longValue());
                protocol.writeFieldEnd();
            }
            if (struct.pets != null) {
                protocol.writeFieldBegin(FindTweenAnalytics.PETS, 13, 2);
                protocol.writeBool(struct.pets.booleanValue());
                protocol.writeFieldEnd();
            }
            if (struct.instant_book != null) {
                protocol.writeFieldBegin(ManageListingAnalytics.INSTANT_BOOK, 14, 2);
                protocol.writeBool(struct.instant_book.booleanValue());
                protocol.writeFieldEnd();
            }
            if (struct.price_range != null) {
                protocol.writeFieldBegin(PlaceFields.PRICE_RANGE, 15, 15);
            ...
            if (struct.beds != null) {
                protocol.writeFieldBegin(ListingRequestConstants.JSON_BEDS_KEY, 17, 10);
                protocol.writeI64(struct.beds.longValue());
                protocol.writeFieldEnd();
            }
            if (struct.bedrooms != null) {
                protocol.writeFieldBegin(ListingRequestConstants.JSON_BEDROOMS_KEY, 18, 10);
                protocol.writeI64(struct.bedrooms.longValue());
                protocol.writeFieldEnd();
            }
            if (struct.bathrooms != null) {
                protocol.writeFieldBegin(ListingRequestConstants.JSON_BATHROOMS_KEY, 19, 4);
