...
/* renamed from: com.airbnb.jitney.event.logging.Explore.v2.ExploreClickListingExperienceEvent */
public final class ExploreClickListingExperienceEvent implements Struct {
    public static final Adapter<ExploreClickListingExperienceEvent, Object> ADAPTER = new ExploreClickListingExperienceEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v2.ExploreClickListingExperienceEvent$ExploreClickListingExperienceEventAdapter */
    private static final class ExploreClickListingExperienceEventAdapter implements Adapter<ExploreClickListingExperienceEvent, Object> {
    ...
    public boolean equals(Object other) {
        ...
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.page == that.page || this.page.equals(that.page)) && ((this.target == that.target || this.target.equals(that.target)) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.location == that.location || (this.location != null && this.location.equals(that.location))) && ((this.dates == that.dates || (this.dates != null && this.dates.equals(that.dates))) && ((this.guests == that.guests || (this.guests != null && this.guests.equals(that.guests))) && ((this.experience_id == that.experience_id || this.experience_id.equals(that.experience_id)) && ((this.subtab == that.subtab || this.subtab.equals(that.subtab)) && (this.search_context == that.search_context || this.search_context.equals(that.search_context))))))))))))) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((code ^ i) * -2128831035) ^ this.experience_id.hashCode()) * -2128831035) ^ this.subtab.hashCode()) * -2128831035) ^ this.search_context.hashCode()) * -2128831035;
    }
