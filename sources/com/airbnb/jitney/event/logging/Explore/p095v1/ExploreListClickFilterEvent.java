...
/* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreListClickFilterEvent */
public final class ExploreListClickFilterEvent implements Struct {
    public static final Adapter<ExploreListClickFilterEvent, Builder> ADAPTER = new ExploreListClickFilterEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreListClickFilterEvent$Builder */
    public static final class Builder implements StructBuilder<ExploreListClickFilterEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Explore:ExploreListClickFilterEvent:1.0.0";
            this.event_name = "explore_list_click_filter";
            this.page = P3Arguments.FROM_EXPLORE;
            this.section = "list";
            this.target = "filter_button";
        ...
        public ExploreListClickFilterEvent build() {
            if (this.event_name == null) {
                ...
                return new ExploreListClickFilterEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreListClickFilterEvent$ExploreListClickFilterEventAdapter */
    private static final class ExploreListClickFilterEventAdapter implements Adapter<ExploreListClickFilterEvent, Builder> {
        private ExploreListClickFilterEventAdapter() {
        }

        public void write(Protocol protocol, ExploreListClickFilterEvent struct) throws IOException {
            protocol.writeStructBegin("ExploreListClickFilterEvent");
    ...
    private ExploreListClickFilterEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExploreListClickFilterEvent)) {
            return false;
        }
        ExploreListClickFilterEvent that = (ExploreListClickFilterEvent) other;
    ...
    public String toString() {
        return "ExploreListClickFilterEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", target=" + this.target + ", operation=" + this.operation + ", subtab=" + this.subtab + ", search_context=" + this.search_context + "}";
    }
