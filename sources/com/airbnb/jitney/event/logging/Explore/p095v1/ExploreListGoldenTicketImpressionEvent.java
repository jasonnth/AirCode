...
/* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreListGoldenTicketImpressionEvent */
public final class ExploreListGoldenTicketImpressionEvent implements Struct {
    public static final Adapter<ExploreListGoldenTicketImpressionEvent, Builder> ADAPTER = new ExploreListGoldenTicketImpressionEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreListGoldenTicketImpressionEvent$Builder */
    public static final class Builder implements StructBuilder<ExploreListGoldenTicketImpressionEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Explore:ExploreListGoldenTicketImpressionEvent:1.0.0";
            this.event_name = "explore_list_golden_ticket_impression";
        ...
        public ExploreListGoldenTicketImpressionEvent build() {
            if (this.event_name == null) {
                ...
                return new ExploreListGoldenTicketImpressionEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreListGoldenTicketImpressionEvent$ExploreListGoldenTicketImpressionEventAdapter */
    private static final class ExploreListGoldenTicketImpressionEventAdapter implements Adapter<ExploreListGoldenTicketImpressionEvent, Builder> {
        private ExploreListGoldenTicketImpressionEventAdapter() {
        }

        public void write(Protocol protocol, ExploreListGoldenTicketImpressionEvent struct) throws IOException {
            protocol.writeStructBegin("ExploreListGoldenTicketImpressionEvent");
    ...
    private ExploreListGoldenTicketImpressionEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExploreListGoldenTicketImpressionEvent)) {
            return false;
        }
        ExploreListGoldenTicketImpressionEvent that = (ExploreListGoldenTicketImpressionEvent) other;
    ...
    public String toString() {
        return "ExploreListGoldenTicketImpressionEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", target=" + this.target + ", operation=" + this.operation + ", subtab=" + this.subtab + ", search_context=" + this.search_context + ", filter_recommendation_type=" + this.filter_recommendation_type + "}";
    }
