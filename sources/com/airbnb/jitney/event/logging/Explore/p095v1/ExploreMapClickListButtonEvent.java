...
/* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreMapClickListButtonEvent */
public final class ExploreMapClickListButtonEvent implements Struct {
    public static final Adapter<ExploreMapClickListButtonEvent, Builder> ADAPTER = new ExploreMapClickListButtonEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreMapClickListButtonEvent$Builder */
    public static final class Builder implements StructBuilder<ExploreMapClickListButtonEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Explore:ExploreMapClickListButtonEvent:1.0.0";
            this.event_name = "explore_map_click_list_button";
            this.page = P3Arguments.FROM_EXPLORE;
            this.section = P3Arguments.FROM_MAP;
            this.target = "list_button";
        ...
        public ExploreMapClickListButtonEvent build() {
            if (this.event_name == null) {
                ...
                return new ExploreMapClickListButtonEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreMapClickListButtonEvent$ExploreMapClickListButtonEventAdapter */
    private static final class ExploreMapClickListButtonEventAdapter implements Adapter<ExploreMapClickListButtonEvent, Builder> {
        private ExploreMapClickListButtonEventAdapter() {
        }

        public void write(Protocol protocol, ExploreMapClickListButtonEvent struct) throws IOException {
            protocol.writeStructBegin("ExploreMapClickListButtonEvent");
    ...
    private ExploreMapClickListButtonEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExploreMapClickListButtonEvent)) {
            return false;
        }
        ExploreMapClickListButtonEvent that = (ExploreMapClickListButtonEvent) other;
    ...
    public String toString() {
        return "ExploreMapClickListButtonEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", target=" + this.target + ", operation=" + this.operation + ", subtab=" + this.subtab + ", search_context=" + this.search_context + "}";
    }
