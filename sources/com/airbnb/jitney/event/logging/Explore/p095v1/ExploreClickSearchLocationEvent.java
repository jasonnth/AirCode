...
/* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreClickSearchLocationEvent */
public final class ExploreClickSearchLocationEvent implements Struct {
    public static final Adapter<ExploreClickSearchLocationEvent, Builder> ADAPTER = new ExploreClickSearchLocationEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreClickSearchLocationEvent$Builder */
    public static final class Builder implements StructBuilder<ExploreClickSearchLocationEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Explore:ExploreClickSearchLocationEvent:1.0.0";
            this.event_name = "explore_click_search_location";
        ...
        public ExploreClickSearchLocationEvent build() {
            if (this.event_name == null) {
                ...
                return new ExploreClickSearchLocationEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreClickSearchLocationEvent$ExploreClickSearchLocationEventAdapter */
    private static final class ExploreClickSearchLocationEventAdapter implements Adapter<ExploreClickSearchLocationEvent, Builder> {
        private ExploreClickSearchLocationEventAdapter() {
        }

        public void write(Protocol protocol, ExploreClickSearchLocationEvent struct) throws IOException {
            protocol.writeStructBegin("ExploreClickSearchLocationEvent");
    ...
    private ExploreClickSearchLocationEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExploreClickSearchLocationEvent)) {
            return false;
        }
        ExploreClickSearchLocationEvent that = (ExploreClickSearchLocationEvent) other;
    ...
    public String toString() {
        return "ExploreClickSearchLocationEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", location=" + this.location + ", dates=" + this.dates + ", guests=" + this.guests + ", subtab=" + this.subtab + ", search_context=" + this.search_context + "}";
    }
