...
/* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreClickSearchDatesEvent */
public final class ExploreClickSearchDatesEvent implements Struct {
    public static final Adapter<ExploreClickSearchDatesEvent, Builder> ADAPTER = new ExploreClickSearchDatesEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreClickSearchDatesEvent$Builder */
    public static final class Builder implements StructBuilder<ExploreClickSearchDatesEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Explore:ExploreClickSearchDatesEvent:1.0.0";
            this.event_name = "explore_click_search_dates";
        ...
        public ExploreClickSearchDatesEvent build() {
            if (this.event_name == null) {
                ...
                return new ExploreClickSearchDatesEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreClickSearchDatesEvent$ExploreClickSearchDatesEventAdapter */
    private static final class ExploreClickSearchDatesEventAdapter implements Adapter<ExploreClickSearchDatesEvent, Builder> {
    ...
    private ExploreClickSearchDatesEvent(Builder builder) {
