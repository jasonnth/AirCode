...
/* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreMapClickMapPinEvent */
public final class ExploreMapClickMapPinEvent implements Struct {
    public static final Adapter<ExploreMapClickMapPinEvent, Builder> ADAPTER = new ExploreMapClickMapPinEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreMapClickMapPinEvent$Builder */
    public static final class Builder implements StructBuilder<ExploreMapClickMapPinEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Explore:ExploreMapClickMapPinEvent:1.0.0";
            this.event_name = "explore_map_click_map_pin";
        ...
        public Builder(Context context2, C2139ExploreSubtab subtab2, C2731SearchContext search_context2, Long listing_id2) {
            this.schema = "com.airbnb.jitney.event.logging.Explore:ExploreMapClickMapPinEvent:1.0.0";
            this.event_name = "explore_map_click_map_pin";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreMapClickMapPinEvent$ExploreMapClickMapPinEventAdapter */
    private static final class ExploreMapClickMapPinEventAdapter implements Adapter<ExploreMapClickMapPinEvent, Builder> {
        private ExploreMapClickMapPinEventAdapter() {
        }

        public void write(Protocol protocol, ExploreMapClickMapPinEvent struct) throws IOException {
            protocol.writeStructBegin("ExploreMapClickMapPinEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExploreMapClickMapPinEvent)) {
            return false;
        }
        ExploreMapClickMapPinEvent that = (ExploreMapClickMapPinEvent) other;
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.page == that.page || this.page.equals(that.page)) && ((this.section == that.section || this.section.equals(that.section)) && ((this.target == that.target || this.target.equals(that.target)) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.subtab == that.subtab || this.subtab.equals(that.subtab)) && ((this.search_context == that.search_context || this.search_context.equals(that.search_context)) && (this.listing_id == that.listing_id || this.listing_id.equals(that.listing_id))))))))))) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((((16777619 ^ (this.schema == null ? 0 : this.schema.hashCode())) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.page.hashCode()) * -2128831035) ^ this.section.hashCode()) * -2128831035) ^ this.target.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.subtab.hashCode()) * -2128831035) ^ this.search_context.hashCode()) * -2128831035) ^ this.listing_id.hashCode()) * -2128831035;
    }

    public String toString() {
        return "ExploreMapClickMapPinEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", target=" + this.target + ", operation=" + this.operation + ", subtab=" + this.subtab + ", search_context=" + this.search_context + ", listing_id=" + this.listing_id + "}";
    }
