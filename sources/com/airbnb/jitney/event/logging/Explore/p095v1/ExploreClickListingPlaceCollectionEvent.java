...
/* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreClickListingPlaceCollectionEvent */
public final class ExploreClickListingPlaceCollectionEvent implements Struct {
    ...
    public final Long collection_name;
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreClickListingPlaceCollectionEvent$ExploreClickListingPlaceCollectionEventAdapter */
    private static final class ExploreClickListingPlaceCollectionEventAdapter implements Adapter<ExploreClickListingPlaceCollectionEvent, Object> {
        ...
        public void write(Protocol protocol, ExploreClickListingPlaceCollectionEvent struct) throws IOException {
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("collection_name", 9, 10);
            protocol.writeI64(struct.collection_name.longValue());
            protocol.writeFieldEnd();
