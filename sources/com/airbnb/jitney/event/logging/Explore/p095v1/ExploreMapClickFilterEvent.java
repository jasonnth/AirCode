...
/* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreMapClickFilterEvent */
public final class ExploreMapClickFilterEvent implements Struct {
    public static final Adapter<ExploreMapClickFilterEvent, Builder> ADAPTER = new ExploreMapClickFilterEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreMapClickFilterEvent$Builder */
    public static final class Builder implements StructBuilder<ExploreMapClickFilterEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Explore:ExploreMapClickFilterEvent:1.0.0";
            this.event_name = "explore_map_click_filter";
        ...
        public ExploreMapClickFilterEvent build() {
            if (this.event_name == null) {
                ...
                return new ExploreMapClickFilterEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreMapClickFilterEvent$ExploreMapClickFilterEventAdapter */
    private static final class ExploreMapClickFilterEventAdapter implements Adapter<ExploreMapClickFilterEvent, Builder> {
        private ExploreMapClickFilterEventAdapter() {
        }

        public void write(Protocol protocol, ExploreMapClickFilterEvent struct) throws IOException {
            protocol.writeStructBegin("ExploreMapClickFilterEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExploreMapClickFilterEvent)) {
            return false;
        }
        ExploreMapClickFilterEvent that = (ExploreMapClickFilterEvent) other;
    ...
    public String toString() {
        return "ExploreMapClickFilterEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", target=" + this.target + ", operation=" + this.operation + ", subtab=" + this.subtab + ", search_context=" + this.search_context + "}";
    }
