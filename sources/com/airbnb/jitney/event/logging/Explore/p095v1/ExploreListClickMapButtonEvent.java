...
/* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreListClickMapButtonEvent */
public final class ExploreListClickMapButtonEvent implements Struct {
    public static final Adapter<ExploreListClickMapButtonEvent, Builder> ADAPTER = new ExploreListClickMapButtonEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreListClickMapButtonEvent$Builder */
    public static final class Builder implements StructBuilder<ExploreListClickMapButtonEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Explore:ExploreListClickMapButtonEvent:1.0.0";
            this.event_name = "explore_list_click_map_button";
            this.page = P3Arguments.FROM_EXPLORE;
            this.section = "list";
            this.target = "map_button";
        ...
        public ExploreListClickMapButtonEvent build() {
            if (this.event_name == null) {
                ...
                return new ExploreListClickMapButtonEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreListClickMapButtonEvent$ExploreListClickMapButtonEventAdapter */
    private static final class ExploreListClickMapButtonEventAdapter implements Adapter<ExploreListClickMapButtonEvent, Builder> {
        private ExploreListClickMapButtonEventAdapter() {
        }

        public void write(Protocol protocol, ExploreListClickMapButtonEvent struct) throws IOException {
    ...
    private ExploreListClickMapButtonEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExploreListClickMapButtonEvent)) {
            return false;
        }
        ExploreListClickMapButtonEvent that = (ExploreListClickMapButtonEvent) other;
