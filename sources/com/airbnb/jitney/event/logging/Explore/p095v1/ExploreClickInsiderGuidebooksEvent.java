...
/* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreClickInsiderGuidebooksEvent */
public final class ExploreClickInsiderGuidebooksEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreClickInsiderGuidebooksEvent$ExploreClickInsiderGuidebooksEventAdapter */
    private static final class ExploreClickInsiderGuidebooksEventAdapter implements Adapter<ExploreClickInsiderGuidebooksEvent, Object> {
        ...
        public void write(Protocol protocol, ExploreClickInsiderGuidebooksEvent struct) throws IOException {
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("album_id", 9, 10);
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExploreClickInsiderGuidebooksEvent)) {
            return false;
        }
        ExploreClickInsiderGuidebooksEvent that = (ExploreClickInsiderGuidebooksEvent) other;
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.page == that.page || this.page.equals(that.page)) && ((this.target == that.target || this.target.equals(that.target)) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.location == that.location || this.location.equals(that.location)) && ((this.dates == that.dates || this.dates.equals(that.dates)) && ((this.guests == that.guests || this.guests.equals(that.guests)) && ((this.album_id == that.album_id || this.album_id.equals(that.album_id)) && ((this.subtab == that.subtab || this.subtab.equals(that.subtab)) && (this.search_context == that.search_context || this.search_context.equals(that.search_context))))))))))))) {
            return true;
        }
        return false;
    }
