...
/* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreFiltersPaneClickResetEvent */
public final class ExploreFiltersPaneClickResetEvent implements Struct {
    public static final Adapter<ExploreFiltersPaneClickResetEvent, Builder> ADAPTER = new ExploreFiltersPaneClickResetEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreFiltersPaneClickResetEvent$Builder */
    public static final class Builder implements StructBuilder<ExploreFiltersPaneClickResetEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Explore:ExploreFiltersPaneClickResetEvent:1.0.0";
            this.event_name = "explore_filters_pane_click_reset";
        ...
        public ExploreFiltersPaneClickResetEvent build() {
            if (this.event_name == null) {
                ...
                return new ExploreFiltersPaneClickResetEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Explore.v1.ExploreFiltersPaneClickResetEvent$ExploreFiltersPaneClickResetEventAdapter */
    private static final class ExploreFiltersPaneClickResetEventAdapter implements Adapter<ExploreFiltersPaneClickResetEvent, Builder> {
        private ExploreFiltersPaneClickResetEventAdapter() {
        }

        public void write(Protocol protocol, ExploreFiltersPaneClickResetEvent struct) throws IOException {
            protocol.writeStructBegin("ExploreFiltersPaneClickResetEvent");
    ...
    private ExploreFiltersPaneClickResetEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExploreFiltersPaneClickResetEvent)) {
            return false;
        }
        ExploreFiltersPaneClickResetEvent that = (ExploreFiltersPaneClickResetEvent) other;
    ...
    public String toString() {
        return "ExploreFiltersPaneClickResetEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", operation=" + this.operation + ", subtab=" + this.subtab + ", search_context=" + this.search_context + "}";
    }
