...
/* renamed from: com.airbnb.jitney.event.logging.Identity.v1.IdentityStartFlowEvent */
public final class IdentityStartFlowEvent implements Struct {
    public static final Adapter<IdentityStartFlowEvent, Object> ADAPTER = new IdentityStartFlowEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Identity.v1.IdentityStartFlowEvent$IdentityStartFlowEventAdapter */
    private static final class IdentityStartFlowEventAdapter implements Adapter<IdentityStartFlowEvent, Object> {
        private IdentityStartFlowEventAdapter() {
        }

        public void write(Protocol protocol, IdentityStartFlowEvent struct) throws IOException {
            protocol.writeStructBegin("IdentityStartFlowEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof IdentityStartFlowEvent)) {
            return false;
        }
        IdentityStartFlowEvent that = (IdentityStartFlowEvent) other;
    ...
    public String toString() {
        return "IdentityStartFlowEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", source=" + this.source + ", page=" + this.page + "}";
    }
