...
/* renamed from: com.airbnb.jitney.event.logging.ExperiencePDP.v1.ExperiencePDPClickSuggestedEvent */
public final class ExperiencePDPClickSuggestedEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperiencePDP.v1.ExperiencePDPClickSuggestedEvent$ExperiencePDPClickSuggestedEventAdapter */
    private static final class ExperiencePDPClickSuggestedEventAdapter implements Adapter<ExperiencePDPClickSuggestedEvent, Object> {
        ...
        public void write(Protocol protocol, ExperiencePDPClickSuggestedEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperiencePDPClickSuggestedEvent)) {
            return false;
        }
        ExperiencePDPClickSuggestedEvent that = (ExperiencePDPClickSuggestedEvent) other;
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.page == that.page || this.page.equals(that.page)) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.product_info == that.product_info || this.product_info.equals(that.product_info)) && (this.parent_product_info == that.parent_product_info || this.parent_product_info.equals(that.parent_product_info)))))))) {
            return true;
        }
        return false;
    }
