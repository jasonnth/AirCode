...
/* renamed from: com.airbnb.jitney.event.logging.ExperiencePDP.v1.ExperiencePDPClickExperienceEvent */
public final class ExperiencePDPClickExperienceEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperiencePDP.v1.ExperiencePDPClickExperienceEvent$ExperiencePDPClickExperienceEventAdapter */
    private static final class ExperiencePDPClickExperienceEventAdapter implements Adapter<ExperiencePDPClickExperienceEvent, Object> {
        ...
        public void write(Protocol protocol, ExperiencePDPClickExperienceEvent struct) throws IOException {
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("experience_id", 6, 10);
    ...
    public boolean equals(Object other) {
        ...
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.page == that.page || this.page.equals(that.page)) && ((this.target == that.target || this.target.equals(that.target)) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.experience_id == that.experience_id || this.experience_id.equals(that.experience_id)) && (this.product_info == that.product_info || this.product_info.equals(that.product_info))))))))) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((16777619 ^ (this.schema == null ? 0 : this.schema.hashCode())) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.page.hashCode()) * -2128831035) ^ this.target.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.experience_id.hashCode()) * -2128831035) ^ this.product_info.hashCode()) * -2128831035;
    }

    public String toString() {
        return "ExperiencePDPClickExperienceEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", experience_id=" + this.experience_id + ", product_info=" + this.product_info + "}";
    }
