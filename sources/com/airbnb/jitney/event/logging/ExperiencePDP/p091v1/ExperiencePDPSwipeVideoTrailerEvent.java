...
/* renamed from: com.airbnb.jitney.event.logging.ExperiencePDP.v1.ExperiencePDPSwipeVideoTrailerEvent */
public final class ExperiencePDPSwipeVideoTrailerEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperiencePDP.v1.ExperiencePDPSwipeVideoTrailerEvent$ExperiencePDPSwipeVideoTrailerEventAdapter */
    ...
    public String toString() {
        return "ExperiencePDPSwipeVideoTrailerEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", target=" + this.target + ", operation=" + this.operation + ", product_info=" + this.product_info + ", video_completion=" + this.video_completion + ", video_id=" + this.video_id + ", swipe_method=" + this.swipe_method + ", direction=" + this.direction + "}";
    }
