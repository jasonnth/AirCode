...
/* renamed from: com.airbnb.jitney.event.logging.ExperiencePDP.v1.ExperiencePDPSwipeSimilarExperiencesCarouselEvent */
public final class ExperiencePDPSwipeSimilarExperiencesCarouselEvent implements Struct {
    public static final Adapter<ExperiencePDPSwipeSimilarExperiencesCarouselEvent, Object> ADAPTER = new ExperiencePDPSwipeSimilarExperiencesCarouselEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperiencePDP.v1.ExperiencePDPSwipeSimilarExperiencesCarouselEvent$ExperiencePDPSwipeSimilarExperiencesCarouselEventAdapter */
    private static final class ExperiencePDPSwipeSimilarExperiencesCarouselEventAdapter implements Adapter<ExperiencePDPSwipeSimilarExperiencesCarouselEvent, Object> {
        private ExperiencePDPSwipeSimilarExperiencesCarouselEventAdapter() {
        }

        public void write(Protocol protocol, ExperiencePDPSwipeSimilarExperiencesCarouselEvent struct) throws IOException {
            protocol.writeStructBegin("ExperiencePDPSwipeSimilarExperiencesCarouselEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperiencePDPSwipeSimilarExperiencesCarouselEvent)) {
            return false;
        }
        ExperiencePDPSwipeSimilarExperiencesCarouselEvent that = (ExperiencePDPSwipeSimilarExperiencesCarouselEvent) other;
    ...
    public String toString() {
        return "ExperiencePDPSwipeSimilarExperiencesCarouselEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", operation=" + this.operation + ", product_info=" + this.product_info + ", direction=" + this.direction + "}";
    }
