...
/* renamed from: com.airbnb.jitney.event.logging.PaidAmenities.v1.PaidAmenitiesGuestAddClickPayEvent */
public final class PaidAmenitiesGuestAddClickPayEvent implements Struct {
    public static final Adapter<PaidAmenitiesGuestAddClickPayEvent, Object> ADAPTER = new PaidAmenitiesGuestAddClickPayEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.PaidAmenities.v1.PaidAmenitiesGuestAddClickPayEvent$PaidAmenitiesGuestAddClickPayEventAdapter */
    private static final class PaidAmenitiesGuestAddClickPayEventAdapter implements Adapter<PaidAmenitiesGuestAddClickPayEvent, Object> {
        private PaidAmenitiesGuestAddClickPayEventAdapter() {
        }

        public void write(Protocol protocol, PaidAmenitiesGuestAddClickPayEvent struct) throws IOException {
            protocol.writeStructBegin("PaidAmenitiesGuestAddClickPayEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PaidAmenitiesGuestAddClickPayEvent)) {
            return false;
        }
        PaidAmenitiesGuestAddClickPayEvent that = (PaidAmenitiesGuestAddClickPayEvent) other;
    ...
    public String toString() {
        return "PaidAmenitiesGuestAddClickPayEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", paid_amenity_order_context=" + this.paid_amenity_order_context + "}";
    }
