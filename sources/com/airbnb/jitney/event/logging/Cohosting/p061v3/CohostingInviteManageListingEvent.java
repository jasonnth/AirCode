package com.airbnb.jitney.event.logging.Cohosting.p061v3;
...
/* renamed from: com.airbnb.jitney.event.logging.Cohosting.v3.CohostingInviteManageListingEvent */
public final class CohostingInviteManageListingEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Cohosting.v3.CohostingInviteManageListingEvent$Builder */
    public static final class Builder implements StructBuilder<CohostingInviteManageListingEvent> {
        ...
        /* access modifiers changed from: private */
        public String invited_user_email;
        /* access modifiers changed from: private */
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Cohosting:CohostingInviteManageListingEvent:3.0.0";
            this.event_name = "cohosting_invite_manage_listing";
            this.cohost_page = C1957CohostingManageListingPage.InvitationModal;
            this.operation = C2451Operation.Click;
        }

        public Builder(Context context2, String invited_user_email2, Long percent_of_shared_earnings2, Boolean pay_cleaning_fees2, Long fixed_fee2, Long maximum_fee2, Long minimum_fee2, String amount_currency2, C1951CohostingContext cohosting_context2) {
            this.schema = "com.airbnb.jitney.event.logging.Cohosting:CohostingInviteManageListingEvent:3.0.0";
            this.event_name = "cohosting_invite_manage_listing";
            this.context = context2;
            this.cohost_page = C1957CohostingManageListingPage.InvitationModal;
            this.operation = C2451Operation.Click;
            this.invited_user_email = invited_user_email2;
        ...
        public CohostingInviteManageListingEvent build() {
            ...
            } else if (this.invited_user_email == null) {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Cohosting.v3.CohostingInviteManageListingEvent$CohostingInviteManageListingEventAdapter */
    ...
    public boolean equals(Object other) {
        ...
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.cohost_page == that.cohost_page || this.cohost_page.equals(that.cohost_page)) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.invited_user_email == that.invited_user_email || this.invited_user_email.equals(that.invited_user_email)) && ((this.percent_of_shared_earnings == that.percent_of_shared_earnings || this.percent_of_shared_earnings.equals(that.percent_of_shared_earnings)) && ((this.pay_cleaning_fees == that.pay_cleaning_fees || this.pay_cleaning_fees.equals(that.pay_cleaning_fees)) && ((this.fixed_fee == that.fixed_fee || this.fixed_fee.equals(that.fixed_fee)) && ((this.maximum_fee == that.maximum_fee || this.maximum_fee.equals(that.maximum_fee)) && ((this.minimum_fee == that.minimum_fee || this.minimum_fee.equals(that.minimum_fee)) && ((this.amount_currency == that.amount_currency || this.amount_currency.equals(that.amount_currency)) && (this.cohosting_context == that.cohosting_context || this.cohosting_context.equals(that.cohosting_context)))))))))))))) {
            return true;
        }
        return false;
    }
