...
/* renamed from: com.airbnb.jitney.event.logging.Cohosting.v1.CohostingInviteDetailPageImpressionInviteFlowEvent */
public final class CohostingInviteDetailPageImpressionInviteFlowEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Cohosting.v1.CohostingInviteDetailPageImpressionInviteFlowEvent$Builder */
    public static final class Builder implements StructBuilder<CohostingInviteDetailPageImpressionInviteFlowEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Cohosting:CohostingInviteDetailPageImpressionInviteFlowEvent:1.0.0";
            this.event_name = "cohosting_invite_detail_page_impression_invite_flow";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Cohosting.v1.CohostingInviteDetailPageImpressionInviteFlowEvent$CohostingInviteDetailPageImpressionInviteFlowEventAdapter */
    private static final class CohostingInviteDetailPageImpressionInviteFlowEventAdapter implements Adapter<CohostingInviteDetailPageImpressionInviteFlowEvent, Builder> {
        ...
        public void write(Protocol protocol, CohostingInviteDetailPageImpressionInviteFlowEvent struct) throws IOException {
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("invitation_id", 5, 10);
            protocol.writeI64(struct.invitation_id.longValue());
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("inviter_user_id", 6, 10);
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("invitee_user_id", 8, 10);
            ...
            if (struct.listing_id != null) {
                protocol.writeFieldBegin("listing_id", 12, 10);
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CohostingInviteDetailPageImpressionInviteFlowEvent)) {
            return false;
        }
        CohostingInviteDetailPageImpressionInviteFlowEvent that = (CohostingInviteDetailPageImpressionInviteFlowEvent) other;
