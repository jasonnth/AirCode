...
/* renamed from: com.airbnb.jitney.event.logging.Cohosting.v1.CohostingSetPrimaryHostManageListingEvent */
public final class CohostingSetPrimaryHostManageListingEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Cohosting.v1.CohostingSetPrimaryHostManageListingEvent$Builder */
    public static final class Builder implements StructBuilder<CohostingSetPrimaryHostManageListingEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Cohosting:CohostingSetPrimaryHostManageListingEvent:1.0.0";
            this.event_name = "cohosting_set_primary_host_manage_listing";
            this.cohost_page = C1957CohostingManageListingPage.PrimaryHostModal;
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Cohosting.v1.CohostingSetPrimaryHostManageListingEvent$CohostingSetPrimaryHostManageListingEventAdapter */
    private static final class CohostingSetPrimaryHostManageListingEventAdapter implements Adapter<CohostingSetPrimaryHostManageListingEvent, Builder> {
        ...
        public void write(Protocol protocol, CohostingSetPrimaryHostManageListingEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CohostingSetPrimaryHostManageListingEvent)) {
            return false;
        }
        CohostingSetPrimaryHostManageListingEvent that = (CohostingSetPrimaryHostManageListingEvent) other;
    ...
    public String toString() {
        return "CohostingSetPrimaryHostManageListingEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", cohost_page=" + this.cohost_page + ", operation=" + this.operation + ", mute_type=" + this.mute_type + ", cohosting_context=" + this.cohosting_context + "}";
    }
