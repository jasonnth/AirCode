...
/* renamed from: com.airbnb.jitney.event.logging.Virality.v1.ViralityReferralCreditRevokedEvent */
public final class ViralityReferralCreditRevokedEvent implements Struct {
    public static final Adapter<ViralityReferralCreditRevokedEvent, Object> ADAPTER = new ViralityReferralCreditRevokedEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Virality.v1.ViralityReferralCreditRevokedEvent$ViralityReferralCreditRevokedEventAdapter */
    private static final class ViralityReferralCreditRevokedEventAdapter implements Adapter<ViralityReferralCreditRevokedEvent, Object> {
        private ViralityReferralCreditRevokedEventAdapter() {
        }

        public void write(Protocol protocol, ViralityReferralCreditRevokedEvent struct) throws IOException {
            protocol.writeStructBegin("ViralityReferralCreditRevokedEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ViralityReferralCreditRevokedEvent)) {
            return false;
        }
        ViralityReferralCreditRevokedEvent that = (ViralityReferralCreditRevokedEvent) other;
    ...
    public String toString() {
        return "ViralityReferralCreditRevokedEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", referring_user_id=" + this.referring_user_id + ", referral_id=" + this.referral_id + ", referral_credit_id=" + this.referral_credit_id + ", referral_credit_type=" + this.referral_credit_type + ", referral_credit_amount_micros=" + this.referral_credit_amount_micros + ", currency=" + this.currency + "}";
    }
