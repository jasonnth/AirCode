...
/* renamed from: com.airbnb.jitney.event.logging.Virality.v2.ViralityShareActionEvent */
public final class ViralityShareActionEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Virality.v2.ViralityShareActionEvent$ViralityShareActionEventAdapter */
    private static final class ViralityShareActionEventAdapter implements Adapter<ViralityShareActionEvent, Object> {
        ...
        public void write(Protocol protocol, ViralityShareActionEvent struct) throws IOException {
            ...
            if (struct.recipients != null) {
                protocol.writeFieldBegin("recipients", 13, 15);
    ...
    public int hashCode() {
        ...
        int code2 = (((((((((((((((code ^ hashCode) * -2128831035) ^ this.virality_entry_point.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.target.hashCode()) * -2128831035) ^ this.operation_result.hashCode()) * -2128831035) ^ this.share_service.hashCode()) * -2128831035) ^ this.share_service_freeform.hashCode()) * -2128831035) ^ (this.total_shares_sent == null ? 0 : this.total_shares_sent.hashCode())) * -2128831035;
    ...
    public String toString() {
        return "ViralityShareActionEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", shared_item_type=" + this.shared_item_type + ", shared_item_id=" + this.shared_item_id + ", photo_index=" + this.photo_index + ", virality_entry_point=" + this.virality_entry_point + ", operation=" + this.operation + ", target=" + this.target + ", operation_result=" + this.operation_result + ", share_service=" + this.share_service + ", share_service_freeform=" + this.share_service_freeform + ", total_shares_sent=" + this.total_shares_sent + ", recipients=" + this.recipients + ", share_module=" + this.share_module + "}";
    }
