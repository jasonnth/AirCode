...
/* renamed from: com.airbnb.jitney.event.logging.Virality.v3.ViralityReferralActionEvent */
public final class ViralityReferralActionEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Virality.v3.ViralityReferralActionEvent$ViralityReferralActionEventAdapter */
    private static final class ViralityReferralActionEventAdapter implements Adapter<ViralityReferralActionEvent, Object> {
        ...
        public void write(Protocol protocol, ViralityReferralActionEvent struct) throws IOException {
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("share_service_type", 3, 8);
            ...
            if (struct.share_recipients != null) {
                protocol.writeFieldBegin("share_recipients", 10, 15);
    ...
    public boolean equals(Object other) {
        ...
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.share_service_type == that.share_service_type || this.share_service_type.equals(that.share_service_type)) && ((this.share_service_freeform == that.share_service_freeform || this.share_service_freeform.equals(that.share_service_freeform)) && ((this.virality_entry_point == that.virality_entry_point || this.virality_entry_point.equals(that.virality_entry_point)) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.target == that.target || this.target.equals(that.target)) && ((this.operation_result == that.operation_result || this.operation_result.equals(that.operation_result)) && ((this.total_invites_sent == that.total_invites_sent || (this.total_invites_sent != null && this.total_invites_sent.equals(that.total_invites_sent))) && ((this.share_recipients == that.share_recipients || (this.share_recipients != null && this.share_recipients.equals(that.share_recipients))) && (this.share_module == that.share_module || this.share_module.equals(that.share_module))))))))))))) {
            return true;
        }
        return false;
    }
