...
/* renamed from: com.airbnb.jitney.event.logging.Rejection.v1.RejectionRejectionSimilarListingsImpressionEvent */
public final class RejectionRejectionSimilarListingsImpressionEvent implements Struct {
    public static final Adapter<RejectionRejectionSimilarListingsImpressionEvent, Builder> ADAPTER = new RejectionRejectionSimilarListingsImpressionEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Rejection.v1.RejectionRejectionSimilarListingsImpressionEvent$Builder */
    public static final class Builder implements StructBuilder<RejectionRejectionSimilarListingsImpressionEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Rejection:RejectionRejectionSimilarListingsImpressionEvent:1.0.0";
            this.event_name = "rejection_rejection_similar_listings_impression";
        ...
        public Builder listing_ids(Set<String> listing_ids2) {
            this.listing_ids = listing_ids2;
            return this;
        }

        public RejectionRejectionSimilarListingsImpressionEvent build() {
            if (this.event_name == null) {
                ...
                return new RejectionRejectionSimilarListingsImpressionEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Rejection.v1.RejectionRejectionSimilarListingsImpressionEvent$RejectionRejectionSimilarListingsImpressionEventAdapter */
    private static final class RejectionRejectionSimilarListingsImpressionEventAdapter implements Adapter<RejectionRejectionSimilarListingsImpressionEvent, Builder> {
        private RejectionRejectionSimilarListingsImpressionEventAdapter() {
        }

        public void write(Protocol protocol, RejectionRejectionSimilarListingsImpressionEvent struct) throws IOException {
            protocol.writeStructBegin("RejectionRejectionSimilarListingsImpressionEvent");
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin(BaseAnalytics.OPERATION, 14, 8);
    ...
    private RejectionRejectionSimilarListingsImpressionEvent(Builder builder) {
        Set<String> set = null;
    ...
    public String toString() {
        return "RejectionRejectionSimilarListingsImpressionEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + ", reservation_code=" + this.reservation_code + ", location=" + this.location + ", checkin_date=" + this.checkin_date + ", checkout_date=" + this.checkout_date + ", guests=" + this.guests + ", pets=" + this.pets + ", room_types=" + this.room_types + ", listing_ids=" + this.listing_ids + ", page=" + this.page + ", operation=" + this.operation + "}";
    }
