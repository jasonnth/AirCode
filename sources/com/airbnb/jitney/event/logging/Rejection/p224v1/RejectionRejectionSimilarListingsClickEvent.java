...
/* renamed from: com.airbnb.jitney.event.logging.Rejection.v1.RejectionRejectionSimilarListingsClickEvent */
public final class RejectionRejectionSimilarListingsClickEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Rejection.v1.RejectionRejectionSimilarListingsClickEvent$Builder */
    public static final class Builder implements StructBuilder<RejectionRejectionSimilarListingsClickEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Rejection:RejectionRejectionSimilarListingsClickEvent:1.0.0";
            this.event_name = "rejection_rejection_similar_listings_click";
            this.page = "RejectionSimilarListings";
            this.target = "SimilarListingCard";
            this.operation = C2451Operation.Click;
        }

        public Builder(Context context2, Long user_id2, Long listing_id2, Set<String> listing_ids2) {
            this.schema = "com.airbnb.jitney.event.logging.Rejection:RejectionRejectionSimilarListingsClickEvent:1.0.0";
            this.event_name = "rejection_rejection_similar_listings_click";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Rejection.v1.RejectionRejectionSimilarListingsClickEvent$RejectionRejectionSimilarListingsClickEventAdapter */
    private static final class RejectionRejectionSimilarListingsClickEventAdapter implements Adapter<RejectionRejectionSimilarListingsClickEvent, Builder> {
        ...
        public void write(Protocol protocol, RejectionRejectionSimilarListingsClickEvent struct) throws IOException {
    ...
    public int hashCode() {
        ...
        return (((((((((code ^ i) * -2128831035) ^ this.listing_ids.hashCode()) * -2128831035) ^ this.page.hashCode()) * -2128831035) ^ this.target.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035;
    }
