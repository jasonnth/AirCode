...
/* renamed from: com.airbnb.jitney.event.logging.Rejection.v1.RejectionRejectionSimilarListingsBrowseMoreClickEvent */
public final class RejectionRejectionSimilarListingsBrowseMoreClickEvent implements Struct {
    public static final Adapter<RejectionRejectionSimilarListingsBrowseMoreClickEvent, Builder> ADAPTER = new RejectionRejectionSimilarListingsBrowseMoreClickEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Rejection.v1.RejectionRejectionSimilarListingsBrowseMoreClickEvent$Builder */
    public static final class Builder implements StructBuilder<RejectionRejectionSimilarListingsBrowseMoreClickEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Rejection:RejectionRejectionSimilarListingsBrowseMoreClickEvent:1.0.0";
            this.event_name = "rejection_rejection_similar_listings_browse_more_click";
            this.page = "RejectionSimilarListings";
            this.target = "BrowseMoreButton";
        ...
        public RejectionRejectionSimilarListingsBrowseMoreClickEvent build() {
            if (this.event_name == null) {
                ...
                return new RejectionRejectionSimilarListingsBrowseMoreClickEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Rejection.v1.RejectionRejectionSimilarListingsBrowseMoreClickEvent$RejectionRejectionSimilarListingsBrowseMoreClickEventAdapter */
    private static final class RejectionRejectionSimilarListingsBrowseMoreClickEventAdapter implements Adapter<RejectionRejectionSimilarListingsBrowseMoreClickEvent, Builder> {
        private RejectionRejectionSimilarListingsBrowseMoreClickEventAdapter() {
        }

        public void write(Protocol protocol, RejectionRejectionSimilarListingsBrowseMoreClickEvent struct) throws IOException {
            protocol.writeStructBegin("RejectionRejectionSimilarListingsBrowseMoreClickEvent");
    ...
    private RejectionRejectionSimilarListingsBrowseMoreClickEvent(Builder builder) {
        Set<String> set = null;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof RejectionRejectionSimilarListingsBrowseMoreClickEvent)) {
            return false;
        }
        RejectionRejectionSimilarListingsBrowseMoreClickEvent that = (RejectionRejectionSimilarListingsBrowseMoreClickEvent) other;
