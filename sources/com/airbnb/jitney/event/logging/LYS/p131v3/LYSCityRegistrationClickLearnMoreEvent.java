...
/* renamed from: com.airbnb.jitney.event.logging.LYS.v3.LYSCityRegistrationClickLearnMoreEvent */
public final class LYSCityRegistrationClickLearnMoreEvent implements Struct {
    public static final Adapter<LYSCityRegistrationClickLearnMoreEvent, Object> ADAPTER = new LYSCityRegistrationClickLearnMoreEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v3.LYSCityRegistrationClickLearnMoreEvent$LYSCityRegistrationClickLearnMoreEventAdapter */
    private static final class LYSCityRegistrationClickLearnMoreEventAdapter implements Adapter<LYSCityRegistrationClickLearnMoreEvent, Object> {
        private LYSCityRegistrationClickLearnMoreEventAdapter() {
        }

        public void write(Protocol protocol, LYSCityRegistrationClickLearnMoreEvent struct) throws IOException {
            protocol.writeStructBegin("LYSCityRegistrationClickLearnMoreEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LYSCityRegistrationClickLearnMoreEvent)) {
            return false;
        }
        LYSCityRegistrationClickLearnMoreEvent that = (LYSCityRegistrationClickLearnMoreEvent) other;
    ...
    public String toString() {
        return "LYSCityRegistrationClickLearnMoreEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", regulatory_body=" + this.regulatory_body + ", page=" + this.page + ", group_key=" + this.group_key + "}";
    }
