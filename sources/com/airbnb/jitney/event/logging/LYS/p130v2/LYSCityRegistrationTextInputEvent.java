...
/* renamed from: com.airbnb.jitney.event.logging.LYS.v2.LYSCityRegistrationTextInputEvent */
public final class LYSCityRegistrationTextInputEvent implements Struct {
    public static final Adapter<LYSCityRegistrationTextInputEvent, Object> ADAPTER = new LYSCityRegistrationTextInputEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v2.LYSCityRegistrationTextInputEvent$LYSCityRegistrationTextInputEventAdapter */
    private static final class LYSCityRegistrationTextInputEventAdapter implements Adapter<LYSCityRegistrationTextInputEvent, Object> {
        private LYSCityRegistrationTextInputEventAdapter() {
        }

        public void write(Protocol protocol, LYSCityRegistrationTextInputEvent struct) throws IOException {
            protocol.writeStructBegin("LYSCityRegistrationTextInputEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LYSCityRegistrationTextInputEvent)) {
            return false;
        }
        LYSCityRegistrationTextInputEvent that = (LYSCityRegistrationTextInputEvent) other;
    ...
    public String toString() {
        return "LYSCityRegistrationTextInputEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", regulatory_body=" + this.regulatory_body + ", page=" + this.page + ", input_key=" + this.input_key + ", group_key=" + this.group_key + ", value=" + this.value + "}";
    }
