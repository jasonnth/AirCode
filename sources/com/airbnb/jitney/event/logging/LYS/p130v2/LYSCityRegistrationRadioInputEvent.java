...
/* renamed from: com.airbnb.jitney.event.logging.LYS.v2.LYSCityRegistrationRadioInputEvent */
public final class LYSCityRegistrationRadioInputEvent implements Struct {
    public static final Adapter<LYSCityRegistrationRadioInputEvent, Object> ADAPTER = new LYSCityRegistrationRadioInputEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v2.LYSCityRegistrationRadioInputEvent$LYSCityRegistrationRadioInputEventAdapter */
    private static final class LYSCityRegistrationRadioInputEventAdapter implements Adapter<LYSCityRegistrationRadioInputEvent, Object> {
        private LYSCityRegistrationRadioInputEventAdapter() {
        }

        public void write(Protocol protocol, LYSCityRegistrationRadioInputEvent struct) throws IOException {
            protocol.writeStructBegin("LYSCityRegistrationRadioInputEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LYSCityRegistrationRadioInputEvent)) {
            return false;
        }
        LYSCityRegistrationRadioInputEvent that = (LYSCityRegistrationRadioInputEvent) other;
    ...
    public String toString() {
        return "LYSCityRegistrationRadioInputEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", regulatory_body=" + this.regulatory_body + ", page=" + this.page + ", input_key=" + this.input_key + ", group_key=" + this.group_key + ", value=" + this.value + "}";
    }
