...
/* renamed from: com.airbnb.jitney.event.logging.LYS.v2.LYSCityRegistrationClickNextButtonEvent */
public final class LYSCityRegistrationClickNextButtonEvent implements Struct {
    public static final Adapter<LYSCityRegistrationClickNextButtonEvent, Object> ADAPTER = new LYSCityRegistrationClickNextButtonEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v2.LYSCityRegistrationClickNextButtonEvent$LYSCityRegistrationClickNextButtonEventAdapter */
    private static final class LYSCityRegistrationClickNextButtonEventAdapter implements Adapter<LYSCityRegistrationClickNextButtonEvent, Object> {
        private LYSCityRegistrationClickNextButtonEventAdapter() {
        }

        public void write(Protocol protocol, LYSCityRegistrationClickNextButtonEvent struct) throws IOException {
            protocol.writeStructBegin("LYSCityRegistrationClickNextButtonEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LYSCityRegistrationClickNextButtonEvent)) {
            return false;
        }
        LYSCityRegistrationClickNextButtonEvent that = (LYSCityRegistrationClickNextButtonEvent) other;
    ...
    public String toString() {
        return "LYSCityRegistrationClickNextButtonEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", regulatory_body=" + this.regulatory_body + ", page=" + this.page + ", target_page=" + this.target_page + ", group_key=" + this.group_key + ", target_group_key=" + this.target_group_key + "}";
    }
