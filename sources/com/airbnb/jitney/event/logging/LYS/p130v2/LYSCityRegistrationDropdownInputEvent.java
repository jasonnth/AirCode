...
/* renamed from: com.airbnb.jitney.event.logging.LYS.v2.LYSCityRegistrationDropdownInputEvent */
public final class LYSCityRegistrationDropdownInputEvent implements Struct {
    public static final Adapter<LYSCityRegistrationDropdownInputEvent, Object> ADAPTER = new LYSCityRegistrationDropdownInputEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v2.LYSCityRegistrationDropdownInputEvent$LYSCityRegistrationDropdownInputEventAdapter */
    private static final class LYSCityRegistrationDropdownInputEventAdapter implements Adapter<LYSCityRegistrationDropdownInputEvent, Object> {
        private LYSCityRegistrationDropdownInputEventAdapter() {
        }

        public void write(Protocol protocol, LYSCityRegistrationDropdownInputEvent struct) throws IOException {
            protocol.writeStructBegin("LYSCityRegistrationDropdownInputEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LYSCityRegistrationDropdownInputEvent)) {
            return false;
        }
        LYSCityRegistrationDropdownInputEvent that = (LYSCityRegistrationDropdownInputEvent) other;
    ...
    public String toString() {
        return "LYSCityRegistrationDropdownInputEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", regulatory_body=" + this.regulatory_body + ", page=" + this.page + ", input_key=" + this.input_key + ", group_key=" + this.group_key + ", value=" + this.value + "}";
    }
