...
/* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSWmpwSelectGuestNumberEvent */
public final class LYSWmpwSelectGuestNumberEvent implements Struct {
    public static final Adapter<LYSWmpwSelectGuestNumberEvent, Object> ADAPTER = new LYSWmpwSelectGuestNumberEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSWmpwSelectGuestNumberEvent$LYSWmpwSelectGuestNumberEventAdapter */
    private static final class LYSWmpwSelectGuestNumberEventAdapter implements Adapter<LYSWmpwSelectGuestNumberEvent, Object> {
    ...
    public String toString() {
        return "LYSWmpwSelectGuestNumberEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", value=" + this.value + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + "}";
    }
