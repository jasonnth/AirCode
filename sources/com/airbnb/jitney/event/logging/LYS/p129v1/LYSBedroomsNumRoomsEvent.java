...
/* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSBedroomsNumRoomsEvent */
public final class LYSBedroomsNumRoomsEvent implements Struct {
    public static final Adapter<LYSBedroomsNumRoomsEvent, Builder> ADAPTER = new LYSBedroomsNumRoomsEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSBedroomsNumRoomsEvent$Builder */
    public static final class Builder implements StructBuilder<LYSBedroomsNumRoomsEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.LYS:LYSBedroomsNumRoomsEvent:1.0.0";
            this.event_name = "lys_bedrooms_num_rooms";
            this.page = "Bedrooms";
        ...
        public LYSBedroomsNumRoomsEvent build() {
            if (this.event_name == null) {
                ...
                return new LYSBedroomsNumRoomsEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSBedroomsNumRoomsEvent$LYSBedroomsNumRoomsEventAdapter */
    private static final class LYSBedroomsNumRoomsEventAdapter implements Adapter<LYSBedroomsNumRoomsEvent, Builder> {
        private LYSBedroomsNumRoomsEventAdapter() {
        }

        public void write(Protocol protocol, LYSBedroomsNumRoomsEvent struct) throws IOException {
            protocol.writeStructBegin("LYSBedroomsNumRoomsEvent");
    ...
    private LYSBedroomsNumRoomsEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LYSBedroomsNumRoomsEvent)) {
            return false;
        }
        LYSBedroomsNumRoomsEvent that = (LYSBedroomsNumRoomsEvent) other;
    ...
    public String toString() {
        return "LYSBedroomsNumRoomsEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", value=" + this.value + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + "}";
    }
