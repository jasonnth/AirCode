...
/* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSEnterResidentNameEvent */
public final class LYSEnterResidentNameEvent implements Struct {
    public static final Adapter<LYSEnterResidentNameEvent, Object> ADAPTER = new LYSEnterResidentNameEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSEnterResidentNameEvent$LYSEnterResidentNameEventAdapter */
    private static final class LYSEnterResidentNameEventAdapter implements Adapter<LYSEnterResidentNameEvent, Object> {
        private LYSEnterResidentNameEventAdapter() {
        }

        public void write(Protocol protocol, LYSEnterResidentNameEvent struct) throws IOException {
            protocol.writeStructBegin("LYSEnterResidentNameEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LYSEnterResidentNameEvent)) {
            return false;
        }
        LYSEnterResidentNameEvent that = (LYSEnterResidentNameEvent) other;
    ...
    public String toString() {
        return "LYSEnterResidentNameEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", target=" + this.target + "}";
    }
