...
/* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSBedroomsNumBedsEvent */
public final class LYSBedroomsNumBedsEvent implements Struct {
    public static final Adapter<LYSBedroomsNumBedsEvent, Builder> ADAPTER = new LYSBedroomsNumBedsEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSBedroomsNumBedsEvent$Builder */
    public static final class Builder implements StructBuilder<LYSBedroomsNumBedsEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.LYS:LYSBedroomsNumBedsEvent:1.0.0";
            this.event_name = "lys_bedrooms_num_beds";
            this.page = "Bedrooms";
        ...
        public LYSBedroomsNumBedsEvent build() {
            if (this.event_name == null) {
                ...
                return new LYSBedroomsNumBedsEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSBedroomsNumBedsEvent$LYSBedroomsNumBedsEventAdapter */
    private static final class LYSBedroomsNumBedsEventAdapter implements Adapter<LYSBedroomsNumBedsEvent, Builder> {
        private LYSBedroomsNumBedsEventAdapter() {
        }

        public void write(Protocol protocol, LYSBedroomsNumBedsEvent struct) throws IOException {
            protocol.writeStructBegin("LYSBedroomsNumBedsEvent");
    ...
    private LYSBedroomsNumBedsEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LYSBedroomsNumBedsEvent)) {
            return false;
        }
        LYSBedroomsNumBedsEvent that = (LYSBedroomsNumBedsEvent) other;
    ...
    public String toString() {
        return "LYSBedroomsNumBedsEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", value=" + this.value + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + "}";
    }
