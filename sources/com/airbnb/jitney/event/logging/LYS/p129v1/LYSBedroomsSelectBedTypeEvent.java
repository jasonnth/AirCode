...
/* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSBedroomsSelectBedTypeEvent */
public final class LYSBedroomsSelectBedTypeEvent implements Struct {
    public static final Adapter<LYSBedroomsSelectBedTypeEvent, Builder> ADAPTER = new LYSBedroomsSelectBedTypeEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSBedroomsSelectBedTypeEvent$Builder */
    public static final class Builder implements StructBuilder<LYSBedroomsSelectBedTypeEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.LYS:LYSBedroomsSelectBedTypeEvent:1.0.0";
            this.event_name = "lys_bedrooms_select_bed_type";
            this.page = "Bedrooms";
        ...
        public LYSBedroomsSelectBedTypeEvent build() {
            if (this.event_name == null) {
                ...
                return new LYSBedroomsSelectBedTypeEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSBedroomsSelectBedTypeEvent$LYSBedroomsSelectBedTypeEventAdapter */
    private static final class LYSBedroomsSelectBedTypeEventAdapter implements Adapter<LYSBedroomsSelectBedTypeEvent, Builder> {
        private LYSBedroomsSelectBedTypeEventAdapter() {
        }

        public void write(Protocol protocol, LYSBedroomsSelectBedTypeEvent struct) throws IOException {
    ...
    private LYSBedroomsSelectBedTypeEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LYSBedroomsSelectBedTypeEvent)) {
            return false;
        }
        LYSBedroomsSelectBedTypeEvent that = (LYSBedroomsSelectBedTypeEvent) other;
