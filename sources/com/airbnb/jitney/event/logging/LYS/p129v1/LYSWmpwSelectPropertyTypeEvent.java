...
/* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSWmpwSelectPropertyTypeEvent */
public final class LYSWmpwSelectPropertyTypeEvent implements Struct {
    public static final Adapter<LYSWmpwSelectPropertyTypeEvent, Object> ADAPTER = new LYSWmpwSelectPropertyTypeEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSWmpwSelectPropertyTypeEvent$LYSWmpwSelectPropertyTypeEventAdapter */
    private static final class LYSWmpwSelectPropertyTypeEventAdapter implements Adapter<LYSWmpwSelectPropertyTypeEvent, Object> {
    ...
    public String toString() {
        return "LYSWmpwSelectPropertyTypeEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", value=" + this.value + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + "}";
    }
