...
/* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSEnterResidentEmailEvent */
public final class LYSEnterResidentEmailEvent implements Struct {
    public static final Adapter<LYSEnterResidentEmailEvent, Object> ADAPTER = new LYSEnterResidentEmailEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSEnterResidentEmailEvent$LYSEnterResidentEmailEventAdapter */
    private static final class LYSEnterResidentEmailEventAdapter implements Adapter<LYSEnterResidentEmailEvent, Object> {
        private LYSEnterResidentEmailEventAdapter() {
        }

        public void write(Protocol protocol, LYSEnterResidentEmailEvent struct) throws IOException {
            protocol.writeStructBegin("LYSEnterResidentEmailEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LYSEnterResidentEmailEvent)) {
            return false;
        }
        LYSEnterResidentEmailEvent that = (LYSEnterResidentEmailEvent) other;
    ...
    public String toString() {
        return "LYSEnterResidentEmailEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", target=" + this.target + "}";
    }
