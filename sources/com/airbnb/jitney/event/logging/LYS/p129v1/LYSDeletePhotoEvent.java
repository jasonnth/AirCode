...
/* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSDeletePhotoEvent */
public final class LYSDeletePhotoEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSDeletePhotoEvent$Builder */
    public static final class Builder implements StructBuilder<LYSDeletePhotoEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.LYS:LYSDeletePhotoEvent:1.0.0";
            this.event_name = "lys_delete_photo";
            this.page = "PhotoDetail";
            this.target = "DeletePhoto";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSDeletePhotoEvent$LYSDeletePhotoEventAdapter */
    private static final class LYSDeletePhotoEventAdapter implements Adapter<LYSDeletePhotoEvent, Builder> {
        ...
        public void write(Protocol protocol, LYSDeletePhotoEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LYSDeletePhotoEvent)) {
            return false;
        }
        LYSDeletePhotoEvent that = (LYSDeletePhotoEvent) other;
