...
/* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSBathroomsSelectNumEvent */
public final class LYSBathroomsSelectNumEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSBathroomsSelectNumEvent$Builder */
    public static final class Builder implements StructBuilder<LYSBathroomsSelectNumEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.LYS:LYSBathroomsSelectNumEvent:1.0.0";
            this.event_name = "lys_bathrooms_select_num";
            this.page = "Bathrooms";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSBathroomsSelectNumEvent$LYSBathroomsSelectNumEventAdapter */
    private static final class LYSBathroomsSelectNumEventAdapter implements Adapter<LYSBathroomsSelectNumEvent, Builder> {
        ...
        public void write(Protocol protocol, LYSBathroomsSelectNumEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LYSBathroomsSelectNumEvent)) {
            return false;
        }
        LYSBathroomsSelectNumEvent that = (LYSBathroomsSelectNumEvent) other;
