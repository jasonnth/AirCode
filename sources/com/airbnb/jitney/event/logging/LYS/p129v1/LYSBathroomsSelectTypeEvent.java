...
/* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSBathroomsSelectTypeEvent */
public final class LYSBathroomsSelectTypeEvent implements Struct {
    public static final Adapter<LYSBathroomsSelectTypeEvent, Builder> ADAPTER = new LYSBathroomsSelectTypeEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSBathroomsSelectTypeEvent$Builder */
    public static final class Builder implements StructBuilder<LYSBathroomsSelectTypeEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.LYS:LYSBathroomsSelectTypeEvent:1.0.0";
            this.event_name = "lys_bathrooms_select_type";
            this.page = "Bathrooms";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.LYS.v1.LYSBathroomsSelectTypeEvent$LYSBathroomsSelectTypeEventAdapter */
    private static final class LYSBathroomsSelectTypeEventAdapter implements Adapter<LYSBathroomsSelectTypeEvent, Builder> {
        private LYSBathroomsSelectTypeEventAdapter() {
        }

        public void write(Protocol protocol, LYSBathroomsSelectTypeEvent struct) throws IOException {
            protocol.writeStructBegin("LYSBathroomsSelectTypeEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LYSBathroomsSelectTypeEvent)) {
            return false;
        }
        LYSBathroomsSelectTypeEvent that = (LYSBathroomsSelectTypeEvent) other;
    ...
    public String toString() {
        return "LYSBathroomsSelectTypeEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", value=" + this.value + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + "}";
    }
