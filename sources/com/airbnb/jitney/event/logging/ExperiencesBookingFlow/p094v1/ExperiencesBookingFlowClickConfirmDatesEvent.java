...
/* renamed from: com.airbnb.jitney.event.logging.ExperiencesBookingFlow.v1.ExperiencesBookingFlowClickConfirmDatesEvent */
public final class ExperiencesBookingFlowClickConfirmDatesEvent implements Struct {
    public static final Adapter<ExperiencesBookingFlowClickConfirmDatesEvent, Object> ADAPTER = new ExperiencesBookingFlowClickConfirmDatesEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ExperiencesBookingFlow.v1.ExperiencesBookingFlowClickConfirmDatesEvent$ExperiencesBookingFlowClickConfirmDatesEventAdapter */
    private static final class ExperiencesBookingFlowClickConfirmDatesEventAdapter implements Adapter<ExperiencesBookingFlowClickConfirmDatesEvent, Object> {
        private ExperiencesBookingFlowClickConfirmDatesEventAdapter() {
        }

        public void write(Protocol protocol, ExperiencesBookingFlowClickConfirmDatesEvent struct) throws IOException {
            protocol.writeStructBegin("ExperiencesBookingFlowClickConfirmDatesEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExperiencesBookingFlowClickConfirmDatesEvent)) {
            return false;
        }
        ExperiencesBookingFlowClickConfirmDatesEvent that = (ExperiencesBookingFlowClickConfirmDatesEvent) other;
    ...
    public String toString() {
        return "ExperiencesBookingFlowClickConfirmDatesEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", target=" + this.target + ", price=" + this.price + ", product_info=" + this.product_info + ", spots_booked=" + this.spots_booked + ", dates=" + this.dates + ", spots_left=" + this.spots_left + "}";
    }
