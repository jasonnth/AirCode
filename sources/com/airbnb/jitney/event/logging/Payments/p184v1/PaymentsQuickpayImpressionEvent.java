...
/* renamed from: com.airbnb.jitney.event.logging.Payments.v1.PaymentsQuickpayImpressionEvent */
public final class PaymentsQuickpayImpressionEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Payments.v1.PaymentsQuickpayImpressionEvent$PaymentsQuickpayImpressionEventAdapter */
    ...
    public boolean equals(Object other) {
        ...
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.page == that.page || this.page.equals(that.page)) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.payments_context == that.payments_context || this.payments_context.equals(that.payments_context)) && ((this.guests == that.guests || this.guests.equals(that.guests)) && ((this.schedulable_info == that.schedulable_info || this.schedulable_info.equals(that.schedulable_info)) && (this.dates == that.dates || this.dates.equals(that.dates)))))))))) {
            return true;
        }
        return false;
    }
