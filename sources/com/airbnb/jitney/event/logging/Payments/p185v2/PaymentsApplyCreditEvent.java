...
/* renamed from: com.airbnb.jitney.event.logging.Payments.v2.PaymentsApplyCreditEvent */
public final class PaymentsApplyCreditEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Payments.v2.PaymentsApplyCreditEvent$PaymentsApplyCreditEventAdapter */
    ...
    public boolean equals(Object other) {
        ...
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.page == that.page || this.page.equals(that.page)) && ((this.target == that.target || this.target.equals(that.target)) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.credit_value == that.credit_value || (this.credit_value != null && this.credit_value.equals(that.credit_value))) && (this.quickpay_config == that.quickpay_config || this.quickpay_config.equals(that.quickpay_config))))))))) {
            return true;
        }
        return false;
    }
