...
/* renamed from: com.airbnb.jitney.event.logging.Places.v1.PlacesConfirmAddItineraryEvent */
public final class PlacesConfirmAddItineraryEvent implements Struct {
    public static final Adapter<PlacesConfirmAddItineraryEvent, Object> ADAPTER = new PlacesConfirmAddItineraryEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Places.v1.PlacesConfirmAddItineraryEvent$PlacesConfirmAddItineraryEventAdapter */
    private static final class PlacesConfirmAddItineraryEventAdapter implements Adapter<PlacesConfirmAddItineraryEvent, Object> {
        private PlacesConfirmAddItineraryEventAdapter() {
        }

        public void write(Protocol protocol, PlacesConfirmAddItineraryEvent struct) throws IOException {
            protocol.writeStructBegin("PlacesConfirmAddItineraryEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PlacesConfirmAddItineraryEvent)) {
            return false;
        }
        PlacesConfirmAddItineraryEvent that = (PlacesConfirmAddItineraryEvent) other;
    ...
    public String toString() {
        return "PlacesConfirmAddItineraryEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", target=" + this.target + ", mt_product_type=" + this.mt_product_type + ", mt_product_id=" + this.mt_product_id + "}";
    }
