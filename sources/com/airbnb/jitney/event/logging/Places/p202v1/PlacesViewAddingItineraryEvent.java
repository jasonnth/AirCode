...
/* renamed from: com.airbnb.jitney.event.logging.Places.v1.PlacesViewAddingItineraryEvent */
public final class PlacesViewAddingItineraryEvent implements Struct {
    public static final Adapter<PlacesViewAddingItineraryEvent, Object> ADAPTER = new PlacesViewAddingItineraryEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Places.v1.PlacesViewAddingItineraryEvent$PlacesViewAddingItineraryEventAdapter */
    private static final class PlacesViewAddingItineraryEventAdapter implements Adapter<PlacesViewAddingItineraryEvent, Object> {
        private PlacesViewAddingItineraryEventAdapter() {
        }

        public void write(Protocol protocol, PlacesViewAddingItineraryEvent struct) throws IOException {
            protocol.writeStructBegin("PlacesViewAddingItineraryEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PlacesViewAddingItineraryEvent)) {
            return false;
        }
        PlacesViewAddingItineraryEvent that = (PlacesViewAddingItineraryEvent) other;
    ...
    public String toString() {
        return "PlacesViewAddingItineraryEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", target=" + this.target + ", mt_product_type=" + this.mt_product_type + ", mt_product_id=" + this.mt_product_id + "}";
    }
