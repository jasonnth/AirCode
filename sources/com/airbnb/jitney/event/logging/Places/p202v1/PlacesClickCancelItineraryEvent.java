...
/* renamed from: com.airbnb.jitney.event.logging.Places.v1.PlacesClickCancelItineraryEvent */
public final class PlacesClickCancelItineraryEvent implements Struct {
    public static final Adapter<PlacesClickCancelItineraryEvent, Object> ADAPTER = new PlacesClickCancelItineraryEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Places.v1.PlacesClickCancelItineraryEvent$PlacesClickCancelItineraryEventAdapter */
    private static final class PlacesClickCancelItineraryEventAdapter implements Adapter<PlacesClickCancelItineraryEvent, Object> {
        private PlacesClickCancelItineraryEventAdapter() {
        }

        public void write(Protocol protocol, PlacesClickCancelItineraryEvent struct) throws IOException {
            protocol.writeStructBegin("PlacesClickCancelItineraryEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PlacesClickCancelItineraryEvent)) {
            return false;
        }
        PlacesClickCancelItineraryEvent that = (PlacesClickCancelItineraryEvent) other;
    ...
    public String toString() {
        return "PlacesClickCancelItineraryEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", target=" + this.target + ", mt_product_type=" + this.mt_product_type + ", mt_product_id=" + this.mt_product_id + "}";
    }
