...
/* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v1.BusinessTravelBookingPermissionsInviteClickEvent */
public final class BusinessTravelBookingPermissionsInviteClickEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v1.BusinessTravelBookingPermissionsInviteClickEvent$BusinessTravelBookingPermissionsInviteClickEventAdapter */
    private static final class BusinessTravelBookingPermissionsInviteClickEventAdapter implements Adapter<BusinessTravelBookingPermissionsInviteClickEvent, Object> {
        ...
        public void write(Protocol protocol, BusinessTravelBookingPermissionsInviteClickEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof BusinessTravelBookingPermissionsInviteClickEvent)) {
            return false;
        }
        BusinessTravelBookingPermissionsInviteClickEvent that = (BusinessTravelBookingPermissionsInviteClickEvent) other;
