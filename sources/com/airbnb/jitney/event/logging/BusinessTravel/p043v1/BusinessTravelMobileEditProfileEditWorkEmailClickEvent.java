...
/* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v1.BusinessTravelMobileEditProfileEditWorkEmailClickEvent */
public final class BusinessTravelMobileEditProfileEditWorkEmailClickEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v1.BusinessTravelMobileEditProfileEditWorkEmailClickEvent$BusinessTravelMobileEditProfileEditWorkEmailClickEventAdapter */
    private static final class BusinessTravelMobileEditProfileEditWorkEmailClickEventAdapter implements Adapter<BusinessTravelMobileEditProfileEditWorkEmailClickEvent, Object> {
        ...
        public void write(Protocol protocol, BusinessTravelMobileEditProfileEditWorkEmailClickEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof BusinessTravelMobileEditProfileEditWorkEmailClickEvent)) {
            return false;
        }
        BusinessTravelMobileEditProfileEditWorkEmailClickEvent that = (BusinessTravelMobileEditProfileEditWorkEmailClickEvent) other;
    ...
    public String toString() {
        return "BusinessTravelMobileEditProfileEditWorkEmailClickEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", page=" + this.page + ", confirmation_code=" + this.confirmation_code + "}";
    }
