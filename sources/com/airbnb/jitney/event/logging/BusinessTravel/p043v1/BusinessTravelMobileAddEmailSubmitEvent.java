...
/* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v1.BusinessTravelMobileAddEmailSubmitEvent */
public final class BusinessTravelMobileAddEmailSubmitEvent implements Struct {
    public static final Adapter<BusinessTravelMobileAddEmailSubmitEvent, Object> ADAPTER = new BusinessTravelMobileAddEmailSubmitEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v1.BusinessTravelMobileAddEmailSubmitEvent$BusinessTravelMobileAddEmailSubmitEventAdapter */
    private static final class BusinessTravelMobileAddEmailSubmitEventAdapter implements Adapter<BusinessTravelMobileAddEmailSubmitEvent, Object> {
    ...
    public String toString() {
        return "BusinessTravelMobileAddEmailSubmitEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", page=" + this.page + ", email=" + this.email + ", referrer=" + this.referrer + "}";
    }
