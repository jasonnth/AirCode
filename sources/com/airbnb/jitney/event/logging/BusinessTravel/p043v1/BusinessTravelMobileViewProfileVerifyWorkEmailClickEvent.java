...
/* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v1.BusinessTravelMobileViewProfileVerifyWorkEmailClickEvent */
public final class BusinessTravelMobileViewProfileVerifyWorkEmailClickEvent implements Struct {
    public static final Adapter<BusinessTravelMobileViewProfileVerifyWorkEmailClickEvent, Object> ADAPTER = new BusinessTravelMobileViewProfileVerifyWorkEmailClickEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v1.BusinessTravelMobileViewProfileVerifyWorkEmailClickEvent$BusinessTravelMobileViewProfileVerifyWorkEmailClickEventAdapter */
    private static final class BusinessTravelMobileViewProfileVerifyWorkEmailClickEventAdapter implements Adapter<BusinessTravelMobileViewProfileVerifyWorkEmailClickEvent, Object> {
    ...
    public String toString() {
        return "BusinessTravelMobileViewProfileVerifyWorkEmailClickEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", page=" + this.page + ", referrer=" + this.referrer + "}";
    }
