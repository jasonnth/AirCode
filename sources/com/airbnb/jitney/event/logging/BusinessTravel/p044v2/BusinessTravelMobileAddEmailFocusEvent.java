...
/* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileAddEmailFocusEvent */
public final class BusinessTravelMobileAddEmailFocusEvent implements Struct {
    public static final Adapter<BusinessTravelMobileAddEmailFocusEvent, Builder> ADAPTER = new BusinessTravelMobileAddEmailFocusEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileAddEmailFocusEvent$Builder */
    public static final class Builder implements StructBuilder<BusinessTravelMobileAddEmailFocusEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.BusinessTravel:BusinessTravelMobileAddEmailFocusEvent:2.0.0";
            this.event_name = "businesstravel_mobile_add_email_focus";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileAddEmailFocusEvent$BusinessTravelMobileAddEmailFocusEventAdapter */
    private static final class BusinessTravelMobileAddEmailFocusEventAdapter implements Adapter<BusinessTravelMobileAddEmailFocusEvent, Builder> {
        private BusinessTravelMobileAddEmailFocusEventAdapter() {
        }

        public void write(Protocol protocol, BusinessTravelMobileAddEmailFocusEvent struct) throws IOException {
            protocol.writeStructBegin("BusinessTravelMobileAddEmailFocusEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof BusinessTravelMobileAddEmailFocusEvent)) {
            return false;
        }
        BusinessTravelMobileAddEmailFocusEvent that = (BusinessTravelMobileAddEmailFocusEvent) other;
    ...
    public String toString() {
        return "BusinessTravelMobileAddEmailFocusEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", page=" + this.page + ", biz_travel_referrer=" + this.biz_travel_referrer + "}";
    }
