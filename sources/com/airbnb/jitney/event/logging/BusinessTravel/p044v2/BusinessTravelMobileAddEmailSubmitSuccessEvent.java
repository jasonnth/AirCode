...
/* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileAddEmailSubmitSuccessEvent */
public final class BusinessTravelMobileAddEmailSubmitSuccessEvent implements Struct {
    public static final Adapter<BusinessTravelMobileAddEmailSubmitSuccessEvent, Builder> ADAPTER = new BusinessTravelMobileAddEmailSubmitSuccessEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileAddEmailSubmitSuccessEvent$Builder */
    public static final class Builder implements StructBuilder<BusinessTravelMobileAddEmailSubmitSuccessEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.BusinessTravel:BusinessTravelMobileAddEmailSubmitSuccessEvent:2.0.0";
            this.event_name = "businesstravel_mobile_add_email_submit_success";
        ...
        public BusinessTravelMobileAddEmailSubmitSuccessEvent build() {
            if (this.event_name == null) {
                ...
                return new BusinessTravelMobileAddEmailSubmitSuccessEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileAddEmailSubmitSuccessEvent$BusinessTravelMobileAddEmailSubmitSuccessEventAdapter */
    private static final class BusinessTravelMobileAddEmailSubmitSuccessEventAdapter implements Adapter<BusinessTravelMobileAddEmailSubmitSuccessEvent, Builder> {
        private BusinessTravelMobileAddEmailSubmitSuccessEventAdapter() {
        }

        public void write(Protocol protocol, BusinessTravelMobileAddEmailSubmitSuccessEvent struct) throws IOException {
            protocol.writeStructBegin("BusinessTravelMobileAddEmailSubmitSuccessEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof BusinessTravelMobileAddEmailSubmitSuccessEvent)) {
            return false;
        }
        BusinessTravelMobileAddEmailSubmitSuccessEvent that = (BusinessTravelMobileAddEmailSubmitSuccessEvent) other;
    ...
    public String toString() {
        return "BusinessTravelMobileAddEmailSubmitSuccessEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", page=" + this.page + ", email=" + this.email + ", biz_travel_referrer=" + this.biz_travel_referrer + "}";
    }
