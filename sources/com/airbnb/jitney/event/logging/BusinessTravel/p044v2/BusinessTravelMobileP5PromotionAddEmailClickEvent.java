...
/* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileP5PromotionAddEmailClickEvent */
public final class BusinessTravelMobileP5PromotionAddEmailClickEvent implements Struct {
    public static final Adapter<BusinessTravelMobileP5PromotionAddEmailClickEvent, Builder> ADAPTER = new BusinessTravelMobileP5PromotionAddEmailClickEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileP5PromotionAddEmailClickEvent$Builder */
    public static final class Builder implements StructBuilder<BusinessTravelMobileP5PromotionAddEmailClickEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.BusinessTravel:BusinessTravelMobileP5PromotionAddEmailClickEvent:2.0.0";
            this.event_name = "businesstravel_mobile_p5_promotion_add_email_click";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileP5PromotionAddEmailClickEvent$BusinessTravelMobileP5PromotionAddEmailClickEventAdapter */
    private static final class BusinessTravelMobileP5PromotionAddEmailClickEventAdapter implements Adapter<BusinessTravelMobileP5PromotionAddEmailClickEvent, Builder> {
        private BusinessTravelMobileP5PromotionAddEmailClickEventAdapter() {
        }

        public void write(Protocol protocol, BusinessTravelMobileP5PromotionAddEmailClickEvent struct) throws IOException {
            protocol.writeStructBegin("BusinessTravelMobileP5PromotionAddEmailClickEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof BusinessTravelMobileP5PromotionAddEmailClickEvent)) {
            return false;
        }
        BusinessTravelMobileP5PromotionAddEmailClickEvent that = (BusinessTravelMobileP5PromotionAddEmailClickEvent) other;
    ...
    public String toString() {
        return "BusinessTravelMobileP5PromotionAddEmailClickEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", page=" + this.page + ", confirmation_code=" + this.confirmation_code + "}";
    }
