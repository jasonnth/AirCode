...
/* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileAddEmailVerificationGotItClickEvent */
public final class BusinessTravelMobileAddEmailVerificationGotItClickEvent implements Struct {
    public static final Adapter<BusinessTravelMobileAddEmailVerificationGotItClickEvent, Builder> ADAPTER = new BusinessTravelMobileAddEmailVerificationGotItClickEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileAddEmailVerificationGotItClickEvent$Builder */
    public static final class Builder implements StructBuilder<BusinessTravelMobileAddEmailVerificationGotItClickEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.BusinessTravel:BusinessTravelMobileAddEmailVerificationGotItClickEvent:2.0.0";
            this.event_name = "businesstravel_mobile_add_email_verification_got_it_click";
            this.operation = C2451Operation.Click;
            this.page = "mobile_add_email_verification";
        }
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileAddEmailVerificationGotItClickEvent$BusinessTravelMobileAddEmailVerificationGotItClickEventAdapter */
    private static final class BusinessTravelMobileAddEmailVerificationGotItClickEventAdapter implements Adapter<BusinessTravelMobileAddEmailVerificationGotItClickEvent, Builder> {
        private BusinessTravelMobileAddEmailVerificationGotItClickEventAdapter() {
        }

        public void write(Protocol protocol, BusinessTravelMobileAddEmailVerificationGotItClickEvent struct) throws IOException {
            protocol.writeStructBegin("BusinessTravelMobileAddEmailVerificationGotItClickEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof BusinessTravelMobileAddEmailVerificationGotItClickEvent)) {
            return false;
        }
        BusinessTravelMobileAddEmailVerificationGotItClickEvent that = (BusinessTravelMobileAddEmailVerificationGotItClickEvent) other;
    ...
    public String toString() {
        return "BusinessTravelMobileAddEmailVerificationGotItClickEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", page=" + this.page + ", biz_travel_referrer=" + this.biz_travel_referrer + "}";
    }
