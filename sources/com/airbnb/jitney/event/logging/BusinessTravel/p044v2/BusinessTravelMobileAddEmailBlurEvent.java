...
/* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileAddEmailBlurEvent */
public final class BusinessTravelMobileAddEmailBlurEvent implements Struct {
    public static final Adapter<BusinessTravelMobileAddEmailBlurEvent, Builder> ADAPTER = new BusinessTravelMobileAddEmailBlurEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileAddEmailBlurEvent$Builder */
    public static final class Builder implements StructBuilder<BusinessTravelMobileAddEmailBlurEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.BusinessTravel:BusinessTravelMobileAddEmailBlurEvent:2.0.0";
            this.event_name = "businesstravel_mobile_add_email_blur";
            this.operation = C2451Operation.Blur;
        ...
        public BusinessTravelMobileAddEmailBlurEvent build() {
            if (this.event_name == null) {
                ...
                return new BusinessTravelMobileAddEmailBlurEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileAddEmailBlurEvent$BusinessTravelMobileAddEmailBlurEventAdapter */
    private static final class BusinessTravelMobileAddEmailBlurEventAdapter implements Adapter<BusinessTravelMobileAddEmailBlurEvent, Builder> {
    ...
    private BusinessTravelMobileAddEmailBlurEvent(Builder builder) {
    ...
    public String toString() {
        return "BusinessTravelMobileAddEmailBlurEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", page=" + this.page + ", biz_travel_referrer=" + this.biz_travel_referrer + "}";
    }
