...
/* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileP5PromotionSkipClickEvent */
public final class BusinessTravelMobileP5PromotionSkipClickEvent implements Struct {
    public static final Adapter<BusinessTravelMobileP5PromotionSkipClickEvent, Builder> ADAPTER = new BusinessTravelMobileP5PromotionSkipClickEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileP5PromotionSkipClickEvent$Builder */
    public static final class Builder implements StructBuilder<BusinessTravelMobileP5PromotionSkipClickEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.BusinessTravel:BusinessTravelMobileP5PromotionSkipClickEvent:2.0.0";
            this.event_name = "businesstravel_mobile_p5_promotion_skip_click";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.BusinessTravel.v2.BusinessTravelMobileP5PromotionSkipClickEvent$BusinessTravelMobileP5PromotionSkipClickEventAdapter */
    private static final class BusinessTravelMobileP5PromotionSkipClickEventAdapter implements Adapter<BusinessTravelMobileP5PromotionSkipClickEvent, Builder> {
        private BusinessTravelMobileP5PromotionSkipClickEventAdapter() {
        }

        public void write(Protocol protocol, BusinessTravelMobileP5PromotionSkipClickEvent struct) throws IOException {
            protocol.writeStructBegin("BusinessTravelMobileP5PromotionSkipClickEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof BusinessTravelMobileP5PromotionSkipClickEvent)) {
            return false;
        }
        BusinessTravelMobileP5PromotionSkipClickEvent that = (BusinessTravelMobileP5PromotionSkipClickEvent) other;
    ...
    public String toString() {
        return "BusinessTravelMobileP5PromotionSkipClickEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", page=" + this.page + ", confirmation_code=" + this.confirmation_code + "}";
    }
