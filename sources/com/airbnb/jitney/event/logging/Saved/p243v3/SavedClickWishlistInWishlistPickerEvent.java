...
/* renamed from: com.airbnb.jitney.event.logging.Saved.v3.SavedClickWishlistInWishlistPickerEvent */
public final class SavedClickWishlistInWishlistPickerEvent implements Struct {
    public static final Adapter<SavedClickWishlistInWishlistPickerEvent, Builder> ADAPTER = new SavedClickWishlistInWishlistPickerEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Saved.v3.SavedClickWishlistInWishlistPickerEvent$Builder */
    public static final class Builder implements StructBuilder<SavedClickWishlistInWishlistPickerEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Saved:SavedClickWishlistInWishlistPickerEvent:3.0.0";
            this.event_name = "saved_click_wishlist_in_wishlist_picker";
            this.target = "wishlist";
            this.operation = C2451Operation.Click;
        }

        public Builder(Context context2, C2813WishlistSource wishlist_source2, C2815WishlistedItemType wishlisted_item_type2, Long wishlisted_item_id2, Long wishlist_id2, String mobile_search_session_id2) {
            this.schema = "com.airbnb.jitney.event.logging.Saved:SavedClickWishlistInWishlistPickerEvent:3.0.0";
            this.event_name = "saved_click_wishlist_in_wishlist_picker";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Saved.v3.SavedClickWishlistInWishlistPickerEvent$SavedClickWishlistInWishlistPickerEventAdapter */
    private static final class SavedClickWishlistInWishlistPickerEventAdapter implements Adapter<SavedClickWishlistInWishlistPickerEvent, Builder> {
