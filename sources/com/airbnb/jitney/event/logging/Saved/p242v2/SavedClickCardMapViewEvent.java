...
/* renamed from: com.airbnb.jitney.event.logging.Saved.v2.SavedClickCardMapViewEvent */
public final class SavedClickCardMapViewEvent implements Struct {
    public static final Adapter<SavedClickCardMapViewEvent, Builder> ADAPTER = new SavedClickCardMapViewEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Saved.v2.SavedClickCardMapViewEvent$Builder */
    public static final class Builder implements StructBuilder<SavedClickCardMapViewEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Saved:SavedClickCardMapViewEvent:2.0.1";
            this.event_name = "saved_click_card_map_view";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Saved.v2.SavedClickCardMapViewEvent$SavedClickCardMapViewEventAdapter */
    private static final class SavedClickCardMapViewEventAdapter implements Adapter<SavedClickCardMapViewEvent, Builder> {
    ...
    public String toString() {
        return "SavedClickCardMapViewEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", subtab=" + this.subtab + ", operation=" + this.operation + ", target=" + this.target + ", wishlisted_item_type=" + this.wishlisted_item_type + ", wishlisted_item_id=" + this.wishlisted_item_id + ", wishlist_id=" + this.wishlist_id + "}";
    }
