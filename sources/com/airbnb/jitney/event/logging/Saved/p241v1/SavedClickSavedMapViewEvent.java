...
/* renamed from: com.airbnb.jitney.event.logging.Saved.v1.SavedClickSavedMapViewEvent */
public final class SavedClickSavedMapViewEvent implements Struct {
    public static final Adapter<SavedClickSavedMapViewEvent, Builder> ADAPTER = new SavedClickSavedMapViewEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Saved.v1.SavedClickSavedMapViewEvent$Builder */
    public static final class Builder implements StructBuilder<SavedClickSavedMapViewEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Saved:SavedClickSavedMapViewEvent:1.0.0";
            this.event_name = "saved_click_saved_map_view";
            this.page = "wishlist_list";
            this.operation = C2451Operation.Click;
            this.target = "wishlist_map";
        }
        ...
        public SavedClickSavedMapViewEvent build() {
            if (this.event_name == null) {
                ...
                return new SavedClickSavedMapViewEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Saved.v1.SavedClickSavedMapViewEvent$SavedClickSavedMapViewEventAdapter */
    private static final class SavedClickSavedMapViewEventAdapter implements Adapter<SavedClickSavedMapViewEvent, Builder> {
        private SavedClickSavedMapViewEventAdapter() {
        }

        public void write(Protocol protocol, SavedClickSavedMapViewEvent struct) throws IOException {
            protocol.writeStructBegin("SavedClickSavedMapViewEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SavedClickSavedMapViewEvent)) {
            return false;
        }
        SavedClickSavedMapViewEvent that = (SavedClickSavedMapViewEvent) other;
    ...
    public String toString() {
        return "SavedClickSavedMapViewEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", subtab=" + this.subtab + ", operation=" + this.operation + ", target=" + this.target + ", wishlist_id=" + this.wishlist_id + "}";
    }
