...
/* renamed from: com.airbnb.jitney.event.logging.Saved.v1.SavedUpdateDatesEvent */
public final class SavedUpdateDatesEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Saved.v1.SavedUpdateDatesEvent$SavedUpdateDatesEventAdapter */
    private static final class SavedUpdateDatesEventAdapter implements Adapter<SavedUpdateDatesEvent, Object> {
        ...
        public void write(Protocol protocol, SavedUpdateDatesEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SavedUpdateDatesEvent)) {
            return false;
        }
        SavedUpdateDatesEvent that = (SavedUpdateDatesEvent) other;
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.page == that.page || this.page.equals(that.page)) && ((this.target == that.target || this.target.equals(that.target)) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.dates == that.dates || this.dates.equals(that.dates)) && (this.wishlist_id == that.wishlist_id || this.wishlist_id.equals(that.wishlist_id))))))))) {
            return true;
        }
        return false;
    }
