...
/* renamed from: com.airbnb.jitney.event.logging.Saved.v1.SavedClickWishlistInWishlistPickerEvent */
public final class SavedClickWishlistInWishlistPickerEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Saved.v1.SavedClickWishlistInWishlistPickerEvent$SavedClickWishlistInWishlistPickerEventAdapter */
    private static final class SavedClickWishlistInWishlistPickerEventAdapter implements Adapter<SavedClickWishlistInWishlistPickerEvent, Object> {
        ...
        public void write(Protocol protocol, SavedClickWishlistInWishlistPickerEvent struct) throws IOException {
            ...
            for (C2807WishlistContext item03 : struct.wishlist_context) {
                C2807WishlistContext.ADAPTER.write(protocol, item03);
            }
            protocol.writeListEnd();
            protocol.writeFieldEnd();
    ...
    public boolean equals(Object other) {
        ...
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.target == that.target || this.target.equals(that.target)) && ((this.operation == that.operation || this.operation.equals(that.operation)) && ((this.wishlist_source == that.wishlist_source || this.wishlist_source.equals(that.wishlist_source)) && ((this.dates == that.dates || (this.dates != null && this.dates.equals(that.dates))) && ((this.guests == that.guests || (this.guests != null && this.guests.equals(that.guests))) && ((this.wishlist_context == that.wishlist_context || this.wishlist_context.equals(that.wishlist_context)) && (this.mobile_search_session_id == that.mobile_search_session_id || this.mobile_search_session_id.equals(that.mobile_search_session_id))))))))))) {
            return true;
        }
        return false;
    }
