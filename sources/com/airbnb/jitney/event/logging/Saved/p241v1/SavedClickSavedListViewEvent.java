...
/* renamed from: com.airbnb.jitney.event.logging.Saved.v1.SavedClickSavedListViewEvent */
public final class SavedClickSavedListViewEvent implements Struct {
    public static final Adapter<SavedClickSavedListViewEvent, Object> ADAPTER = new SavedClickSavedListViewEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Saved.v1.SavedClickSavedListViewEvent$SavedClickSavedListViewEventAdapter */
    private static final class SavedClickSavedListViewEventAdapter implements Adapter<SavedClickSavedListViewEvent, Object> {
        private SavedClickSavedListViewEventAdapter() {
        }

        public void write(Protocol protocol, SavedClickSavedListViewEvent struct) throws IOException {
            protocol.writeStructBegin("SavedClickSavedListViewEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SavedClickSavedListViewEvent)) {
            return false;
        }
        SavedClickSavedListViewEvent that = (SavedClickSavedListViewEvent) other;
    ...
    public String toString() {
        return "SavedClickSavedListViewEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", subtab=" + this.subtab + ", operation=" + this.operation + ", target=" + this.target + ", wishlist_id=" + this.wishlist_id + "}";
    }
