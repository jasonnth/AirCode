...
/* renamed from: com.airbnb.jitney.event.logging.Saved.v1.SavedClickSettingsEvent */
public final class SavedClickSettingsEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Saved.v1.SavedClickSettingsEvent$SavedClickSettingsEventAdapter */
    private static final class SavedClickSettingsEventAdapter implements Adapter<SavedClickSettingsEvent, Object> {
        ...
        public void write(Protocol protocol, SavedClickSettingsEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SavedClickSettingsEvent)) {
            return false;
        }
        SavedClickSettingsEvent that = (SavedClickSettingsEvent) other;
