...
/* renamed from: com.airbnb.jitney.event.logging.Saved.v1.SavedClickMapMarkerEvent */
public final class SavedClickMapMarkerEvent implements Struct {
    public static final Adapter<SavedClickMapMarkerEvent, Builder> ADAPTER = new SavedClickMapMarkerEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Saved.v1.SavedClickMapMarkerEvent$Builder */
    public static final class Builder implements StructBuilder<SavedClickMapMarkerEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Saved:SavedClickMapMarkerEvent:1.0.0";
            this.event_name = "saved_click_map_marker";
            this.page = "wishlist_map";
            this.operation = C2451Operation.Click;
            this.target = "map_marker";
        }
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Saved.v1.SavedClickMapMarkerEvent$SavedClickMapMarkerEventAdapter */
    private static final class SavedClickMapMarkerEventAdapter implements Adapter<SavedClickMapMarkerEvent, Builder> {
        private SavedClickMapMarkerEventAdapter() {
        }

        public void write(Protocol protocol, SavedClickMapMarkerEvent struct) throws IOException {
            protocol.writeStructBegin("SavedClickMapMarkerEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SavedClickMapMarkerEvent)) {
            return false;
        }
        SavedClickMapMarkerEvent that = (SavedClickMapMarkerEvent) other;
    ...
    public String toString() {
        return "SavedClickMapMarkerEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", subtab=" + this.subtab + ", operation=" + this.operation + ", target=" + this.target + ", wishlisted_item_type=" + this.wishlisted_item_type + ", wishlisted_item_id=" + this.wishlisted_item_id + ", wishlist_id=" + this.wishlist_id + "}";
    }
