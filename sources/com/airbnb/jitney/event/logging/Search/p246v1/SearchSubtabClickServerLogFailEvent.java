...
/* renamed from: com.airbnb.jitney.event.logging.Search.v1.SearchSubtabClickServerLogFailEvent */
public final class SearchSubtabClickServerLogFailEvent implements Struct {
    public static final Adapter<SearchSubtabClickServerLogFailEvent, Builder> ADAPTER = new SearchSubtabClickServerLogFailEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Search.v1.SearchSubtabClickServerLogFailEvent$Builder */
    public static final class Builder implements StructBuilder<SearchSubtabClickServerLogFailEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Search:SearchSubtabClickServerLogFailEvent:1.0.0";
            this.event_name = "search_subtab_click_server_log_fail";
        ...
        public SearchSubtabClickServerLogFailEvent build() {
            if (this.event_name == null) {
                ...
                return new SearchSubtabClickServerLogFailEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Search.v1.SearchSubtabClickServerLogFailEvent$SearchSubtabClickServerLogFailEventAdapter */
    private static final class SearchSubtabClickServerLogFailEventAdapter implements Adapter<SearchSubtabClickServerLogFailEvent, Builder> {
        private SearchSubtabClickServerLogFailEventAdapter() {
        }

        public void write(Protocol protocol, SearchSubtabClickServerLogFailEvent struct) throws IOException {
            protocol.writeStructBegin("SearchSubtabClickServerLogFailEvent");
    ...
    private SearchSubtabClickServerLogFailEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SearchSubtabClickServerLogFailEvent)) {
            return false;
        }
        SearchSubtabClickServerLogFailEvent that = (SearchSubtabClickServerLogFailEvent) other;
    ...
    public String toString() {
        return "SearchSubtabClickServerLogFailEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", location=" + this.location + ", dates=" + this.dates + ", guests=" + this.guests + ", subtab=" + this.subtab + ", subtab_previous=" + this.subtab_previous + ", search_context=" + this.search_context + ", new_query=" + this.new_query + ", location_next=" + this.location_next + ", dates_next=" + this.dates_next + "}";
    }
