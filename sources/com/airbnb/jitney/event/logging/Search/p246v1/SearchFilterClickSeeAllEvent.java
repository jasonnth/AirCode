...
/* renamed from: com.airbnb.jitney.event.logging.Search.v1.SearchFilterClickSeeAllEvent */
public final class SearchFilterClickSeeAllEvent implements Struct {
    public static final Adapter<SearchFilterClickSeeAllEvent, Object> ADAPTER = new SearchFilterClickSeeAllEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Search.v1.SearchFilterClickSeeAllEvent$SearchFilterClickSeeAllEventAdapter */
    private static final class SearchFilterClickSeeAllEventAdapter implements Adapter<SearchFilterClickSeeAllEvent, Object> {
        private SearchFilterClickSeeAllEventAdapter() {
        }

        public void write(Protocol protocol, SearchFilterClickSeeAllEvent struct) throws IOException {
            protocol.writeStructBegin("SearchFilterClickSeeAllEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SearchFilterClickSeeAllEvent)) {
            return false;
        }
        SearchFilterClickSeeAllEvent that = (SearchFilterClickSeeAllEvent) other;
    ...
    public String toString() {
        return "SearchFilterClickSeeAllEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", source=" + this.source + ", operation=" + this.operation + ", target=" + this.target + ", subtab=" + this.subtab + ", search_context=" + this.search_context + "}";
    }
