...
/* renamed from: com.airbnb.jitney.event.logging.Search.v1.SearchUnhideListingEvent */
public final class SearchUnhideListingEvent implements Struct {
    public static final Adapter<SearchUnhideListingEvent, Object> ADAPTER = new SearchUnhideListingEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Search.v1.SearchUnhideListingEvent$SearchUnhideListingEventAdapter */
    private static final class SearchUnhideListingEventAdapter implements Adapter<SearchUnhideListingEvent, Object> {
        private SearchUnhideListingEventAdapter() {
        }

        public void write(Protocol protocol, SearchUnhideListingEvent struct) throws IOException {
            protocol.writeStructBegin("SearchUnhideListingEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SearchUnhideListingEvent)) {
            return false;
        }
        SearchUnhideListingEvent that = (SearchUnhideListingEvent) other;
    ...
    public String toString() {
        return "SearchUnhideListingEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", search_context=" + this.search_context + "}";
    }
