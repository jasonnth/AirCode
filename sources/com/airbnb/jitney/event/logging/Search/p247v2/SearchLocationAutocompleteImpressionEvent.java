...
import com.airbnb.jitney.event.logging.AutocompletionTuple.p039v2.C1801AutocompletionTuple;
...
/* renamed from: com.airbnb.jitney.event.logging.Search.v2.SearchLocationAutocompleteImpressionEvent */
public final class SearchLocationAutocompleteImpressionEvent implements Struct {
    ...
    public final C1801AutocompletionTuple autocomplete_suggestion_clicked;
    public final List<C1801AutocompletionTuple> autocomplete_suggestions;
    public final Context context;
    public final String event_name;
    public final String location_input;
    public final String schema;

    /* renamed from: com.airbnb.jitney.event.logging.Search.v2.SearchLocationAutocompleteImpressionEvent$SearchLocationAutocompleteImpressionEventAdapter */
    private static final class SearchLocationAutocompleteImpressionEventAdapter implements Adapter<SearchLocationAutocompleteImpressionEvent, Object> {
        ...
        public void write(Protocol protocol, SearchLocationAutocompleteImpressionEvent struct) throws IOException {
            ...
            for (C1801AutocompletionTuple item0 : struct.autocomplete_suggestions) {
                C1801AutocompletionTuple.ADAPTER.write(protocol, item0);
            }
            ...
            if (struct.autocomplete_suggestion_clicked != null) {
                ...
                C1801AutocompletionTuple.ADAPTER.write(protocol, struct.autocomplete_suggestion_clicked);
                protocol.writeFieldEnd();
            }
