...
/* renamed from: com.airbnb.jitney.event.logging.ManageListing.v2.ManageListingCityRegistrationAddressInputEvent */
public final class ManageListingCityRegistrationAddressInputEvent implements Struct {
    public static final Adapter<ManageListingCityRegistrationAddressInputEvent, Object> ADAPTER = new ManageListingCityRegistrationAddressInputEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ManageListing.v2.ManageListingCityRegistrationAddressInputEvent$ManageListingCityRegistrationAddressInputEventAdapter */
    private static final class ManageListingCityRegistrationAddressInputEventAdapter implements Adapter<ManageListingCityRegistrationAddressInputEvent, Object> {
        private ManageListingCityRegistrationAddressInputEventAdapter() {
        }

        public void write(Protocol protocol, ManageListingCityRegistrationAddressInputEvent struct) throws IOException {
            protocol.writeStructBegin("ManageListingCityRegistrationAddressInputEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ManageListingCityRegistrationAddressInputEvent)) {
            return false;
        }
        ManageListingCityRegistrationAddressInputEvent that = (ManageListingCityRegistrationAddressInputEvent) other;
    ...
    public String toString() {
        return "ManageListingCityRegistrationAddressInputEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", regulatory_body=" + this.regulatory_body + ", page=" + this.page + ", input_key=" + this.input_key + ", group_key=" + this.group_key + ", value=" + this.value + "}";
    }
