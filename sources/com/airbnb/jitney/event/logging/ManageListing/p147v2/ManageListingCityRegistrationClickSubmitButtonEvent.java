...
/* renamed from: com.airbnb.jitney.event.logging.ManageListing.v2.ManageListingCityRegistrationClickSubmitButtonEvent */
public final class ManageListingCityRegistrationClickSubmitButtonEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ManageListing.v2.ManageListingCityRegistrationClickSubmitButtonEvent$ManageListingCityRegistrationClickSubmitButtonEventAdapter */
    private static final class ManageListingCityRegistrationClickSubmitButtonEventAdapter implements Adapter<ManageListingCityRegistrationClickSubmitButtonEvent, Object> {
        ...
        public void write(Protocol protocol, ManageListingCityRegistrationClickSubmitButtonEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ManageListingCityRegistrationClickSubmitButtonEvent)) {
            return false;
        }
        ManageListingCityRegistrationClickSubmitButtonEvent that = (ManageListingCityRegistrationClickSubmitButtonEvent) other;
