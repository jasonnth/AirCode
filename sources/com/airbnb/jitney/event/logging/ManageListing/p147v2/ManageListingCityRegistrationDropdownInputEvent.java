...
/* renamed from: com.airbnb.jitney.event.logging.ManageListing.v2.ManageListingCityRegistrationDropdownInputEvent */
public final class ManageListingCityRegistrationDropdownInputEvent implements Struct {
    public static final Adapter<ManageListingCityRegistrationDropdownInputEvent, Object> ADAPTER = new ManageListingCityRegistrationDropdownInputEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ManageListing.v2.ManageListingCityRegistrationDropdownInputEvent$ManageListingCityRegistrationDropdownInputEventAdapter */
    private static final class ManageListingCityRegistrationDropdownInputEventAdapter implements Adapter<ManageListingCityRegistrationDropdownInputEvent, Object> {
        private ManageListingCityRegistrationDropdownInputEventAdapter() {
        }

        public void write(Protocol protocol, ManageListingCityRegistrationDropdownInputEvent struct) throws IOException {
            protocol.writeStructBegin("ManageListingCityRegistrationDropdownInputEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ManageListingCityRegistrationDropdownInputEvent)) {
            return false;
        }
        ManageListingCityRegistrationDropdownInputEvent that = (ManageListingCityRegistrationDropdownInputEvent) other;
    ...
    public String toString() {
        return "ManageListingCityRegistrationDropdownInputEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", regulatory_body=" + this.regulatory_body + ", page=" + this.page + ", input_key=" + this.input_key + ", group_key=" + this.group_key + ", value=" + this.value + "}";
    }
