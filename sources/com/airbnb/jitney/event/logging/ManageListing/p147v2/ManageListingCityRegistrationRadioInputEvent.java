...
/* renamed from: com.airbnb.jitney.event.logging.ManageListing.v2.ManageListingCityRegistrationRadioInputEvent */
public final class ManageListingCityRegistrationRadioInputEvent implements Struct {
    public static final Adapter<ManageListingCityRegistrationRadioInputEvent, Object> ADAPTER = new ManageListingCityRegistrationRadioInputEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.ManageListing.v2.ManageListingCityRegistrationRadioInputEvent$ManageListingCityRegistrationRadioInputEventAdapter */
    private static final class ManageListingCityRegistrationRadioInputEventAdapter implements Adapter<ManageListingCityRegistrationRadioInputEvent, Object> {
        private ManageListingCityRegistrationRadioInputEventAdapter() {
        }

        public void write(Protocol protocol, ManageListingCityRegistrationRadioInputEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ManageListingCityRegistrationRadioInputEvent)) {
            return false;
        }
        ManageListingCityRegistrationRadioInputEvent that = (ManageListingCityRegistrationRadioInputEvent) other;
