...
/* renamed from: com.airbnb.jitney.event.logging.Calendar.v1.CalendarSingleListingAgendaLoadMoreEvent */
public final class CalendarSingleListingAgendaLoadMoreEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Calendar.v1.CalendarSingleListingAgendaLoadMoreEvent$Builder */
    public static final class Builder implements StructBuilder<CalendarSingleListingAgendaLoadMoreEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Calendar:CalendarSingleListingAgendaLoadMoreEvent:1.0.0";
            this.event_name = "calendar_single_listing_agenda_load_more";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Calendar.v1.CalendarSingleListingAgendaLoadMoreEvent$CalendarSingleListingAgendaLoadMoreEventAdapter */
    private static final class CalendarSingleListingAgendaLoadMoreEventAdapter implements Adapter<CalendarSingleListingAgendaLoadMoreEvent, Builder> {
        ...
        public void write(Protocol protocol, CalendarSingleListingAgendaLoadMoreEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CalendarSingleListingAgendaLoadMoreEvent)) {
            return false;
        }
        CalendarSingleListingAgendaLoadMoreEvent that = (CalendarSingleListingAgendaLoadMoreEvent) other;
