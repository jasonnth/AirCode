...
/* renamed from: com.airbnb.jitney.event.logging.Calendar.v1.CalendarMultiListingAgendaMessageEvent */
public final class CalendarMultiListingAgendaMessageEvent implements Struct {
    public static final Adapter<CalendarMultiListingAgendaMessageEvent, Builder> ADAPTER = new CalendarMultiListingAgendaMessageEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Calendar.v1.CalendarMultiListingAgendaMessageEvent$Builder */
    public static final class Builder implements StructBuilder<CalendarMultiListingAgendaMessageEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Calendar:CalendarMultiListingAgendaMessageEvent:1.0.0";
            this.event_name = "calendar_multi_listing_agenda_message";
        ...
        public CalendarMultiListingAgendaMessageEvent build() {
            if (this.event_name == null) {
                ...
                return new CalendarMultiListingAgendaMessageEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Calendar.v1.CalendarMultiListingAgendaMessageEvent$CalendarMultiListingAgendaMessageEventAdapter */
    private static final class CalendarMultiListingAgendaMessageEventAdapter implements Adapter<CalendarMultiListingAgendaMessageEvent, Builder> {
        private CalendarMultiListingAgendaMessageEventAdapter() {
        }

        public void write(Protocol protocol, CalendarMultiListingAgendaMessageEvent struct) throws IOException {
            protocol.writeStructBegin("CalendarMultiListingAgendaMessageEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CalendarMultiListingAgendaMessageEvent)) {
            return false;
        }
        CalendarMultiListingAgendaMessageEvent that = (CalendarMultiListingAgendaMessageEvent) other;
    ...
    public String toString() {
        return "CalendarMultiListingAgendaMessageEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", message_thread_id=" + this.message_thread_id + "}";
    }
