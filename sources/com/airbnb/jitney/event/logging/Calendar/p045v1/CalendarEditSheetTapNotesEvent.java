...
/* renamed from: com.airbnb.jitney.event.logging.Calendar.v1.CalendarEditSheetTapNotesEvent */
public final class CalendarEditSheetTapNotesEvent implements Struct {
    public static final Adapter<CalendarEditSheetTapNotesEvent, Builder> ADAPTER = new CalendarEditSheetTapNotesEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Calendar.v1.CalendarEditSheetTapNotesEvent$Builder */
    public static final class Builder implements StructBuilder<CalendarEditSheetTapNotesEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Calendar:CalendarEditSheetTapNotesEvent:1.0.0";
            this.event_name = "calendar_edit_sheet_tap_notes";
            this.page = "calendar_edit_sheet";
            this.target = "note_button";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Calendar.v1.CalendarEditSheetTapNotesEvent$CalendarEditSheetTapNotesEventAdapter */
    private static final class CalendarEditSheetTapNotesEventAdapter implements Adapter<CalendarEditSheetTapNotesEvent, Builder> {
        private CalendarEditSheetTapNotesEventAdapter() {
        }

        public void write(Protocol protocol, CalendarEditSheetTapNotesEvent struct) throws IOException {
            protocol.writeStructBegin("CalendarEditSheetTapNotesEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CalendarEditSheetTapNotesEvent)) {
            return false;
        }
        CalendarEditSheetTapNotesEvent that = (CalendarEditSheetTapNotesEvent) other;
    ...
    public String toString() {
        return "CalendarEditSheetTapNotesEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", listing_id=" + this.listing_id + ", dates_selected=" + this.dates_selected + ", add_or_edit=" + this.add_or_edit + "}";
    }
