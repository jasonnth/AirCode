...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowBookingSummaryToggleBtEvent */
public final class MobileP4FlowBookingSummaryToggleBtEvent implements Struct {
    public static final Adapter<MobileP4FlowBookingSummaryToggleBtEvent, Builder> ADAPTER = new MobileP4FlowBookingSummaryToggleBtEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowBookingSummaryToggleBtEvent$Builder */
    public static final class Builder implements StructBuilder<MobileP4FlowBookingSummaryToggleBtEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.MobileP4Flow:MobileP4FlowBookingSummaryToggleBtEvent:1.0.0";
            this.event_name = "mobilep4flow_booking_summary_toggle_bt";
            this.page = "BookingSummary";
            this.section = IntentPredictionConstants.BusinessTravelServerKey;
            this.operation = C2451Operation.Toggle;
        }

        public Builder(Context context2, Long user_id2, Long listing_id2, String reservation_code2, Boolean instant_book2, C2759ToggleMethod toggle_method2) {
            this.schema = "com.airbnb.jitney.event.logging.MobileP4Flow:MobileP4FlowBookingSummaryToggleBtEvent:1.0.0";
            this.event_name = "mobilep4flow_booking_summary_toggle_bt";
        ...
        public MobileP4FlowBookingSummaryToggleBtEvent build() {
            if (this.event_name == null) {
                ...
                return new MobileP4FlowBookingSummaryToggleBtEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowBookingSummaryToggleBtEvent$MobileP4FlowBookingSummaryToggleBtEventAdapter */
    private static final class MobileP4FlowBookingSummaryToggleBtEventAdapter implements Adapter<MobileP4FlowBookingSummaryToggleBtEvent, Builder> {
        private MobileP4FlowBookingSummaryToggleBtEventAdapter() {
        }

        public void write(Protocol protocol, MobileP4FlowBookingSummaryToggleBtEvent struct) throws IOException {
            protocol.writeStructBegin("MobileP4FlowBookingSummaryToggleBtEvent");
    ...
    private MobileP4FlowBookingSummaryToggleBtEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MobileP4FlowBookingSummaryToggleBtEvent)) {
            return false;
        }
        MobileP4FlowBookingSummaryToggleBtEvent that = (MobileP4FlowBookingSummaryToggleBtEvent) other;
