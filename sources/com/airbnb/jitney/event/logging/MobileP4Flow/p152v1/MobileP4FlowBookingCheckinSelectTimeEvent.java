...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowBookingCheckinSelectTimeEvent */
public final class MobileP4FlowBookingCheckinSelectTimeEvent implements Struct {
    public static final Adapter<MobileP4FlowBookingCheckinSelectTimeEvent, Builder> ADAPTER = new MobileP4FlowBookingCheckinSelectTimeEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowBookingCheckinSelectTimeEvent$Builder */
    public static final class Builder implements StructBuilder<MobileP4FlowBookingCheckinSelectTimeEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.MobileP4Flow:MobileP4FlowBookingCheckinSelectTimeEvent:1.0.0";
            this.event_name = "mobilep4flow_booking_checkin_select_time";
            this.page = "BookingCheckinTime";
            this.operation = C2451Operation.Select;
        }

        public Builder(Context context2, Long user_id2, Long listing_id2, Long reservation_id2, Boolean instant_book2) {
            this.schema = "com.airbnb.jitney.event.logging.MobileP4Flow:MobileP4FlowBookingCheckinSelectTimeEvent:1.0.0";
            this.event_name = "mobilep4flow_booking_checkin_select_time";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowBookingCheckinSelectTimeEvent$MobileP4FlowBookingCheckinSelectTimeEventAdapter */
    private static final class MobileP4FlowBookingCheckinSelectTimeEventAdapter implements Adapter<MobileP4FlowBookingCheckinSelectTimeEvent, Builder> {
        ...
        public void write(Protocol protocol, MobileP4FlowBookingCheckinSelectTimeEvent struct) throws IOException {
            protocol.writeStructBegin("MobileP4FlowBookingCheckinSelectTimeEvent");
            ...
            if (struct.checkin_time != null) {
                protocol.writeFieldBegin("checkin_time", 15, 10);
                protocol.writeI64(struct.checkin_time.longValue());
                protocol.writeFieldEnd();
            }
    ...
    private MobileP4FlowBookingCheckinSelectTimeEvent(Builder builder) {
        ...
        this.checkin_time = builder.checkin_time;
