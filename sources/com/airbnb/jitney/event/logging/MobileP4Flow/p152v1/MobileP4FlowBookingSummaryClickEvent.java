...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowBookingSummaryClickEvent */
public final class MobileP4FlowBookingSummaryClickEvent implements Struct {
    public static final Adapter<MobileP4FlowBookingSummaryClickEvent, Builder> ADAPTER = new MobileP4FlowBookingSummaryClickEventAdapter();
    ...
    public final C2469P4FlowSummarySection section;
    public final Long user_id;

    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowBookingSummaryClickEvent$Builder */
    public static final class Builder implements StructBuilder<MobileP4FlowBookingSummaryClickEvent> {
        ...
        /* access modifiers changed from: private */
        public C2469P4FlowSummarySection section;
        /* access modifiers changed from: private */
        public Long user_id;

        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.MobileP4Flow:MobileP4FlowBookingSummaryClickEvent:1.0.0";
            this.event_name = "mobilep4flow_booking_summary_click";
            this.page = "BookingSummary";
            this.operation = C2451Operation.Click;
        }

        public Builder(Context context2, Long user_id2, Long listing_id2, Long reservation_id2, Boolean instant_book2, C2469P4FlowSummarySection section2) {
            this.schema = "com.airbnb.jitney.event.logging.MobileP4Flow:MobileP4FlowBookingSummaryClickEvent:1.0.0";
            this.event_name = "mobilep4flow_booking_summary_click";
        ...
        public MobileP4FlowBookingSummaryClickEvent build() {
            if (this.event_name == null) {
                ...
                return new MobileP4FlowBookingSummaryClickEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowBookingSummaryClickEvent$MobileP4FlowBookingSummaryClickEventAdapter */
    private static final class MobileP4FlowBookingSummaryClickEventAdapter implements Adapter<MobileP4FlowBookingSummaryClickEvent, Builder> {
        private MobileP4FlowBookingSummaryClickEventAdapter() {
        }

        public void write(Protocol protocol, MobileP4FlowBookingSummaryClickEvent struct) throws IOException {
            protocol.writeStructBegin("MobileP4FlowBookingSummaryClickEvent");
    ...
    private MobileP4FlowBookingSummaryClickEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MobileP4FlowBookingSummaryClickEvent)) {
            return false;
        }
        MobileP4FlowBookingSummaryClickEvent that = (MobileP4FlowBookingSummaryClickEvent) other;
    ...
    public String toString() {
        return "MobileP4FlowBookingSummaryClickEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + ", reservation_id=" + this.reservation_id + ", instant_book=" + this.instant_book + ", page=" + this.page + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + ", pets=" + this.pets + ", checkin_date=" + this.checkin_date + ", checkout_date=" + this.checkout_date + ", section=" + this.section + ", operation=" + this.operation + "}";
    }
