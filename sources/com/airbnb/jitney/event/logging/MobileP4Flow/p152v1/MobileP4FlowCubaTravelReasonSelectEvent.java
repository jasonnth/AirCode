...
import com.airbnb.jitney.event.logging.CubaTravelReasonType.p076v1.C1975CubaTravelReasonType;
...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowCubaTravelReasonSelectEvent */
public final class MobileP4FlowCubaTravelReasonSelectEvent implements Struct {
    public static final Adapter<MobileP4FlowCubaTravelReasonSelectEvent, Object> ADAPTER = new MobileP4FlowCubaTravelReasonSelectEventAdapter();
    public final Long adults;
    public final String checkin_date;
    public final String checkout_date;
    public final Long children;
    public final Context context;
    public final C1975CubaTravelReasonType cuba_travel_reason;
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowCubaTravelReasonSelectEvent$MobileP4FlowCubaTravelReasonSelectEventAdapter */
    private static final class MobileP4FlowCubaTravelReasonSelectEventAdapter implements Adapter<MobileP4FlowCubaTravelReasonSelectEvent, Object> {
        private MobileP4FlowCubaTravelReasonSelectEventAdapter() {
        }

        public void write(Protocol protocol, MobileP4FlowCubaTravelReasonSelectEvent struct) throws IOException {
            protocol.writeStructBegin("MobileP4FlowCubaTravelReasonSelectEvent");
            ...
            protocol.writeFieldEnd();
            if (struct.cuba_travel_reason != null) {
                protocol.writeFieldBegin("cuba_travel_reason", 16, 8);
                protocol.writeI32(struct.cuba_travel_reason.value);
                protocol.writeFieldEnd();
            }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MobileP4FlowCubaTravelReasonSelectEvent)) {
            return false;
        }
        MobileP4FlowCubaTravelReasonSelectEvent that = (MobileP4FlowCubaTravelReasonSelectEvent) other;
        if ((this.schema == that.schema || (this.schema != null && this.schema.equals(that.schema))) && ((this.event_name == that.event_name || this.event_name.equals(that.event_name)) && ((this.context == that.context || this.context.equals(that.context)) && ((this.user_id == that.user_id || this.user_id.equals(that.user_id)) && ((this.listing_id == that.listing_id || this.listing_id.equals(that.listing_id)) && ((this.reservation_code == that.reservation_code || this.reservation_code.equals(that.reservation_code)) && ((this.instant_book == that.instant_book || this.instant_book.equals(that.instant_book)) && ((this.page == that.page || this.page.equals(that.page)) && ((this.guests == that.guests || (this.guests != null && this.guests.equals(that.guests))) && ((this.adults == that.adults || (this.adults != null && this.adults.equals(that.adults))) && ((this.children == that.children || (this.children != null && this.children.equals(that.children))) && ((this.infants == that.infants || (this.infants != null && this.infants.equals(that.infants))) && ((this.pets == that.pets || (this.pets != null && this.pets.equals(that.pets))) && ((this.checkin_date == that.checkin_date || (this.checkin_date != null && this.checkin_date.equals(that.checkin_date))) && ((this.checkout_date == that.checkout_date || (this.checkout_date != null && this.checkout_date.equals(that.checkout_date))) && (this.operation == that.operation || this.operation.equals(that.operation))))))))))))))))) {
            if (this.cuba_travel_reason == that.cuba_travel_reason) {
                return true;
            }
            if (this.cuba_travel_reason != null && this.cuba_travel_reason.equals(that.cuba_travel_reason)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        ...
        if (this.cuba_travel_reason != null) {
            i = this.cuba_travel_reason.hashCode();
        }
        return (code ^ i) * -2128831035;
    }

    public String toString() {
        return "MobileP4FlowCubaTravelReasonSelectEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + ", reservation_code=" + this.reservation_code + ", instant_book=" + this.instant_book + ", page=" + this.page + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + ", pets=" + this.pets + ", checkin_date=" + this.checkin_date + ", checkout_date=" + this.checkout_date + ", operation=" + this.operation + ", cuba_travel_reason=" + this.cuba_travel_reason + "}";
    }
