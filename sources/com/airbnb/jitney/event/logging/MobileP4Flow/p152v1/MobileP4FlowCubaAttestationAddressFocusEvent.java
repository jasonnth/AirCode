...
import com.airbnb.jitney.event.logging.CubaAttestationSection.p075v1.C1974CubaAttestationSection;
import com.airbnb.jitney.event.logging.FocusMethod.p102v1.C2143FocusMethod;
...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowCubaAttestationAddressFocusEvent */
public final class MobileP4FlowCubaAttestationAddressFocusEvent implements Struct {
    public static final Adapter<MobileP4FlowCubaAttestationAddressFocusEvent, Object> ADAPTER = new MobileP4FlowCubaAttestationAddressFocusEventAdapter();
    ...
    public final C2143FocusMethod method;
    public final C2451Operation operation;
    public final String page;
    public final Boolean pets;
    public final String reservation_code;
    public final String schema;
    public final C1974CubaAttestationSection section;
    public final String text;
    public final Long user_id;

    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowCubaAttestationAddressFocusEvent$MobileP4FlowCubaAttestationAddressFocusEventAdapter */
    private static final class MobileP4FlowCubaAttestationAddressFocusEventAdapter implements Adapter<MobileP4FlowCubaAttestationAddressFocusEvent, Object> {
        private MobileP4FlowCubaAttestationAddressFocusEventAdapter() {
        }

        public void write(Protocol protocol, MobileP4FlowCubaAttestationAddressFocusEvent struct) throws IOException {
            protocol.writeStructBegin("MobileP4FlowCubaAttestationAddressFocusEvent");
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("method", 17, 8);
            protocol.writeI32(struct.method.value);
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("text", 18, PassportService.SF_DG11);
    ...
    public int hashCode() {
        ...
        return (((((((((code ^ i) * -2128831035) ^ this.section.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.method.hashCode()) * -2128831035) ^ this.text.hashCode()) * -2128831035;
    }

    public String toString() {
        return "MobileP4FlowCubaAttestationAddressFocusEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + ", reservation_code=" + this.reservation_code + ", instant_book=" + this.instant_book + ", page=" + this.page + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + ", pets=" + this.pets + ", checkin_date=" + this.checkin_date + ", checkout_date=" + this.checkout_date + ", section=" + this.section + ", operation=" + this.operation + ", method=" + this.method + ", text=" + this.text + "}";
    }
