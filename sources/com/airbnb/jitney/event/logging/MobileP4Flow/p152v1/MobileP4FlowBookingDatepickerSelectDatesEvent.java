...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowBookingDatepickerSelectDatesEvent */
public final class MobileP4FlowBookingDatepickerSelectDatesEvent implements Struct {
    public static final Adapter<MobileP4FlowBookingDatepickerSelectDatesEvent, Builder> ADAPTER = new MobileP4FlowBookingDatepickerSelectDatesEventAdapter();
    ...
    public final C2463P4FlowDatepickerSection section;
    public final Long user_id;

    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowBookingDatepickerSelectDatesEvent$Builder */
    public static final class Builder implements StructBuilder<MobileP4FlowBookingDatepickerSelectDatesEvent> {
        ...
        /* access modifiers changed from: private */
        public C2463P4FlowDatepickerSection section;
        /* access modifiers changed from: private */
        public Long user_id;

        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.MobileP4Flow:MobileP4FlowBookingDatepickerSelectDatesEvent:1.0.0";
            this.event_name = "mobilep4flow_booking_datepicker_select_dates";
            this.page = "BookingDatepicker";
            this.operation = C2451Operation.Select;
        }

        public Builder(Context context2, Long user_id2, Long listing_id2, Long reservation_id2, Boolean instant_book2, C2463P4FlowDatepickerSection section2) {
            this.schema = "com.airbnb.jitney.event.logging.MobileP4Flow:MobileP4FlowBookingDatepickerSelectDatesEvent:1.0.0";
            this.event_name = "mobilep4flow_booking_datepicker_select_dates";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowBookingDatepickerSelectDatesEvent$MobileP4FlowBookingDatepickerSelectDatesEventAdapter */
    private static final class MobileP4FlowBookingDatepickerSelectDatesEventAdapter implements Adapter<MobileP4FlowBookingDatepickerSelectDatesEvent, Builder> {
        ...
        public void write(Protocol protocol, MobileP4FlowBookingDatepickerSelectDatesEvent struct) throws IOException {
            protocol.writeStructBegin("MobileP4FlowBookingDatepickerSelectDatesEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MobileP4FlowBookingDatepickerSelectDatesEvent)) {
            return false;
        }
        MobileP4FlowBookingDatepickerSelectDatesEvent that = (MobileP4FlowBookingDatepickerSelectDatesEvent) other;
    ...
    public String toString() {
        return "MobileP4FlowBookingDatepickerSelectDatesEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + ", reservation_id=" + this.reservation_id + ", instant_book=" + this.instant_book + ", page=" + this.page + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + ", pets=" + this.pets + ", checkin_date=" + this.checkin_date + ", checkout_date=" + this.checkout_date + ", section=" + this.section + ", operation=" + this.operation + "}";
    }
