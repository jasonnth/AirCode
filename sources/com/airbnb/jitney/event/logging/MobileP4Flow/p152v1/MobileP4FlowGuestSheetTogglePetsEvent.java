...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowGuestSheetTogglePetsEvent */
public final class MobileP4FlowGuestSheetTogglePetsEvent implements Struct {
    public static final Adapter<MobileP4FlowGuestSheetTogglePetsEvent, Builder> ADAPTER = new MobileP4FlowGuestSheetTogglePetsEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowGuestSheetTogglePetsEvent$Builder */
    public static final class Builder implements StructBuilder<MobileP4FlowGuestSheetTogglePetsEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.MobileP4Flow:MobileP4FlowGuestSheetTogglePetsEvent:1.0.0";
            this.event_name = "mobilep4flow_guest_sheet_toggle_pets";
            this.page = "guest_sheet";
            this.section = FindTweenAnalytics.PETS;
            this.operation = C2451Operation.Toggle;
        }

        public Builder(Context context2, Long user_id2, Long listing_id2, Long reservation_id2, Boolean instant_book2, C2759ToggleMethod toggle_method2) {
            this.schema = "com.airbnb.jitney.event.logging.MobileP4Flow:MobileP4FlowGuestSheetTogglePetsEvent:1.0.0";
            this.event_name = "mobilep4flow_guest_sheet_toggle_pets";
        ...
        public MobileP4FlowGuestSheetTogglePetsEvent build() {
            if (this.event_name == null) {
                ...
                return new MobileP4FlowGuestSheetTogglePetsEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowGuestSheetTogglePetsEvent$MobileP4FlowGuestSheetTogglePetsEventAdapter */
    private static final class MobileP4FlowGuestSheetTogglePetsEventAdapter implements Adapter<MobileP4FlowGuestSheetTogglePetsEvent, Builder> {
        private MobileP4FlowGuestSheetTogglePetsEventAdapter() {
        }

        public void write(Protocol protocol, MobileP4FlowGuestSheetTogglePetsEvent struct) throws IOException {
            protocol.writeStructBegin("MobileP4FlowGuestSheetTogglePetsEvent");
            ...
            protocol.writeFieldBegin(BaseAnalytics.SECTION, 15, PassportService.SF_DG11);
            protocol.writeString(struct.section);
            protocol.writeFieldEnd();
            protocol.writeFieldBegin(BaseAnalytics.OPERATION, 16, 8);
            protocol.writeI32(struct.operation.value);
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("toggle_method", 17, 8);
    ...
    private MobileP4FlowGuestSheetTogglePetsEvent(Builder builder) {
    ...
    public int hashCode() {
        ...
        return (((((((code ^ i) * -2128831035) ^ this.section.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.toggle_method.hashCode()) * -2128831035;
    }

    public String toString() {
        return "MobileP4FlowGuestSheetTogglePetsEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + ", reservation_id=" + this.reservation_id + ", instant_book=" + this.instant_book + ", page=" + this.page + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + ", pets=" + this.pets + ", checkin_date=" + this.checkin_date + ", checkout_date=" + this.checkout_date + ", section=" + this.section + ", operation=" + this.operation + ", toggle_method=" + this.toggle_method + "}";
    }
