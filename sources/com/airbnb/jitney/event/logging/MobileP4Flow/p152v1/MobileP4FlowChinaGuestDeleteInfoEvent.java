...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowChinaGuestDeleteInfoEvent */
public final class MobileP4FlowChinaGuestDeleteInfoEvent implements Struct {
    public static final Adapter<MobileP4FlowChinaGuestDeleteInfoEvent, Builder> ADAPTER = new MobileP4FlowChinaGuestDeleteInfoEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowChinaGuestDeleteInfoEvent$Builder */
    public static final class Builder implements StructBuilder<MobileP4FlowChinaGuestDeleteInfoEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.MobileP4Flow:MobileP4FlowChinaGuestDeleteInfoEvent:1.0.0";
            this.event_name = "mobilep4flow_china_guest_delete_info";
            this.page = "ChinaGuestProfiles";
        ...
        public MobileP4FlowChinaGuestDeleteInfoEvent build() {
            if (this.event_name == null) {
                ...
                return new MobileP4FlowChinaGuestDeleteInfoEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowChinaGuestDeleteInfoEvent$MobileP4FlowChinaGuestDeleteInfoEventAdapter */
    private static final class MobileP4FlowChinaGuestDeleteInfoEventAdapter implements Adapter<MobileP4FlowChinaGuestDeleteInfoEvent, Builder> {
        private MobileP4FlowChinaGuestDeleteInfoEventAdapter() {
        }

        public void write(Protocol protocol, MobileP4FlowChinaGuestDeleteInfoEvent struct) throws IOException {
            protocol.writeStructBegin("MobileP4FlowChinaGuestDeleteInfoEvent");
    ...
    private MobileP4FlowChinaGuestDeleteInfoEvent(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MobileP4FlowChinaGuestDeleteInfoEvent)) {
            return false;
        }
        MobileP4FlowChinaGuestDeleteInfoEvent that = (MobileP4FlowChinaGuestDeleteInfoEvent) other;
    ...
    public String toString() {
        return "MobileP4FlowChinaGuestDeleteInfoEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + ", reservation_id=" + this.reservation_id + ", instant_book=" + this.instant_book + ", page=" + this.page + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + ", pets=" + this.pets + ", checkin_date=" + this.checkin_date + ", checkout_date=" + this.checkout_date + ", operation=" + this.operation + "}";
    }
