...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowCubaAttestationCountrySelectEvent */
public final class MobileP4FlowCubaAttestationCountrySelectEvent implements Struct {
    public static final Adapter<MobileP4FlowCubaAttestationCountrySelectEvent, Object> ADAPTER = new MobileP4FlowCubaAttestationCountrySelectEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowCubaAttestationCountrySelectEvent$MobileP4FlowCubaAttestationCountrySelectEventAdapter */
    private static final class MobileP4FlowCubaAttestationCountrySelectEventAdapter implements Adapter<MobileP4FlowCubaAttestationCountrySelectEvent, Object> {
        private MobileP4FlowCubaAttestationCountrySelectEventAdapter() {
        }

        public void write(Protocol protocol, MobileP4FlowCubaAttestationCountrySelectEvent struct) throws IOException {
            protocol.writeStructBegin("MobileP4FlowCubaAttestationCountrySelectEvent");
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("country_code", 17, PassportService.SF_DG11);
