...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowChinaGuestFocusNameSectionEvent */
public final class MobileP4FlowChinaGuestFocusNameSectionEvent implements Struct {
    public static final Adapter<MobileP4FlowChinaGuestFocusNameSectionEvent, Builder> ADAPTER = new MobileP4FlowChinaGuestFocusNameSectionEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowChinaGuestFocusNameSectionEvent$Builder */
    public static final class Builder implements StructBuilder<MobileP4FlowChinaGuestFocusNameSectionEvent> {
        ...
        /* access modifiers changed from: private */
        public C1923ChinaGuestNameSection section;
        /* access modifiers changed from: private */
        public Long user_id;

        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.MobileP4Flow:MobileP4FlowChinaGuestFocusNameSectionEvent:1.0.0";
            this.event_name = "mobilep4flow_china_guest_focus_name_section";
            this.page = "ChinaGuestName";
            this.operation = C2451Operation.Focus;
        }

        public Builder(Context context2, Long user_id2, Long listing_id2, Long reservation_id2, Boolean instant_book2, C1923ChinaGuestNameSection section2) {
            this.schema = "com.airbnb.jitney.event.logging.MobileP4Flow:MobileP4FlowChinaGuestFocusNameSectionEvent:1.0.0";
            this.event_name = "mobilep4flow_china_guest_focus_name_section";
        ...
        public MobileP4FlowChinaGuestFocusNameSectionEvent build() {
            if (this.event_name == null) {
                ...
                return new MobileP4FlowChinaGuestFocusNameSectionEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowChinaGuestFocusNameSectionEvent$MobileP4FlowChinaGuestFocusNameSectionEventAdapter */
    private static final class MobileP4FlowChinaGuestFocusNameSectionEventAdapter implements Adapter<MobileP4FlowChinaGuestFocusNameSectionEvent, Builder> {
    ...
    private MobileP4FlowChinaGuestFocusNameSectionEvent(Builder builder) {
