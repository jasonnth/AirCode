...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowClickNavigationEvent */
public final class MobileP4FlowClickNavigationEvent implements Struct {
    public static final Adapter<MobileP4FlowClickNavigationEvent, Builder> ADAPTER = new MobileP4FlowClickNavigationEventAdapter();
    ...
    public final C2466P4FlowNavigationMethod method;
    public final C2451Operation operation;
    public final C2467P4FlowPage page;
    public final Boolean pets;
    public final Long reservation_id;
    public final String schema;
    public final Long user_id;

    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowClickNavigationEvent$Builder */
    public static final class Builder implements StructBuilder<MobileP4FlowClickNavigationEvent> {
        ...
        /* access modifiers changed from: private */
        public C2466P4FlowNavigationMethod method;
        /* access modifiers changed from: private */
        public C2451Operation operation;
        /* access modifiers changed from: private */
        public C2467P4FlowPage page;
        /* access modifiers changed from: private */
        public Boolean pets;
        /* access modifiers changed from: private */
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.MobileP4Flow:MobileP4FlowClickNavigationEvent:1.0.0";
            this.event_name = "mobilep4flow_click_navigation";
            this.operation = C2451Operation.Click;
        }

        public Builder(Context context2, Long user_id2, Long listing_id2, Long reservation_id2, Boolean instant_book2, C2467P4FlowPage page2, C2466P4FlowNavigationMethod method2) {
            this.schema = "com.airbnb.jitney.event.logging.MobileP4Flow:MobileP4FlowClickNavigationEvent:1.0.0";
            this.event_name = "mobilep4flow_click_navigation";
        ...
        public MobileP4FlowClickNavigationEvent build() {
            if (this.event_name == null) {
                ...
                return new MobileP4FlowClickNavigationEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v1.MobileP4FlowClickNavigationEvent$MobileP4FlowClickNavigationEventAdapter */
    private static final class MobileP4FlowClickNavigationEventAdapter implements Adapter<MobileP4FlowClickNavigationEvent, Builder> {
        private MobileP4FlowClickNavigationEventAdapter() {
        }

        public void write(Protocol protocol, MobileP4FlowClickNavigationEvent struct) throws IOException {
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("page", 7, 8);
            ...
            protocol.writeFieldBegin("method", 15, 8);
    ...
    public int hashCode() {
        ...
        return (((((code ^ i) * -2128831035) ^ this.method.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035;
    }
