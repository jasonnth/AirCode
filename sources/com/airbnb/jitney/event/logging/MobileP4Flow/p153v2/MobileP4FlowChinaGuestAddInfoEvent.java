...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v2.MobileP4FlowChinaGuestAddInfoEvent */
public final class MobileP4FlowChinaGuestAddInfoEvent implements Struct {
    public static final Adapter<MobileP4FlowChinaGuestAddInfoEvent, Object> ADAPTER = new MobileP4FlowChinaGuestAddInfoEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v2.MobileP4FlowChinaGuestAddInfoEvent$MobileP4FlowChinaGuestAddInfoEventAdapter */
    private static final class MobileP4FlowChinaGuestAddInfoEventAdapter implements Adapter<MobileP4FlowChinaGuestAddInfoEvent, Object> {
        private MobileP4FlowChinaGuestAddInfoEventAdapter() {
        }

        public void write(Protocol protocol, MobileP4FlowChinaGuestAddInfoEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MobileP4FlowChinaGuestAddInfoEvent)) {
            return false;
        }
        MobileP4FlowChinaGuestAddInfoEvent that = (MobileP4FlowChinaGuestAddInfoEvent) other;
    ...
    public String toString() {
        return "MobileP4FlowChinaGuestAddInfoEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + ", reservation_code=" + this.reservation_code + ", instant_book=" + this.instant_book + ", page=" + this.page + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + ", pets=" + this.pets + ", checkin_date=" + this.checkin_date + ", checkout_date=" + this.checkout_date + ", operation=" + this.operation + "}";
    }
