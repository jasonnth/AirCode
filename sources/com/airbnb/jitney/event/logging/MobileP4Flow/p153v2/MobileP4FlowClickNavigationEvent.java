...
import com.airbnb.jitney.event.logging.P4FlowPage.p174v2.C2468P4FlowPage;
...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v2.MobileP4FlowClickNavigationEvent */
public final class MobileP4FlowClickNavigationEvent implements Struct {
    ...
    public final C2468P4FlowPage page;
    public final Boolean pets;
    public final String reservation_code;
    public final String schema;
    public final Long user_id;

    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v2.MobileP4FlowClickNavigationEvent$MobileP4FlowClickNavigationEventAdapter */
    ...
    public String toString() {
        return "MobileP4FlowClickNavigationEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + ", reservation_code=" + this.reservation_code + ", instant_book=" + this.instant_book + ", page=" + this.page + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + ", pets=" + this.pets + ", checkin_date=" + this.checkin_date + ", checkout_date=" + this.checkout_date + ", method=" + this.method + ", operation=" + this.operation + "}";
    }
