...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v2.MobileP4FlowGuestSheetTogglePetsEvent */
public final class MobileP4FlowGuestSheetTogglePetsEvent implements Struct {
    public static final Adapter<MobileP4FlowGuestSheetTogglePetsEvent, Object> ADAPTER = new MobileP4FlowGuestSheetTogglePetsEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v2.MobileP4FlowGuestSheetTogglePetsEvent$MobileP4FlowGuestSheetTogglePetsEventAdapter */
    private static final class MobileP4FlowGuestSheetTogglePetsEventAdapter implements Adapter<MobileP4FlowGuestSheetTogglePetsEvent, Object> {
    ...
    public String toString() {
        return "MobileP4FlowGuestSheetTogglePetsEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + ", reservation_code=" + this.reservation_code + ", instant_book=" + this.instant_book + ", page=" + this.page + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + ", pets=" + this.pets + ", checkin_date=" + this.checkin_date + ", checkout_date=" + this.checkout_date + ", section=" + this.section + ", operation=" + this.operation + ", toggle_method=" + this.toggle_method + "}";
    }
