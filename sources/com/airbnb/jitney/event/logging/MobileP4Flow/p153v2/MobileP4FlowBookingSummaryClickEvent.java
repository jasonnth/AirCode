...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v2.MobileP4FlowBookingSummaryClickEvent */
public final class MobileP4FlowBookingSummaryClickEvent implements Struct {
    public static final Adapter<MobileP4FlowBookingSummaryClickEvent, Object> ADAPTER = new MobileP4FlowBookingSummaryClickEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v2.MobileP4FlowBookingSummaryClickEvent$MobileP4FlowBookingSummaryClickEventAdapter */
    private static final class MobileP4FlowBookingSummaryClickEventAdapter implements Adapter<MobileP4FlowBookingSummaryClickEvent, Object> {
    ...
    public String toString() {
        return "MobileP4FlowBookingSummaryClickEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + ", reservation_code=" + this.reservation_code + ", instant_book=" + this.instant_book + ", page=" + this.page + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + ", pets=" + this.pets + ", checkin_date=" + this.checkin_date + ", checkout_date=" + this.checkout_date + ", section=" + this.section + ", operation=" + this.operation + "}";
    }
