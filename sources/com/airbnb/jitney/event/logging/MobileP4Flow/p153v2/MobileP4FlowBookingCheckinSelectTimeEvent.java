...
/* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v2.MobileP4FlowBookingCheckinSelectTimeEvent */
public final class MobileP4FlowBookingCheckinSelectTimeEvent implements Struct {
    public static final Adapter<MobileP4FlowBookingCheckinSelectTimeEvent, Object> ADAPTER = new MobileP4FlowBookingCheckinSelectTimeEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.MobileP4Flow.v2.MobileP4FlowBookingCheckinSelectTimeEvent$MobileP4FlowBookingCheckinSelectTimeEventAdapter */
    private static final class MobileP4FlowBookingCheckinSelectTimeEventAdapter implements Adapter<MobileP4FlowBookingCheckinSelectTimeEvent, Object> {
    ...
    public String toString() {
        return "MobileP4FlowBookingCheckinSelectTimeEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", user_id=" + this.user_id + ", listing_id=" + this.listing_id + ", reservation_code=" + this.reservation_code + ", instant_book=" + this.instant_book + ", page=" + this.page + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + ", pets=" + this.pets + ", checkin_date=" + this.checkin_date + ", checkout_date=" + this.checkout_date + ", checkin_time=" + this.checkin_time + ", operation=" + this.operation + "}";
    }
