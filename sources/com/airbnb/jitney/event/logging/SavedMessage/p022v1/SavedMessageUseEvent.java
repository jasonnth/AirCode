...
/* renamed from: com.airbnb.jitney.event.logging.SavedMessage.v1.SavedMessageUseEvent */
public final class SavedMessageUseEvent implements Struct {
    public static final Adapter<SavedMessageUseEvent, Builder> ADAPTER = new SavedMessageUseEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.SavedMessage.v1.SavedMessageUseEvent$Builder */
    public static final class Builder implements StructBuilder<SavedMessageUseEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.SavedMessage:SavedMessageUseEvent:1.0.0";
            this.event_name = "saved_message_use";
            this.page = SavedMessageConstants.SAVED_MESSAGE;
            this.target = "use_saved_message";
    ...
    /* renamed from: com.airbnb.jitney.event.logging.SavedMessage.v1.SavedMessageUseEvent$SavedMessageUseEventAdapter */
    private static final class SavedMessageUseEventAdapter implements Adapter<SavedMessageUseEvent, Builder> {
        private SavedMessageUseEventAdapter() {
        }

        public void write(Protocol protocol, SavedMessageUseEvent struct) throws IOException {
            protocol.writeStructBegin("SavedMessageUseEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SavedMessageUseEvent)) {
            return false;
        }
        SavedMessageUseEvent that = (SavedMessageUseEvent) other;
    ...
    public String toString() {
        return "SavedMessageUseEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", target=" + this.target + ", operation=" + this.operation + ", user_role=" + this.user_role + "}";
    }
