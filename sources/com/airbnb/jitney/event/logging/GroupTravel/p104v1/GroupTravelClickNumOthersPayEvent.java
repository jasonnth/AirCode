...
/* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelClickNumOthersPayEvent */
public final class GroupTravelClickNumOthersPayEvent implements Struct {
    public static final Adapter<GroupTravelClickNumOthersPayEvent, Object> ADAPTER = new GroupTravelClickNumOthersPayEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelClickNumOthersPayEvent$GroupTravelClickNumOthersPayEventAdapter */
    private static final class GroupTravelClickNumOthersPayEventAdapter implements Adapter<GroupTravelClickNumOthersPayEvent, Object> {
        private GroupTravelClickNumOthersPayEventAdapter() {
        }

        public void write(Protocol protocol, GroupTravelClickNumOthersPayEvent struct) throws IOException {
            protocol.writeStructBegin("GroupTravelClickNumOthersPayEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof GroupTravelClickNumOthersPayEvent)) {
            return false;
        }
        GroupTravelClickNumOthersPayEvent that = (GroupTravelClickNumOthersPayEvent) other;
    ...
    public String toString() {
        return "GroupTravelClickNumOthersPayEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", reservation2_id=" + this.reservation2_id + ", bill_item_product_type=" + this.bill_item_product_type + ", bill_item_product_id=" + this.bill_item_product_id + ", reservation_code=" + this.reservation_code + ", bill_price_quote_token=" + this.bill_price_quote_token + ", reservation_price_version_id=" + this.reservation_price_version_id + ", payments_context=" + this.payments_context + ", instant_book=" + this.instant_book + ", listing_id=" + this.listing_id + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + "}";
    }
