...
/* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelClickAddInviteeInformationEvent */
public final class GroupTravelClickAddInviteeInformationEvent implements Struct {
    public static final Adapter<GroupTravelClickAddInviteeInformationEvent, Object> ADAPTER = new GroupTravelClickAddInviteeInformationEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelClickAddInviteeInformationEvent$GroupTravelClickAddInviteeInformationEventAdapter */
    private static final class GroupTravelClickAddInviteeInformationEventAdapter implements Adapter<GroupTravelClickAddInviteeInformationEvent, Object> {
        private GroupTravelClickAddInviteeInformationEventAdapter() {
        }

        public void write(Protocol protocol, GroupTravelClickAddInviteeInformationEvent struct) throws IOException {
            protocol.writeStructBegin("GroupTravelClickAddInviteeInformationEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof GroupTravelClickAddInviteeInformationEvent)) {
            return false;
        }
        GroupTravelClickAddInviteeInformationEvent that = (GroupTravelClickAddInviteeInformationEvent) other;
