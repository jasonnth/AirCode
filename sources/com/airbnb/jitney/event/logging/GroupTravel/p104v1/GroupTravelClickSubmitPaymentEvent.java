...
/* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelClickSubmitPaymentEvent */
public final class GroupTravelClickSubmitPaymentEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelClickSubmitPaymentEvent$GroupTravelClickSubmitPaymentEventAdapter */
    private static final class GroupTravelClickSubmitPaymentEventAdapter implements Adapter<GroupTravelClickSubmitPaymentEvent, Object> {
        ...
        public void write(Protocol protocol, GroupTravelClickSubmitPaymentEvent struct) throws IOException {
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("paid_users", 8, 15);
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("unpaid_users", 9, 15);
            ...
            protocol.writeListEnd();
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("is_organizer", 10, 2);
    ...
    public String toString() {
        return "GroupTravelClickSubmitPaymentEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", num_group_payment_split=" + this.num_group_payment_split + ", num_people_invited=" + this.num_people_invited + ", reservation_user_payer_id=" + this.reservation_user_payer_id + ", paid_users=" + this.paid_users + ", unpaid_users=" + this.unpaid_users + ", is_organizer=" + this.is_organizer + ", reservation2_id=" + this.reservation2_id + ", bill_item_product_type=" + this.bill_item_product_type + ", bill_item_product_id=" + this.bill_item_product_id + ", reservation_code=" + this.reservation_code + ", bill_price_quote_token=" + this.bill_price_quote_token + ", reservation_price_version_id=" + this.reservation_price_version_id + ", payments_context=" + this.payments_context + ", instant_book=" + this.instant_book + ", listing_id=" + this.listing_id + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + "}";
    }
