...
/* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelClickPayRemainingAmountEvent */
public final class GroupTravelClickPayRemainingAmountEvent implements Struct {
    public static final Adapter<GroupTravelClickPayRemainingAmountEvent, Object> ADAPTER = new GroupTravelClickPayRemainingAmountEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelClickPayRemainingAmountEvent$GroupTravelClickPayRemainingAmountEventAdapter */
    private static final class GroupTravelClickPayRemainingAmountEventAdapter implements Adapter<GroupTravelClickPayRemainingAmountEvent, Object> {
        private GroupTravelClickPayRemainingAmountEventAdapter() {
        }

        public void write(Protocol protocol, GroupTravelClickPayRemainingAmountEvent struct) throws IOException {
            protocol.writeStructBegin("GroupTravelClickPayRemainingAmountEvent");
            ...
            protocol.writeFieldBegin("is_organizer", 7, 2);
            protocol.writeBool(struct.is_organizer.booleanValue());
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("num_group_payment_split", 8, 10);
            protocol.writeI64(struct.num_group_payment_split.longValue());
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("num_people_invited", 9, 10);
            protocol.writeI64(struct.num_people_invited.longValue());
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("reservation2_id", 10, 10);
            ...
            if (struct.bill_item_product_id != null) {
                protocol.writeFieldBegin("bill_item_product_id", 12, 10);
                protocol.writeI64(struct.bill_item_product_id.longValue());
                protocol.writeFieldEnd();
            }
            if (struct.reservation_code != null) {
                protocol.writeFieldBegin("reservation_code", 13, PassportService.SF_DG11);
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("listing_id", 18, 10);
            protocol.writeI64(struct.listing_id.longValue());
            protocol.writeFieldEnd();
            protocol.writeFieldBegin(FindTweenAnalytics.GUESTS, 19, 10);
    ...
    public String toString() {
        return "GroupTravelClickPayRemainingAmountEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", paid_users=" + this.paid_users + ", unpaid_users=" + this.unpaid_users + ", is_organizer=" + this.is_organizer + ", num_group_payment_split=" + this.num_group_payment_split + ", num_people_invited=" + this.num_people_invited + ", reservation2_id=" + this.reservation2_id + ", bill_item_product_type=" + this.bill_item_product_type + ", bill_item_product_id=" + this.bill_item_product_id + ", reservation_code=" + this.reservation_code + ", bill_price_quote_token=" + this.bill_price_quote_token + ", reservation_price_version_id=" + this.reservation_price_version_id + ", payments_context=" + this.payments_context + ", instant_book=" + this.instant_book + ", listing_id=" + this.listing_id + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + "}";
    }
