...
/* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelClickWhoseSpotPayingForEvent */
public final class GroupTravelClickWhoseSpotPayingForEvent implements Struct {
    public static final Adapter<GroupTravelClickWhoseSpotPayingForEvent, Object> ADAPTER = new GroupTravelClickWhoseSpotPayingForEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelClickWhoseSpotPayingForEvent$GroupTravelClickWhoseSpotPayingForEventAdapter */
    private static final class GroupTravelClickWhoseSpotPayingForEventAdapter implements Adapter<GroupTravelClickWhoseSpotPayingForEvent, Object> {
        private GroupTravelClickWhoseSpotPayingForEventAdapter() {
        }

        public void write(Protocol protocol, GroupTravelClickWhoseSpotPayingForEvent struct) throws IOException {
            protocol.writeStructBegin("GroupTravelClickWhoseSpotPayingForEvent");
    ...
    public String toString() {
        return "GroupTravelClickWhoseSpotPayingForEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", num_group_payment_split=" + this.num_group_payment_split + ", num_people_invited=" + this.num_people_invited + ", user_id=" + this.user_id + ", reservation_user_payer_id=" + this.reservation_user_payer_id + ", organizer_paid=" + this.organizer_paid + ", paid_users=" + this.paid_users + ", unpaid_users=" + this.unpaid_users + ", is_organizer=" + this.is_organizer + ", reservation2_id=" + this.reservation2_id + ", bill_item_product_type=" + this.bill_item_product_type + ", bill_item_product_id=" + this.bill_item_product_id + ", reservation_code=" + this.reservation_code + ", bill_price_quote_token=" + this.bill_price_quote_token + ", reservation_price_version_id=" + this.reservation_price_version_id + ", payments_context=" + this.payments_context + ", instant_book=" + this.instant_book + ", listing_id=" + this.listing_id + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + "}";
    }
