...
import com.airbnb.jitney.event.logging.LinkShareMethodType.p134v1.C2370LinkShareMethodType;
...
/* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelPaymentLinkSelectionEvent */
public final class GroupTravelPaymentLinkSelectionEvent implements Struct {
    public static final Adapter<GroupTravelPaymentLinkSelectionEvent, Object> ADAPTER = new GroupTravelPaymentLinkSelectionEventAdapter();
    ...
    public final C2370LinkShareMethodType link_share_method;
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelPaymentLinkSelectionEvent$GroupTravelPaymentLinkSelectionEventAdapter */
    private static final class GroupTravelPaymentLinkSelectionEventAdapter implements Adapter<GroupTravelPaymentLinkSelectionEvent, Object> {
        private GroupTravelPaymentLinkSelectionEventAdapter() {
        }

        public void write(Protocol protocol, GroupTravelPaymentLinkSelectionEvent struct) throws IOException {
            protocol.writeStructBegin("GroupTravelPaymentLinkSelectionEvent");
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("link_share_method", 5, 8);
            protocol.writeI32(struct.link_share_method.value);
            protocol.writeFieldEnd();
    ...
    public String toString() {
        return "GroupTravelPaymentLinkSelectionEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", link_share_method=" + this.link_share_method + ", organizer_paid=" + this.organizer_paid + ", paid_users=" + this.paid_users + ", unpaid_users=" + this.unpaid_users + ", num_group_payment_split=" + this.num_group_payment_split + ", num_people_invited=" + this.num_people_invited + ", reservation2_id=" + this.reservation2_id + ", bill_item_product_type=" + this.bill_item_product_type + ", bill_item_product_id=" + this.bill_item_product_id + ", reservation_code=" + this.reservation_code + ", bill_price_quote_token=" + this.bill_price_quote_token + ", reservation_price_version_id=" + this.reservation_price_version_id + ", payments_context=" + this.payments_context + ", instant_book=" + this.instant_book + ", listing_id=" + this.listing_id + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + "}";
    }
