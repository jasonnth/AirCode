...
/* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelClickRequestPaymentEvent */
public final class GroupTravelClickRequestPaymentEvent implements Struct {
    public static final Adapter<GroupTravelClickRequestPaymentEvent, Object> ADAPTER = new GroupTravelClickRequestPaymentEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelClickRequestPaymentEvent$GroupTravelClickRequestPaymentEventAdapter */
    private static final class GroupTravelClickRequestPaymentEventAdapter implements Adapter<GroupTravelClickRequestPaymentEvent, Object> {
        private GroupTravelClickRequestPaymentEventAdapter() {
        }

        public void write(Protocol protocol, GroupTravelClickRequestPaymentEvent struct) throws IOException {
            protocol.writeStructBegin("GroupTravelClickRequestPaymentEvent");
            ...
            if (struct.paid_users != null) {
                protocol.writeFieldBegin("paid_users", 5, 15);
            ...
            if (struct.unpaid_users != null) {
                protocol.writeFieldBegin("unpaid_users", 6, 15);
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("listing_id", 17, 10);
            protocol.writeI64(struct.listing_id.longValue());
            protocol.writeFieldEnd();
            protocol.writeFieldBegin(FindTweenAnalytics.GUESTS, 18, 10);
            protocol.writeI64(struct.guests.longValue());
            protocol.writeFieldEnd();
            protocol.writeFieldBegin(FindTweenAnalytics.ADULTS, 19, 10);
            protocol.writeI64(struct.adults.longValue());
            protocol.writeFieldEnd();
            if (struct.children != null) {
                protocol.writeFieldBegin(FindTweenAnalytics.CHILDREN, 20, 10);
                protocol.writeI64(struct.children.longValue());
                protocol.writeFieldEnd();
            }
            if (struct.infants != null) {
                protocol.writeFieldBegin(FindTweenAnalytics.INFANTS, 21, 10);
    ...
    public String toString() {
        return "GroupTravelClickRequestPaymentEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", paid_users=" + this.paid_users + ", unpaid_users=" + this.unpaid_users + ", num_group_payment_split=" + this.num_group_payment_split + ", num_people_invited=" + this.num_people_invited + ", reservation2_id=" + this.reservation2_id + ", bill_item_product_type=" + this.bill_item_product_type + ", bill_item_product_id=" + this.bill_item_product_id + ", reservation_code=" + this.reservation_code + ", bill_price_quote_token=" + this.bill_price_quote_token + ", reservation_price_version_id=" + this.reservation_price_version_id + ", payments_context=" + this.payments_context + ", instant_book=" + this.instant_book + ", listing_id=" + this.listing_id + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + "}";
    }
