...
/* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelViewSubmitPaymentEvent */
public final class GroupTravelViewSubmitPaymentEvent implements Struct {
    public static final Adapter<GroupTravelViewSubmitPaymentEvent, Object> ADAPTER = new GroupTravelViewSubmitPaymentEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelViewSubmitPaymentEvent$GroupTravelViewSubmitPaymentEventAdapter */
    private static final class GroupTravelViewSubmitPaymentEventAdapter implements Adapter<GroupTravelViewSubmitPaymentEvent, Object> {
        private GroupTravelViewSubmitPaymentEventAdapter() {
        }

        public void write(Protocol protocol, GroupTravelViewSubmitPaymentEvent struct) throws IOException {
            protocol.writeStructBegin("GroupTravelViewSubmitPaymentEvent");
            ...
            if (struct.source != null) {
                protocol.writeFieldBegin("source", 7, PassportService.SF_DG11);
                protocol.writeString(struct.source);
                protocol.writeFieldEnd();
            }
            protocol.writeFieldBegin("reservation_user_payer_id", 8, 10);
            protocol.writeI64(struct.reservation_user_payer_id.longValue());
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("paid_users", 9, 15);
            ...
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("unpaid_users", 10, 15);
            ...
            protocol.writeListEnd();
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("is_organizer", 11, 2);
            protocol.writeBool(struct.is_organizer.booleanValue());
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("reservation2_id", 12, 10);
            ...
            if (struct.bill_item_product_id != null) {
                protocol.writeFieldBegin("bill_item_product_id", 14, 10);
                protocol.writeI64(struct.bill_item_product_id.longValue());
                protocol.writeFieldEnd();
            }
            if (struct.reservation_code != null) {
                protocol.writeFieldBegin("reservation_code", 15, PassportService.SF_DG11);
            ...
            protocol.writeFieldBegin(ManageListingAnalytics.INSTANT_BOOK, 19, 2);
            protocol.writeBool(struct.instant_book.booleanValue());
            protocol.writeFieldEnd();
            protocol.writeFieldBegin("listing_id", 20, 10);
            protocol.writeI64(struct.listing_id.longValue());
            protocol.writeFieldEnd();
            protocol.writeFieldBegin(FindTweenAnalytics.GUESTS, 21, 10);
            protocol.writeI64(struct.guests.longValue());
            protocol.writeFieldEnd();
            protocol.writeFieldBegin(FindTweenAnalytics.ADULTS, 22, 10);
            protocol.writeI64(struct.adults.longValue());
            protocol.writeFieldEnd();
            if (struct.children != null) {
                protocol.writeFieldBegin(FindTweenAnalytics.CHILDREN, 23, 10);
                protocol.writeI64(struct.children.longValue());
                protocol.writeFieldEnd();
            }
            if (struct.infants != null) {
                protocol.writeFieldBegin(FindTweenAnalytics.INFANTS, 24, 10);
    ...
    public String toString() {
        return "GroupTravelViewSubmitPaymentEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", num_group_payment_split=" + this.num_group_payment_split + ", num_people_invited=" + this.num_people_invited + ", source=" + this.source + ", reservation_user_payer_id=" + this.reservation_user_payer_id + ", paid_users=" + this.paid_users + ", unpaid_users=" + this.unpaid_users + ", is_organizer=" + this.is_organizer + ", reservation2_id=" + this.reservation2_id + ", bill_item_product_type=" + this.bill_item_product_type + ", bill_item_product_id=" + this.bill_item_product_id + ", reservation_code=" + this.reservation_code + ", bill_price_quote_token=" + this.bill_price_quote_token + ", reservation_price_version_id=" + this.reservation_price_version_id + ", payments_context=" + this.payments_context + ", instant_book=" + this.instant_book + ", listing_id=" + this.listing_id + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + "}";
    }
