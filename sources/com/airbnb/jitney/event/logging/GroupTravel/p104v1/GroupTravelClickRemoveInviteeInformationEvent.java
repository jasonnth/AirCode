...
/* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelClickRemoveInviteeInformationEvent */
public final class GroupTravelClickRemoveInviteeInformationEvent implements Struct {
    public static final Adapter<GroupTravelClickRemoveInviteeInformationEvent, Object> ADAPTER = new GroupTravelClickRemoveInviteeInformationEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.GroupTravel.v1.GroupTravelClickRemoveInviteeInformationEvent$GroupTravelClickRemoveInviteeInformationEventAdapter */
    private static final class GroupTravelClickRemoveInviteeInformationEventAdapter implements Adapter<GroupTravelClickRemoveInviteeInformationEvent, Object> {
        private GroupTravelClickRemoveInviteeInformationEventAdapter() {
        }

        public void write(Protocol protocol, GroupTravelClickRemoveInviteeInformationEvent struct) throws IOException {
            protocol.writeStructBegin("GroupTravelClickRemoveInviteeInformationEvent");
            ...
            protocol.writeFieldEnd();
            if (struct.is_organizer != null) {
                protocol.writeFieldBegin("is_organizer", 5, 2);
                protocol.writeBool(struct.is_organizer.booleanValue());
                protocol.writeFieldEnd();
            }
            protocol.writeFieldBegin("organizer_paid", 6, 2);
            protocol.writeBool(struct.organizer_paid.booleanValue());
            protocol.writeFieldEnd();
            if (struct.paid_users != null) {
                protocol.writeFieldBegin("paid_users", 7, 15);
            ...
            if (struct.unpaid_users != null) {
                protocol.writeFieldBegin("unpaid_users", 8, 15);
    ...
    public String toString() {
        return "GroupTravelClickRemoveInviteeInformationEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", is_organizer=" + this.is_organizer + ", organizer_paid=" + this.organizer_paid + ", paid_users=" + this.paid_users + ", unpaid_users=" + this.unpaid_users + ", num_group_payment_split=" + this.num_group_payment_split + ", num_people_invited=" + this.num_people_invited + ", reservation2_id=" + this.reservation2_id + ", bill_item_product_type=" + this.bill_item_product_type + ", bill_item_product_id=" + this.bill_item_product_id + ", reservation_code=" + this.reservation_code + ", bill_price_quote_token=" + this.bill_price_quote_token + ", reservation_price_version_id=" + this.reservation_price_version_id + ", payments_context=" + this.payments_context + ", instant_book=" + this.instant_book + ", listing_id=" + this.listing_id + ", guests=" + this.guests + ", adults=" + this.adults + ", children=" + this.children + ", infants=" + this.infants + "}";
    }
