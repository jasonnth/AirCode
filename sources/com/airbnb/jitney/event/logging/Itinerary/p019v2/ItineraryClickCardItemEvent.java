...
/* renamed from: com.airbnb.jitney.event.logging.Itinerary.v2.ItineraryClickCardItemEvent */
public final class ItineraryClickCardItemEvent implements Struct {
    public static final Adapter<ItineraryClickCardItemEvent, Builder> ADAPTER = new ItineraryClickCardItemEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Itinerary.v2.ItineraryClickCardItemEvent$Builder */
    public static final class Builder implements StructBuilder<ItineraryClickCardItemEvent> {
        ...
        private Builder() {
            this.schema = "com.airbnb.jitney.event.logging.Itinerary:ItineraryClickCardItemEvent:2.0.0";
            this.event_name = "itinerary_click_card_item";
            this.operation = C2451Operation.Click;
        }

        public Builder(Context context2, String page2, String target2, C0973SchedulableInfo schedulable_info2, C0973SchedulableInfo parent_schedulable_info2) {
            this.schema = "com.airbnb.jitney.event.logging.Itinerary:ItineraryClickCardItemEvent:2.0.0";
            this.event_name = "itinerary_click_card_item";
        ...
        public ItineraryClickCardItemEvent build() {
            if (this.event_name == null) {
                ...
                return new ItineraryClickCardItemEvent(this);
            } else {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Itinerary.v2.ItineraryClickCardItemEvent$ItineraryClickCardItemEventAdapter */
    private static final class ItineraryClickCardItemEventAdapter implements Adapter<ItineraryClickCardItemEvent, Builder> {
        private ItineraryClickCardItemEventAdapter() {
        }

        public void write(Protocol protocol, ItineraryClickCardItemEvent struct) throws IOException {
            protocol.writeStructBegin("ItineraryClickCardItemEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ItineraryClickCardItemEvent)) {
            return false;
        }
        ItineraryClickCardItemEvent that = (ItineraryClickCardItemEvent) other;
    ...
    public int hashCode() {
        return (((((((((((((((16777619 ^ (this.schema == null ? 0 : this.schema.hashCode())) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.page.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.target.hashCode()) * -2128831035) ^ this.schedulable_info.hashCode()) * -2128831035) ^ this.parent_schedulable_info.hashCode()) * -2128831035;
    }

    public String toString() {
        return "ItineraryClickCardItemEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", target=" + this.target + ", schedulable_info=" + this.schedulable_info + ", parent_schedulable_info=" + this.parent_schedulable_info + "}";
    }
