...
/* renamed from: com.airbnb.jitney.event.logging.Itinerary.v2.ItineraryScrollOverviewEvent */
public final class ItineraryScrollOverviewEvent implements Struct {
    public static final Adapter<ItineraryScrollOverviewEvent, Object> ADAPTER = new ItineraryScrollOverviewEventAdapter();
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Itinerary.v2.ItineraryScrollOverviewEvent$ItineraryScrollOverviewEventAdapter */
    private static final class ItineraryScrollOverviewEventAdapter implements Adapter<ItineraryScrollOverviewEvent, Object> {
        private ItineraryScrollOverviewEventAdapter() {
        }

        public void write(Protocol protocol, ItineraryScrollOverviewEvent struct) throws IOException {
            protocol.writeStructBegin("ItineraryScrollOverviewEvent");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ItineraryScrollOverviewEvent)) {
            return false;
        }
        ItineraryScrollOverviewEvent that = (ItineraryScrollOverviewEvent) other;
    ...
    public String toString() {
        return "ItineraryScrollOverviewEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", operation=" + this.operation + ", direction=" + this.direction + ", max_scroll_item_index=" + this.max_scroll_item_index + "}";
    }
