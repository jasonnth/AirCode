...
/* renamed from: com.airbnb.jitney.event.logging.Itinerary.v1.ItineraryImpressionItineraryPageEvent */
public final class ItineraryImpressionItineraryPageEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Itinerary.v1.ItineraryImpressionItineraryPageEvent$ItineraryImpressionItineraryPageEventAdapter */
    ...
    public int hashCode() {
        return (((((((((((((16777619 ^ (this.schema == null ? 0 : this.schema.hashCode())) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.page.hashCode()) * -2128831035) ^ this.section.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.confirmation_code.hashCode()) * -2128831035;
    }

    public String toString() {
        return "ItineraryImpressionItineraryPageEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", operation=" + this.operation + ", confirmation_code=" + this.confirmation_code + "}";
    }
