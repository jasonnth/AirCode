...
/* renamed from: com.airbnb.jitney.event.logging.Itinerary.v1.ItineraryScrollItineraryEvent */
public final class ItineraryScrollItineraryEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Itinerary.v1.ItineraryScrollItineraryEvent$ItineraryScrollItineraryEventAdapter */
    private static final class ItineraryScrollItineraryEventAdapter implements Adapter<ItineraryScrollItineraryEvent, Object> {
        ...
        public void write(Protocol protocol, ItineraryScrollItineraryEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ItineraryScrollItineraryEvent)) {
            return false;
        }
        ItineraryScrollItineraryEvent that = (ItineraryScrollItineraryEvent) other;
    ...
    public String toString() {
        return "ItineraryScrollItineraryEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", section=" + this.section + ", operation=" + this.operation + ", direction=" + this.direction + ", max_scroll_item_index=" + this.max_scroll_item_index + "}";
    }
