...
/* renamed from: com.airbnb.jitney.event.logging.Itinerary.v1.ItineraryImpressionCardScreenEvent */
public final class ItineraryImpressionCardScreenEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Itinerary.v1.ItineraryImpressionCardScreenEvent$ItineraryImpressionCardScreenEventAdapter */
    private static final class ItineraryImpressionCardScreenEventAdapter implements Adapter<ItineraryImpressionCardScreenEvent, Object> {
        ...
        public void write(Protocol protocol, ItineraryImpressionCardScreenEvent struct) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ItineraryImpressionCardScreenEvent)) {
            return false;
        }
        ItineraryImpressionCardScreenEvent that = (ItineraryImpressionCardScreenEvent) other;
    ...
    public String toString() {
        return "ItineraryImpressionCardScreenEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", schedulable_info=" + this.schedulable_info + ", schedulable_place_type=" + this.schedulable_place_type + "}";
    }
