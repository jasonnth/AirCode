...
/* renamed from: com.airbnb.jitney.event.logging.Itinerary.v1.ItineraryClickInfoSectionEvent */
public final class ItineraryClickInfoSectionEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Itinerary.v1.ItineraryClickInfoSectionEvent$ItineraryClickInfoSectionEventAdapter */
    ...
    public int hashCode() {
        return (((((((((((((16777619 ^ (this.schema == null ? 0 : this.schema.hashCode())) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.page.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.target.hashCode()) * -2128831035) ^ this.schedulable_info.hashCode()) * -2128831035;
    }

    public String toString() {
        return "ItineraryClickInfoSectionEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", target=" + this.target + ", schedulable_info=" + this.schedulable_info + "}";
    }
