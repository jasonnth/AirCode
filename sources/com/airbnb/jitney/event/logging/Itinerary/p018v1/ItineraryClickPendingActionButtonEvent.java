...
/* renamed from: com.airbnb.jitney.event.logging.Itinerary.v1.ItineraryClickPendingActionButtonEvent */
public final class ItineraryClickPendingActionButtonEvent implements Struct {
    ...
    /* renamed from: com.airbnb.jitney.event.logging.Itinerary.v1.ItineraryClickPendingActionButtonEvent$ItineraryClickPendingActionButtonEventAdapter */
    ...
    public int hashCode() {
        return (((((((((((((((16777619 ^ (this.schema == null ? 0 : this.schema.hashCode())) * -2128831035) ^ this.event_name.hashCode()) * -2128831035) ^ this.context.hashCode()) * -2128831035) ^ this.page.hashCode()) * -2128831035) ^ this.operation.hashCode()) * -2128831035) ^ this.needs_verification.hashCode()) * -2128831035) ^ this.needs_mt_tos.hashCode()) * -2128831035) ^ this.schedulable_info.hashCode()) * -2128831035;
    }

    public String toString() {
        return "ItineraryClickPendingActionButtonEvent{schema=" + this.schema + ", event_name=" + this.event_name + ", context=" + this.context + ", page=" + this.page + ", operation=" + this.operation + ", needs_verification=" + this.needs_verification + ", needs_mt_tos=" + this.needs_mt_tos + ", schedulable_info=" + this.schedulable_info + "}";
    }
