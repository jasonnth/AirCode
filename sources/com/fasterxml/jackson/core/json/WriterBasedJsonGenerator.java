...
public final class WriterBasedJsonGenerator extends JsonGeneratorImpl {
    ...
    public void _writeFieldName(String name, boolean commaBefore) throws IOException {
    ...
    /* access modifiers changed from: protected */
    public void _writePPFieldName(String name, boolean commaBefore) throws IOException {
        if (commaBefore) {
    ...
    /* access modifiers changed from: protected */
    public void _writePPFieldName(SerializableString name, boolean commaBefore) throws IOException {
        if (commaBefore) {
            this._cfgPrettyPrinter.writeObjectEntrySeparator(this);
        } else {
            this._cfgPrettyPrinter.beforeObjectEntries(this);
    ...
    private void _prependOrWriteCharacterEscape(char ch, int escCode) throws IOException, JsonGenerationException {
        ...
        if (escCode >= 0) {
            if (this._outputTail >= 2) {
                ...
                this._outputBuffer[ptr3] = (char) escCode;
                return;
            }
            ...
            if (this._outputTail >= len) {
                int ptr4 = this._outputTail - len;
                this._outputHead = ptr4;
                escape.getChars(0, len, this._outputBuffer, ptr4);
                return;
            }
            this._outputHead = this._outputTail;
            ...
            int ptr5 = this._outputTail - 6;
            this._outputHead = ptr5;
            buf2[ptr5] = '\\';
            int ptr6 = ptr5 + 1;
            buf2[ptr6] = 'u';
            if (ch > 255) {
            ...
            int ptr9 = ptr + 1;
            buf2[ptr9] = HEX_CHARS[ch >> 4];
            buf2[ptr9 + 1] = HEX_CHARS[ch & 15];
        } else {
