...
public final class CharTypes {
    ...
    /* renamed from: HB */
    private static final byte[] f3138HB;

    /* renamed from: HC */
    private static final char[] f3139HC = "0123456789ABCDEF".toCharArray();
    ...
    static {
        int code;
        int len = f3139HC.length;
        f3138HB = new byte[len];
        for (int i = 0; i < len; i++) {
            f3138HB[i] = (byte) f3139HC[i];
        }
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (c >= escLen || escCodes[c] == 0) {
                ...
                if (escCode < 0) {
                    ...
                    sb.append('0');
                    char c2 = c;
                    sb.append(f3139HC[c2 >> 4]);
                    sb.append(f3139HC[c2 & 15]);
                } else {
    ...
    public static char[] copyHexChars() {
        return (char[]) f3139HC.clone();
    }

    public static byte[] copyHexBytes() {
        return (byte[]) f3138HB.clone();
    }
}
