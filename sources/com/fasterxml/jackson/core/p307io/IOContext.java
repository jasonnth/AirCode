...
public class IOContext {
    ...
    public final void _verifyAlloc(Object buffer) {
        if (buffer != null) {
    ...
    /* access modifiers changed from: protected */
    public final void _verifyRelease(byte[] toRelease, byte[] src) {
    ...
    /* access modifiers changed from: protected */
    public final void _verifyRelease(char[] toRelease, char[] src) {
        if (toRelease != src && toRelease.length < src.length) {
            throw wrongBuf();
        }
    }
