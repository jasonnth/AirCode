...
public final class Base64Variant implements Serializable {
    ...
    public void decode(String str, ByteArrayBuilder builder) throws IllegalArgumentException {
        ...
        while (ptr2 < len) {
            ...
            int bits3 = decodeBase64Char(ch2);
            if (bits3 < 0) {
            ...
            int bits4 = decodeBase64Char(ch3);
            if (bits4 < 0) {
                if (bits4 != -2) {
                ...
                int decodedData3 = (decodedData2 << 6) | bits4;
                if (ptr4 >= len) {
                    if (!usesPadding()) {
                ...
                int bits5 = decodeBase64Char(ch5);
                if (bits5 < 0) {
                    if (bits5 != -2) {
                    ...
                    builder.appendThreeBytes((decodedData3 << 6) | bits5);
                }
            }
        }
    }
