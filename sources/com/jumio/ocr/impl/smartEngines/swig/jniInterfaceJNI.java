...
public class jniInterfaceJNI {
    ...
    public static final native long DetectionInternalSettingsFactory_createFromFileSystem(String str) throws Exception;
    ...
    public static final native float ImageCheck_computeFlashConfidence(byte[] bArr, int i, int i2, int i3, int i4) throws Exception;

    public static final native int ImageCheck_computeFocusConfidence(byte[] bArr, int i, int i2, int i3, int i4) throws Exception;

    public static final native boolean ImageCheck_isFlashNeeded(byte[] bArr, int i, int i2, int i3, int i4, int i5) throws Exception;

    public static final native boolean ImageCheck_isRefocusNeeded(byte[] bArr, int i, int i2, int i3, int i4, int i5) throws Exception;
    ...
    public static final native int OcrCardTypePrivate_get();
    ...
    public static final native long OcrEngineBaseSession_processUncompressedImageData__SWIG_0(long j, OcrEngineBaseSession ocrEngineBaseSession, byte[] bArr, int i, int i2, int i3, long j2, OcrEngineSettings ocrEngineSettings) throws Exception;

    public static final native long OcrEngineBaseSession_processUncompressedImageData__SWIG_1(long j, OcrEngineBaseSession ocrEngineBaseSession, byte[] bArr, int i, int i2, int i3) throws Exception;

    public static final native long OcrEngineBaseSession_processUncompressedYUVImageData__SWIG_0(long j, OcrEngineBaseSession ocrEngineBaseSession, byte[] bArr, int i, int i2, int i3, long j2, OcrEngineSettings ocrEngineSettings) throws Exception;

    public static final native long OcrEngineBaseSession_processUncompressedYUVImageData__SWIG_1(long j, OcrEngineBaseSession ocrEngineBaseSession, byte[] bArr, int i, int i2, int i3) throws Exception;
    ...
    public static final native long OcrEngineInternalSettings_createFromFilesystem(String str) throws Exception;
    ...
    public static final native long OcrEngineSession_processImageData__SWIG_0(long j, OcrEngineSession ocrEngineSession, byte[] bArr, long j2, OcrEngineSettings ocrEngineSettings) throws Exception;

    public static final native long OcrEngineSession_processImageData__SWIG_1(long j, OcrEngineSession ocrEngineSession, byte[] bArr) throws Exception;

    public static final native long OcrEngineSession_processImageFile__SWIG_0(long j, OcrEngineSession ocrEngineSession, String str, long j2, OcrEngineSettings ocrEngineSettings) throws Exception;

    public static final native long OcrEngineSession_processImageFile__SWIG_1(long j, OcrEngineSession ocrEngineSession, String str) throws Exception;
    ...
    /* renamed from: OcrEngineSettings_getUkSortCodeAccountNumberContextCorrectionFlag */
    public static final native boolean m2050x71b585de(long j, OcrEngineSettings ocrEngineSettings);
    ...
    /* renamed from: OcrEngineSettings_isOverridenUkSortCodeAccountNumberContextCorrectionFlag */
    public static final native boolean m2051x7fa7d7a0(long j, OcrEngineSettings ocrEngineSettings);

    /* renamed from: OcrEngineSettings_isOverridenUkSortCodeAccountNumberRecognitionFlag */
    public static final native boolean m2052x7121692a(long j, OcrEngineSettings ocrEngineSettings);
    ...
    /* renamed from: OcrEngineSettings_setUkSortCodeAccountNumberContextCorrectionFlag */
    public static final native void m2053xf36f50ea(long j, OcrEngineSettings ocrEngineSettings, boolean z);
    ...
    /* renamed from: ResultAcceptorInterface_acceptSwigExplicitResultAcceptorInterface */
    public static final native void m2054x6812f25(long j, ResultAcceptorInterface resultAcceptorInterface, int i, long j2, OcrCharStringVector ocrCharStringVector, int i2, int i3, long j3, ResultAcceptorInterfaceSettings resultAcceptorInterfaceSettings, boolean z);
    ...
    public static void SwigDirector_ResultAcceptorInterface_accept(ResultAcceptorInterface self, int fieldName, long value, int quadrangleIndex, int totalQuadrangles, long acceptorSettings, boolean toAcceptFlag) {
        self.accept(FieldName.swigToEnum(fieldName), new OcrCharStringVector(value, false), quadrangleIndex, totalQuadrangles, new ResultAcceptorInterfaceSettings(acceptorSettings, false), toAcceptFlag);
    }
