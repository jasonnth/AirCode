...
/* renamed from: com.jumio.nv.IsoCountryConverter */
public class IsoCountryConverter {
    ...
    static {
        ...
        localeMap.put("AUS", AirbnbConstants.COUNTRY_CODE_AUSTRALIA);
        ...
        localeMap.put("BRA", AirbnbConstants.COUNTRY_CODE_BRAZIL);
        ...
        localeMap.put("CHN", AirbnbConstants.COUNTRY_CODE_CHINA);
        ...
        localeMap.put("CUB", AirbnbConstants.COUNTRY_CODE_CUBA);
        ...
        localeMap.put(ServerSettingsModel.FRANCE_ISO3, "FR");
        ...
        localeMap.put(ServerSettingsModel.GERMAN_ISO3, AirbnbConstants.COUNTRY_CODE_GERMANY);
        ...
        localeMap.put("IND", AirbnbConstants.COUNTRY_CODE_INDIA);
        ...
        localeMap.put("JPN", AirbnbConstants.COUNTRY_CODE_JAPAN);
        ...
        localeMap.put("KOR", AirbnbConstants.COUNTRY_CODE_KOREA);
        ...
        localeMap.put("NLD", AirbnbConstants.COUNTRY_CODE_NETHERLANDS);
        ...
        localeMap.put("SYC", BouncyCastleProvider.PROVIDER_NAME);
    ...
    public static String convertToAlpha2(String str) {
        if (str != null && localeMap.containsKey(str)) {
            return (String) localeMap.get(str);
        }
        return null;
    }
