...
public class UrlValidator implements Serializable {
    ...
    private static final String[] DEFAULT_SCHEMES = {UriUtil.HTTP_SCHEME, UriUtil.HTTPS_SCHEME, "ftp"};
    ...
    public boolean isValid(String value) {
        ...
        if (((!UriUtil.LOCAL_FILE_SCHEME.equals(scheme) || !"".equals(authority)) && !isValidAuthority(authority)) || !isValidPath(urlMatcher.group(5)) || !isValidQuery(urlMatcher.group(7)) || !isValidFragment(urlMatcher.group(9))) {
            return false;
        }
        return true;
    }
