...
public class mrzjniInterfaceJNI {
    ...
    public static final native long MrzEngineInternalSettings_createFromFilesystem(String str) throws Exception;
    ...
    public static final native void MrzEngine_FeedImageFile__SWIG_0(long j, MrzEngine mrzEngine, String str, int i) throws Exception;

    public static final native void MrzEngine_FeedImageFile__SWIG_1(long j, MrzEngine mrzEngine, String str) throws Exception;

    public static final native void MrzEngine_FeedUncompressedImageData__SWIG_0(long j, MrzEngine mrzEngine, byte[] bArr, int i, int i2, int i3, int i4, long j2, MrzRect mrzRect, int i5) throws Exception;

    public static final native void MrzEngine_FeedUncompressedImageData__SWIG_1(long j, MrzEngine mrzEngine, byte[] bArr, int i, int i2, int i3, int i4, long j2, MrzRect mrzRect) throws Exception;

    public static final native void MrzEngine_FeedUncompressedYUVImageData__SWIG_0(long j, MrzEngine mrzEngine, byte[] bArr, int i, int i2, int i3, long j2, MrzRect mrzRect, int i4) throws Exception;

    public static final native void MrzEngine_FeedUncompressedYUVImageData__SWIG_1(long j, MrzEngine mrzEngine, byte[] bArr, int i, int i2, int i3, long j2, MrzRect mrzRect) throws Exception;

    public static final native void MrzEngine_InitializeSession__SWIG_0(long j, MrzEngine mrzEngine, long j2, StreamReporterInterface streamReporterInterface, long j3, MrzEngineSessionHelpers mrzEngineSessionHelpers, long j4, MrzEngineSessionSettings mrzEngineSessionSettings) throws Exception;

    public static final native void MrzEngine_InitializeSession__SWIG_1(long j, MrzEngine mrzEngine, long j2, StreamReporterInterface streamReporterInterface, long j3, MrzEngineSessionHelpers mrzEngineSessionHelpers) throws Exception;

    public static final native void MrzEngine_InitializeSession__SWIG_2(long j, MrzEngine mrzEngine, long j2, StreamReporterInterface streamReporterInterface) throws Exception;

    public static final native void MrzEngine_TerminateSession(long j, MrzEngine mrzEngine) throws Exception;

    public static final native int MrzField_calculateChecksum(long j, MrzField mrzField) throws Exception;
    ...
    public static final native float MrzImageCheck_computeFlashConfidence(byte[] bArr, int i, int i2, int i3, int i4) throws Exception;

    public static final native int MrzImageCheck_computeFocusConfidence(byte[] bArr, int i, int i2, int i3, int i4) throws Exception;

    public static final native boolean MrzImageCheck_isFlashNeeded(byte[] bArr, int i, int i2, int i3, int i4, int i5) throws Exception;

    public static final native boolean MrzImageCheck_isRefocusNeeded(byte[] bArr, int i, int i2, int i3, int i4, int i5) throws Exception;
    ...
    public static final native char MrzOcrChar_GetChar(long j, MrzOcrChar mrzOcrChar) throws Exception;
    ...
    /* renamed from: StreamReporterInterface_SnapshotRejectedSwigExplicitStreamReporterInterface__SWIG_0 */
    public static final native void m1932x715d2f8c(long j, StreamReporterInterface streamReporterInterface);

    /* renamed from: StreamReporterInterface_SnapshotRejectedSwigExplicitStreamReporterInterface__SWIG_1 */
    public static final native void m1933x715d2f8d(long j, StreamReporterInterface streamReporterInterface, String str);
    ...
    /* renamed from: StreamReporterInterface_SymbolRectsFoundAfterSnapshotProcessedSwigExplicitStreamReporterInterface */
    public static final native void m1934xb2444682(long j, StreamReporterInterface streamReporterInterface, long j2, MrzRectMatrix mrzRectMatrix);

    /* renamed from: StreamReporterInterface_SymbolRectsFoundSwigExplicitStreamReporterInterface */
    public static final native void m1935xfccf7350(long j, StreamReporterInterface streamReporterInterface, long j2, MrzRectMatrix mrzRectMatrix);
    ...
    public static final native long new_MrzEngine(long j, MrzEngineInternalSettings mrzEngineInternalSettings) throws Exception;
    ...
    /* renamed from: SwigDirector_StreamReporterInterface_SymbolRectsFoundAfterSnapshotProcessed */
    public static void m1936x6eef0d71(StreamReporterInterface streamReporterInterface, long j) {
