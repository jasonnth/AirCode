...
public class MrzDateField extends MrzField {
    ...
    public synchronized void delete() {
        if (this.f3207a != 0) {
            if (this.swigCMemOwn) {
                ...
                mrzjniInterfaceJNI.delete_MrzDateField(this.f3207a);
            }
            this.f3207a = 0;
        }
        super.delete();
    ...
    public MrzDate getAsMrzDate() {
        return new MrzDate(mrzjniInterfaceJNI.MrzDateField_getAsMrzDate(this.f3207a, this), false);
    }
}
