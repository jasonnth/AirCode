...
public class ShortNumbersRegionCodeSet {
    static Set<String> getRegionCodeSet() {
        Set<String> regionCodeSet = new HashSet<>(317);
        ...
        regionCodeSet.add(AirbnbConstants.COUNTRY_CODE_AUSTRALIA);
        ...
        regionCodeSet.add(AirbnbConstants.COUNTRY_CODE_BRAZIL);
        ...
        regionCodeSet.add(AirbnbConstants.COUNTRY_CODE_CHINA);
        regionCodeSet.add("CO");
        regionCodeSet.add("CR");
        regionCodeSet.add(AirbnbConstants.COUNTRY_CODE_CUBA);
        regionCodeSet.add("CV");
        regionCodeSet.add("CW");
        regionCodeSet.add("CX");
        regionCodeSet.add("CY");
        regionCodeSet.add("CZ");
        regionCodeSet.add(AirbnbConstants.COUNTRY_CODE_GERMANY);
        ...
        regionCodeSet.add(AirbnbConstants.COUNTRY_CODE_INDIA);
        ...
        regionCodeSet.add(AirbnbConstants.COUNTRY_CODE_JAPAN);
        ...
        regionCodeSet.add(AirbnbConstants.COUNTRY_CODE_KOREA);
        ...
        regionCodeSet.add(AirbnbConstants.COUNTRY_CODE_NETHERLANDS);
        ...
        regionCodeSet.add(BouncyCastleProvider.PROVIDER_NAME);
