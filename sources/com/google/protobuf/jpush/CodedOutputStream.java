...
public final class CodedOutputStream {
    ...
    public void writeStringNoTag(String value) throws IOException {
        byte[] bytes = value.getBytes(JPushConstants.ENCODING_UTF_8);
    ...
    public void writeRawBytes(ByteString value, int offset, int length) throws IOException {
        ...
        while (length2 > 0) {
            int bytesToRead = Math.min(length2, this.limit);
    ...
    public void writeRawVarint32(int value) throws IOException {
        while ((value & -128) != 0) {
            writeRawByte((value & CertificateBody.profileType) | 128);
            value >>>= 7;
        }
        writeRawByte(value);
    }
    ...
    public void writeRawVarint64(long value) throws IOException {
        while ((-128 & value) != 0) {
            writeRawByte((((int) value) & CertificateBody.profileType) | 128);
            value >>>= 7;
        }
