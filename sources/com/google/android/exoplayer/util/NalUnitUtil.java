...
public final class NalUnitUtil {
    ...
    public static int findNalUnit(byte[] data, int startOffset, int endOffset, boolean[] prefixFlags) {
        ...
        boolean z3 = length > 2 ? data[endOffset + -3] == 0 && data[endOffset + -2] == 0 && data[endOffset + -1] == 1 : length == 2 ? prefixFlags[2] && data[endOffset + -2] == 0 && data[endOffset + -1] == 1 : prefixFlags[1] && data[endOffset + -1] == 1;
        prefixFlags[0] = z3;
        boolean z4 = length > 1 ? data[endOffset + -2] == 0 && data[endOffset + -1] == 0 : prefixFlags[2] && data[endOffset + -1] == 0;
        prefixFlags[1] = z4;
