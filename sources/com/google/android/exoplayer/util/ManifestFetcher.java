...
public class ManifestFetcher<T> implements Callback {
    ...
    public ManifestFetcher(String manifestUri2, UriDataSource uriDataSource2, Parser<T> parser2) {
        this(manifestUri2, uriDataSource2, parser2, null, null);
    }

    public ManifestFetcher(String manifestUri2, UriDataSource uriDataSource2, Parser<T> parser2, Handler eventHandler2, EventListener eventListener2) {
        this.parser = parser2;
