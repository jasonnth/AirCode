...
import com.google.android.exoplayer.C4002C;
...
public final class AudioTrack {
    ...
    public void configure(String mimeType, int channelCount, int sampleRate2, int pcmEncoding, int specifiedBufferSize) {
        ...
        switch (channelCount) {
            ...
            case 7:
                ...
                break;
            case 8:
                channelConfig2 = C4002C.CHANNEL_OUT_7POINT1_SURROUND;
                break;
            default:
                throw new IllegalArgumentException("Unsupported channel count: " + channelCount);
        }
        boolean passthrough2 = !"audio/raw".equals(mimeType);
        if (passthrough2) {
        ...
        if (!isInitialized() || this.sourceEncoding != sourceEncoding2 || this.sampleRate != sampleRate2 || this.channelConfig != channelConfig2) {
            ...
            if (specifiedBufferSize != 0) {
                ...
                int maxAppBufferSize = (int) Math.max((long) minBufferSize, durationUsToFrames(750000) * ((long) this.pcmFrameSize));
        ...
        if (this.bufferBytesRemaining == 0) {
            ...
            if (this.startMediaTimeState == 0) {
                ...
                if (this.startMediaTimeState == 1 && Math.abs(expectedBufferStartTime - presentationTimeUs) > 200000) {
                    Log.e("AudioTrack", "Discontinuity detected [expected " + expectedBufferStartTime + ", got " + presentationTimeUs + "]");
                    this.startMediaTimeState = 2;
                }
    ...
    private long framesToDurationUs(long frameCount) {
        return (1000000 * frameCount) / ((long) this.sampleRate);
    }

    private long durationUsToFrames(long durationUs) {
        return (((long) this.sampleRate) * durationUs) / 1000000;
    }
        ...
        switch (sourceEncoding2) {
            ...
            case 3:
                for (int i2 = offset; i2 < limit; i2++) {
                    resampledBuffer2.put(0);
                    resampledBuffer2.put((byte) ((buffer.get(i2) & 255) + ISOFileInfo.DATA_BYTES1));
                }
                break;
            case 1073741824:
