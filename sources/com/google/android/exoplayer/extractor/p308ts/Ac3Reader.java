...
final class Ac3Reader extends ElementaryStreamReader {
            ...
            switch (this.state) {
                case 0:
                    if (!skipToNextSync(data)) {
                        ...
                        this.state = 1;
                        this.headerScratchBytes.data[0] = PassportService.SF_DG11;
    ...
    private void parseHeader() {
        ...
        if (this.mediaFormat == null) {
            if (this.isEac3) {
                parseAc3SyncframeFormat = Ac3Util.parseEac3SyncframeFormat(this.headerScratchBits, null, -1, null);
            } else {
                parseAc3SyncframeFormat = Ac3Util.parseAc3SyncframeFormat(this.headerScratchBits, null, -1, null);
            }
        ...
        this.sampleDurationUs = (long) ((int) ((1000000 * ((long) audioSamplesPerSyncframe)) / ((long) this.mediaFormat.sampleRate)));
    }
}
