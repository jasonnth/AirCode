...
public final class AdtsExtractor implements Extractor {
    ...
    public boolean sniff(ExtractorInput input) throws IOException, InterruptedException {
        ...
        while (true) {
            ...
            int length = ((scratch.data[6] & AccountVerificationOfflineIdController.PERMISSION_REQUEST_CODE_NETVERIFY) << 21) | ((scratch.data[7] & AccountVerificationOfflineIdController.PERMISSION_REQUEST_CODE_NETVERIFY) << 14) | ((scratch.data[8] & AccountVerificationOfflineIdController.PERMISSION_REQUEST_CODE_NETVERIFY) << 7) | (scratch.data[9] & CertificateBody.profileType);
