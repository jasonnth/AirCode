...
public final class TsExtractor implements Extractor {
    ...
    Id3Reader id3Reader;
    /* access modifiers changed from: private */
    public int nextEmbeddedTrackId;
                ...
                while (remainingEntriesLength > 0) {
                    ...
                    if (!TsExtractor.this.trackIds.get(trackId)) {
                        switch (streamType) {
                            ...
                            case 21:
                                if ((TsExtractor.this.workaroundFlags & 16) == 0) {
                                    pesPayloadReader = new Id3Reader(output.track(TsExtractor.this.nextEmbeddedTrackId = TsExtractor.this.nextEmbeddedTrackId + 1));
                                    break;
                                } else {
                            ...
                            case 27:
                                if ((TsExtractor.this.workaroundFlags & 4) == 0) {
                                    pesPayloadReader = new H264Reader(output.track(trackId), new SeiReader(output.track(TsExtractor.this.nextEmbeddedTrackId = TsExtractor.this.nextEmbeddedTrackId + 1)), (TsExtractor.this.workaroundFlags & 1) != 0, (TsExtractor.this.workaroundFlags & 8) != 0);
                                    break;
                                } else {
                                    pesPayloadReader = null;
                                    break;
                            ...
                            case 36:
                                pesPayloadReader = new H265Reader(output.track(trackId), new SeiReader(output.track(TsExtractor.this.nextEmbeddedTrackId = TsExtractor.this.nextEmbeddedTrackId + 1)));
                                break;
                            case 129:
            ...
            while (true) {
                ...
                if (descriptorTag == 5) {
                    ...
                    if (descriptorTag == 106) {
                        ...
                        streamType = CipherSuite.TLS_PSK_WITH_RC4_128_SHA;
                    }
