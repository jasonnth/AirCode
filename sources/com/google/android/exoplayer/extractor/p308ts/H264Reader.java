        ...
        if (!this.hasOutputFormat || this.sampleReader.needsSpsPps()) {
            ...
            if (!this.hasOutputFormat) {
                if (this.sps.isCompleted() && this.pps.isCompleted()) {
                    ...
                    this.output.format(MediaFormat.createVideoFormat(null, "video/avc", -1, -1, -1, spsData.width, spsData.height, initializationData, -1, spsData.pixelWidthAspectRatio));
