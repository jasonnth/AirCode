...
public final class ExtractorSampleSource implements SampleSource, SampleSourceReader, ExtractorOutput, Callback {
    ...
    public void maybeThrowError() throws IOException {
        if (this.currentLoadableException != null) {
            ...
            int minLoadableRetryCountForMedia = this.minLoadableRetryCount != -1 ? this.minLoadableRetryCount : (this.seekMap == null || this.seekMap.isSeekable()) ? 3 : 6;
    ...
    public void onLoadCompleted(Loadable loadable2) {
        this.loadingFinished = true;
    }

    public void onLoadCanceled(Loadable loadable2) {
        if (this.enabledTrackCount > 0) {
