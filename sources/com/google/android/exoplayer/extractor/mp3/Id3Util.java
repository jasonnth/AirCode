...
final class Id3Util {
    private static final Charset[] CHARSET_BY_ENCODING = {Charset.forName(LocalizedMessage.DEFAULT_ENCODING), Charset.forName("UTF-16LE"), Charset.forName("UTF-16BE"), Charset.forName(JPushConstants.ENCODING_UTF_8)};
    ...
    private static void writeSyncSafeInteger(byte[] bytes, int offset, int value) {
        bytes[offset] = (byte) ((value >> 21) & CertificateBody.profileType);
        bytes[offset + 1] = (byte) ((value >> 14) & CertificateBody.profileType);
        bytes[offset + 2] = (byte) ((value >> 7) & CertificateBody.profileType);
        bytes[offset + 3] = (byte) (value & CertificateBody.profileType);
    }
}
