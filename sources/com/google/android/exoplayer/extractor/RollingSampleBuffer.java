...
final class RollingSampleBuffer {
    ...
    public RollingSampleBuffer(Allocator allocator2) {
    ...
    private void readEncryptionData(SampleHolder sampleHolder, SampleExtrasHolder extrasHolder2) {
        int subsampleCount;
        ...
        boolean subsampleEncryption = (signalByte & ISOFileInfo.DATA_BYTES1) != 0;
        int ivSize = signalByte & CertificateBody.profileType;
        if (sampleHolder.cryptoInfo.f3147iv == null) {
            sampleHolder.cryptoInfo.f3147iv = new byte[16];
        }
        readData(offset2, sampleHolder.cryptoInfo.f3147iv, ivSize);
        ...
        if (subsampleEncryption) {
            ...
            clearDataSizes[0] = 0;
            encryptedDataSizes[0] = sampleHolder.size - ((int) (offset3 - extrasHolder2.offset));
        }
        sampleHolder.cryptoInfo.set(subsampleCount, clearDataSizes, encryptedDataSizes, extrasHolder2.encryptionKeyId, sampleHolder.cryptoInfo.f3147iv, 1);
