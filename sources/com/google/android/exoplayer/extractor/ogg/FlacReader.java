...
final class FlacReader extends StreamReader {
    ...
    public int read(ExtractorInput input, PositionHolder seekPosition) throws IOException, InterruptedException {
        ...
        if (this.streamInfo == null) {
            ...
            metadata[4] = ISOFileInfo.DATA_BYTES1;
            this.trackOutput.format(MediaFormat.createAudioFormat(null, "audio/x-flac", this.streamInfo.bitRate(), -1, this.streamInfo.durationUs(), this.streamInfo.channels, this.streamInfo.sampleRate, Collections.singletonList(metadata), null));
        } else if (data[0] == -1) {
        ...
        } else if ((data[0] & AccountVerificationOfflineIdController.PERMISSION_REQUEST_CODE_NETVERIFY) == 3 && this.seekTable == null) {
