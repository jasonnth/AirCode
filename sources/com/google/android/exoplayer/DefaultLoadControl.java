...
public final class DefaultLoadControl implements LoadControl {
    ...
    public DefaultLoadControl(Allocator allocator2) {
        this(allocator2, null, null);
    }

    public DefaultLoadControl(Allocator allocator2, Handler eventHandler2, EventListener eventListener2) {
        this(allocator2, eventHandler2, eventListener2, JPushConstants.DURATION_HEARTBEAT_AFTER_LOGGEDIN, 30000, 0.2f, 0.8f);
    }
    ...
    private void updateControlState() {
        ...
        if (this.fillingBuffers) {
            for (int i2 = 0; i2 < this.loaders.size(); i2++) {
                long loaderTime = ((LoaderState) this.loaderStates.get(this.loaders.get(i2))).nextLoadPositionUs;
