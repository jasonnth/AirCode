...
public final class MediaCodecUtil {
    ...
    private static final class CodecKey {
        ...
        public int hashCode() {
            return (((this.mimeType == null ? 0 : this.mimeType.hashCode()) + 31) * 31) + (this.secure ? 1231 : HelpCenterArticle.VERIFIED_ID_LEARN_MORE);
        }
            ...
            if (decoderInfos2 != null) {
                ...
                if (secure && decoderInfos3.isEmpty() && 21 <= Util.SDK_INT && Util.SDK_INT <= 23) {
                    ...
                    if (!decoderInfos3.isEmpty()) {
                        Log.w("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + mimeType + ". Assuming: " + ((DecoderInfo) decoderInfos3.get(0)).name);
                    }
                }
