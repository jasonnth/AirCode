...
public abstract class SampleSourceTrackRenderer extends TrackRenderer {
    ...
    /* access modifiers changed from: protected */
    public abstract boolean handlesTrack(MediaFormat mediaFormat) throws DecoderQueryException;
    ...
    public SampleSourceTrackRenderer(SampleSource... sources2) {
        this.sources = new SampleSourceReader[sources2.length];
    ...
    public final boolean doPrepare(long positionUs) throws ExoPlaybackException {
        ...
        for (SampleSourceReader trackCount : this.sources) {
        ...
        for (int sourceIndex = 0; sourceIndex < sourceCount; sourceIndex++) {
            ...
            while (trackIndex < sourceTrackCount) {
                ...
                try {
                    ...
                    ExoPlaybackException exoPlaybackException = new ExoPlaybackException((Throwable) e);
