...
public abstract class MediaCodecTrackRenderer extends SampleSourceTrackRenderer {
    ...
    /* access modifiers changed from: protected */
    public abstract boolean handlesTrack(MediaCodecSelector mediaCodecSelector2, MediaFormat mediaFormat) throws DecoderQueryException;

    /* access modifiers changed from: protected */
    public abstract boolean processOutputBuffer(long j, long j2, MediaCodec mediaCodec, ByteBuffer byteBuffer, BufferInfo bufferInfo, int i, boolean z) throws ExoPlaybackException;
    ...
    /* access modifiers changed from: protected */
    public final boolean handlesTrack(MediaFormat mediaFormat) throws DecoderQueryException {
        return handlesTrack(this.mediaCodecSelector, mediaFormat);
    }

    /* access modifiers changed from: protected */
    public DecoderInfo getDecoderInfo(MediaCodecSelector mediaCodecSelector2, String mimeType, boolean requiresSecureDecoder) throws DecoderQueryException {
    ...
    private static CryptoInfo getFrameworkCryptoInfo(SampleHolder sampleHolder2, int adaptiveReconfigurationBytes) {
        CryptoInfo cryptoInfo = sampleHolder2.cryptoInfo.getFrameworkCryptoInfoV16();
