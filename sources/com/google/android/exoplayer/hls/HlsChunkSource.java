...
import com.google.android.exoplayer.extractor.p308ts.AdtsExtractor;
import com.google.android.exoplayer.extractor.p308ts.PtsTimestampAdjuster;
import com.google.android.exoplayer.extractor.p308ts.TsExtractor;
...
public class HlsChunkSource implements Output {
    ...
    public HlsChunkSource(boolean isMaster2, DataSource dataSource2, HlsPlaylist playlist, HlsTrackSelector trackSelector2, BandwidthMeter bandwidthMeter2, PtsTimestampAdjusterProvider timestampAdjusterProvider2) {
        this(isMaster2, dataSource2, playlist, trackSelector2, bandwidthMeter2, timestampAdjusterProvider2, 5000, 20000, null, null);
    }
    ...
    public HlsChunkSource(boolean isMaster2, DataSource dataSource2, HlsPlaylist playlist, HlsTrackSelector trackSelector2, BandwidthMeter bandwidthMeter2, PtsTimestampAdjusterProvider timestampAdjusterProvider2, long minBufferDurationToSwitchUpMs, long maxBufferDurationToSwitchDownMs, Handler eventHandler2, EventListener eventListener2) {
        ...
        this.masterPlaylist = new HlsMasterPlaylist(this.baseUri, variants2, Collections.emptyList(), Collections.emptyList(), null, null);
    }
    ...
    public Variant getFixedTrackVariant(int index) {
        Variant[] variants2 = ((ExposedTrack) this.tracks.get(index)).variants;
            ...
            if (lastPathSegment.endsWith(".aac")) {
                ...
                if (lastPathSegment.endsWith(".mp3")) {
                    ...
                    if (timestampAdjuster2 != null) {
                        extractorWrapper = new HlsExtractorWrapper(0, format, startTimeUs, new WebvttExtractor(timestampAdjuster2), switchingVariant, -1, -1);
                    } else {
                        return;
                    }
                }
    ...
    public void onChunkLoadCompleted(Chunk chunk) {
        if (chunk instanceof MediaPlaylistChunk) {
            ...
            setEncryptionData(encryptionKeyChunk.dataSpec.uri, encryptionKeyChunk.f3154iv, encryptionKeyChunk.getResult());
        }
    }
    ...
    private int getLiveNextChunkSequenceNumber(int previousChunkIndex, int oldVariantIndex, int newVariantIndex) {
        ...
        double offsetToLiveInstantSecs2 = ((offsetToLiveInstantSecs + (((double) (currentTimeMs - this.variantLastPlaylistLoadTimesMs[oldVariantIndex])) / 1000.0d)) + 2.0d) - (((double) (currentTimeMs - this.variantLastPlaylistLoadTimesMs[newVariantIndex])) / 1000.0d);
        ...
        for (int i2 = newMediaPlaylist.segments.size() - 1; i2 >= 0; i2--) {
            offsetToLiveInstantSecs2 -= ((Segment) newMediaPlaylist.segments.get(i2)).durationSecs;
            if (offsetToLiveInstantSecs2 < 0.0d) {
