...
public final class HlsSampleSource implements SampleSource, SampleSourceReader, Callback {
            ...
            if (i2 == primaryExtractorTrackIndex) {
                ...
                while (j < chunkSourceTrackCount) {
                    ...
                    if (fixedTrackVariant == null) {
                        copyWithFixedTrackInfo = format.copyAsAdaptive(null);
                    } else {
    ...
    private static MediaFormat copyWithFixedTrackInfo(MediaFormat format, Format fixedTrackFormat, String muxedLanguage) {
        return format.copyWithFixedTrackInfo(fixedTrackFormat.f3148id, fixedTrackFormat.bitrate, fixedTrackFormat.width == -1 ? -1 : fixedTrackFormat.width, fixedTrackFormat.height == -1 ? -1 : fixedTrackFormat.height, fixedTrackFormat.language == null ? muxedLanguage : fixedTrackFormat.language);
    }
