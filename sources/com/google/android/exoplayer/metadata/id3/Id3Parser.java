...
public final class Id3Parser implements MetadataParser<List<Id3Frame>> {
    ...
    private static PrivFrame parsePrivFrame(ParsableByteArray id3Data, int frameSize) throws UnsupportedEncodingException {
        ...
        return new PrivFrame(new String(data, 0, ownerEndIndex, LocalizedMessage.DEFAULT_ENCODING), Arrays.copyOfRange(data, ownerEndIndex + 1, data.length));
    }
    ...
    private static GeobFrame parseGeobFrame(ParsableByteArray id3Data, int frameSize) throws UnsupportedEncodingException {
        ...
        String mimeType = new String(data, 0, mimeTypeEndIndex, LocalizedMessage.DEFAULT_ENCODING);
    ...
    private static String getCharsetName(int encodingByte) {
        switch (encodingByte) {
            ...
            case 2:
                return "UTF-16BE";
            case 3:
                return JPushConstants.ENCODING_UTF_8;
            default:
                return LocalizedMessage.DEFAULT_ENCODING;
        }
    }
