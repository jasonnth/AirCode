...
public class MediaCodecVideoTrackRenderer extends MediaCodecTrackRenderer {
    ...
    public MediaCodecVideoTrackRenderer(Context context, SampleSource source, MediaCodecSelector mediaCodecSelector, int videoScalingMode2, long allowedJoiningTimeMs, Handler eventHandler, EventListener eventListener2, int maxDroppedFrameCountToNotify2) {
        this(context, source, mediaCodecSelector, videoScalingMode2, allowedJoiningTimeMs, null, false, eventHandler, eventListener2, maxDroppedFrameCountToNotify2);
    }
    ...
    public MediaCodecVideoTrackRenderer(Context context, SampleSource source, MediaCodecSelector mediaCodecSelector, int videoScalingMode2, long allowedJoiningTimeMs, DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, boolean playClearSamplesWithoutKeys, Handler eventHandler, EventListener eventListener2, int maxDroppedFrameCountToNotify2) {
        super(source, mediaCodecSelector, drmSessionManager, playClearSamplesWithoutKeys, eventHandler, (com.google.android.exoplayer.MediaCodecTrackRenderer.EventListener) eventListener2);
    ...
    public boolean handlesTrack(MediaCodecSelector mediaCodecSelector, MediaFormat mediaFormat) throws DecoderQueryException {
        ...
        if ("video/x-unknown".equals(mimeType) || mediaCodecSelector.getDecoderInfo(mimeType, false) != null) {
            return true;
        }
        return false;
    }
    ...
    /* access modifiers changed from: protected */
    public boolean processOutputBuffer(long positionUs, long elapsedRealtimeUs, MediaCodec codec, ByteBuffer buffer, BufferInfo bufferInfo, int bufferIndex, boolean shouldSkip) {
        if (shouldSkip) {
