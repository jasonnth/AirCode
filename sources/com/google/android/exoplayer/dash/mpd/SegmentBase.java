...
public abstract class SegmentBase {
    ...
    public static abstract class MultiSegmentBase extends SegmentBase {
        ...
        public final long getSegmentDurationUs(int sequenceNumber, long periodDurationUs) {
            ...
            return sequenceNumber == getLastSegmentNum(periodDurationUs) ? periodDurationUs - getSegmentTimeUs(sequenceNumber) : (this.duration * 1000000) / this.timescale;
        }
    ...
    public static class SegmentTemplate extends MultiSegmentBase {
        ...
        public RangedUri getInitialization(Representation representation) {
            ...
            return new RangedUri(this.baseUrl, this.initializationTemplate.buildUri(representation.format.f3148id, 0, representation.format.bitrate, 0), 0, -1);
        }
        ...
        public RangedUri getSegmentUrl(Representation representation, int sequenceNumber) {
            ...
            return new RangedUri(this.baseUrl, this.mediaTemplate.buildUri(representation.format.f3148id, sequenceNumber, representation.format.bitrate, time), 0, -1);
        }
        ...
        public int getLastSegmentNum(long periodDurationUs) {
            ...
            return (this.startNumber + ((int) Util.ceilDivide(periodDurationUs, (this.duration * 1000000) / this.timescale))) - 1;
        }
    }
