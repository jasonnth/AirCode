...
public interface zzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzr {
        ...
        private static class C7678zza implements zzr {
            private IBinder zzrk;

            C7678zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzr zzbr(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzr)) ? new C7678zza(iBinder) : (zzr) queryLocalInterface;
        }
