...
public interface zzs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzs {
        ...
        private static class C7679zza implements zzs {
            private IBinder zzrk;

            C7679zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzs zzbs(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzs)) ? new C7679zza(iBinder) : (zzs) queryLocalInterface;
        }
