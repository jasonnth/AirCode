...
final class zzo extends zzn implements Callback {
    ...
    /* access modifiers changed from: private */
    public final HashMap<zza, zza> zzaGf = new HashMap<>();
    /* access modifiers changed from: private */
        ...
        switch (message.what) {
            case 0:
                synchronized (this.zzaGf) {
                    ...
                    zza zza3 = (zza) this.zzaGf.get(zza2);
            ...
            case 1:
                synchronized (this.zzaGf) {
                    zza zza4 = (zza) message.obj;
                    zza zza5 = (zza) this.zzaGf.get(zza4);
    ...
    public boolean zza(zza zza2, ServiceConnection serviceConnection, String str) {
        boolean isBound;
    ...
    /* access modifiers changed from: protected */
    public void zzb(zza zza2, ServiceConnection serviceConnection, String str) {
        zzac.zzb(serviceConnection, (Object) "ServiceConnection must not be null");
        synchronized (this.zzaGf) {
            zza zza3 = (zza) this.zzaGf.get(zza2);
            if (zza3 == null) {
