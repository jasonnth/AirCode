...
public interface zzu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzu {
        ...
        private static class C7680zza implements zzu {
            private IBinder zzrk;

            C7680zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzu zzbt(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzu)) ? new C7680zza(iBinder) : (zzu) queryLocalInterface;
        }
