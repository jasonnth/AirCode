...
public interface zzx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzx {
        ...
        private static class C7683zza implements zzx {
            private IBinder zzrk;

            C7683zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzx zzbw(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzx)) ? new C7683zza(iBinder) : (zzx) queryLocalInterface;
        }
