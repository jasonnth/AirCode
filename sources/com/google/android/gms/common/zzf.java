...
class zzf {
    ...
    static abstract class zza extends com.google.android.gms.common.internal.zzt.zza {
        ...
        protected zza(byte[] bArr) {
            ...
            if (bArr.length != 25) {
                ...
                zzac.zzb(z, (Object) "cert hash data has incorrect length. length=" + bArr.length);
            }
        ...
        public boolean equals(Object obj) {
            ...
            try {
                zzt zzt = (zzt) obj;
                if (zzt.zzvb() != hashCode()) {
                    return false;
                }
                IObjectWrapper zzva = zzt.zzva();
                if (zzva == null) {
                    return false;
                }
    ...
    static abstract class zzc extends zza {
        ...
        public abstract byte[] zzvc();
    }

    static final class zzd {
        static final zza[] zzayw = {new zzc(zza.zzdc("0\u0004C0\u0003+ \u0003\u0002\u0001\u0002\u0002\t\u0000ÂàFdJ00")) {
            /* access modifiers changed from: protected */
            public byte[] zzvc() {
    ...
    static boolean zza(String str, zza zza2) {
        ...
        try {
            return zzayp.zze(str, zza2.zzva());
        } catch (RemoteException e) {
            Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e);
            return z;
        }
    ...
    static boolean zzb(String str, zza zza2) {
        ...
        try {
            return zzayp.zzf(str, zza2.zzva());
        } catch (RemoteException e) {
            Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e);
            return z;
        }
            ...
            synchronized (zzayq) {
                if (zzayp == null) {
                    try {
                        ...
                        zzayp = com.google.android.gms.common.internal.zzw.zza.zzbv(zza2.zzdT("com.google.android.gms.common.GoogleCertificatesImpl"));
                    } catch (com.google.android.gms.dynamite.DynamiteModule.zza e) {
