...
public final class WakeLockEvent extends StatsEvent {
    ...
    public String zzyL() {
        ...
        StringBuilder sb = new StringBuilder(String.valueOf(valueOf).length() + 37 + String.valueOf(valueOf2).length() + String.valueOf(valueOf3).length() + String.valueOf(valueOf4).length() + String.valueOf(join).length() + String.valueOf(valueOf5).length() + String.valueOf(valueOf6).length() + String.valueOf(zzyN).length() + String.valueOf(valueOf7).length() + String.valueOf(zzyU).length() + String.valueOf(valueOf8).length() + String.valueOf(valueOf9).length() + String.valueOf(zzyO).length());
        return sb.append(valueOf).append(valueOf2).append(valueOf3).append(zzyP).append(valueOf4).append(join).append(valueOf5).append(zzyT).append(valueOf6).append(zzyN).append(valueOf7).append(zzyU).append(valueOf8).append(zzyV).append(valueOf9).append(zzyO).toString();
    }
