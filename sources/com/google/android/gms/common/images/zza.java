...
public abstract class zza {
    ...
    static final class C7676zza {
        public final Uri uri;

        public C7676zza(Uri uri2) {
            this.uri = uri2;
        }

        public boolean equals(Object obj) {
            if (!(obj instanceof C7676zza)) {
                return false;
            }
            if (this == obj) {
                return true;
            }
            return zzaa.equal(((C7676zza) obj).uri, this.uri);
        }
    ...
    public static final class zzb extends zza {
        ...
        private void zza(ImageView imageView, Drawable drawable, boolean z, boolean z2, boolean z3) {
            ...
            if (zzc) {
                ((zzacb) drawable2).startTransition(250);
            }
        }
