...
public interface zza extends IInterface {
    ...
    public static abstract class C7688zza extends Binder implements zza {

        /* renamed from: com.google.android.gms.dynamite.zza$zza$zza reason: collision with other inner class name */
        private static class C7689zza implements zza {
            private IBinder zzrk;

            C7689zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zza zzce(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zza)) ? new C7689zza(iBinder) : (zza) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    int zze = zze(com.google.android.gms.dynamic.IObjectWrapper.zza.zzcd(parcel.readStrongBinder()), parcel.readString());
                ...
                case 3:
                    parcel.enforceInterface("com.google.android.gms.dynamite.IDynamiteLoader");
                    int zza2 = zza(com.google.android.gms.dynamic.IObjectWrapper.zza.zzcd(parcel.readStrongBinder()), parcel.readString(), parcel.readInt() != 0);
                    parcel2.writeNoException();
