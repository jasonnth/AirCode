...
public interface IObjectWrapper extends IInterface {
    ...
    public static abstract class zza extends Binder implements IObjectWrapper {
        ...
        private static class C7685zza implements IObjectWrapper {
            private IBinder zzrk;

            C7685zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static IObjectWrapper zzcd(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IObjectWrapper)) ? new C7685zza(iBinder) : (IObjectWrapper) queryLocalInterface;
        }
