...
public interface zzf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzf {
        ...
        private static class C7797zza implements zzf {
            private IBinder zzrk;

            C7797zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzf zzdA(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzf)) ? new C7797zza(iBinder) : (zzf) queryLocalInterface;
        }
