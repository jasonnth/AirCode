...
public interface IProjectionDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IProjectionDelegate {
        ...
        private static class C7781zza implements IProjectionDelegate {
            private IBinder zzrk;

            C7781zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static IProjectionDelegate zzeb(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IProjectionDelegate)) ? new C7781zza(iBinder) : (IProjectionDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 2:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IProjectionDelegate");
                    IObjectWrapper screenLocation = toScreenLocation(parcel.readInt() != 0 ? (LatLng) LatLng.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
