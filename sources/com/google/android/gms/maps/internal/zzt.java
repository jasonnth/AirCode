...
public interface zzt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzt {
        ...
        private static class C7811zza implements zzt {
            private IBinder zzrk;

            C7811zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzt zzdO(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzt)) ? new C7811zza(iBinder) : (zzt) queryLocalInterface;
        }
