...
public interface zzp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzp {
        ...
        private static class C7807zza implements zzp {
            private IBinder zzrk;

            C7807zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzp zzdK(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzp)) ? new C7807zza(iBinder) : (zzp) queryLocalInterface;
        }
