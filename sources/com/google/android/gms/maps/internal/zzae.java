...
public interface zzae extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzae {
        ...
        private static class C7790zza implements zzae {
            private IBinder zzrk;

            C7790zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzae zzdZ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzae)) ? new C7790zza(iBinder) : (zzae) queryLocalInterface;
        }
