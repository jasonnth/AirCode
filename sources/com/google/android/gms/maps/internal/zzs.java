...
public interface zzs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzs {
        ...
        private static class C7810zza implements zzs {
            private IBinder zzrk;

            C7810zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzs zzdN(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzs)) ? new C7810zza(iBinder) : (zzs) queryLocalInterface;
        }
