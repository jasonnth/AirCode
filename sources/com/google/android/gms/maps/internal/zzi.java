...
public interface zzi extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzi {
        ...
        private static class C7800zza implements zzi {
            private IBinder zzrk;

            C7800zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzi zzdD(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzi)) ? new C7800zza(iBinder) : (zzi) queryLocalInterface;
        }
