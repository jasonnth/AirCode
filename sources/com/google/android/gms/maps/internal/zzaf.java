...
public interface zzaf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaf {
        ...
        /* renamed from: com.google.android.gms.maps.internal.zzaf$zza$zza reason: collision with other inner class name */
        private static class C7791zza implements zzaf {
            private IBinder zzrk;

            C7791zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzaf zzea(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaf)) ? new C7791zza(iBinder) : (zzaf) queryLocalInterface;
        }
