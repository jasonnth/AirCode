...
public interface zzac extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzac {
        ...
        private static class C7788zza implements zzac {
            private IBinder zzrk;

            C7788zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzac zzdX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzac)) ? new C7788zza(iBinder) : (zzac) queryLocalInterface;
        }
