...
public interface zzad extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzad {
        ...
        private static class C7789zza implements zzad {
            private IBinder zzrk;

            C7789zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzad zzdY(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzad)) ? new C7789zza(iBinder) : (zzad) queryLocalInterface;
        }
