...
public interface zzab extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzab {
        ...
        private static class C7787zza implements zzab {
            private IBinder zzrk;

            C7787zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzab zzdW(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzab)) ? new C7787zza(iBinder) : (zzab) queryLocalInterface;
        }
