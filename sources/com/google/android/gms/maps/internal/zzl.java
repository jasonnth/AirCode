...
public interface zzl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzl {
        ...
        private static class C7803zza implements zzl {
            private IBinder zzrk;

            C7803zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzl zzdG(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzl)) ? new C7803zza(iBinder) : (zzl) queryLocalInterface;
        }
