...
public interface zzj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzj {
        ...
        private static class C7801zza implements zzj {
            private IBinder zzrk;

            C7801zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzj zzdE(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzj)) ? new C7801zza(iBinder) : (zzj) queryLocalInterface;
        }
