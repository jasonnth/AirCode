...
public interface zzy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzy {
        ...
        private static class C7816zza implements zzy {
            private IBinder zzrk;

            C7816zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzy zzdT(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzy)) ? new C7816zza(iBinder) : (zzy) queryLocalInterface;
        }
