...
public interface IMapFragmentDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IMapFragmentDelegate {
        ...
        private static class C7779zza implements IMapFragmentDelegate {
            private IBinder zzrk;

            C7779zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static IMapFragmentDelegate zzdx(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapFragmentDelegate)) ? new C7779zza(iBinder) : (IMapFragmentDelegate) queryLocalInterface;
        }
