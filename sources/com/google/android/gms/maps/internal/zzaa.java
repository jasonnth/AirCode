...
public interface zzaa extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaa {
        ...
        private static class C7786zza implements zzaa {
            private IBinder zzrk;

            C7786zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzaa zzdV(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaa)) ? new C7786zza(iBinder) : (zzaa) queryLocalInterface;
        }
