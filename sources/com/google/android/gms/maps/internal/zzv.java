...
public interface zzv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzv {
        ...
        private static class C7813zza implements zzv {
            private IBinder zzrk;

            C7813zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzv zzdQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzv)) ? new C7813zza(iBinder) : (zzv) queryLocalInterface;
        }
