...
public interface zzn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzn {
        ...
        private static class C7805zza implements zzn {
            private IBinder zzrk;

            C7805zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzn zzdI(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzn)) ? new C7805zza(iBinder) : (zzn) queryLocalInterface;
        }
