...
public interface zzag extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzag {
        ...
        private static class C7792zza implements zzag {
            private IBinder zzrk;

            C7792zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzag zzec(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzag)) ? new C7792zza(iBinder) : (zzag) queryLocalInterface;
        }
