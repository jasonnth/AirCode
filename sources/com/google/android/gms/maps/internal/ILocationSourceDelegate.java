...
public interface ILocationSourceDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements ILocationSourceDelegate {
        ...
        private static class C7778zza implements ILocationSourceDelegate {
            private IBinder zzrk;

            C7778zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }

            public void activate(zzp zzp) throws RemoteException {
        ...
        public static ILocationSourceDelegate zzdw(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ILocationSourceDelegate)) ? new C7778zza(iBinder) : (ILocationSourceDelegate) queryLocalInterface;
        }
    ...
    void activate(zzp zzp) throws RemoteException;
