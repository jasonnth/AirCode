...
public interface zzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzr {
        ...
        private static class C7809zza implements zzr {
            private IBinder zzrk;

            C7809zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzr zzdM(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzr)) ? new C7809zza(iBinder) : (zzr) queryLocalInterface;
        }
