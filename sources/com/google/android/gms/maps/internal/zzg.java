...
public interface zzg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzg {
        ...
        private static class C7798zza implements zzg {
            private IBinder zzrk;

            C7798zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzg zzdB(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzg)) ? new C7798zza(iBinder) : (zzg) queryLocalInterface;
        }
