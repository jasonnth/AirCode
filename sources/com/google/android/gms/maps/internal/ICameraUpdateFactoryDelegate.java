...
public interface ICameraUpdateFactoryDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements ICameraUpdateFactoryDelegate {
        ...
        private static class C7776zza implements ICameraUpdateFactoryDelegate {
            private IBinder zzrk;

            C7776zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static ICameraUpdateFactoryDelegate zzdr(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ICameraUpdateFactoryDelegate)) ? new C7776zza(iBinder) : (ICameraUpdateFactoryDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 7:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
                    IObjectWrapper newCameraPosition = newCameraPosition(parcel.readInt() != 0 ? (CameraPosition) CameraPosition.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                ...
                case 8:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
                    IObjectWrapper newLatLng = newLatLng(parcel.readInt() != 0 ? (LatLng) LatLng.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    if (newLatLng != null) {
                ...
                case 9:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
                    IObjectWrapper newLatLngZoom = newLatLngZoom(parcel.readInt() != 0 ? (LatLng) LatLng.CREATOR.createFromParcel(parcel) : null, parcel.readFloat());
                    parcel2.writeNoException();
                ...
                case 10:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
                    IObjectWrapper newLatLngBounds = newLatLngBounds(parcel.readInt() != 0 ? (LatLngBounds) LatLngBounds.CREATOR.createFromParcel(parcel) : null, parcel.readInt());
                    parcel2.writeNoException();
                ...
                case 11:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
                    IObjectWrapper newLatLngBoundsWithSize = newLatLngBoundsWithSize(parcel.readInt() != 0 ? (LatLngBounds) LatLngBounds.CREATOR.createFromParcel(parcel) : null, parcel.readInt(), parcel.readInt(), parcel.readInt());
                    parcel2.writeNoException();
