...
public interface zzd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzd {
        ...
        private static class C7823zza implements zzd {
            private IBinder zzrk;

            C7823zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzd zzel(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzd)) ? new C7823zza(iBinder) : (zzd) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 5:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                    boolean zzb = zzb(zzel(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    if (zzb) {
                        i3 = 1;
                    }
