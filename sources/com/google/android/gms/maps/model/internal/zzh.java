...
public interface zzh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzh {
        ...
        private static class C7826zza implements zzh {
            private IBinder zzrk;

            C7826zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzh zzeq(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzh)) ? new C7826zza(iBinder) : (zzh) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 8:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    boolean zza = zza(zzeq(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    if (zza) {
                        z = true;
                    }
