...
public final class GroundOverlayOptions extends zza {
    ...
    public GroundOverlayOptions image(BitmapDescriptor bitmapDescriptor) {
        zzac.zzb(bitmapDescriptor, (Object) "imageDescriptor must not be null");
    ...
    public GroundOverlayOptions positionFromBounds(LatLngBounds latLngBounds) {
        ...
        zzac.zza(z, (Object) new StringBuilder(String.valueOf(valueOf).length() + 46).append("Position has already been set using position: ").append(valueOf).toString());
        this.zzbno = latLngBounds;
        return this;
    }
