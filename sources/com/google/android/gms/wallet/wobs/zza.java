...
public class zza implements Creator<CommonWalletObject> {
    static void zza(CommonWalletObject commonWalletObject, Parcel parcel, int i) {
        ...
        zzc.zza(parcel, 3, commonWalletObject.zzbQG, false);
        zzc.zza(parcel, 4, commonWalletObject.name, false);
        zzc.zza(parcel, 5, commonWalletObject.zzbQA, false);
        zzc.zza(parcel, 6, commonWalletObject.zzbQC, false);
        zzc.zza(parcel, 7, commonWalletObject.zzbQD, false);
        zzc.zza(parcel, 8, commonWalletObject.zzbQE, false);
        zzc.zza(parcel, 9, commonWalletObject.zzbQF, false);
        zzc.zzc(parcel, 10, commonWalletObject.state);
        zzc.zzc(parcel, 11, commonWalletObject.zzbQH, false);
        zzc.zza(parcel, 12, (Parcelable) commonWalletObject.zzbQI, i, false);
        zzc.zzc(parcel, 13, commonWalletObject.zzbQJ, false);
        zzc.zza(parcel, 14, commonWalletObject.zzbQK, false);
        zzc.zza(parcel, 15, commonWalletObject.zzbQL, false);
        zzc.zzc(parcel, 16, commonWalletObject.zzbQM, false);
        zzc.zza(parcel, 17, commonWalletObject.zzbQN);
        zzc.zzc(parcel, 18, commonWalletObject.zzbQO, false);
        zzc.zzc(parcel, 19, commonWalletObject.zzbQP, false);
        zzc.zzc(parcel, 20, commonWalletObject.zzbQQ, false);
        zzc.zzJ(parcel, zzaZ);
    }
    ...
    public CommonWalletObject createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == zzaY) {
            return new CommonWalletObject(str, str2, str3, str4, str5, str6, str7, str8, i, zzyY, zzl, zzyY2, str9, str10, zzyY3, z, zzyY4, zzyY5, zzyY6);
        }
