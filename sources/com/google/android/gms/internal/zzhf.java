...
public interface zzhf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhf {
        ...
        private static class C7731zza implements zzhf {
            private IBinder zzrk;

            C7731zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhf zzB(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.formats.client.INativeAdImage");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhf)) ? new C7731zza(iBinder) : (zzhf) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IObjectWrapper zzfP = zzfP();
                    parcel2.writeNoException();
                    parcel2.writeStrongBinder(zzfP != null ? zzfP.asBinder() : null);
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.formats.client.INativeAdImage");
                    Uri uri = getUri();
    ...
    IObjectWrapper zzfP() throws RemoteException;
}
