...
public class zzcy implements ActivityLifecycleCallbacks, OnAttachStateChangeListener, OnGlobalLayoutListener, OnScrollChangedListener {
    private static final long zzwR = ((Long) zzgd.zzDu.get()).longValue();
    ...
    public void zzl(int i) {
        if (this.zzwX.size() != 0 && this.zzwU != null) {
            ...
            int i2 = view != null ? view.getWindowVisibility() : 8;
            if (this.zzwW != -1) {
                i2 = this.zzwW;
            }
            boolean z5 = !z2 && zzw.zzcM().zza(view, this.zzwp, this.zzwq) && z3 && z4 && i2 == 0;
