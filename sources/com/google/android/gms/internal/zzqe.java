...
public class zzqe {
    ...
    private void zza(ViewGroup viewGroup, zzeg zzeg, String str, int i, int i2) {
        if (viewGroup.getChildCount() == 0) {
            ...
            frameLayout.addView(textView, new LayoutParams(zzeg.widthPixels - zzb, zzeg.heightPixels - zzb, 17));
    ...
    public void zza(Context context, String str, String str2, Bundle bundle, boolean z, zza zza2) {
        if (z) {
            ...
            bundle.putString(JPushReportInterface.APP_ID, applicationContext.getPackageName());
            if (str == null) {
                str = zze.zzuY().zzaC(context) + "." + 10260000;
            }
    ...
    public void zza(ViewGroup viewGroup, zzeg zzeg, String str) {
        zza(viewGroup, zzeg, str, (int) AirMapInterface.CIRCLE_BORDER_COLOR, -1);
    }

    public void zza(ViewGroup viewGroup, zzeg zzeg, String str, String str2) {
        zzqf.zzbh(str2);
        zza(viewGroup, zzeg, str, -65536, (int) AirMapInterface.CIRCLE_BORDER_COLOR);
    }
    ...
    public String zzad(Context context) {
        ...
        String string = contentResolver == null ? null : Secure.getString(contentResolver, JPushReportInterface.ANDROID_ID);
        if (string == null || zzli()) {
            string = "emulator";
        }
        return zzbe(string);
