...
public class zzdb {
    ...
    public String toString() {
        ...
        return new StringBuilder(String.valueOf(valueOf).length() + CipherSuite.TLS_DH_DSS_WITH_AES_256_GCM_SHA384 + String.valueOf(valueOf2).length() + String.valueOf(str).length() + String.valueOf(str2).length() + String.valueOf(str3).length()).append("ActivityContent fetchId: ").append(i).append(" score:").append(i2).append(" total_length:").append(i3).append("\n text: ").append(valueOf).append("\n viewableText").append(valueOf2).append("\n signture: ").append(str).append("\n viewableSignture: ").append(str2).append("\n viewableSignatureForVertical: ").append(str3).toString();
    }
    ...
    public void zzeg() {
        synchronized (this.zzrJ) {
            ...
            if (zzb > this.zzxA) {
                ...
                if (((Boolean) zzgd.zzCk.get()).booleanValue() && !zzw.zzcQ().zzkh()) {
