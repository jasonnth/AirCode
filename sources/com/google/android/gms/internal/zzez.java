...
public interface zzez extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzez {
        ...
        private static class C7726zza implements zzez {
            private IBinder zzrk;

            C7726zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
            ...
            public IBinder zza(IObjectWrapper iObjectWrapper, int i) throws RemoteException {
        ...
        public static zzez zzv(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzez)) ? new C7726zza(iBinder) : (zzez) queryLocalInterface;
        }
