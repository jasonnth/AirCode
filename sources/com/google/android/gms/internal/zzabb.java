...
public interface zzabb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzabb {
        ...
        private static class C7694zza implements zzabb {
            private IBinder zzrk;

            C7694zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzabb zzbp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzabb)) ? new C7694zza(iBinder) : (zzabb) queryLocalInterface;
        }
