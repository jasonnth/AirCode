...
public enum zzvv {
    ...
    private zzvv(String str) {
        this.zzalT = str;
    }

    public static boolean zza(zzvv zzvv) {
        return BAD_AUTHENTICATION.equals(zzvv) || CAPTCHA.equals(zzvv) || NEED_PERMISSION.equals(zzvv) || NEED_REMOTE_CONSENT.equals(zzvv) || NEEDS_BROWSER.equals(zzvv) || USER_CANCEL.equals(zzvv) || DEVICE_MANAGEMENT_REQUIRED.equals(zzvv) || DM_INTERNAL_ERROR.equals(zzvv) || DM_SYNC_DISABLED.equals(zzvv) || DM_ADMIN_BLOCKED.equals(zzvv) || DM_ADMIN_PENDING_APPROVAL.equals(zzvv) || DM_STALE_SYNC_REQUIRED.equals(zzvv) || DM_DEACTIVATED.equals(zzvv) || DM_REQUIRED.equals(zzvv) || THIRD_PARTY_DEVICE_MANAGEMENT_REQUIRED.equals(zzvv) || DM_SCREENLOCK_REQUIRED.equals(zzvv);
    }

    public static boolean zzb(zzvv zzvv) {
        return NETWORK_ERROR.equals(zzvv) || SERVICE_UNAVAILABLE.equals(zzvv);
    }
