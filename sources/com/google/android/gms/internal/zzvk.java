...
public interface zzvk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzvk {

        /* renamed from: com.google.android.gms.internal.zzvk$zza$zza reason: collision with other inner class name */
        private static class C7768zza implements zzvk {
            private IBinder zzrk;

            C7768zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzvk zzaF(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzvk)) ? new C7768zza(iBinder) : (zzvk) queryLocalInterface;
        }
