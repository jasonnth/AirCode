    ...
    static HttpUriRequest zzb(zzl<?> zzl, Map<String, String> map) throws zza {
        switch (zzl.getMethod()) {
            case -1:
                ...
                httpPost.addHeader(ApiRequestHeadersInterceptor.HEADER_CONTENT_TYPE, zzl.zzi());
            ...
            case 1:
                ...
                httpPost2.addHeader(ApiRequestHeadersInterceptor.HEADER_CONTENT_TYPE, zzl.zzl());
                zza((HttpEntityEnclosingRequestBase) httpPost2, zzl);
                return httpPost2;
            case 2:
                HttpPut httpPut = new HttpPut(zzl.getUrl());
                httpPut.addHeader(ApiRequestHeadersInterceptor.HEADER_CONTENT_TYPE, zzl.zzl());
            ...
            case 7:
                ...
                zza2.addHeader(ApiRequestHeadersInterceptor.HEADER_CONTENT_TYPE, zzl.zzl());
