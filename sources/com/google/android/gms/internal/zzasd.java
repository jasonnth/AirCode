...
public interface zzasd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzasd {
        ...
        private static class C7703zza implements zzasd {
            private IBinder zzrk;

            C7703zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzasd zzdh(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzasd)) ? new C7703zza(iBinder) : (zzasd) queryLocalInterface;
        }
