...
public class zzvh implements Creator<zzvg> {
    static void zza(zzvg zzvg, Parcel parcel, int i) {
        int zzaZ = zzc.zzaZ(parcel);
        zzc.zza(parcel, 1, (Parcelable) zzvg.getCredential(), i, false);
        zzc.zzc(parcel, 1000, zzvg.zzaiI);
        zzc.zzJ(parcel, zzaZ);
    }
