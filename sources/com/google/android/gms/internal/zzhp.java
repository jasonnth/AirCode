...
public interface zzhp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhp {

        /* renamed from: com.google.android.gms.internal.zzhp$zza$zza reason: collision with other inner class name */
        private static class C7737zza implements zzhp {
            private IBinder zzrk;

            C7737zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhp zzH(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.formats.client.IOnAppInstallAdLoadedListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhp)) ? new C7737zza(iBinder) : (zzhp) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(com.google.android.gms.internal.zzhj.zza.zzE(parcel.readStrongBinder()));
    ...
    void zza(zzhj zzhj) throws RemoteException;
}
