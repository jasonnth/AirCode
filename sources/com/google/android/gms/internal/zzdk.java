...
public class zzdk {
    ...
    static String zza(String[] strArr, int i, int i2) {
        if (strArr.length < i + i2) {
            zzpk.m1280e("Unable to construct shingle");
            return "";
        }
    ...
    static void zza(int i, long j, String str, int i2, PriorityQueue<zza> priorityQueue) {
        ...
        if ((priorityQueue.size() != i || (((zza) priorityQueue.peek()).zzyv <= zza2.zzyv && ((zza) priorityQueue.peek()).value <= zza2.value)) && !priorityQueue.contains(zza2)) {
    ...
    public static void zza(String[] strArr, int i, int i2, PriorityQueue<zza> priorityQueue) {
        if (strArr.length < i2) {
            int i3 = i;
            zza(i3, zzb(strArr, 0, strArr.length), zza(strArr, 0, strArr.length), strArr.length, priorityQueue);
            return;
        }
        ...
        while (i4 < (strArr.length - i2) + 1) {
            long zza3 = zza(zzdi.zzH(strArr[i4 - 1]), zzdi.zzH(strArr[(i4 + i2) - 1]), zzb, zza2, 16785407);
            zza(i, zza3, zza(strArr, i4, i2), strArr.length, priorityQueue);
            i4++;
            zzb = zza3;
        }
    }
