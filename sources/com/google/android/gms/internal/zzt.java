...
public class zzt {
    ...
    static class zza {
        ...
        private final List<C7762zza> zzak = new ArrayList();
        ...
        private static class C7762zza {
            public final String name;
            public final long time;
            public final long zzam;

            public C7762zza(String str, long j, long j2) {
                this.name = str;
                this.zzam = j;
                this.time = j2;
            }
        ...
        private long getTotalDuration() {
            ...
            return ((C7762zza) this.zzak.get(this.zzak.size() - 1)).time - ((C7762zza) this.zzak.get(0)).time;
        }
        ...
        public synchronized void zza(String str, long j) {
            ...
            this.zzak.add(new C7762zza(str, j, SystemClock.elapsedRealtime()));
        }
        ...
        public synchronized void zzd(String str) {
            ...
            if (totalDuration > 0) {
                long j = ((C7762zza) this.zzak.get(0)).time;
                zzt.zzb("(%-4d ms) %s", Long.valueOf(totalDuration), str);
                long j2 = j;
                for (C7762zza zza : this.zzak) {
                    long j3 = zza.time;
