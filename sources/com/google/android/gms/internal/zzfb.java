...
public interface zzfb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfb {
        ...
        private static class C7728zza implements zzfb {
            private IBinder zzrk;

            C7728zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzfb zzx(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzfb)) ? new C7728zza(iBinder) : (zzfb) queryLocalInterface;
        }
