...
public interface zzcq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcq {
        ...
        private static class C7713zza implements zzcq {
            private IBinder zzrk;

            C7713zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzcq zzf(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzcq)) ? new C7713zza(iBinder) : (zzcq) queryLocalInterface;
        }
