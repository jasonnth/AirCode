...
public interface zzex extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzex {
        ...
        private static class C7724zza implements zzex {
            private IBinder zzrk;

            C7724zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzex zzt(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzex)) ? new C7724zza(iBinder) : (zzex) queryLocalInterface;
        }
