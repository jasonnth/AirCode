...
public class zzaaa extends zzaae {
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        while (true) {
            ...
            if (i2 < this.zzazN.size()) {
                ((zza) this.zzazN.valueAt(i2)).dump(str, fileDescriptor, printWriter, strArr);
                i = i2 + 1;
            } else {
                return;
            }
    ...
    public void onStart() {
        ...
        if (!this.zzazZ) {
            ...
            while (true) {
                int i2 = i;
                if (i2 < this.zzazN.size()) {
                    ((zza) this.zzazN.valueAt(i2)).zzazP.connect();
                    i = i2 + 1;
                } else {
                    return;
                }
    ...
    public void onStop() {
        ...
        while (true) {
            int i2 = i;
            if (i2 < this.zzazN.size()) {
                ((zza) this.zzazN.valueAt(i2)).zzazP.disconnect();
                i = i2 + 1;
            } else {
                return;
            }
    ...
    public void zza(int i, GoogleApiClient googleApiClient, OnConnectionFailedListener onConnectionFailedListener) {
        ...
        zzac.zza(this.zzazN.indexOfKey(i) < 0, (Object) "Already managing a GoogleApiClient with id " + i);
    ...
    public void zza(ConnectionResult connectionResult, int i) {
        ...
        zza zza2 = (zza) this.zzazN.get(i);
        if (zza2 != null) {
            zzcA(i);
            OnConnectionFailedListener onConnectionFailedListener = zza2.zzazQ;
