...
public class zzpr {
    ...
    static String zzbc(String str) {
        ...
        for (String str2 : zzg.keySet()) {
            sb.append(str2).append(" = ").append((String) zzg.get(str2)).append("\n\n");
        }
    ...
    private void zzkU() {
        ...
        String str = resources != null ? resources.getString(R.string.debug_menu_title) : "Select a Debug Mode";
        String str2 = resources != null ? resources.getString(R.string.debug_menu_ad_information) : "Ad Information";
        String str3 = resources != null ? resources.getString(R.string.debug_menu_creative_preview) : "Creative Preview";
        String str4 = resources != null ? resources.getString(R.string.debug_menu_troubleshooting) : "Troubleshooting";
        ArrayList arrayList = new ArrayList();
        final int zza = zza((List<String>) arrayList, str2, true);
        final int zza2 = zza((List<String>) arrayList, str3, ((Boolean) zzgd.zzFl.get()).booleanValue());
        final int zza3 = zza((List<String>) arrayList, str4, ((Boolean) zzgd.zzFm.get()).booleanValue());
        new AlertDialog.Builder(this.mContext).setTitle(str).setItems((CharSequence[]) arrayList.toArray(new String[0]), new OnClickListener() {
