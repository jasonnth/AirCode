...
public interface zzaqm extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaqm {
        ...
        private static class C7700zza implements zzaqm {
            private IBinder zzrk;

            C7700zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
            ...
            public zzaqk zza(zzaqi zzaqi) throws RemoteException {
                ...
                try {
                    ...
                    return obtain2.readInt() != 0 ? (zzaqk) zzaqk.CREATOR.createFromParcel(obtain2) : null;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
        ...
        public static zzaqm zzcU(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaqm)) ? new C7700zza(iBinder) : (zzaqm) queryLocalInterface;
        }
