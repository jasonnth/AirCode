...
public interface zzhh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhh {
        ...
        private static class C7732zza implements zzhh {
            private IBinder zzrk;

            C7732zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
            ...
            public IObjectWrapper zzU(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.INativeAdViewDelegate");
            ...
            public void zzb(IObjectWrapper iObjectWrapper, int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.INativeAdViewDelegate");
            ...
            public void zzd(String str, IObjectWrapper iObjectWrapper) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.INativeAdViewDelegate");
        ...
        public static zzhh zzC(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhh)) ? new C7732zza(iBinder) : (zzhh) queryLocalInterface;
        }
    ...
    IObjectWrapper zzU(String str) throws RemoteException;
