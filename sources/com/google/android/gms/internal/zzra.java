...
class zzra extends WebView implements OnGlobalLayoutListener, DownloadListener, zzqw {
    ...
    protected zzra(zza zza2, zzeg zzeg, boolean z, boolean z2, zzaw zzaw, zzqh zzqh, zzgl zzgl, zzu zzu, com.google.android.gms.ads.internal.zze zze) {
        super(zza2);
        this.zzZZ = zza2;
        this.zzus = zzeg;
        this.zzaaf = z;
    ...
    static zzra zzb(Context context, zzeg zzeg, boolean z, boolean z2, zzaw zzaw, zzqh zzqh, zzgl zzgl, zzu zzu, com.google.android.gms.ads.internal.zze zze) {
    ...
    public void destroy() {
        synchronized (this.zzrJ) {
            ...
            if (!this.zzaae) {
                ...
                zzmj();
                this.zzaae = true;
                zzpk.m1279v("Initiating WebView self destruct sequence in 3...");
                this.zzaab.zzlS();
            }
        }
    }
    ...
    public void evaluateJavascript(java.lang.String r3, android.webkit.ValueCallback<java.lang.String> r4) {
        /*
            ...
            monitor-enter(r1)
            boolean r0 = r2.isDestroyed()     // Catch:{ all -> 0x001c }
            if (r0 == 0) goto L_0x0017
            java.lang.String r0 = "The webview is destroyed. Ignoring action."
            com.google.android.gms.internal.zzpk.zzbh(r0)     // Catch:{ all -> 0x001c }
    ...
    public void zza(com.google.android.gms.internal.zzcy.zza zza2) {
        synchronized (this.zzrJ) {
    ...
    public void zza(zzrb zzrb) {
        synchronized (this.zzrJ) {
            if (this.zzaak != null) {
                zzpk.m1280e("Attempt to create multiple AdWebViewVideoControllers.");
            } else {
                this.zzaak = zzrb;
            }
        }
    ...
    public void zzbm(String str) {
        ...
        zzbl(valueOf2.length() != 0 ? str3.concat(valueOf2) : new String(str3));
    }
    ...
    public void zzlA() {
        synchronized (this.zzrJ) {
            zzpk.m1279v("Destroying WebView!");
            zzkC();
