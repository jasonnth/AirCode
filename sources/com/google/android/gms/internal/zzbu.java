...
public class zzbu extends zzca {
    ...
    public zzbu(zzbd zzbd, String str, String str2, zza zza, int i, int i2, StackTraceElement[] stackTraceElementArr) {
    ...
    public void zzbd() throws IllegalAccessException, InvocationTargetException {
        if (this.zzqZ != null) {
            zzbb zzbb = new zzbb((String) this.zzre.invoke(null, new Object[]{this.zzqZ}));
