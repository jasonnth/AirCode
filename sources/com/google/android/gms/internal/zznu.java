...
public interface zznu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznu {
        ...
        private static class C7758zza implements zznu {
            private IBinder zzrk;

            C7758zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zznu zzah(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznu)) ? new C7758zza(iBinder) : (zznu) queryLocalInterface;
        }
