...
class zzip implements zzid {
    ...
    public void zza(zzqw zzqw, Map<String, String> map) {
        ...
        if (((Boolean) zzgd.zzDE.get()).booleanValue()) {
            ...
            if (zzlG == null) {
                try {
                    zzrb zzrb2 = new zzrb(zzqw, Float.parseFloat((String) map.get("duration")));
                    zzqw.zza(zzrb2);
                    zzrb = zzrb2;
            ...
            float parseFloat = Float.parseFloat((String) map.get(ReactVideoView.EVENT_PROP_CURRENT_TIME));
            int zzh = zzh(map);
