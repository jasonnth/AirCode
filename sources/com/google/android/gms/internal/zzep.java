...
public interface zzep extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzep {
        ...
        private static class C7716zza implements zzep {
            private IBinder zzrk;

            C7716zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzep zzm(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzep)) ? new C7716zza(iBinder) : (zzep) queryLocalInterface;
        }
