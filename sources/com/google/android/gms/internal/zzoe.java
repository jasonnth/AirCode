...
public class zzoe extends zzpj implements zzog, zzoj {
    ...
    public zzoe(Context context, String str, String str2, zzjq zzjq, zza zza, zzol zzol, zzoj zzoj, long j) {
                    ...
                    zzqe.zzYP.post(new Runnable() {
                        public void run() {
                            try {
                                ...
                                zzpk.zzc(valueOf.length() != 0 ? str.concat(valueOf) : new String(str), remoteException);
