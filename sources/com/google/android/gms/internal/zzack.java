...
public interface zzack extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzack {
        ...
        /* renamed from: com.google.android.gms.internal.zzack$zza$zza reason: collision with other inner class name */
        private static class C7696zza implements zzack {
            private IBinder zzrk;

            C7696zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzack zzbA(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzack)) ? new C7696zza(iBinder) : (zzack) queryLocalInterface;
        }
