...
public interface zzhl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhl {
        ...
        private static class C7735zza implements zzhl {
            private IBinder zzrk;

            C7735zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhl zzF(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhl)) ? new C7735zza(iBinder) : (zzhl) queryLocalInterface;
        }
