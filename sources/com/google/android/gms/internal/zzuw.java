...
public interface zzuw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzuw {
        ...
        private static class C7766zza implements zzuw {
            private IBinder zzrk;

            C7766zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzuw zzaC(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzuw)) ? new C7766zza(iBinder) : (zzuw) queryLocalInterface;
        }
