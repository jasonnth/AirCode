...
public interface zzmu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmu {
        ...
        private static class C7756zza implements zzmu {
            private IBinder zzrk;

            C7756zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
            ...
            public void zza(zzmn zzmn) throws RemoteException {
        ...
        public static zzmu zzaf(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzmu)) ? new C7756zza(iBinder) : (zzmu) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(parcel.readInt() != 0 ? (zzmn) zzmn.CREATOR.createFromParcel(parcel) : null);
    ...
    void zza(zzmn zzmn) throws RemoteException;
}
