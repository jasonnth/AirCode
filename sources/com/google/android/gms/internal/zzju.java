...
public class zzju implements zza {
    ...
    public boolean zzG(int i) {
        try {
            Bundle zzhe = this.zzwf ? this.zzLb.zzhf() : this.zzus.zzzz ? this.zzLb.getInterstitialAdapterInfo() : this.zzLb.zzhe();
            if (zzhe == null) {
                return false;
            }
            return (zzhe.getInt("capabilities", 0) & i) == i;
    ...
    public zzkb zzgX() {
        ...
        try {
            ...
            zzpk.zza(valueOf2.length() != 0 ? str2.concat(valueOf2) : new String(str2), remoteException);
            return null;
        }
    }
    ...
    private int zzgZ() {
        ...
        try {
            ...
            int i = zzG(2) ? jSONObject.optInt("cpm_floor_cents", 0) : 0;
            return i == 0 ? jSONObject.optInt("penalized_average_cpm_cents", 0) : i;
        } catch (JSONException e) {
