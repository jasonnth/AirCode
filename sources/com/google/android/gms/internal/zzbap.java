...
public interface zzbap extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzbap {
        ...
        private static class C7706zza implements zzbap {
            private IBinder zzrk;

            C7706zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzbap zzfe(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzbap)) ? new C7706zza(iBinder) : (zzbap) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 3:
                    ...
                    zza(parcel.readInt() != 0 ? (ConnectionResult) ConnectionResult.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (zzbak) zzbak.CREATOR.createFromParcel(parcel) : null);
                ...
                case 8:
                    parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInCallbacks");
                    zzb(parcel.readInt() != 0 ? (zzbaw) zzbaw.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
