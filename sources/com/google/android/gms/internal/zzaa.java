...
public class zzaa implements zzz {
    ...
    private HttpURLConnection zza(URL url, zzl<?> zzl) throws IOException {
        ...
        if (UriUtil.HTTPS_SCHEME.equals(url.getProtocol()) && this.zzaF != null) {
        ...
        switch (zzl.getMethod()) {
            case -1:
                ...
                if (zzj != null) {
                    ...
                    httpURLConnection.addRequestProperty(ApiRequestHeadersInterceptor.HEADER_CONTENT_TYPE, zzl.zzi());
    ...
    private static void zzb(HttpURLConnection httpURLConnection, zzl<?> zzl) throws IOException, zza {
        ...
        if (zzm != null) {
            httpURLConnection.setDoOutput(true);
            httpURLConnection.addRequestProperty(ApiRequestHeadersInterceptor.HEADER_CONTENT_TYPE, zzl.zzl());
            DataOutputStream dataOutputStream = new DataOutputStream(httpURLConnection.getOutputStream());
