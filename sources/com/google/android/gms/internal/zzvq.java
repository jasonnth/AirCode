...
public interface zzvq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzvq {

        /* renamed from: com.google.android.gms.internal.zzvq$zza$zza reason: collision with other inner class name */
        private static class C7770zza implements zzvq {
            private IBinder zzrk;

            C7770zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzvq zzaI(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.internal.IAuthCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzvq)) ? new C7770zza(iBinder) : (zzvq) queryLocalInterface;
        }
