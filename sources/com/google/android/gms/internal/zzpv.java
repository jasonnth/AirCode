...
public class zzpv {
    ...
    private static class zzb<T> extends zzl<InputStream> {
        ...
        /* access modifiers changed from: private */
        public final com.google.android.gms.internal.zzn.zzb<T> zzaG;

        public zzb(String str, final zza<T> zza, final com.google.android.gms.internal.zzn.zzb<T> zzb) {
            super(0, str, new com.google.android.gms.internal.zzn.zza() {
                public void zze(zzs zzs) {
                    com.google.android.gms.internal.zzn.zzb.this.zzb(zza.zzji());
                }
            });
            this.zzYs = zza;
            this.zzaG = zzb;
        ...
        public void zza(final InputStream inputStream) {
            final zzqm zza = zzpn.zza((Callable<T>) new Callable<T>() {
                public T call() {
    ...
    public zzqm<String> zza(int i, final String str, Map<String, String> map, byte[] bArr) {
        final zzc zzc2 = new zzc();
        final byte[] bArr2 = bArr;
        final Map<String, String> map2 = map;
        zzYm.zze(new zzac(this, i, str, zzc2, new com.google.android.gms.internal.zzn.zza(this) {
            public void zze(zzs zzs) {
                String str = str;
