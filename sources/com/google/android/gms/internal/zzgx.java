...
public class zzgx extends zza implements zzha.zza {
    ...
    public void performClick(String str) {
        synchronized (this.zzrJ) {
            if (this.zzGA == null) {
                zzqf.m1280e("Attempt to call performClick before ad initialized.");
            } else {
    ...
    public void recordImpression() {
        synchronized (this.zzrJ) {
            if (this.zzGA == null) {
                zzqf.m1280e("Attempt to perform recordImpression before ad initialized.");
            } else {
    ...
    public boolean zzj(IObjectWrapper iObjectWrapper) {
        if (this.zzGA == null) {
            zzqf.m1280e("Attempt to call renderVideoInMediaView before ad initialized.");
            return false;
            ...
            this.zzGA.zza((View) frameLayout, (zzgy) new zzgy() {
                ...
                public void zzfX() {
                    zzgx.this.performClick("_videoMediaView");
                }
            });
            return true;
        }
