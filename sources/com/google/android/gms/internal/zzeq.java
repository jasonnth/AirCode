...
public interface zzeq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeq {
        ...
        private static class C7717zza implements zzeq {
            private IBinder zzrk;

            C7717zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzeq zzn(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzeq)) ? new C7717zza(iBinder) : (zzeq) queryLocalInterface;
        }
