...
public final class zzkl implements NativeMediationAdRequest {
    ...
    public zzkl(Date date, int i, Set<String> set, Location location, boolean z, int i2, zzhc zzhc, List<String> list, boolean z2) {
        this.zzcR = date;
        this.zzzk = i;
        this.zzcT = set;
        this.zzcV = location;
    ...
    public NativeAdOptions getNativeAdOptions() {
        ...
        Builder requestMultipleImages = new Builder().setReturnUrlsForImageAssets(this.zztp.zzHa).setImageOrientation(this.zztp.zzHb).setRequestMultipleImages(this.zztp.zzHc);
