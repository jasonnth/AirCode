...
public interface zzasc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzasc {
        ...
        private static class C7702zza implements zzasc {
            private IBinder zzrk;

            C7702zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzasc zzdg(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzasc)) ? new C7702zza(iBinder) : (zzasc) queryLocalInterface;
        }
