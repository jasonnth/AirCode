...
public interface zzeo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeo {
        ...
        private static class C7715zza implements zzeo {
            private IBinder zzrk;

            C7715zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzeo zzl(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzeo)) ? new C7715zza(iBinder) : (zzeo) queryLocalInterface;
        }
