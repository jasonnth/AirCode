...
public interface zzlf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzlf {
        ...
        /* renamed from: com.google.android.gms.internal.zzlf$zza$zza reason: collision with other inner class name */
        private static class C7751zza implements zzlf {
            private IBinder zzrk;

            C7751zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzlf zzY(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzlf)) ? new C7751zza(iBinder) : (zzlf) queryLocalInterface;
        }
