...
public class zzqx extends WebViewClient {
    ...
    public zzqx(zzqw zzqw, boolean z) {
        this(zzqw, z, new zzkv(zzqw, zzqw.zzls(), new zzfv(zzqw.getContext())), null);
    }
    ...
    private void zzc(Context context, String str, String str2, String str3) {
        if (((Boolean) zzgd.zzDy.get()).booleanValue()) {
            ...
            bundle.putString(TripRole.ROLE_KEY_HOST, zzbk(str3));
    ...
    public final void onLoadResource(WebView webView, String str) {
        ...
        zzpk.m1279v(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2));
        Uri parse = Uri.parse(str);
    ...
    public final void onPageFinished(WebView webView, String str) {
        synchronized (this.zzrJ) {
            if (this.zzZL) {
                zzpk.m1279v("Blank page loaded, 1...");
                this.zzIs.zzlA();
                return;
            }
            this.zzZM = true;
    ...
    public WebResourceResponse shouldInterceptRequest(WebView webView, String str) {
        try {
            ...
            zzdp zza2 = zzw.zzcR().zza(zzJ);
            if (zza2 == null || !zza2.zzew()) {
                return null;
            }
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        ...
        if ("gmsg".equalsIgnoreCase(parse.getScheme()) && "mobileads.google.com".equalsIgnoreCase(parse.getHost())) {
            ...
            try {
                ...
                zzpk.zzbh(valueOf2.length() != 0 ? str3.concat(valueOf2) : new String(str3));
                uri = parse;
            }
            ...
            zzpk.zzbh(valueOf3.length() != 0 ? str4.concat(valueOf3) : new String(str4));
        }
        return true;
    }
    ...
    public void zza(AdOverlayInfoParcel adOverlayInfoParcel) {
        boolean z = false;
        boolean z2 = this.zzIp != null ? this.zzIp.zzhm() : false;
    ...
    public void zza(zzdx zzdx, zzh zzh, zzhz zzhz, zzq zzq, boolean z, zzif zzif, zzih zzih, zzf zzf, zzkx zzkx, zzot zzot) {
        if (zzf == null) {
    ...
    public void zzj(Uri uri) {
        ...
        if (list != null) {
            ...
            if (zzpk.zzak(2)) {
                ...
                for (String str2 : zzg.keySet()) {
                    ...
                    zzpk.m1279v(new StringBuilder(String.valueOf(str2).length() + 4 + String.valueOf(str3).length()).append("  ").append(str2).append(": ").append(str3).toString());
                }
            }
            for (zzid zza2 : list) {
        ...
        zzpk.m1279v(new StringBuilder(String.valueOf(valueOf2).length() + 32).append("No GMSG handler found for GMSG: ").append(valueOf2).toString());
    }
    ...
    public void zzlS() {
        synchronized (this.zzrJ) {
            zzpk.m1279v("Loading blank page in WebView, 2...");
            this.zzZL = true;
