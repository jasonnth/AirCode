...
public interface zzacl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzacl {
        ...
        private static class C7697zza implements zzacl {
            private IBinder zzrk;

            C7697zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzacl zzbB(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzacl)) ? new C7697zza(iBinder) : (zzacl) queryLocalInterface;
        }
