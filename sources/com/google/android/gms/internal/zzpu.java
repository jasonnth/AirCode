...
public class zzpu {
    ...
    public static class zza {
        ...
        public String toString() {
            return zzaa.zzv(this).zzg("name", this.name).zzg("minBound", Double.valueOf(this.zzYh)).zzg("maxBound", Double.valueOf(this.zzYg)).zzg("percent", Double.valueOf(this.zzYi)).zzg(MediaLoader.COLUMN_COUNT, Integer.valueOf(this.count)).toString();
        }
    }
