...
public interface zzla extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzla {
        ...
        private static class C7748zza implements zzla {
            private IBinder zzrk;

            C7748zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzla zzU(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzla)) ? new C7748zza(iBinder) : (zzla) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IBinder zzp = zzp(com.google.android.gms.dynamic.IObjectWrapper.zza.zzcd(parcel.readStrongBinder()));
