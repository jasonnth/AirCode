...
public class zzhb implements zzha {
    ...
    private static class zza {
        ...
        public zzid zzf(final zzjj zzjj) {
            return new zzid() {
                public void zza(zzqw zzqw, final Map<String, String> map) {
                    ...
                    zzqw2.zzlv().zza((com.google.android.gms.internal.zzqx.zza) new com.google.android.gms.internal.zzqx.zza() {
                    ...
                    if (TextUtils.isEmpty(str2)) {
                        zzqw2.loadData(str, "text/html", JPushConstants.ENCODING_UTF_8);
                    } else {
                        zzqw2.loadDataWithBaseURL(str2, str, "text/html", JPushConstants.ENCODING_UTF_8, null);
                    }
                }
            };
        }
        ...
        public com.google.android.gms.internal.zzlw.zza zzgh() {
            return new com.google.android.gms.internal.zzlw.zza() {
    ...
    public zzhb(Context context, zzs zzs, zzlw zzlw, zzaw zzaw, JSONObject jSONObject, com.google.android.gms.internal.zzha.zza zza2, zzqh zzqh, String str) {
    ...
    public View zza(OnClickListener onClickListener, boolean z) {
        ...
        zzgt.setContentDescription((CharSequence) zzgd.zzEu.get());
        return zzgt;
    }
    ...
    public void zza(View view, zzgy zzgy) {
        ...
        if (zzfU != null) {
            ...
            zzb zzb = (zzb) this.zzGO;
            if (zzb.getImages() != null && zzb.getImages().size() > 0) {
                zzhf zze = zze(zzb.getImages().get(0));
                if (zze != null) {
                    try {
                        ...
                        if (zzfP != null) {
                            ...
                            ImageView zzgf = zzgf();
                            zzgf.setImageDrawable(drawable);
                            zzgf.setScaleType(ScaleType.CENTER_INSIDE);
    ...
    public zzhf zze(Object obj) {
        if (obj instanceof IBinder) {
            return com.google.android.gms.internal.zzhf.zza.zzB((IBinder) obj);
        }
        return null;
    }
