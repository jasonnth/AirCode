...
public interface zzkd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkd {
        ...
        private static class C7744zza implements zzkd {
            private IBinder zzrk;

            C7744zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzkd zzP(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkd)) ? new C7744zza(iBinder) : (zzkd) queryLocalInterface;
        }
