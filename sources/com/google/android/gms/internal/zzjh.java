...
public class zzjh implements zzjf {
    ...
    public zzjh(Context context, zzqh zzqh, zzaw zzaw, zze zze) {
        this.zzIs = zzw.zzcN().zza(context, new zzeg(), false, false, zzaw, zzqh, null, null, zze);
    ...
    public void zza(zzdx zzdx, zzh zzh, zzhz zzhz, zzq zzq, boolean z, zzif zzif, zzih zzih, zzf zzf, zzkx zzkx) {
        this.zzIs.zzlv().zza(zzdx, zzh, zzhz, zzq, z, zzif, zzih, new zzf(this.zzIs.getContext(), false), zzkx, null);
    }
    ...
    public void zzam(String str) {
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                zzjh.this.zzIs.loadData(format, "text/html", JPushConstants.ENCODING_UTF_8);
            }
        });
    }
    ...
    public void zzao(final String str) {
        runOnUiThread(new Runnable() {
            public void run() {
                zzjh.this.zzIs.loadData(str, "text/html", JPushConstants.ENCODING_UTF_8);
            }
        });
    }
