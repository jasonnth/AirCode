...
public interface zzev extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzev {
        ...
        private static class C7722zza implements zzev {
            private IBinder zzrk;

            C7722zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzev zzs(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzev)) ? new C7722zza(iBinder) : (zzev) queryLocalInterface;
        }
