...
public interface zzke extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzke {
        ...
        private static class C7745zza implements zzke {
            private IBinder zzrk;

            C7745zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzke zzQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzke)) ? new C7745zza(iBinder) : (zzke) queryLocalInterface;
        }
