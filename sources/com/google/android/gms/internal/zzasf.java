...
public interface zzasf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzasf {

        /* renamed from: com.google.android.gms.internal.zzasf$zza$zza reason: collision with other inner class name */
        private static class C7705zza implements zzasf {
            private IBinder zzrk;

            C7705zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzasf zzdj(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzasf)) ? new C7705zza(iBinder) : (zzasf) queryLocalInterface;
        }
