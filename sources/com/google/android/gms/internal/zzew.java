...
public interface zzew extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzew {
        ...
        private static class C7723zza implements zzew {
            private IBinder zzrk;

            C7723zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
            ...
            public zzer createAdLoaderBuilder(IObjectWrapper iObjectWrapper, String str, zzka zzka, int i) throws RemoteException {
                ...
                try {
                    ...
                    return com.google.android.gms.internal.zzer.zza.zzo(obtain2.readStrongBinder());
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public zzkz createAdOverlay(IObjectWrapper iObjectWrapper) throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    return com.google.android.gms.internal.zzkz.zza.zzT(obtain2.readStrongBinder());
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public zzet createBannerAdManager(IObjectWrapper iObjectWrapper, zzeg zzeg, String str, zzka zzka, int i) throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    return com.google.android.gms.internal.zzet.zza.zzq(obtain2.readStrongBinder());
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public zzlf createInAppPurchaseManager(IObjectWrapper iObjectWrapper) throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    return com.google.android.gms.internal.zzlf.zza.zzY(obtain2.readStrongBinder());
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public zzhh createNativeAdViewDelegate(IObjectWrapper iObjectWrapper, IObjectWrapper iObjectWrapper2) throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    return com.google.android.gms.internal.zzhh.zza.zzC(obtain2.readStrongBinder());
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public zznu createRewardedVideoAd(IObjectWrapper iObjectWrapper, zzka zzka, int i) throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    return com.google.android.gms.internal.zznu.zza.zzah(obtain2.readStrongBinder());
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public zzey getMobileAdsSettingsManager(IObjectWrapper iObjectWrapper) throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    return com.google.android.gms.internal.zzey.zza.zzu(obtain2.readStrongBinder());
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
        ...
        public static zzew asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzew)) ? new C7723zza(iBinder) : (zzew) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    zzet createBannerAdManager = createBannerAdManager(com.google.android.gms.dynamic.IObjectWrapper.zza.zzcd(parcel.readStrongBinder()), parcel.readInt() != 0 ? (zzeg) zzeg.CREATOR.createFromParcel(parcel) : null, parcel.readString(), com.google.android.gms.internal.zzka.zza.zzM(parcel.readStrongBinder()), parcel.readInt());
                ...
                case 2:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IClientApi");
                    zzet createInterstitialAdManager = createInterstitialAdManager(com.google.android.gms.dynamic.IObjectWrapper.zza.zzcd(parcel.readStrongBinder()), parcel.readInt() != 0 ? (zzeg) zzeg.CREATOR.createFromParcel(parcel) : null, parcel.readString(), com.google.android.gms.internal.zzka.zza.zzM(parcel.readStrongBinder()), parcel.readInt());
                    parcel2.writeNoException();
                ...
                case 4:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IClientApi");
                    zzey mobileAdsSettingsManager = getMobileAdsSettingsManager(com.google.android.gms.dynamic.IObjectWrapper.zza.zzcd(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                ...
                case 9:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IClientApi");
                    zzey mobileAdsSettingsManagerWithClientJarVersion = getMobileAdsSettingsManagerWithClientJarVersion(com.google.android.gms.dynamic.IObjectWrapper.zza.zzcd(parcel.readStrongBinder()), parcel.readInt());
                    parcel2.writeNoException();
                ...
                case 10:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IClientApi");
                    zzet createSearchAdManager = createSearchAdManager(com.google.android.gms.dynamic.IObjectWrapper.zza.zzcd(parcel.readStrongBinder()), parcel.readInt() != 0 ? (zzeg) zzeg.CREATOR.createFromParcel(parcel) : null, parcel.readString(), parcel.readInt());
                    parcel2.writeNoException();
