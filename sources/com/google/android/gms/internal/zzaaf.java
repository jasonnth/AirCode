...
public abstract class zzaaf<R extends Result> extends PendingResult<R> {
    ...
    private void zzvG() {
        zzb zzb2 = (zzb) this.zzaAm.getAndSet(null);
        if (zzb2 != null) {
            zzb2.zzc(this);
        }
    }
    ...
    public final void setResultCallback(com.google.android.gms.common.api.ResultCallback<? super R> r6) {
        /*
            ...
            r0 = 0
            r5.zzaAl = r0     // Catch:{ all -> 0x0029 }
            monitor-exit(r3)     // Catch:{ all -> 0x0029 }
        L_0x000b:
            return
        L_0x000c:
            boolean r2 = r5.zzaAo     // Catch:{ all -> 0x0029 }
            if (r2 != 0) goto L_0x002c
            r2 = r0
        L_0x0011:
            java.lang.String r4 = "Result has already been consumed."
            com.google.android.gms.common.internal.zzac.zza(r2, r4)     // Catch:{ all -> 0x0029 }
            com.google.android.gms.internal.zzabx<R> r2 = r5.zzaAr     // Catch:{ all -> 0x0029 }
            if (r2 != 0) goto L_0x002e
        L_0x001b:
            java.lang.String r1 = "Cannot set callbacks if then() has been called."
            com.google.android.gms.common.internal.zzac.zza(r0, r1)     // Catch:{ all -> 0x0029 }
        ...
        L_0x0030:
            ...
            com.google.android.gms.internal.zzaaf$zza<R> r0 = r5.zzaAi     // Catch:{ all -> 0x0029 }
    ...
    public final void setResultCallback(com.google.android.gms.common.api.ResultCallback<? super R> r7, long r8, java.util.concurrent.TimeUnit r10) {
        /*
            ...
            r0 = 0
            r6.zzaAl = r0     // Catch:{ all -> 0x0029 }
            monitor-exit(r3)     // Catch:{ all -> 0x0029 }
        L_0x000b:
            return
        L_0x000c:
            boolean r2 = r6.zzaAo     // Catch:{ all -> 0x0029 }
            if (r2 != 0) goto L_0x002c
            r2 = r0
        L_0x0011:
            java.lang.String r4 = "Result has already been consumed."
            com.google.android.gms.common.internal.zzac.zza(r2, r4)     // Catch:{ all -> 0x0029 }
            com.google.android.gms.internal.zzabx<R> r2 = r6.zzaAr     // Catch:{ all -> 0x0029 }
            if (r2 != 0) goto L_0x002e
        L_0x001b:
            java.lang.String r1 = "Cannot set callbacks if then() has been called."
            com.google.android.gms.common.internal.zzac.zza(r0, r1)     // Catch:{ all -> 0x0029 }
        ...
        L_0x0030:
            ...
            if (r0 == 0) goto L_0x0041
            com.google.android.gms.internal.zzaaf$zza<R> r0 = r6.zzaAi     // Catch:{ all -> 0x0029 }
        ...
        L_0x003f:
            ...
            goto L_0x000b
        L_0x0041:
            r6.zzaAl = r7     // Catch:{ all -> 0x0029 }
            com.google.android.gms.internal.zzaaf$zza<R> r0 = r6.zzaAi     // Catch:{ all -> 0x0029 }
            long r4 = r10.toMillis(r8)     // Catch:{ all -> 0x0029 }
            r0.zza(r6, r4)     // Catch:{ all -> 0x0029 }
            goto L_0x003f
        */
    ...
    public <S extends Result> TransformedResult<S> then(ResultTransform<? super R, ? extends S> resultTransform) {
        ...
        synchronized (this.zzaAh) {
            ...
            if (isReady()) {
                this.zzaAi.zza((ResultCallback<? super R>) this.zzaAr, get());
            } else {
