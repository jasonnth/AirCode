...
public interface zzta extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzta {
        ...
        private static class C7763zza implements zzta {
            private IBinder zzrk;

            C7763zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzta zzam(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzta)) ? new C7763zza(iBinder) : (zzta) queryLocalInterface;
        }
