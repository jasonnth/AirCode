...
public interface zzhq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhq {
        ...
        private static class C7738zza implements zzhq {
            private IBinder zzrk;

            C7738zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhq zzI(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.formats.client.IOnContentAdLoadedListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhq)) ? new C7738zza(iBinder) : (zzhq) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(com.google.android.gms.internal.zzhl.zza.zzF(parcel.readStrongBinder()));
    ...
    void zza(zzhl zzhl) throws RemoteException;
}
