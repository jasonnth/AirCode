...
public interface zzle extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzle {
        ...
        private static class C7750zza implements zzle {
            private IBinder zzrk;

            C7750zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzle zzX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzle)) ? new C7750zza(iBinder) : (zzle) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(com.google.android.gms.internal.zzld.zza.zzW(parcel.readStrongBinder()));
