...
public class zzpo {
    ...
    public boolean zzJ(Context context) {
        ...
        if ((resolveActivity.activityInfo.configChanges & 16) == 0) {
            zzpk.zzbh(String.format(str, new Object[]{"keyboard"}));
            z = false;
        } else {
            z = true;
        }
        if ((resolveActivity.activityInfo.configChanges & 32) == 0) {
            zzpk.zzbh(String.format(str, new Object[]{"keyboardHidden"}));
            z = false;
        }
        if ((resolveActivity.activityInfo.configChanges & 128) == 0) {
            zzpk.zzbh(String.format(str, new Object[]{"orientation"}));
            z = false;
        }
        if ((resolveActivity.activityInfo.configChanges & 256) == 0) {
            zzpk.zzbh(String.format(str, new Object[]{"screenLayout"}));
            z = false;
        }
        if ((resolveActivity.activityInfo.configChanges & 512) == 0) {
            zzpk.zzbh(String.format(str, new Object[]{"uiMode"}));
            z = false;
        }
        if ((resolveActivity.activityInfo.configChanges & 1024) == 0) {
            zzpk.zzbh(String.format(str, new Object[]{"screenSize"}));
            z = false;
        }
        if ((resolveActivity.activityInfo.configChanges & 2048) != 0) {
            return z;
        }
        zzpk.zzbh(String.format(str, new Object[]{"smallestScreenSize"}));
        return false;
    }
    ...
    public Bundle zza(zzde zzde) {
        ...
        if (zzkp != null && ((Boolean) zzgd.zzCk.get()).booleanValue() && !zzw.zzcQ().zzkh()) {
            bundle.putString("v_fp_vertical", zzkp);
        }
        if (zzko != null && ((Boolean) zzgd.zzCi.get()).booleanValue() && !zzw.zzcQ().zzkg()) {
    ...
    public void zza(final Context context, final String str, String str2, Bundle bundle, boolean z) {
        ...
        zzel.zzeT().zza(context, str, str2, bundle, z, new com.google.android.gms.internal.zzqe.zza(this) {
    ...
    public void zza(Context context, String str, boolean z, HttpURLConnection httpURLConnection, boolean z2) {
        httpURLConnection.setConnectTimeout(JPushConstants.ONE_MINUTE);
        httpURLConnection.setInstanceFollowRedirects(z);
        httpURLConnection.setReadTimeout(JPushConstants.ONE_MINUTE);
    ...
    public void zza(final Context context, final List<String> list) {
        if (!(context instanceof Activity) || TextUtils.isEmpty(zzbze.zzcI((Activity) context))) {
            return;
        }
        if (list == null) {
            zzpk.m1279v("Cannot ping urls: empty list.");
        } else if (!zzgr.zzo(context)) {
            zzpk.m1279v("Cannot ping url because custom tabs is not supported");
        } else {
            final zzgr zzgr = new zzgr();
            zzgr.zza((com.google.android.gms.internal.zzgr.zza) new com.google.android.gms.internal.zzgr.zza(this) {
                public void zzfJ() {
                    for (String str : list) {
                        String str2 = "Pinging url: ";
                        String valueOf = String.valueOf(str);
                        zzpk.zzbg(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2));
                        zzgr.mayLaunchUrl(Uri.parse(str), null, null);
                    }
    ...
    public boolean zza(Activity activity, Configuration configuration) {
        ...
        int intValue = ((Integer) zzgd.zzFs.get()).intValue() * ((int) Math.round(((double) activity.getResources().getDisplayMetrics().density) + 0.5d));
        return zzb(i, i3 + zzb, intValue) && zzb(i2, zzb2, intValue);
    }
    ...
    public boolean zza(View view, PowerManager powerManager, KeyguardManager keyguardManager) {
        return view.getVisibility() == 0 && view.isShown() && zza(powerManager) && (zzw.zzcM().zzkJ() || !zza(keyguardManager)) && (!((Boolean) zzgd.zzDs.get()).booleanValue() || view.getLocalVisibleRect(new Rect()) || view.getGlobalVisibleRect(new Rect()));
    }
    ...
    public zzji zzd(Context context, zzqh zzqh) {
        ...
        synchronized (this.zzrJ) {
            if (this.zzTy == null) {
                ...
                this.zzTy = new zzji(context, zzqh, (String) zzgd.zzBh.get());
            }
            zzji = this.zzTy;
        }
        return zzji;
    ...
    public void zzg(Context context, String str, String str2) {
        try {
            ...
            openFileOutput.write(str2.getBytes(JPushConstants.ENCODING_UTF_8));
                        ...
                        zzXC.post(new Runnable() {
                            public void run() {
                                synchronized (zzpo.this.zzrJ) {
                                    zzpo.this.zzIA = zzpo.this.zzL(context);
    ...
    public String zzv(Context context, String str) {
        try {
            return new String(zzp.zza((InputStream) context.openFileInput(str), true), JPushConstants.ENCODING_UTF_8);
        } catch (IOException e) {
