...
public interface zzlg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzlg {
        ...
        private static class C7752zza implements zzlg {
            private IBinder zzrk;

            C7752zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzlg zzZ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzlg)) ? new C7752zza(iBinder) : (zzlg) queryLocalInterface;
        }
