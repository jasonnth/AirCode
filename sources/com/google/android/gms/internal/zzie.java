...
public class zzie implements zzid {
    ...
    public com.google.android.gms.internal.zzie.zzc zza(com.google.android.gms.internal.zzie.zzb r10) {
        /*
            ...
            r4 = 0
            r1.zza(r2, r3, r4, r0)     // Catch:{ Exception -> 0x0039, all -> 0x00bd }
        ...
        L_0x00c7:
            ...
            java.lang.String r5 = r5.zza(r6)     // Catch:{ Exception -> 0x0039, all -> 0x00bd }
    ...
    public void zza(final zzqw zzqw, final Map<String, String> map) {
        zzpn.zza((Runnable) new Runnable() {
            public void run() {
                ...
                if (zzaa == null) {
                    zzpk.m1280e("Response should not be null.");
                } else {
    ...
    public JSONObject zzaa(String str) {
        try {
            ...
            try {
                ...
                jSONObject2.put(CancellationAnalytics.VALUE_PAGE_REASON, zza2.getReason());
                return jSONObject2;
            } catch (Exception e) {
                try {
                    jSONObject2.put("response", new JSONObject().put("http_request_id", str2));
                    jSONObject2.put("success", false);
                    jSONObject2.put(CancellationAnalytics.VALUE_PAGE_REASON, e.toString());
                    return jSONObject2;
            ...
            zzpk.m1280e("The request is not a valid JSON.");
            try {
