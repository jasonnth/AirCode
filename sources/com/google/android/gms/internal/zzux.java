...
public interface zzux extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzux {
        ...
        private static class C7767zza implements zzux {
            private IBinder zzrk;

            C7767zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
            ...
            public void zza(Account account, int i, zzuw zzuw) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    obtain.writeStrongBinder(zzuw != null ? zzuw.asBinder() : null);
        ...
        public static zzux zzaD(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzux)) ? new C7767zza(iBinder) : (zzux) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(parcel.readInt() != 0 ? (Account) Account.CREATOR.createFromParcel(parcel) : null, parcel.readInt(), com.google.android.gms.internal.zzuw.zza.zzaC(parcel.readStrongBinder()));
    ...
    void zza(Account account, int i, zzuw zzuw) throws RemoteException;
}
