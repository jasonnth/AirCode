...
public interface zzom extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzom {
        ...
        private static class C7761zza implements zzom {
            private IBinder zzrk;

            C7761zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzom zzal(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzom)) ? new C7761zza(iBinder) : (zzom) queryLocalInterface;
        }
