...
public interface zzhn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhn {
        ...
        private static class C7736zza implements zzhn {
            private IBinder zzrk;

            C7736zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhn zzG(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhn)) ? new C7736zza(iBinder) : (zzhn) queryLocalInterface;
        }
