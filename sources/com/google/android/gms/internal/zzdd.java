...
public class zzdd {
                ...
                public void run() {
                    synchronized (zza.this.zzrJ) {
                        if (!zza.this.zzxJ || !zza.this.zzxK) {
                            ...
                            for (zzb zzj : zza.this.mListeners) {
                                try {
                                    zzj.zzj(false);
                                } catch (Exception e) {
    ...
    public void initialize(android.content.Context r5) {
        /*
            ...
            monitor-enter(r2)
            boolean r0 = r4.zzxI     // Catch:{ all -> 0x0032 }
            if (r0 != 0) goto L_0x0048
            com.google.android.gms.common.util.zzt.zzzg()     // Catch:{ all -> 0x0032 }
            com.google.android.gms.internal.zzfz<java.lang.Boolean> r0 = com.google.android.gms.internal.zzgd.zzCP     // Catch:{ all -> 0x0032 }
        ...
        L_0x0028:
            ...
            com.google.android.gms.internal.zzpk.zzbh(r0)     // Catch:{ all -> 0x0032 }
            monitor-exit(r2)     // Catch:{ all -> 0x0032 }
            goto L_0x0019
        L_0x0032:
            r0 = move-exception
            ...
            throw r0
        L_0x0035:
            com.google.android.gms.internal.zzdd$zza r1 = r4.zzxH     // Catch:{ all -> 0x0032 }
            if (r1 != 0) goto L_0x0040
            com.google.android.gms.internal.zzdd$zza r1 = new com.google.android.gms.internal.zzdd$zza     // Catch:{ all -> 0x0032 }
            r1.<init>()     // Catch:{ all -> 0x0032 }
            r4.zzxH = r1     // Catch:{ all -> 0x0032 }
        L_0x0040:
            com.google.android.gms.internal.zzdd$zza r1 = r4.zzxH     // Catch:{ all -> 0x0032 }
            r1.zza(r0, r5)     // Catch:{ all -> 0x0032 }
            r0 = 1
            r4.zzxI = r0     // Catch:{ all -> 0x0032 }
        L_0x0048:
            monitor-exit(r2)     // Catch:{ all -> 0x0032 }
            goto L_0x0019
        L_0x004a:
