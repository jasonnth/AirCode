...
public final class zzsw {
    ...
    public static zza<Integer> zzafH = zza.zze("analytics.max_hit_length.k", 8192);
    public static zza<Integer> zzafI = zza.zze("analytics.max_post_length.k", 8192);
    public static zza<Integer> zzafJ = zza.zze("analytics.max_batch_post_length", 8192);
    ...
    public static zza<Integer> zzafN = zza.zze("analytics.http_connection.connect_timeout_millis", JPushConstants.ONE_MINUTE);
    ...
    public static zza<Long> zzafT = zza.zza("analytics.service_client.idle_disconnect_millis", 10000, 10000);
    ...
    public static zza<Integer> zzafo = zza.zza("analytics.max_stored_hits", (int) OfficialIdPhotoSelectionFragment.MAX_IMAGE_SIZE, (int) SDKConstants.CAM_INIT_CAMERA);
    public static zza<Integer> zzafp = zza.zze("analytics.max_stored_hits_per_app", OfficialIdPhotoSelectionFragment.MAX_IMAGE_SIZE);
    public static zza<Integer> zzafq = zza.zze("analytics.max_stored_properties_per_app", 100);
    public static zza<Long> zzafr = zza.zza("analytics.local_dispatch_millis", 1800000, 120000);
    public static zza<Long> zzafs = zza.zza("analytics.initial_local_dispatch_millis", 5000, 5000);
