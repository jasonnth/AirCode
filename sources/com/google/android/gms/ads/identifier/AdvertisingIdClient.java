...
public class AdvertisingIdClient {
    ...
    static zzcq zza(Context context, com.google.android.gms.common.zza zza2) throws IOException {
        try {
            return com.google.android.gms.internal.zzcq.zza.zzf(zza2.zza(10000, TimeUnit.MILLISECONDS));
        } catch (InterruptedException e) {
    ...
    public void finish() {
        /*
            ...
            monitor-enter(r3)
            android.content.Context r0 = r3.mContext     // Catch:{ all -> 0x002b }
            if (r0 == 0) goto L_0x000f
            com.google.android.gms.common.zza r0 = r3.zzsa     // Catch:{ all -> 0x002b }
        ...
        L_0x0010:
            return
        L_0x0011:
            boolean r0 = r3.zzsc     // Catch:{ IllegalArgumentException -> 0x002e, Throwable -> 0x0039 }
            if (r0 == 0) goto L_0x0020
            com.google.android.gms.common.stats.zza r0 = com.google.android.gms.common.stats.zza.zzyJ()     // Catch:{ IllegalArgumentException -> 0x002e, Throwable -> 0x0039 }
            android.content.Context r1 = r3.mContext     // Catch:{ IllegalArgumentException -> 0x002e, Throwable -> 0x0039 }
            com.google.android.gms.common.zza r2 = r3.zzsa     // Catch:{ IllegalArgumentException -> 0x002e, Throwable -> 0x0039 }
            r0.zza(r1, r2)     // Catch:{ IllegalArgumentException -> 0x002e, Throwable -> 0x0039 }
        L_0x0020:
            r0 = 0
            r3.zzsc = r0     // Catch:{ all -> 0x002b }
            r0 = 0
            r3.zzsb = r0     // Catch:{ all -> 0x002b }
            r0 = 0
            r3.zzsa = r0     // Catch:{ all -> 0x002b }
            monitor-exit(r3)     // Catch:{ all -> 0x002b }
            goto L_0x0010
        L_0x002b:
            r0 = move-exception
    ...
    /* access modifiers changed from: protected */
    public void start(boolean z) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        zzac.zzdk("Calling this from your main thread can lead to deadlock");
        synchronized (this) {
            if (this.zzsc) {
                finish();
