...
public final class zzx implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    public static class zza extends ViewSwitcher {
        ...
        public void zzds() {
            zzpk.m1279v("Disable position monitoring on adFrame.");
            if (this.zzvY != null) {
                this.zzvY.zzlf();
            }
        }
        ...
        public void zzdx() {
            zzpk.m1279v("Enable debug gesture detector on adFrame.");
            this.zzvZ = true;
        }

        public void zzdy() {
            zzpk.m1279v("Disable debug gesture detector on adFrame.");
            this.zzvZ = false;
        }
    }

    public zzx(Context context, zzeg zzeg, String str, zzqh zzqh) {
        this(context, zzeg, str, zzqh, null);
    }
    ...
    public void zzdv() {
        if (this.zzvu != null) {
            if (this.zzvs != null) {
                ...
                this.zzvu.zzD(this.zzvs.zzSn);
            }
            this.zzvu.zzC(this.zzvr.zzzz);
        }
    }
