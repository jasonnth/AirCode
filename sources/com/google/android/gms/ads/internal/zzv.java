...
public class zzv extends com.google.android.gms.internal.zzet.zza {
    ...
    private class zza extends AsyncTask<Void, Void, String> {
        ...
        public String doInBackground(Void... voidArr) {
            try {
                zzv.this.zzuw = (zzck) zzv.this.zzut.get(((Long) zzgd.zzET.get()).longValue(), TimeUnit.MILLISECONDS);
    ...
    private Future<zzck> zzcC() {
        return zzpn.zza((Callable<T>) new Callable<zzck>() {
            /* renamed from: zzcD */
    ...
    private void zzcz() {
        ...
        this.zzuv.setOnTouchListener(new OnTouchListener() {
    ...
    public String zzcA() {
        ...
        for (String str : zzcG.keySet()) {
            builder.appendQueryParameter(str, (String) zzcG.get(str));
        }
