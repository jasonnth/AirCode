...
public class zzz {
    ...
    private final zzpu zzOX = new zzb().zza("min_1", Double.MIN_VALUE, 1.0d).zza("1_5", 1.0d, 5.0d).zza("5_10", 5.0d, 10.0d).zza("10_20", 10.0d, 20.0d).zza("20_30", 20.0d, 30.0d).zza("30_max", 30.0d, Double.MAX_VALUE).zzla();
    ...
    public zzz(Context context, zzqh zzqh, String str, zzgl zzgl, zzgj zzgj) {
    ...
    public void onStop() {
        if (((Boolean) zzgd.zzBD.get()).booleanValue() && !this.zzPf) {
            ...
            bundle.putString(ShareConstants.WEB_DIALOG_RESULT_PARAM_REQUEST_ID, this.zzOV);
            bundle.putString("player", this.zzPe.zzhy());
            for (zza zza : this.zzOX.getBuckets()) {
                ...
                bundle.putString(valueOf4.length() != 0 ? valueOf3.concat(valueOf4) : new String(valueOf3), Double.toString(zza.zzYi));
            }
