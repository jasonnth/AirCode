    ...
    public void start() {
        if (this.zzOu == null) {
            ...
            if (defaultSensor == null) {
                zzpk.m1280e("No Sensor of TYPE_ROTATION_VECTOR");
                return;
            }
            ...
            if (!this.zzOo.registerListener(this, defaultSensor, 0, this.zzOu)) {
                zzpk.m1280e("SensorManager.registerListener failed.");
                stop();
            }
        }
    }
        ...
        if (fArr[0] != 0.0f || fArr[1] != 0.0f || fArr[2] != 0.0f) {
            ...
            switch (getRotation()) {
                case 1:
                    ...
                    break;
                case 2:
                    SensorManager.remapCoordinateSystem(this.zzOr, 129, ISO781611.BIOMETRIC_SUBTYPE_TAG, this.zzOs);
                    break;
                case 3:
                    SensorManager.remapCoordinateSystem(this.zzOr, ISO781611.BIOMETRIC_SUBTYPE_TAG, 1, this.zzOs);
                    break;
                default:
