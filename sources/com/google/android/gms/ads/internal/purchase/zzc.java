...
public class zzc extends zzpj implements ServiceConnection {
    ...
    private void zze(long j) {
        do {
            if (!zzf(j)) {
                zzpk.m1279v("Timeout waiting for pending transaction to be processed.");
            }
        } while (!this.zzPs);
    }
    ...
    public void zziI() {
        if (!this.zzPv.isEmpty()) {
            ...
            for (zzf zzf : this.zzPv) {
                hashMap.put(zzf.zzPI, zzf);
            }
            String str = null;
            while (true) {
                ...
                while (true) {
                    ...
                    if (hashMap.containsKey(stringArrayList.get(i2))) {
                        ...
                        if (zzf2.zzPH.equals(zzw.zzda().zzaE(str3))) {
                            zza(zzf2, str3, str4);
                            hashMap.remove(str2);
                        }
                    }
