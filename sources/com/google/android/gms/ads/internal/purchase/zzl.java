...
public class zzl {
    public static boolean zza(PublicKey publicKey, String str, String str2) {
        try {
            ...
            zzpk.m1280e("Signature verification failed.");
            return false;
        } catch (NoSuchAlgorithmException e) {
            zzpk.m1280e("NoSuchAlgorithmException.");
            return false;
        } catch (InvalidKeyException e2) {
            zzpk.m1280e("Invalid key specification.");
            return false;
        } catch (SignatureException e3) {
            zzpk.m1280e("Signature exception.");
            return false;
        }
    }
    ...
    public static boolean zzb(String str, String str2, String str3) {
        ...
        zzpk.m1280e("Purchase verification failed: missing data.");
        return false;
    }
}
