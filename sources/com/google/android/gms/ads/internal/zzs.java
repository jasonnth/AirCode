...
public class zzs extends zzb {
    ...
    private static zzgv zza(zzke zzke) throws RemoteException {
        return new zzgv(zzke.getHeadline(), zzke.getImages(), zzke.getBody(), zzke.zzfQ() != null ? zzke.zzfQ() : null, zzke.getCallToAction(), zzke.getStarRating(), zzke.getStore(), zzke.getPrice(), null, zzke.getExtras(), zzke.zzbF(), null);
    }

    private static zzgw zza(zzkf zzkf) throws RemoteException {
        return new zzgw(zzkf.getHeadline(), zzkf.getImages(), zzkf.getBody(), zzkf.zzfV() != null ? zzkf.zzfV() : null, zzkf.getCallToAction(), zzkf.getAdvertiser(), null, zzkf.getExtras(), zzkf.zzbF(), null);
    }
    ...
    private void zza(final zzpb zzpb, final String str) {
        zzpo.zzXC.post(new Runnable() {
            public void run() {
                try {
                    ((zzhs) zzs.this.zzss.zzvE.get(str)).zza((zzgx) zzpb.zzWi);
                } catch (RemoteException e) {
    ...
    public void zza(final zza zza, zzgl zzgl) {
        ...
        if (zza.errorCode != -2) {
            zzpo.zzXC.post(new Runnable() {
                public void run() {
                    zzs.this.zzb(new zzpb(zza, null, null, null, null, null, null, null));
                }
            });
            return;
        }
        this.zzss.zzvO = 0;
        this.zzss.zzvq = zzw.zzcL().zza(this.zzss.zzqn, this, zza, this.zzss.zzvm, null, this.zzsz, this, zzgl);
    ...
    public boolean zza(zzpb zzpb, zzpb zzpb2) {
        ...
        if (zzpb2.zzSn) {
            try {
                zzke zzke = zzpb2.zzLj != null ? zzpb2.zzLj.zzhc() : null;
                zzkf zzkf = zzpb2.zzLj != null ? zzpb2.zzLj.zzhd() : null;
                if (zzke == null || this.zzss.zzvB == null) {
                    if (zzkf != null) {
                        if (this.zzss.zzvC != null) {
                            zzgw zza = zza(zzkf);
                            zza.zzb(new zzgz(this.zzss.zzqn, this, this.zzss.zzvm, zzkf, (zzha.zza) zza));
                            zza(zza);
                        }
                    }
                ...
                zzgv zza2 = zza(zzke);
                zza2.zzb(new zzgz(this.zzss.zzqn, this, this.zzss.zzvm, zzke, (zzha.zza) zza2));
                zza(zza2);
            } catch (RemoteException e) {
    ...
    public void zzcw() {
        if (this.zzug != null && this.zzug.zzlG() != null && this.zzss.zzvF != null && this.zzss.zzvF.zzHe != null) {
            this.zzug.zzlG().zzP(this.zzss.zzvF.zzHe.zzAU);
        }
    }
