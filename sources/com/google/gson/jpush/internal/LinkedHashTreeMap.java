...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public LinkedHashTreeMap(java.util.Comparator r3) {
        ...
        L_0x000a:
            r2.comparator = r3
            com.google.gson.jpush.internal.LinkedHashTreeMap$Node r0 = new com.google.gson.jpush.internal.LinkedHashTreeMap$Node
            r0.<init>()
            r2.header = r0
            r0 = 16
            com.google.gson.jpush.internal.LinkedHashTreeMap$Node[] r0 = new com.google.gson.jpush.internal.LinkedHashTreeMap.Node[r0]
            r2.table = r0
            com.google.gson.jpush.internal.LinkedHashTreeMap$Node<K, V>[] r0 = r2.table
            int r0 = r0.length
            int r0 = r0 / 2
            com.google.gson.jpush.internal.LinkedHashTreeMap$Node<K, V>[] r1 = r2.table
            int r1 = r1.length
            int r1 = r1 / 4
            int r0 = r0 + r1
            r2.threshold = r0
        ...
        L_0x0027:
            ...
            goto L_0x000a
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.gson.jpush.internal.LinkedHashTreeMap.<init>(java.util.Comparator):void");
    }
    ...
    public Node<K, V> find(K key, boolean create) {
        ...
        if (nearest != null) {
            ...
            while (true) {
                if (comparable != null) {
                    comparison = comparable.compareTo(nearest.key);
                } else {
    ...
    static <K, V> Node<K, V>[] doubleCapacity(Node<K, V>[] oldTable) {
        ...
        for (int i = 0; i < oldCapacity; i++) {
            ...
            if (root != null) {
                ...
                int rightSize = 0;
                while (true) {
                    Node<K, V> node3 = iterator.next();
                    if (node3 == null) {
                        break;
                    } else if ((node3.hash & oldCapacity) == 0) {
                        leftSize++;
                    } else {
                        rightSize++;
                    }
                ...
                iterator.reset(root);
                while (true) {
                    Node<K, V> node4 = iterator.next();
                    if (node4 == null) {
                        break;
                    } else if ((node4.hash & oldCapacity) == 0) {
                        leftBuilder.add(node4);
                    } else {
                        rightBuilder.add(node4);
                    }
                }
                if (leftSize > 0) {
                    node = leftBuilder.root();
                } else {
                    node = null;
                }
                newTable[i] = node;
