...
final class BitmapUtils {
    ...
    static void writeBitmapToUri(Context context, Bitmap bitmap, Uri uri, CompressFormat compressFormat, int compressQuality) throws FileNotFoundException {
    ...
    static Bitmap resizeBitmap(Bitmap bitmap, int reqWidth, int reqHeight, RequestSizeOptions options) {
        if (reqWidth > 0 && reqHeight > 0) {
            try {
                if (options == RequestSizeOptions.RESIZE_FIT || options == RequestSizeOptions.RESIZE_INSIDE || options == RequestSizeOptions.RESIZE_EXACT) {
                    Bitmap resized = null;
                    if (options == RequestSizeOptions.RESIZE_EXACT) {
                        ...
                        if (scale > 1.0f || options == RequestSizeOptions.RESIZE_FIT) {
    ...
    private static com.theartofdev.edmodo.cropper.BitmapUtils.BitmapSampled decodeSampledBitmapRegion(android.content.Context r7, android.net.Uri r8, android.graphics.Rect r9, int r10, int r11, int r12) {
        /*
            r3 = 0
            r0 = 0
        ...
        L_0x0023:
            com.theartofdev.edmodo.cropper.BitmapUtils$BitmapSampled r4 = new com.theartofdev.edmodo.cropper.BitmapUtils$BitmapSampled     // Catch:{ OutOfMemoryError -> 0x0037 }
        ...
        L_0x0054:
            r1 = move-exception
            java.lang.RuntimeException r4 = new java.lang.RuntimeException     // Catch:{ all -> 0x007e }
