...
public class CropImageView extends FrameLayout {
    ...
    public void setImageResource(int resId) {
        if (resId != 0) {
            this.mCropOverlayView.setInitialCropWindowRect(null);
            setBitmap(BitmapFactory.decodeResource(getResources(), resId), resId, null, 1, 0);
        }
    }
    ...
    public void rotateImage(int degrees) {
        ...
        if (this.mBitmap != null) {
            if (degrees < 0) {
                degrees2 = (degrees % FacialCaptureApiConstants.EYE_MAX_DISTANCE_DEFAULT) + FacialCaptureApiConstants.EYE_MAX_DISTANCE_DEFAULT;
            } else {
                degrees2 = degrees % FacialCaptureApiConstants.EYE_MAX_DISTANCE_DEFAULT;
            }
            ...
            this.mDegreesRotated = (this.mDegreesRotated + degrees2) % FacialCaptureApiConstants.EYE_MAX_DISTANCE_DEFAULT;
            applyImageMatrix((float) getWidth(), (float) getHeight(), true, false);
    ...
    public void onImageCroppingAsyncComplete(Result result) {
        ...
        if (listener != null) {
            listener.onCropImageComplete(this, new CropResult(this.mBitmap, this.mLoadedImageUri, result.bitmap, result.uri, result.error, getCropPoints(), getCropRect(), getRotatedDegrees(), result.sampleSize));
        }
    }
