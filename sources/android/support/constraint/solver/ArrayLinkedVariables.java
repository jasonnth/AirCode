...
public class ArrayLinkedVariables {
    ...
    public final void put(SolverVariable variable, float value) {
        if (value == 0.0f) {
            ...
            this.mArrayIndices[this.mHead] = variable.f0id;
            ...
            while (current != -1 && counter < this.currentSize) {
                if (this.mArrayIndices[current] == variable.f0id) {
            ...
            this.mArrayIndices[availableIndice] = variable.f0id;
    ...
    public void updateFromRow(ArrayRow self, ArrayRow definition) {
        ...
        int counter = 0;
        while (current != -1 && counter < this.currentSize) {
            if (this.mArrayIndices[current] == definition.variable.f0id) {
    ...
    public final float get(SolverVariable v) {
        ...
        int counter = 0;
        while (current != -1 && counter < this.currentSize) {
            if (this.mArrayIndices[current] == v.f0id) {
                return this.mArrayValues[current];
            }
            current = this.mArrayNextIndices[current];
            counter++;
