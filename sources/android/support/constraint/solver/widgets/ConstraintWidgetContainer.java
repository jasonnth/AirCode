...
public class ConstraintWidgetContainer extends WidgetContainer {
        ...
        for (int i = 0; i < this.mHorizontalChainsSize; i++) {
            ...
            if (currentWidget != null) {
                if (this.flags[1]) {
                    ...
                    boolean isWrapContent = this.mHorizontalDimensionBehaviour == DimensionBehaviour.WRAP_CONTENT;
        ...
        for (int i = 0; i < this.mVerticalChainsSize; i++) {
            ...
            if (currentWidget != null) {
                if (this.flags[1]) {
                    ...
                    ConstraintWidget widget = first;
                    boolean isWrapContent = this.mVerticalDimensionBehaviour == DimensionBehaviour.WRAP_CONTENT;
        ...
        while (needsSolving) {
            ...
            if (!needsSolving) {
                ...
                while (true) {
                    ...
                    if (widget2.mHorizontalDimensionBehaviour == DimensionBehaviour.MATCH_CONSTRAINT && widget2.getWidth() < widget2.getWrapWidth()) {
                        this.flags[2] = true;
                        break;
                    }
                    if (widget2.mVerticalDimensionBehaviour == DimensionBehaviour.MATCH_CONSTRAINT && widget2.getHeight() < widget2.getWrapHeight()) {
                        this.flags[2] = true;
                        break;
                    }
                    i2++;
            ...
            if (countSolve < 8 && this.flags[2]) {
                ...
                for (int i3 = 0; i3 < count; i3++) {
                    ...
                    maxX = Math.max(maxX, widget3.f2mX + widget3.getWidth());
                    maxY = Math.max(maxY, widget3.f3mY + widget3.getHeight());
                }
    ...
    public void findWrapSize(ArrayList<ConstraintWidget> children, boolean[] flags2) {
        ...
        for (int j2 = 0; j2 < size; j2++) {
            ConstraintWidget child = (ConstraintWidget) children.get(j2);
