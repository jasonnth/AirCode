...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object anchor) {
        ...
        if (variable.f0id != -1 && variable.f0id <= this.mVariablesID && this.mCache.mIndexedVariables[variable.f0id] != null) {
            return variable;
        }
        if (variable.f0id != -1) {
            variable.reset();
        ...
        this.mVariablesID++;
        this.mNumColumns++;
        variable.f0id = this.mVariablesID;
    ...
    private int optimize(Goal goal) {
        ...
        while (!done) {
            ...
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f0id]) {
                    pivotCandidate = null;
                } else {
                    this.mAlreadyTestedCandidates[pivotCandidate.f0id] = true;
                    tested++;
