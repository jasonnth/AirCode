...
public class FragmentActivity extends BaseFragmentActivityJB implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    class HostCallbacks extends FragmentHostCallback<FragmentActivity> {
        ...
        public void onRequestPermissionsFromFragment(Fragment fragment, String[] permissions2, int requestCode) {
            FragmentActivity.this.requestPermissionsFromFragment(fragment, permissions2, requestCode);
        }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions2, int[] grantResults) {
        int index = (requestCode >> 16) & MinElf.PN_XNUM;
        if (index != 0) {
            int index2 = index - 1;
            ...
            if (frag == null) {
                ...
                frag.onRequestPermissionsResult(requestCode & MinElf.PN_XNUM, permissions2, grantResults);
            }
        }
    }
    ...
    /* access modifiers changed from: 0000 */
    public void requestPermissionsFromFragment(Fragment fragment, String[] permissions2, int requestCode) {
        if (requestCode == -1) {
            ActivityCompat.requestPermissions(this, permissions2, requestCode);
            return;
        }
        checkForValidRequestCode(requestCode);
        try {
            this.mRequestedPermissionsFromFragment = true;
            ActivityCompat.requestPermissions(this, permissions2, ((allocateRequestIndex(fragment) + 1) << 16) + (65535 & requestCode));
        } finally {
