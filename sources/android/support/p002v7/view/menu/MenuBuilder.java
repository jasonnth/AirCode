...
public class MenuBuilder implements SupportMenu {
    ...
    private void setShortcutsVisibleInner(boolean shortcutsVisible) {
        boolean z = true;
        if (!shortcutsVisible || this.mResources.getConfiguration().keyboard == 1 || !this.mResources.getBoolean(C0199R.bool.abc_config_showMenuShortcutsWhenKeyboardPresent)) {
            z = false;
        }
    ...
    public boolean performItemAction(MenuItem item, MenuPresenter preferredPresenter, int flags) {
        ...
        if (itemImpl.hasCollapsibleActionView()) {
            ...
            boolean invoked3 = invoked | dispatchSubMenuSelected(subMenu, preferredPresenter);
            if (invoked3) {
                return invoked3;
            }
            close(true);
