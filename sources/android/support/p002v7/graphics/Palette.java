package android.support.p002v7.graphics;
...
import android.support.p000v4.p001os.AsyncTaskCompat;
        ...
        private void ensureTextColorsGenerated() {
            ...
            if (!this.mGeneratedTextColors) {
                ...
                if (lightBodyAlpha == -1 || lightTitleAlpha == -1) {
                    int darkBodyAlpha = ColorUtils.calculateMinimumAlpha(AirMapInterface.CIRCLE_BORDER_COLOR, this.mRgb, Palette.MIN_CONTRAST_BODY_TEXT);
                    int darkTitleAlpha = ColorUtils.calculateMinimumAlpha(AirMapInterface.CIRCLE_BORDER_COLOR, this.mRgb, Palette.MIN_CONTRAST_TITLE_TEXT);
                    if (darkBodyAlpha == -1 || darkBodyAlpha == -1) {
                        if (lightBodyAlpha != -1) {
                            alphaComponent = ColorUtils.setAlphaComponent(-1, lightBodyAlpha);
                        } else {
                            alphaComponent = ColorUtils.setAlphaComponent(AirMapInterface.CIRCLE_BORDER_COLOR, darkBodyAlpha);
                        }
                        this.mBodyTextColor = alphaComponent;
                        if (lightTitleAlpha != -1) {
                            alphaComponent2 = ColorUtils.setAlphaComponent(-1, lightTitleAlpha);
                        } else {
                            alphaComponent2 = ColorUtils.setAlphaComponent(AirMapInterface.CIRCLE_BORDER_COLOR, darkTitleAlpha);
                        }
                        this.mTitleTextColor = alphaComponent2;
                        this.mGeneratedTextColors = true;
                        return;
                    }
                    this.mBodyTextColor = ColorUtils.setAlphaComponent(AirMapInterface.CIRCLE_BORDER_COLOR, darkBodyAlpha);
                    this.mTitleTextColor = ColorUtils.setAlphaComponent(AirMapInterface.CIRCLE_BORDER_COLOR, darkTitleAlpha);
                    this.mGeneratedTextColors = true;
                    return;
                }
