...
class AlertController {
    ...
    public static class AlertParams {
        ...
        /* JADX WARNING: type inference failed for: r0v0, types: [android.support.v7.app.AlertController$CheckedItemAdapter] */
        /* JADX WARNING: type inference failed for: r0v1, types: [android.widget.ListAdapter] */
        /* JADX WARNING: type inference failed for: r0v2, types: [android.widget.SimpleCursorAdapter] */
        /* JADX WARNING: type inference failed for: r0v5, types: [android.support.v7.app.AlertController$AlertParams$1] */
        /* JADX WARNING: Multi-variable type inference failed */
        /* JADX WARNING: Unknown variable types count: 4 */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        private void createListView(final android.support.p002v7.app.AlertController r11) {
            /*
                r10 = this;
                ...
                android.support.v7.app.AlertController$RecycleListView r6 = (android.support.p002v7.app.AlertController.RecycleListView) r6
            ...
            L_0x00a0:
                ...
                goto L_0x004f
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p002v7.app.AlertController.AlertParams.createListView(android.support.v7.app.AlertController):void");
        }
    }
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0199R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0199R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0199R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0199R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0199R.styleable.AlertDialog, C0199R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0199R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0199R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0199R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0199R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0199R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0199R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0199R.styleable.AlertDialog_showTitle, true);
        a.recycle();
    ...
    private void setupView() {
        View parentPanel = this.mWindow.findViewById(C0199R.C0201id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0199R.C0201id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0199R.C0201id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0199R.C0201id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0199R.C0201id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0199R.C0201id.topPanel);
        View customContentPanel = customPanel.findViewById(C0199R.C0201id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0199R.C0201id.buttonPanel);
        ...
        if (!hasButtonPanel && contentPanel != null) {
            View spacer = contentPanel.findViewById(C0199R.C0201id.textSpacerNoButtons);
            if (spacer != null) {
        ...
        if (hasTopPanel) {
            ...
            if (!(this.mMessage == null && this.mListView == null && !hasCustomPanel) && !hasCustomPanel) {
                divider = topPanel.findViewById(C0199R.C0201id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
        } else if (contentPanel != null) {
            View spacer2 = contentPanel.findViewById(C0199R.C0201id.textSpacerNoTitle);
            if (spacer2 != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0199R.C0201id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0199R.C0201id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0199R.C0201id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0199R.C0201id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0199R.C0201id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0199R.C0201id.scrollView);
