...
class TwilightCalculator {
    ...
    /* renamed from: C1 */
    private static final float f22C1 = 0.0334196f;

    /* renamed from: C2 */
    private static final float f23C2 = 3.49066E-4f;

    /* renamed from: C3 */
    private static final float f24C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* renamed from: J0 */
    private static final float f25J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        double solarTransitJ2000 = ((double) (f25J0 + ((float) Math.round(((double) (daysSince2000 - f25J0)) - arcLongitude)))) + arcLongitude + (0.0053d * Math.sin((double) meanAnomaly)) + (-0.0069d * Math.sin(2.0d * solarLng));
