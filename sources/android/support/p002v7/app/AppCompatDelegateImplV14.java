...
class AppCompatDelegateImplV14 extends AppCompatDelegateImplV11 {
    ...
    class AppCompatWindowCallbackV14 extends AppCompatWindowCallbackBase {
        ...
        public final ActionMode startAsSupportActionMode(ActionMode.Callback callback) {
            ...
            android.support.p002v7.view.ActionMode supportActionMode = AppCompatDelegateImplV14.this.startSupportActionMode(callbackWrapper);
    ...
    public int mapNightMode(int mode) {
        switch (mode) {
            case QuickPayBookingStep.RESULT_CODE_IDENTITY_ERROR /*-100*/:
                return -1;
            case 0:
                ensureAutoNightModeManager();
