...
public class DrawableUtils {
    ...
    public static boolean canSafelyMutateDrawable(Drawable drawable) {
        ...
        if (drawable instanceof DrawableContainer) {
            ...
            if (drawable instanceof android.support.p002v7.graphics.drawable.DrawableWrapper) {
                return canSafelyMutateDrawable(((android.support.p002v7.graphics.drawable.DrawableWrapper) drawable).getWrappedDrawable());
            }
