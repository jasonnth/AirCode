    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0199R.C0201id.topPanel) {
                    topPanel = child;
                } else if (id == C0199R.C0201id.buttonPanel) {
                    buttonPanel = child;
                } else if (id != C0199R.C0201id.contentPanel && id != C0199R.C0201id.customPanel) {
                    return false;
                } else {
                    if (middlePanel != null) {
                        return false;
        ...
        if (middlePanel != null && remainingHeight > 0) {
            ...
            middlePanel.measure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(middleHeight + heightToGive2, heightMode));
