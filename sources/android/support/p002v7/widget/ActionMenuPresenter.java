...
import android.support.p002v7.transition.ActionBarTransition;
...
class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenu, View anchorView) {
            super(context, subMenu, anchorView, false, C0199R.attr.actionOverflowMenuStyle);
    ...
    private class OverflowMenuButton extends AppCompatImageView implements ActionMenuChildView {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0199R.attr.actionOverflowButtonStyle);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
    ...
    private class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menu, View anchorView, boolean overflowOnly) {
            super(context, menu, anchorView, overflowOnly, C0199R.attr.actionOverflowMenuStyle);
            setGravity(8388613);
            setPresenterCallback(ActionMenuPresenter.this.mPopupPresenterCallback);
        }
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0199R.layout.abc_action_menu_layout, C0199R.layout.abc_action_menu_item_layout);
    }
    ...
    public void updateMenuView(boolean cleared) {
        ...
        if (this.mReserveOverflow && nonActionItems != null) {
            ...
            hasOverflow = count2 == 1 ? !((MenuItemImpl) nonActionItems.get(0)).isActionViewExpanded() : count2 > 0;
        }
        if (hasOverflow) {
            if (this.mOverflowButton == null) {
                this.mOverflowButton = new OverflowMenuButton(this.mSystemContext);
    ...
    public boolean flagActionItems() {
        ...
        for (int i2 = 0; i2 < itemsSize; i2++) {
            MenuItemImpl item2 = (MenuItemImpl) visibleItems.get(i2);
