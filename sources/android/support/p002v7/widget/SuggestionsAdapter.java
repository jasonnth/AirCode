...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private final SearchManager mSearchManager = ((SearchManager) this.mContext.getSystemService(NVStrings.SEARCH));
    private final C0289SearchView mSearchView;
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0199R.C0201id.edit_query);
        }
    }

    public SuggestionsAdapter(Context context, C0289SearchView searchView, SearchableInfo searchable, WeakHashMap<String, ConstantState> outsideDrawablesCache) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ((ImageView) v.findViewById(C0199R.C0201id.edit_query)).setImageResource(this.mCommitIconResId);
        return v;
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0199R.attr.textColorSearchUrl, colorValue, true);
    ...
    private Drawable getDrawableFromResourceValue(String drawableId) {
        if (drawableId == null || drawableId.length() == 0 || AppEventsConstants.EVENT_PARAM_VALUE_NO.equals(drawableId)) {
            return null;
        }
        try {
