...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.gravity = -1;
            TypedArray a = c.obtainStyledAttributes(attrs, C0199R.styleable.LinearLayoutCompat_Layout);
            this.weight = a.getFloat(C0199R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = a.getInt(C0199R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            a.recycle();
        }
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0199R.styleable.LinearLayoutCompat, defStyleAttr, 0);
        int index = a.getInt(C0199R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (index >= 0) {
            setOrientation(index);
        }
        int index2 = a.getInt(C0199R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (index2 >= 0) {
            setGravity(index2);
        }
        boolean baselineAligned = a.getBoolean(C0199R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!baselineAligned) {
            setBaselineAligned(baselineAligned);
        }
        this.mWeightSum = a.getFloat(C0199R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = a.getInt(C0199R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = a.getBoolean(C0199R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(a.getDrawable(C0199R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = a.getInt(C0199R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = a.getDimensionPixelSize(C0199R.styleable.LinearLayoutCompat_dividerPadding, 0);
        a.recycle();
    }
            ...
            for (int i3 = 0; i3 < count; i3++) {
                ...
                if (child3.getVisibility() != 8) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        childState = ViewUtils.combineMeasuredStates(childState, ViewCompat.getMeasuredState(child3) & -256);
                    }
            ...
            for (int i5 = 0; i5 < count; i5++) {
                ...
                if (!(child3 == null || child3.getVisibility() == 8)) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        childState = ViewUtils.combineMeasuredStates(childState, ViewCompat.getMeasuredState(child3) & AirMapInterface.CIRCLE_BORDER_COLOR);
                    }
                    if (isExactly) {
