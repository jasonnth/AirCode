...
public class C0289SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        private C0289SearchView mSearchView;
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0199R.attr.autoCompleteTextViewStyle);
        }
        ...
        /* access modifiers changed from: 0000 */
        public void setSearchView(C0289SearchView searchView) {
        ...
        public void onWindowFocusChanged(boolean hasWindowFocus) {
            ...
            if (hasWindowFocus && this.mSearchView.hasFocus() && getVisibility() == 0) {
                ...
                if (C0289SearchView.isLandscapeMode(getContext())) {
                    C0289SearchView.HIDDEN_METHOD_INVOKER.ensureImeVisible(this, true);
                }
            }
        }
    ...
    public C0289SearchView(Context context) {
        this(context, null);
    }

    public C0289SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0199R.attr.searchViewStyle);
    }

    public C0289SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new Runnable() {
            public void run() {
                InputMethodManager imm = (InputMethodManager) C0289SearchView.this.getContext().getSystemService("input_method");
                if (imm != null) {
                    C0289SearchView.HIDDEN_METHOD_INVOKER.showSoftInputUnchecked(imm, C0289SearchView.this, 0);
                }
            }
        };
        this.mUpdateDrawableStateRunnable = new Runnable() {
            public void run() {
                C0289SearchView.this.updateFocusedState();
            }
        };
        this.mReleaseCursorRunnable = new Runnable() {
            public void run() {
                if (C0289SearchView.this.mSuggestionsAdapter != null && (C0289SearchView.this.mSuggestionsAdapter instanceof SuggestionsAdapter)) {
                    C0289SearchView.this.mSuggestionsAdapter.changeCursor(null);
                }
            }
        };
        ...
        this.mOnClickListener = new OnClickListener() {
            public void onClick(View v) {
                if (v == C0289SearchView.this.mSearchButton) {
                    C0289SearchView.this.onSearchClicked();
                } else if (v == C0289SearchView.this.mCloseButton) {
                    C0289SearchView.this.onCloseClicked();
                } else if (v == C0289SearchView.this.mGoButton) {
                    C0289SearchView.this.onSubmitQuery();
                } else if (v == C0289SearchView.this.mVoiceButton) {
                    C0289SearchView.this.onVoiceClicked();
                } else if (v == C0289SearchView.this.mSearchSrcTextView) {
                    C0289SearchView.this.forceSuggestionQuery();
                }
            }
        };
        this.mTextKeyListener = new OnKeyListener() {
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (C0289SearchView.this.mSearchable == null) {
                    return false;
                }
                if (C0289SearchView.this.mSearchSrcTextView.isPopupShowing() && C0289SearchView.this.mSearchSrcTextView.getListSelection() != -1) {
                    return C0289SearchView.this.onSuggestionsKey(v, keyCode, event);
                }
                if (C0289SearchView.this.mSearchSrcTextView.isEmpty() || !KeyEventCompat.hasNoModifiers(event) || event.getAction() != 1 || keyCode != 66) {
                    return false;
                }
                v.cancelLongPress();
                C0289SearchView.this.launchQuerySearch(0, null, C0289SearchView.this.mSearchSrcTextView.getText().toString());
                return true;
            }
        };
        ...
        this.mOnItemClickListener = new OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                C0289SearchView.this.onItemClicked(position, 0, null);
            }
        };
        this.mOnItemSelectedListener = new OnItemSelectedListener() {
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                C0289SearchView.this.onItemSelected(position);
            }
        ...
        this.mTextWatcher = new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int after) {
                C0289SearchView.this.onTextChanged(s);
            }

            public void afterTextChanged(Editable s) {
            }
        };
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0199R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0199R.styleable.SearchView_layout, C0199R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0199R.C0201id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0199R.C0201id.search_edit_frame);
        this.mSearchPlate = findViewById(C0199R.C0201id.search_plate);
        this.mSubmitArea = findViewById(C0199R.C0201id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0199R.C0201id.search_button);
        this.mGoButton = (ImageView) findViewById(C0199R.C0201id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0199R.C0201id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0199R.C0201id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0199R.C0201id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0199R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0199R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0199R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0199R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0199R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0199R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0199R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0199R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0199R.styleable.SearchView_suggestionRowLayout, C0199R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0199R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new OnFocusChangeListener() {
            public void onFocusChange(View v, boolean hasFocus) {
                if (C0289SearchView.this.mOnQueryTextFocusChangeListener != null) {
                    C0289SearchView.this.mOnQueryTextFocusChangeListener.onFocusChange(C0289SearchView.this, hasFocus);
                }
            }
        });
        setIconifiedByDefault(a.getBoolean(C0199R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0199R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0199R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0199R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0199R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0199R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0199R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new OnLayoutChangeListener() {
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                C0289SearchView.this.adjustDropDownSizeAndPosition();
            }
        });
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0199R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0199R.dimen.abc_search_view_preferred_height);
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0199R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0199R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    private Intent createVoiceWebSearchIntent(Intent baseIntent, SearchableInfo searchable) {
        ...
        voiceIntent.putExtra(str, flattenToShortString);
        return voiceIntent;
    }
