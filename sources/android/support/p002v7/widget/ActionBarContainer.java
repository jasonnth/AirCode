...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0199R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0199R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0199R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0199R.styleable.ActionBar_height, -1);
        if (getId() == C0199R.C0201id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0199R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        if (this.mIsSplit) {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0199R.C0201id.action_bar);
        this.mContextView = findViewById(C0199R.C0201id.action_context_bar);
    }
