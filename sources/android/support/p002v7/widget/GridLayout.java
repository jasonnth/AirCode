...
import android.support.p002v7.gridlayout.C0208R;
...
public class GridLayout extends ViewGroup {
    private static final int ALIGNMENT_MODE = C0208R.styleable.GridLayout_alignmentMode;
    ...
    private static final int COLUMN_COUNT = C0208R.styleable.GridLayout_columnCount;
    private static final int COLUMN_ORDER_PRESERVED = C0208R.styleable.GridLayout_columnOrderPreserved;
    ...
    private static final int ORIENTATION = C0208R.styleable.GridLayout_orientation;
    public static final Alignment RIGHT = createSwitchingAlignment(END, START);
    private static final int ROW_COUNT = C0208R.styleable.GridLayout_rowCount;
    private static final int ROW_ORDER_PRESERVED = C0208R.styleable.GridLayout_rowOrderPreserved;
    ...
    private static final int USE_DEFAULT_MARGINS = C0208R.styleable.GridLayout_useDefaultMargins;
    ...
    final class Axis {
        static final /* synthetic */ boolean $assertionsDisabled = (!GridLayout.class.desiredAssertionStatus() ? GridLayout.DEFAULT_ORDER_PRESERVED : false);
        ...
        private void computeGroupBounds() {
            ...
            for (int i2 = 0; i2 < N; i2++) {
                ...
                ((Bounds) this.groupBounds.getValue(i2)).include(GridLayout.this, c, spec, this, measurementIncludingMargin + i);
            }
        }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        private static final int BOTTOM_MARGIN = C0208R.styleable.GridLayout_Layout_android_layout_marginBottom;
        private static final int COLUMN = C0208R.styleable.GridLayout_Layout_layout_column;
        private static final int COLUMN_SPAN = C0208R.styleable.GridLayout_Layout_layout_columnSpan;
        private static final int COLUMN_WEIGHT = C0208R.styleable.GridLayout_Layout_layout_columnWeight;
        ...
        private static final int GRAVITY = C0208R.styleable.GridLayout_Layout_layout_gravity;
        private static final int LEFT_MARGIN = C0208R.styleable.GridLayout_Layout_android_layout_marginLeft;
        private static final int MARGIN = C0208R.styleable.GridLayout_Layout_android_layout_margin;
        private static final int RIGHT_MARGIN = C0208R.styleable.GridLayout_Layout_android_layout_marginRight;
        private static final int ROW = C0208R.styleable.GridLayout_Layout_layout_row;
        private static final int ROW_SPAN = C0208R.styleable.GridLayout_Layout_layout_rowSpan;
        private static final int ROW_WEIGHT = C0208R.styleable.GridLayout_Layout_layout_rowWeight;
        private static final int TOP_MARGIN = C0208R.styleable.GridLayout_Layout_android_layout_marginTop;
        ...
        private void reInitSuper(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0208R.styleable.GridLayout_Layout);
            try {
    ...
    public GridLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mDefaultGap = context.getResources().getDimensionPixelOffset(C0208R.dimen.default_gap);
        TypedArray a = context.obtainStyledAttributes(attrs, C0208R.styleable.GridLayout);
        try {
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (c.getVisibility() != 8) {
                ...
                int topMargin = getMargin(c, false, DEFAULT_ORDER_PRESERVED);
                int rightMargin = getMargin(c, DEFAULT_ORDER_PRESERVED, false);
