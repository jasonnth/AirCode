...
import android.support.p002v7.recyclerview.C0211R;
...
public class RecyclerView extends ViewGroup implements NestedScrollingChild, ScrollingView {
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0211R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0211R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0211R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0211R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0211R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a2 = context.obtainStyledAttributes(attrs, C0211R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a2.getString(C0211R.styleable.RecyclerView_layoutManager);
            if (a2.getInt(C0211R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private void createLayoutManager(android.content.Context r11, java.lang.String r12, android.util.AttributeSet r13, int r14, int r15) {
        ...
        L_0x001e:
            ...
            java.lang.Class<android.support.v7.widget.RecyclerView$LayoutManager> r8 = android.support.p002v7.widget.RecyclerView.LayoutManager.class
        ...
        L_0x0047:
            ...
            android.support.v7.widget.RecyclerView$LayoutManager r7 = (android.support.p002v7.widget.RecyclerView.LayoutManager) r7     // Catch:{ ClassNotFoundException -> 0x0089, InvocationTargetException -> 0x00ac, InstantiationException -> 0x00cf, IllegalAccessException -> 0x00f2, ClassCastException -> 0x0115 }
        ...
        L_0x0115:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p002v7.widget.RecyclerView.createLayoutManager(android.content.Context, java.lang.String, android.util.AttributeSet, int, int):void");
    }
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (!canRunFocusFailure || !(direction == 2 || direction == 1)) {
            ...
            boolean needsFocusFailureLayout2 = false;
            if (this.mLayout.canScrollVertically()) {
                int absDir = direction == 2 ? ISO781611.BIOMETRIC_SUBTYPE_TAG : 33;
                if (ff.findNextFocus(this, focused, absDir) == null) {
                    needsFocusFailureLayout2 = true;
                } else {
                    needsFocusFailureLayout2 = false;
                }
                if (FORCE_ABS_FOCUS_SEARCH_DIRECTION) {
                    direction = absDir;
                }
            }
            if (!needsFocusFailureLayout2 && this.mLayout.canScrollHorizontally()) {
    ...
    private boolean isPreferredNextFocus(View focused, View next, int direction) {
        ...
        if (isPreferredNextFocusAbsolute(focused, next, z ^ rtl ? 66 : 17)) {
            return true;
        }
        if (direction == 2) {
            return isPreferredNextFocusAbsolute(focused, next, ISO781611.BIOMETRIC_SUBTYPE_TAG);
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:82:0x037d, code lost:
        if (fling((int) r15, (int) r17) == false) goto L_0x037f;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean onTouchEvent(android.view.MotionEvent r24) {
        ...
        L_0x0050:
            ...
            int r3 = android.support.p000v4.view.MotionEventCompat.getActionMasked(r24)
            int r4 = android.support.p000v4.view.MotionEventCompat.getActionIndex(r24)
        ...
        L_0x0102:
            r0 = r24
            int r18 = r0.getPointerId(r4)
            r0 = r18
            r1 = r23
            r1.mScrollPointerId = r0
            r0 = r24
            float r18 = r0.getX(r4)
            r19 = 1056964608(0x3f000000, float:0.5)
            float r18 = r18 + r19
            r0 = r18
            int r0 = (int) r0
        ...
        L_0x0146:
            ...
            r0 = r24
            r1 = r18
            int r10 = r0.findPointerIndex(r1)
        ...
        L_0x0181:
            r0 = r24
            float r18 = r0.getX(r10)
            r19 = 1056964608(0x3f000000, float:0.5)
            float r18 = r18 + r19
            r0 = r18
            int r14 = (int) r0
            r0 = r24
            float r18 = r0.getY(r10)
            r19 = 1056964608(0x3f000000, float:0.5)
            float r18 = r18 + r19
            r0 = r18
            int r0 = (int) r0
        ...
        L_0x02c0:
            ...
            r1 = r19
            r2 = r18
            boolean r18 = r0.scrollByInternal(r1, r2, r13)
        ...
        L_0x0311:
            ...
            int r0 = r0.mScrollPointerId
            r19 = r0
            float r18 = android.support.p000v4.view.VelocityTrackerCompat.getXVelocity(r18, r19)
            r0 = r18
            float r15 = -r0
        L_0x0348:
            ...
            int r0 = r0.mScrollPointerId
            r19 = r0
            float r18 = android.support.p000v4.view.VelocityTrackerCompat.getYVelocity(r18, r19)
            r0 = r18
            float r0 = -r0
            r17 = r0
        L_0x035f:
