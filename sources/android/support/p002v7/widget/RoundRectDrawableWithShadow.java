...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius, float shadowSize, float maxShadowSize) {
        this.mShadowStartColor = resources.getColor(C0203R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0203R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0203R.dimen.cardview_compat_inset_shadow);
    ...
    public void setShadowSize(float shadowSize, float maxShadowSize) {
        if (shadowSize < 0.0f) {
            ...
            if (this.mRawShadowSize != shadowSize2 || this.mRawMaxShadowSize != maxShadowSize2) {
                ...
                this.mMaxShadowSize = ((float) this.mInsetShadow) + maxShadowSize2;
                this.mDirty = true;
                invalidateSelf();
            }
        }
