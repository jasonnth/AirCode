...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public static class LayoutParams extends android.support.p002v7.widget.RecyclerView.LayoutParams {
        ...
        public LayoutParams(android.support.p002v7.widget.RecyclerView.LayoutParams source) {
            super(source);
        }
    ...
    public android.support.p002v7.widget.RecyclerView.LayoutParams generateDefaultLayoutParams() {
        if (this.mOrientation == 0) {
    ...
    public android.support.p002v7.widget.RecyclerView.LayoutParams generateLayoutParams(Context c, AttributeSet attrs) {
        return new LayoutParams(c, attrs);
    }

    public android.support.p002v7.widget.RecyclerView.LayoutParams generateLayoutParams(android.view.ViewGroup.LayoutParams lp) {
    ...
    public boolean checkLayoutParams(android.support.p002v7.widget.RecyclerView.LayoutParams lp) {
    ...
    public View findReferenceChild(Recycler recycler, State state, int start, int end, int itemCount) {
        ...
        for (int i = start; i != end; i += diff) {
            ...
            if (position >= 0 && position < itemCount && getSpanIndex(recycler, state, position) == 0) {
                if (((android.support.p002v7.widget.RecyclerView.LayoutParams) view.getLayoutParams()).isItemRemoved()) {
    ...
    private void measureChildWithDecorationsAndMargin(View child, int widthSpec, int heightSpec, boolean alreadyMeasured) {
        boolean measure;
        android.support.p002v7.widget.RecyclerView.LayoutParams lp = (android.support.p002v7.widget.RecyclerView.LayoutParams) child.getLayoutParams();
        if (alreadyMeasured) {
