...
public final class MultiDex {
    ...
    private static final class C0072V4 {
        /* access modifiers changed from: private */
    ...
    public static void install(android.content.Context r11) {
        ...
        L_0x001a:
            ...
            throw r7
        L_0x004c:
            android.content.pm.ApplicationInfo r1 = getApplicationInfo(r11)     // Catch:{ Exception -> 0x0064 }
            if (r1 == 0) goto L_0x0019
            java.util.Set<java.lang.String> r8 = installedApk     // Catch:{ Exception -> 0x0064 }
            monitor-enter(r8)     // Catch:{ Exception -> 0x0064 }
            java.lang.String r0 = r1.sourceDir     // Catch:{ all -> 0x0061 }
            java.util.Set<java.lang.String> r7 = installedApk     // Catch:{ all -> 0x0061 }
            boolean r7 = r7.contains(r0)     // Catch:{ all -> 0x0061 }
        ...
        L_0x0093:
            ...
            int r7 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x0061 }
            if (r7 <= r9) goto L_0x00ec
            java.lang.String r7 = "MultiDex"
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ all -> 0x0061 }
            r9.<init>()     // Catch:{ all -> 0x0061 }
            java.lang.String r10 = "MultiDex is not guaranteed to work in SDK version "
            java.lang.StringBuilder r9 = r9.append(r10)     // Catch:{ all -> 0x0061 }
            int r10 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x0061 }
            java.lang.StringBuilder r9 = r9.append(r10)     // Catch:{ all -> 0x0061 }
            ...
            java.lang.String r10 = java.lang.System.getProperty(r10)     // Catch:{ all -> 0x0061 }
            java.lang.StringBuilder r9 = r9.append(r10)     // Catch:{ all -> 0x0061 }
            java.lang.String r10 = "\""
            java.lang.StringBuilder r9 = r9.append(r10)     // Catch:{ all -> 0x0061 }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x0061 }
            android.util.Log.w(r7, r9)     // Catch:{ all -> 0x0061 }
        L_0x00ec:
            java.lang.ClassLoader r5 = r11.getClassLoader()     // Catch:{ RuntimeException -> 0x00fe }
        ...
        L_0x010e:
            java.io.File r2 = new java.io.File     // Catch:{ all -> 0x0061 }
            java.lang.String r7 = r1.dataDir     // Catch:{ all -> 0x0061 }
            java.lang.String r9 = SECONDARY_FOLDER_NAME     // Catch:{ all -> 0x0061 }
            r2.<init>(r7, r9)     // Catch:{ all -> 0x0061 }
            r7 = 0
            java.util.List r4 = android.support.multidex.MultiDexExtractor.load(r11, r1, r2, r7)     // Catch:{ all -> 0x0061 }
            boolean r7 = checkValidZipFiles(r4)     // Catch:{ all -> 0x0061 }
