...
final class RequestBuilder {
    ...
    public void addHeader(String name, String value) {
        if (ApiRequestHeadersInterceptor.HEADER_CONTENT_TYPE.equalsIgnoreCase(name)) {
    ...
    public Request build() {
        ...
        if (contentType2 != null) {
            if (body2 != null) {
                ...
                this.requestBuilder.addHeader(ApiRequestHeadersInterceptor.HEADER_CONTENT_TYPE, contentType2.toString());
            }
        }
