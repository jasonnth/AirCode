    ...
    static final class Builder<T> {
        ...
        private Headers parseHeaders(String[] headers2) {
            ...
            for (String header : headers2) {
                ...
                if (ApiRequestHeadersInterceptor.HEADER_CONTENT_TYPE.equalsIgnoreCase(headerName)) {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int p, Type type, Annotation[] annotations, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                if (!Map.class.isAssignableFrom(rawParameterType2)) {
                    throw parameterError(p, "@QueryMap parameter type must be Map.", new Object[0]);
                }
                Type mapType = Utils.getSupertype(type, rawParameterType2, Map.class);
                ...
                if (Iterable.class.isAssignableFrom(rawParameterType3)) {
                    if (!(type instanceof ParameterizedType)) {
                        throw parameterError(p, rawParameterType3.getSimpleName() + " must include generic type (e.g., " + rawParameterType3.getSimpleName() + "<String>)", new Object[0]);
                    }
                    ...
                    Header header2 = new Header(name3, this.retrofit.stringConverter(ServiceMethod.boxIfPrimitive(rawParameterType3.getComponentType()), annotations));
                ...
                if (!Map.class.isAssignableFrom(rawParameterType4)) {
                    throw parameterError(p, "@HeaderMap parameter type must be Map.", new Object[0]);
                }
                Type mapType2 = Utils.getSupertype(type, rawParameterType4, Map.class);
                ...
                if (Iterable.class.isAssignableFrom(rawParameterType5)) {
                    if (!(type instanceof ParameterizedType)) {
                        throw parameterError(p, rawParameterType5.getSimpleName() + " must include generic type (e.g., " + rawParameterType5.getSimpleName() + "<String>)", new Object[0]);
                    }
                    Field field2 = new Field(name4, this.retrofit.stringConverter(Utils.getParameterUpperBound(0, (ParameterizedType) type), annotations), encoded2);
                    return field2.iterable();
                } else if (rawParameterType5.isArray()) {
                    Field field3 = new Field(name4, this.retrofit.stringConverter(ServiceMethod.boxIfPrimitive(rawParameterType5.getComponentType()), annotations), encoded2);
                    return field3.array();
                } else {
                    Field field4 = new Field(name4, this.retrofit.stringConverter(type, annotations), encoded2);
                    return field4;
                }
                ...
                if (!Map.class.isAssignableFrom(rawParameterType6)) {
                    throw parameterError(p, "@FieldMap parameter type must be Map.", new Object[0]);
                }
                Type mapType3 = Utils.getSupertype(type, rawParameterType6, Map.class);
                ...
                if (!partName.isEmpty()) {
                    Headers headers2 = Headers.m3948of("Content-Disposition", "form-data; name=\"" + partName + "\"", "Content-Transfer-Encoding", part.encoding());
                    if (Iterable.class.isAssignableFrom(rawParameterType7)) {
                        if (!(type instanceof ParameterizedType)) {
                            throw parameterError(p, rawParameterType7.getSimpleName() + " must include generic type (e.g., " + rawParameterType7.getSimpleName() + "<String>)", new Object[0]);
                        }
                    ...
                    } else if (rawParameterType7.isArray()) {
                        Class<?> arrayComponentType = ServiceMethod.boxIfPrimitive(rawParameterType7.getComponentType());
                        ...
                        return part3.array();
                    } else if (MultipartBody.Part.class.isAssignableFrom(rawParameterType7)) {
                        throw parameterError(p, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                    } else {
                        Part part4 = new Part(headers2, this.retrofit.requestBodyConverter(type, annotations, this.methodAnnotations));
                        return part4;
                    }
                } else if (Iterable.class.isAssignableFrom(rawParameterType7)) {
                    if (!(type instanceof ParameterizedType)) {
                        throw parameterError(p, rawParameterType7.getSimpleName() + " must include generic type (e.g., " + rawParameterType7.getSimpleName() + "<String>)", new Object[0]);
                    ...
                    if (MultipartBody.Part.class.isAssignableFrom(rawParameterType7.getComponentType())) {
                ...
                if (!Map.class.isAssignableFrom(rawParameterType8)) {
                    throw parameterError(p, "@PartMap parameter type must be Map.", new Object[0]);
                }
                Type mapType4 = Utils.getSupertype(type, rawParameterType8, Map.class);
