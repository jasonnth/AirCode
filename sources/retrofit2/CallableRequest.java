...
public final class CallableRequest extends TypedRequest {
    ...
    public static final class Builder extends retrofit2.TypedRequest.Builder {
        ...
        public TypedRequest newRequest() {
            return new CallableRequest(this.retrofit, new ParameterizedType() {
    ...
    private CallableRequest(Retrofit retrofit, ParameterizedType returnType, BodyEncoding bodyEncoding, String path, Method method, Object body, Object tag, List<Query> query, Map<String, String> headers, List<Part> parts, List<Field> fields) {
