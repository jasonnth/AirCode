...
final class OkHttpCall<T> implements Call<T> {
    ...
    OkHttpCall(CallFactory<T> rawCallFactory2, Object[] args2) {
        this.rawCallFactory = rawCallFactory2;
        this.args = args2;
    }

    public OkHttpCall<T> clone() {
        return new OkHttpCall<>(this.rawCallFactory, this.args);
    }
    ...
    public retrofit2.Response<T> execute() throws java.io.IOException {
        ...
        L_0x0028:
            ...
            okhttp3.Call r0 = r4.createRawCall()     // Catch:{ IOException -> 0x0043, RuntimeException -> 0x0048 }
    ...
    private Call createRawCall() throws IOException {
        Call call = this.rawCallFactory.create(this.args);
        if (call != null) {
            return call;
        }
    ...
    public Response<T> parseResponse(Response rawResponse) throws IOException {
        ...
        if (code < 200 || code >= 300) {
            ...
            try {
                return Response.success(this.rawCallFactory.toResponse(catchingBody), rawResponse2);
            } catch (RuntimeException e) {
